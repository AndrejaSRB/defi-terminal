    ...
    70673: (e, t, o) => {
      ...
      function d(e) {
        ...
        return n.createElement(
          ...
          n.createElement(i.CheckboxView, {
            className: c().view,
      ...
      function u(e) {
        const {
          ...
          f = r()(
            ...
            o && d().checked,
            c && d().disabled,
            u && d().disableActiveStyles,
          );
        return n.createElement(
          'span',
          { className: f, ...h },
          n.createElement(l.Icon, { icon: v, className: d().icon }),
        );
      }
    },
    45601: (e, t, o) => {
    ...
    14283: (e, t, o) => {
      ...
      function T(e) {
        ...
        return n.createElement(
          ...
          n.createElement(S.SymbolSearchDialogContentItem, {
            ...
            onClick: function (t) {
              if (Boolean(a) && s && !c)
                return (t?.preventDefault(), void m(s));
              ...
              n.createElement(
                ...
                (function () {
                  ...
                  if (!Boolean(I.length) && !Boolean(C.length)) {
                    const e =
                      f.watchedTheme.value() === v.StdTheme.Dark ? R : A;
                    return n.createElement(
                      'div',
      ...
      function Y(e) {
        const {
          ...
          } = (0, w.useEnsuredContext)(b.SymbolSearchItemsDialogContext),
          {
            ...
            hoveredItemId: C,
            setHoveredItemId: E,
            selectedCompareOptionIndex: k,
            setSelectedCompareOptionIndex: D,
            selectedCompareIndex: M,
            setSelectedCompareIndex: N,
            selectedItemRef: _,
            clearInput: L,
            allowExtendTimeScale: O,
          } = (0, w.useEnsuredContext)(y),
          T = (0, p.useWatchedValueReadonly)({ watchedValue: I.studies() }),
          A = a[r],
          R = 'compare' === d,
          z = 'exchange' === d,
          H = R ? M : r,
            ...
            onKeyDown: function (e) {
              ...
              switch (n) {
                case 13: {
                  ...
                  const n = (function () {
                    ...
                    const n = l.enabled('allow_arbitrary_symbol_search_input'),
                      a = 'empty' !== S;
                    if (n)
                      return a && V.length ? e(V[0]) : o?.current?.value.trim();
                    if (!a && !t && !n) return;
                    if (V.length) return e(V[0]);
                  })();
                  return void (
                    n &&
                    (c([
                ...
                case 27:
                  return (
                    e.preventDefault(),
                    z ? void u('symbolSearch') : void f()
                  );
              }
              if (!R && 'good' !== S) return;
              switch ((0, j.mapKeyCodeToDirection)(n)) {
                case 'blockPrev':
                  if ((e.preventDefault(), 0 === H)) return;
                  if (-1 === H) return void G(0);
                  G(H - 1);
                  break;
                case 'blockNext':
                  if ((e.preventDefault(), H === V.length - 1)) return;
                  G(H + 1);
                  break;
                case 'inlinePrev': {
                  const o = Z();
                  ...
                  if (!k || o) return;
                  (e.preventDefault(), D(k - 1));
                  break;
                }
                case 'inlineNext': {
                  const o = Z();
                  if (o && !t.has(o)) return (e.preventDefault(), void i(o));
                  if (k === Y.length - 1 || o) return;
                  (e.preventDefault(), D(k + 1));
                  break;
                }
              }
        ...
        function U() {
          _.current?.scrollIntoView({ block: 'nearest' });
        }
        function Z() {
          if (!A) return;
          const { id: e, isOffset: t, onExpandClick: o } = A;
      ...
      function ee(e) {
        ...
        return (
          ...
          n.createElement($.DialogSearch, { ...e })
        );
        function r() {
          t.current &&
            a &&
      ...
      function le(e) {
        return new q({
          ...
          symbolTypes: (0, Q.getAvailableSymbolTypes)(),
          showSpreadActions:
            l.enabled('show_spread_operators') &&
            l.enabled('compare_symbol_search_spread_operators'),
        });
