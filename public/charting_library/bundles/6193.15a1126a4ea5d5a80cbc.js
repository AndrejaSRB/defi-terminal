(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6193],
  {
    ...
    53885: (e, t, o) => {
      'use strict';
      o.d(t, { getStyleClasses: () => l, isCircleLogoWithUrlProps: () => c });
      var n = o(97754),
        r = o.n(n),
        i = o(52292),
        s = o(57554),
      ...
      function l(e, t = 2, o) {
        return r()(
          ...
          o,
          0 === t || 1 === t
            ? r()(i.skeletonTheme.wrapper, a().skeleton)
            : a().letter,
    ...
    50238: (e, t, o) => {
      'use strict';
      o.d(t, { useRovingTabindexElement: () => s });
      var n = o(50959),
        r = o(39416),
        i = o(43010);
      function s(e, t = []) {
    ...
    59695: (e, t, o) => {
      ...
      var n = o(50959),
        r = o(53885),
        i = o(57554);
      const s = o.n(i)().hidden;
      function a(e) {
        const t = (0, r.isCircleLogoWithUrlProps)(e),
          [o, i] = (0, n.useState)(0),
          s = (0, n.useRef)(null),
          a = (0, r.getStyleClasses)(e.size, o, e.className),
          l = e.alt ?? e.title ?? '',
          c = t ? l[0] : e.placeholderLetter;
        return (
          (0, n.useEffect)(() => i((s.current?.complete ?? !t) ? 2 : 1), [t]),
          t && 3 !== o
            ? n.createElement('img', {
                ref: s,
                className: a,
        ...
        return (
          (0, n.useLayoutEffect)(
            () => (
              ...
              v.addDrawer(g),
              () => {
                (v.removeDrawer(g), x.unsubscribe(v, o));
              }
            ),
            [],
          ),
          n.createElement(
            ...
            n.createElement(
              'div',
              { ref: p, className: i(u.wrap, u[`position${t}`]) },
              g === v.currentDrawer &&
                n.createElement('div', { className: u.backdrop, onClick: o }),
              n.createElement(
                m,
                {
                  className: i(f.drawer, u[`position${t}`], h),
                  ref: b,
      ...
      function p(e) {
            ...
            () =>
              (function (e) {
                function t(t) {
                  ...
                  return n.createElement(i, { ...s, ref: o });
                }
        ...
        return n.createElement(
          ee,
          {
            ...
            id: t,
            role: o,
            className: r(d, L.item, b && L.withIcon, {
              [L.isActive]: w,
              [L.isDisabled]: E || C,
              [L.hovered]: k,
            }),
            ...
            reference: function (e) {
              ((X.current = e), 'function' == typeof B && B(e));
          ...
          $ && n.createElement('span', { className: L.startSlot }, $),
          b &&
            n.createElement('span', {
              'aria-label': H && H['aria-label'],
              'aria-hidden': H && Boolean(H['aria-hidden']),
              className: r(L.icon, W && c['round-icon'], x),
              dangerouslySetInnerHTML: { __html: b },
            }),
          n.createElement(
            'span',
            { className: r(L.labelRow, h) },
            n.createElement('span', { className: r(L.label, m) }, D),
          ),
          (void 0 !== v || g) &&
            n.createElement(
              'span',
    ...
    10381: (e, t, o) => {
      ...
      function l(e) {
        ...
        return n.createElement(i.Icon, {
          className: r(o, s.icon, { [s.dropped]: t }),
          icon: a,
        });
      }
    },
    ...
    73607: (e, t, o) => {
      ...
      function c(e) {
        ...
        const d = m(l),
          ...
          v = -1 !== f,
          g = (e) => {
            (o && (0, r.becomeSecondaryElement)(o),
        ...
        switch ((0, n.mapKeyCodeToDirection)(t)) {
          case 'inlinePrev':
            if (!d.length) return;
            (e.preventDefault(),
              g(0 === f ? s[c] : v ? u(d, f, -1) : d[d.length - 1]));
            break;
          case 'inlineNext':
            if (!d.length) return;
            (e.preventDefault(),
              f === d.length - 1 ? g(s[c]) : g(v ? u(d, f, 1) : d[0]));
            break;
          case 'blockPrev': {
            e.preventDefault();
            const t = u(s, c, -1);
    ...
    33647: (e, t, o) => {
      ...
      (o.d(t, { becomeMainElement: () => r, becomeSecondaryElement: () => i }),
        (function (e) {
    ...
    90397: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        c = o(11098);
      function d(e) {
        const { className: t, reference: o, ...r } = e,
          [d, u] = (0, a.useRovingTabindexElement)(o ?? null);
        return n.createElement(l.PopupMenuItem, {
          ...
          onKeyDown: function (e) {
            ...
            (13 !== t && 32 !== t) ||
              (e.preventDefault(),
              d.current instanceof HTMLElement && d.current.click());
          },
          'data-role': 'menuitem',
    ...
    78014: (e, t, o) => {
      ...
      function c(e, t) {
        return (o) => {
          const { contentWidth: c, contentHeight: d, availableHeight: u } = o,
          ...
          let b = t.verticalAttachEdge ?? l.verticalAttachEdge,
            x = t.verticalDropDirection ?? l.verticalDropDirection;
          b === n.AutoStrict &&
            (u < p.y + p.height + v + d
              ? ((b = n.Top), (x = i.FromBottomToTop))
              : ((b = n.Bottom), (x = i.FromTopToBottom)));
          const w = b === n.Top ? -1 * v : v,
            E = h === r.Right ? p.right : p.left,
            k = b === n.Top ? p.top : p.bottom,
            C = {
              x: E - (m === s.FromRightToLeft ? c : 0) + f,
              y: k - (x === i.FromBottomToTop ? d : 0) + w,
            };
      ...
      const a = s,
        l = n.forwardRef((e, t) => {
          const {
            ...
            N = r(E, w.button, {
              'apply-common-tooltip': Boolean(x || D),
              'common-tooltip-vertical': Boolean(D) && 'vertical' === y,
              [w.isActive]: c,
              [w.isOpened]: d,
              [w.isInteractive]: (k || Boolean(v)) && !u && !p,
              [w.isDisabled]: Boolean(u || p),
              [w.isGrouped]: h,
              [w.hover]: m,
              [w.clicked]: f,
              [w.pressed]: O,
            ...
            F =
              a &&
              ('string' == typeof a
                ? n.createElement(i.Icon, { className: w.icon, icon: a })
                : n.cloneElement(a, {
          ...
          return 'button' === o
            ...
            : n.createElement(
                ...
                l && n.createElement(i.Icon, { icon: l, className: s.endIcon }),
                M,
              );
        });
    },
    21618: (e, t, o) => {
      'use strict';
      o.d(t, { ToolWidgetIconButton: () => a });
      var n = o(50959),
        r = o(97754),
        i = o(46003),
        s = o(80204);
      const a = n.forwardRef(function (e, t) {
        const { className: o, id: a, ...l } = e;
    ...
    54374: (e, t, o) => {
      ...
      class b extends n.PureComponent {
        ...
        render() {
          const {
            ...
            E = i()(p, f.button, {
              'apply-common-tooltip': d || !s,
              [f.isDisabled]: s,
              [f.isOpened]: w,
              [f.clicked]: b,
            }),
            k = x(r) ? r({ isOpened: w }) : r;
          return 'button' === e
            ? n.createElement(
                'button',
                {
                ...
                o &&
                  n.createElement(
                    ...
                    n.createElement(
                      ...
                      n.createElement(l.ToolWidgetCaret, { dropped: w }),
                    ),
                  ),
                this.state.isOpened &&
                  (v
      ...
      b.defaultProps = { arrow: !0, closeOnClickOutside: !0, theme: v };
    },
    60925: (e) => {
      e.exports =
