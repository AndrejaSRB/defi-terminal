  ...
  [360],
  {
    84682: (e, t, i) => {
      ...
      var n = i(10555),
        ...
        l = i(2383),
        h = i(54707);
      class d extends h.LineSourcePaneView {
        constructor() {
          (super(...arguments),
        ...
        _updateImpl(e) {
          ...
          for (let e = 1; e < i.length; e++) {
            const r = i[e].subtract(i[e - 1]),
              o = r.length(),
              s = Math.min(5, Math.floor(o / t)),
              a = r.normalized().scaled(o / s);
            for (let t = 0; t < s - 1; t++) n.push(i[e - 1].add(a.scaled(t)));
            n.push(i[e]);
          }
    ...
    76196: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolDemonstrationHighlighter: () => h }));
      var n = i(4226),
        r = i(78176),
        o = i(55393),
        s = i(69558),
      ...
      class h extends o.LineToolBrushBase {
        constructor(e, t, i, r) {
          (super(
            e,
            h.createProperties(e.backgroundTheme().spawnOwnership()),
            !1,
            (0, n.randomHash)(),
          ),
            ...
            (this._color = t),
            (this._width = i),
            (this._visibilityTime = r),
            this._setPaneViews([new l(this, e)]));
        }
        smooth() {
          return 5;
        }
        ...
        _ignoreSourceEvent(e) {
          return (
            ...
            e.sourceId !== this.model().crosshairSource().id()
          );
        }
      }
    },
    54707: (e, t, i) => {
      ...
      function p(e, t) {
        ...
        if (!Number.isFinite(i) || !Number.isFinite(n) || (0 === i && 0 === n))
          return h.PaneCursorType.Default;
        let o = Math.atan2(n, i);
        return (
          o < 0 && (o += 2 * Math.PI),
          o >= _.deg337_5 ||
          o < _.deg22_5 ||
          (o >= _.deg157_5 && o < _.deg202_5)
            ? h.PaneCursorType.HorizontalResize
            : (o >= _.deg22_5 && o < _.deg67_5) ||
                (o >= _.deg202_5 && o < _.deg247_5)
              ? h.PaneCursorType.DiagonalNwSeResize
              : (o >= _.deg67_5 && o < _.deg112_5) ||
                  (o >= _.deg247_5 && o < _.deg292_5)
                ? h.PaneCursorType.VerticalResize
                : (o >= _.deg112_5 && o < _.deg157_5) ||
                    (o >= _.deg292_5 && o < _.deg337_5)
    ...
    73914: (e, t, i) => {
      i.d(t, {
        ...
        mapLineSourcePaneViewPointToLineAnchorPoint: () => w,
      });
      var n = i(10555),
        r = i(6453),
        o = i(50151),
      ...
      class f extends c.BitmapCoordinatesPaneRenderer {
        ...
        _drawPoints(e, t, i, r, s) {
          const {
            ...
            c = (0, o.ensureNotNull)(this._data),
            u = c.radius;
          let _ = Math.max(1, Math.floor((c.strokeWidth || 2) * h));
          c.selected && (_ += Math.max(1, Math.floor(h / 2)));
          ...
          for (let e = 0; e < t.length; ++e) {
            ...
            if (
              !(
                ...
                c.linePointBeingEdited === o.pointIndex
              )
            ) {
              l.fillStyle = i[e];
              if (
                (r(
                  l,
                  {
                    ...o,
                    point: new n.Point(
                      Math.round(o.point.x * h) + P,
                      Math.round(o.point.y * d) + P,
                    ),
                  },
                  g / 2,
                  _,
                ...
                if (
                  ...
                  o.pointIndex === c.hoveredPointIndex
                ) {
                  const e = Math.max(1, Math.floor(c.selectedStrokeWidth * h));
      ...
      function S(e, t = e.pointIndex, i, n, r, o, s, a, l, h) {
        return {
          point: e,
          pointIndex: t,
          cursorType: i,
      ...
      class p extends h.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          for (let n = 1; n < i; n++) {
            const i = this._points[n - 1],
              o = this._points[n];
            if ((0, r.distanceToSegment)(i, o, e).distance <= t)
              return this._hittest;
          }
          if (this._data.filled && this._data.fillBackground && i > 0) {
            const n = this._points[0],
              o = this._points[i - 1];
            if ((0, r.distanceToSegment)(n, o, e).distance <= t)
              return this._hittest;
          }
        ...
        _correctArrowPoints(e, t, i, n) {
          const r = t.subtract(e),
            o = r.length();
          if ('butt' === n || o < 1) return [e, t];
          const s = o + i / 2;
          return [e, r.scaled(s / o).add(e)];
        }
      }
    },
  },
