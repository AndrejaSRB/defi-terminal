...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8537, 5231],
  {
    ...
    90700: (e, t, i) => {
      i.d(t, { getLinesStylesPropertiesDefinitions: () => f });
      var n = i(11542),
        r = i(95804),
        o = i(67725),
        l = i(95338),
      ...
      const a = new r.TranslatedString(
        ...
        h = n.t(null, void 0, i(41410));
      function f(e, t, i) {
        const n = (0, s.removeSpaces)(i.originalText()),
          r = [],
          f = (0, o.createLineStyleDefinition)(
            e,
            {
    ...
    6255: (e, t, i) => {
      ...
      const a = new l.TranslatedString(
        ...
        f = new l.TranslatedString('show price', n.t(null, void 0, i(59012)));
      function y(e, t) {
        const l = [];
        if ('linesWidths' in e || 'linestyle' in e || 'linesColors' in e) {
          const p = (0, s.createLinePropertyDefinition)(
            {
              width: e.linesWidths
                ? new o.CollectiblePropertyUndoWrapper(
                    new r.LineToolCollectedProperty(e.linesWidths),
                    a,
                    t,
                  )
                : void 0,
              style: e.linestyle
                ? new o.CollectiblePropertyUndoWrapper(
                    new r.LineToolCollectedProperty(e.linestyle),
                    c,
                    t,
                  )
                : void 0,
              color: e.linesColors
                ? new o.CollectiblePropertyUndoWrapper(
                    new r.LineToolCollectedProperty(e.linesColors),
                    d,
                    t,
                  )
                : void 0,
        ...
        if (
          ...
          const {
            ...
            p = (0, s.createCheckablePropertyDefinition)(
              {
                checked: new o.CollectiblePropertyUndoWrapper(
                  new r.LineToolCollectedProperty([...a, ...c, ...d]),
                  f,
                  t,
                ),
              },
          ...
          const a = (0, s.createColorPropertyDefinition)(
            {
              checked: e.fillBackground
                ? new o.CollectiblePropertyUndoWrapper(
                    new r.LineToolCollectedProperty(e.fillBackground),
                    u,
                    t,
                  )
                : void 0,
              color: new o.CollectiblePropertyUndoWrapper(
                new r.LineToolCollectedProperty(e.backgroundsColors),
                p,
                t,
              ),
            },
        ...
        if ('textsColors' in e) {
          const a = (0, s.createLinePropertyDefinition)(
            {
              color: new o.CollectiblePropertyUndoWrapper(
                new r.LineToolCollectedProperty(e.textsColors),
                h,
                t,
              ),
            },
    ...
    67621: (e, t, i) => {
      i.d(t, { getTrendLineToolsStylePropertiesDefinitions: () => B });
      var n = i(11542),
        r = i(95804),
        o = i(67725),
        l = i(95338),
      ...
      const d = new r.TranslatedString(
        ...
        W = n.t(null, void 0, i(42349));
      function B(e, t, i, n) {
        const r = (0, c.removeSpaces)(i.originalText()),
          a = [],
          B = t,
        ...
        const I = (0, l.createCheckablePropertyDefinition)(
          ...
          { id: `${r}MiddlePoint`, title: (n && n.middlePoint) || w },
        );
        a.push(I);
        ...
        const N = [],
          E = (0, l.createCheckablePropertyDefinition)(
            ...
            { id: `${r}PriceRange`, title: (n && n.priceRange) || b },
          );
        N.push(E);
        const U = (0, l.createCheckablePropertyDefinition)(
          ...
          { id: `${r}PercentChange`, title: (n && n.percentChange) || C },
        );
        N.push(U);
        const O = (0, l.createCheckablePropertyDefinition)(
          {
          ...
          { id: `${r}PipsChange`, title: (n && n.pipsChange) || x },
        );
        N.push(O);
        const G = (0, l.createCheckablePropertyDefinition)(
          ...
          { id: `${r}BarsRange`, title: (n && n.barRange) || L },
        );
        if ((N.push(G), 'showDateTimeRange' in t)) {
          const o = (0, l.createCheckablePropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(
                e,
            ...
            { id: `${r}DateTimeRange`, title: (n && n.dateTimeRange) || A },
          );
          N.push(o);
        }
        if ('showDistance' in t) {
          const o = (0, l.createCheckablePropertyDefinition)(
            ...
            { id: `${r}Distance`, title: (n && n.distance) || k },
          );
          N.push(o);
        }
        if ('showAngle' in t) {
          const o = (0, l.createCheckablePropertyDefinition)(
            ...
            { id: `${r}Angle`, title: (n && n.angle) || V },
          );
          N.push(o);
        }
        const F = [];
        F.push(
          (0, l.createPropertyDefinitionsCheckableListOptionsGroup)(
            N,
            void 0,
            [],
            'trendLineToolCheckableListGroup',
            $,
          ),
        );
        const H = (0, l.createOptionsPropertyDefinition)(
          {
        ...
        const j = (0, l.createCheckablePropertyDefinition)(
          ...
          { id: `${r}ShowStats`, title: (n && n.showStats) || M },
        );
        return (
          F.push(j),
          a.push(
    ...
    91445: (e, t, i) => {
      ...
      const s = new r.TranslatedString(
        ...
        w = n.t(null, void 0, i(79468)),
        m = n.t(null, void 0, i(38408)),
        S = n.t(null, void 0, i(7560)),
        b = n.t(null, void 0, i(6060));
      function C(e, t, i, n) {
        const r = {},
          C = {
        ...
        if (
          (void 0 === t.showText ||
            n.hideTextCheckbox ||
            (r.checked = (0, o.convertToDefinitionProperty)(
              e,
              t.showText,
              s.format({ toolName: i }),
            )),
          void 0 !== t.textColor &&
            (r.color = (0, o.getColorDefinitionProperty)(
              e,
              t.textColor,
              t.transparency || null,
              a.format({ toolName: i }),
          ...
          void 0 !== t.fontSize &&
            (r.size = (0, o.convertToDefinitionProperty)(
              e,
              t.fontSize,
              c.format({ toolName: i }),
            )),
          void 0 !== t.bold &&
            (r.bold = (0, o.convertToDefinitionProperty)(
              e,
              t.bold,
              d.format({ toolName: i }),
            )),
          void 0 !== t.italic &&
            (r.italic = (0, o.convertToDefinitionProperty)(
              e,
              t.italic,
              p.format({ toolName: i }),
            )),
          ...
          const l = u.format({ toolName: i });
          ((r.text = (0, o.convertToDefinitionProperty)(e, t.text, l, void 0)),
            (C.isEditable = Boolean(n.isEditable)),
            (C.isMultiLine = Boolean(n.isMultiLine)));
        }
        if (
          (void 0 !== t.vertLabelsAlign &&
            ((r.alignmentVertical = (0, o.convertToDefinitionProperty)(
              e,
              t.vertLabelsAlign,
              h.format({ toolName: i }),
            )),
            (C.alignmentVerticalItems = n.alignmentVerticalItems)),
          void 0 !== t.horzLabelsAlign &&
            ((r.alignmentHorizontal = (0, o.convertToDefinitionProperty)(
              e,
              t.horzLabelsAlign,
              f.format({ toolName: i }),
            )),
            (C.alignmentHorizontalItems = n.alignmentHorizontalItems)),
          void 0 !== t.textOrientation &&
            (r.orientation = (0, o.convertToDefinitionProperty)(
              e,
              t.textOrientation,
              y.format({ toolName: i }),
            )),
          void 0 !== t.backgroundVisible &&
            (r.backgroundVisible = (0, o.convertToDefinitionProperty)(
              e,
              t.backgroundVisible,
              g.format({ toolName: i }),
            )),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (C.backgroundTitle =
              (n.customTitles && n.customTitles.backgroundTitle) || w),
          void 0 !== t.borderVisible &&
            (r.borderVisible = (0, o.convertToDefinitionProperty)(
              e,
              t.borderVisible,
              _.format({ toolName: i }),
            )),
          void 0 !== t.borderWidth &&
            (r.borderWidth = (0, o.convertToDefinitionProperty)(
              e,
              t.borderWidth,
              P.format({ toolName: i }),
            )),
          void 0 !== t.borderColor &&
            (r.borderColor = (0, o.getColorDefinitionProperty)(
              e,
              t.borderColor,
              null,
              T.format({ toolName: i }),
          ...
          void 0 !== t.wrap &&
            ((r.wrap = (0, o.convertToDefinitionProperty)(
              e,
              t.wrap,
              D.format({ toolName: i }),
            )),
            (C.wrapTitle = (n.customTitles && n.customTitles.wrapTitle) || S)),
          (0, o.createTextPropertyDefinition)(r, C)
        );
      }
    },
    28578: (e, t, i) => {
    ...
    62171: (e, t, i) => {
      (i.r(t), i.d(t, { ArrowMarkerDefinitionsViewModel: () => p }));
      var n = i(11542),
        r = i(95804),
        o = i(95338),
        l = i(14472),
      ...
      class p extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = new r.TranslatedString(t, this._source.translatedType());
          return {
            definitions: [
    ...
    1336: (e, t, i) => {
      ...
      class T extends o.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = new r.TranslatedString(t, this._source.translatedType()),
          ...
          return {
            definitions: [
              ...
              (0, l.createOptionsPropertyDefinition)(
                ...
                { id: `${n}Mode`, title: g, options: new s.WatchedValue(P) },
              ),
            ...
            return {
              definitions: [
                (0, s.createTextStyleDefinition)(
                  this._propertyApplier,
                  { ...e, textColor: e.textcolor, fontSize: e.fontsize },
                  new r.TranslatedString(
                    this._source.name(),
                    this._source.translatedType(),
                  ),
    ...
    6238: (e, t, i) => {
      (i.r(t), i.d(t, { ElliottPatternDefinitionsViewModel: () => y }));
      var n = i(11542),
        r = i(95804),
        o = i(67725),
        l = i(14472),
    ...
    3086: (e, t, i) => {
      (i.r(t), i.d(t, { EllipseCircleDefinitionsViewModel: () => l }));
      var n = i(95804),
        r = i(91445),
        o = i(27877);
      class l extends o.GeneralFiguresDefinitionsViewModelBase {
        _textPropertyDefinitions() {
          const e = this._source.properties().childs();
          return {
            definitions: [
    ...
    38455: (e, t, i) => {
      ...
      const p = new o.TranslatedString(
        ...
        P = new o.TranslatedString(
          ...
          r.t(null, void 0, i(31753)),
        ),
        T = r.t(null, void 0, i(51574)),
        D = r.t(null, void 0, i(28683)),
        w = r.t(null, void 0, i(79468)),
        m = r.t(null, void 0, i(79650)),
        S = r.t(null, void 0, i(53912));
      class b extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            ...
            a = new o.TranslatedString(i, this._source.translatedType()),
    ...
    55200: (e, t, i) => {
      (i.r(t),
        i.d(t, { FibDrawingsWith24LevelsDefinitionsViewModel: () => j }));
      var n = i(50151),
        r = i(11542),
        o = i(95804),
        l = i(67725),
      ...
      const f = new o.TranslatedString(
        ...
        x = new o.TranslatedString(
          ...
          r.t(null, void 0, i(85509)),
        ),
        L = r.t(null, void 0, i(51574)),
        A = r.t(null, void 0, i(36937)),
        k = r.t(null, void 0, i(68461)),
        V = r.t(null, void 0, i(25112)),
        M = r.t(null, void 0, i(79192)),
        $ = r.t(null, void 0, i(25188)),
        W = r.t(null, void 0, i(64489)),
        B = r.t(null, void 0, i(29416)),
        R = r.t(null, void 0, i(79650)),
        I = r.t(null, void 0, i(5119)),
        z = r.t(null, void 0, i(70320)),
        N = r.t(null, void 0, i(2573)),
        E = r.t(null, void 0, i(28683)),
        U = r.t(null, void 0, i(79468)),
        O = r.t(null, void 0, i(66086)),
        G = [
          { id: 'values', value: !1, title: r.t(null, void 0, i(60092)) },
          { id: 'percents', value: !0, title: r.t(null, void 0, i(33120)) },
        ],
        F = [
          {
            id: c.VerticalAlign.Top,
            value: c.VerticalAlign.Bottom,
            title: r.t(null, void 0, i(97118)),
          },
          {
            id: c.VerticalAlign.Middle,
            value: c.VerticalAlign.Middle,
            title: r.t(null, void 0, i(68833)),
          },
          {
            id: c.VerticalAlign.Bottom,
            value: c.VerticalAlign.Top,
            title: r.t(null, void 0, i(27567)),
          },
        ],
      ...
      class j extends a.LineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          const e = [],
            ...
            i = t.childs(),
            r = this._source.name(),
            a = (0, u.removeSpaces)(r),
            c = new o.TranslatedString(r, this._source.translatedType());
          if ('trendline' in i) {
          ...
          const q = (0, l.createLineStyleDefinition)(
            this._propertyApplier,
            Y,
            c,
            'LevelsStyleLine',
          ...
          e.push(
            (0, s.createPropertyDefinitionsGeneralGroup)([Q], `${a}Group`),
          );
          ...
          e.push(ne);
          const re = (0, s.createTwoOptionsPropertyDefinition)(
            {
          ...
          const ae = (0, s.createOptionsPropertyDefinition)(
            ...
            { id: `${a}FontSize`, title: N, options: new p.WatchedValue(H) },
          );
          if (
            (e.push(ae),
    ...
    56689: (e, t, i) => {
      ...
      const u = new o.TranslatedString(
        ...
        m = r.t(null, void 0, i(79468)),
        S = r.t(null, void 0, i(5119)),
        b = [
          {
    ...
    66758: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          GannComplexAndFixedDefinitionsViewModel: () => I,
      ...
      const f = new o.TranslatedString(
        ...
        D = new o.TranslatedString(
          ...
          r.t(null, void 0, i(28833)),
        ),
        w = new o.TranslatedString(
          'change {title} fan {index} line color',
          r.t(null, void 0, i(62500)),
        ),
        m = new o.TranslatedString(
          'change {title} fan {index} line width',
          r.t(null, void 0, i(6298)),
        ),
        S = new o.TranslatedString(
          'change {title} arcs {index} line visibility',
          r.t(null, void 0, i(4313)),
        ),
        b = new o.TranslatedString(
          'change {title} arcs {index} line color',
          r.t(null, void 0, i(95582)),
        ),
        C = new o.TranslatedString(
          'change {title} arcs {index} line width',
          r.t(null, void 0, i(8745)),
        ),
        x = new o.TranslatedString(
          'change top margin',
          r.t(null, void 0, i(74883)),
        ),
        L = r.t(null, void 0, i(64489)),
        A = r.t(null, void 0, i(28683)),
        k = r.t(null, void 0, i(79468)),
        V = r.t(null, void 0, i(78393)),
        M = r.t(null, void 0, i(27177)),
        $ = r.t(null, void 0, i(79650)),
        W = r.t(null, void 0, i(84885)),
        B = r.t(null, void 0, i(59129));
      function R(e) {
        return e instanceof c.LineToolGannComplex;
      }
      class I extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            t = this._source.properties().childs(),
            i = this._source.name(),
            r = (0, u.removeSpaces)(i),
            a = new o.TranslatedString(i, this._source.translatedType()),
            c = [],
          ...
          for (let e = 0; e < I; e++) {
            const i = t.levels.childs()[e].childs(),
              n = (0, s.createLeveledLinePropertyDefinition)(
                ...
                { id: `${r}LineLevel${e}`, title: `${e}` },
              );
            c.push(n);
          }
          const z = (0, s.createPropertyDefinitionsLeveledLinesGroup)(
            c,
            `${r}LeveledLinesGroup`,
          );
          e.push(
    ...
    52715: (e, t, i) => {
      (i.r(t), i.d(t, { GannFanDefinitionsViewModel: () => D }));
      var n = i(50151),
        r = i(11542),
        o = i(95804),
        l = i(95338),
      ...
      const d = new o.TranslatedString(
        ...
        _ = r.t(null, void 0, i(28683)),
        P = r.t(null, void 0, i(79468)),
        T = r.t(null, void 0, i(5119));
      class D extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            t = this._source.properties().childs(),
            i = this._source.name(),
            r = (0, a.removeSpaces)(i),
            s = new o.TranslatedString(i, this._source.translatedType()),
    ...
    11033: (e, t, i) => {
      ...
      const d = new o.TranslatedString(
        ...
        D = new o.TranslatedString(
          ...
          r.t(null, void 0, i(15972)),
        ),
        w = new o.TranslatedString(
          'change {title} fans line color',
          r.t(null, void 0, i(1716)),
        ),
        m = r.t(null, void 0, i(28683)),
        S = r.t(null, void 0, i(79468)),
        b = r.t(null, void 0, i(58557)),
        C = r.t(null, void 0, i(58476)),
        x = r.t(null, void 0, i(65e3)),
        L = r.t(null, void 0, i(28971)),
        A = r.t(null, void 0, i(74939)),
        k = r.t(null, void 0, i(17129)),
        V = r.t(null, void 0, i(36335)),
        M = r.t(null, void 0, i(64489));
        ...
        _stylePropertyDefinitions() {
          ...
          const B = (0, l.createPropertyDefinitionsLeveledLinesGroup)(
            ...
            I = (0, l.createCheckablePropertyDefinition)(
              ...
              { id: `${r}RightLabels`, title: L },
            ),
            z = (0, l.createTransparencyPropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(
                  this._propertyApplier,
              ...
              { id: `${r}BackgroundH`, title: S },
            ),
            N = (0, l.createPropertyDefinitionsGeneralGroup)(
              [B, R, I, z],
              `${r}HLevelGroup`,
              b,
            );
          ...
          const O = (0, l.createPropertyDefinitionsLeveledLinesGroup)(
              E,
    ...
    86763: (e, t, i) => {
      (i.r(t), i.d(t, { GeneralDatePriceRangeDefinitionsViewModel: () => z }));
      var n = i(11542),
        r = i(95804),
        o = i(67725),
        l = i(91445),
      ...
      const d = new r.TranslatedString(
        ...
        D = n.t(null, void 0, i(3554)),
        w = n.t(null, void 0, i(38408)),
        m = n.t(null, void 0, i(79468)),
        S = n.t(null, void 0, i(71397)),
        b = n.t(null, void 0, i(76410)),
        C = n.t(null, void 0, i(25112)),
        x = n.t(null, void 0, i(68461)),
        L = n.t(null, void 0, i(42349)),
        A = n.t(null, void 0, i(26754)),
        k = n.t(null, void 0, i(89073)),
        V = n.t(null, void 0, i(62374)),
        M = n.t(null, void 0, i(37644)),
        $ = n.t(null, void 0, i(62362)),
        W = n.t(null, void 0, i(73525)),
        B = n.t(null, void 0, i(4518)),
        R = n.t(null, void 0, i(74872)),
        I = n.t(null, void 0, i(16236));
      class z extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            t = this._source.properties().childs(),
            s = this._source.name(),
            z = (0, c.removeSpaces)(s),
            N = new r.TranslatedString(s, this._source.translatedType()),
            E = (0, o.createLineStyleDefinition)(
              this._propertyApplier,
          ...
          e.push(E);
          const U = t.hasOwnProperty('borderWidth');
          if (U) {
          ...
          const O = (0, a.createColorPropertyDefinition)(
            {
          ...
          if (G) {
            const r = (0, a.createCheckablePropertyDefinition)(
                {
                  checked: (0, a.convertToDefinitionProperty)(
                    this._propertyApplier,
                    t.extendTop,
              ...
              o = (0, a.createCheckablePropertyDefinition)(
                ...
                { id: `${z}ExtendBottom`, title: b },
              );
            e.push(
              (0, a.createPropertyDefinitionsCheckableListOptionsGroup)(
                [r, o],
                void 0,
                [],
                'lineExtend',
                n.t(null, void 0, i(41410)),
                void 0,
                void 0,
                n.t(null, void 0, i(80736)),
              ),
            );
          }
          const F = (function (e) {
          ...
          const H = [];
          if (F || U) {
            const e = (0, a.createCheckablePropertyDefinition)(
              {
                checked: (0, a.convertToDefinitionProperty)(
                  this._propertyApplier,
                  t.showPriceRange,
            ...
            const i = (0, a.createCheckablePropertyDefinition)(
              ...
              { id: `${z}PercentChange`, title: W },
            );
            H.push(i);
            const n = (0, a.createCheckablePropertyDefinition)(
              {
                checked: (0, a.convertToDefinitionProperty)(
                  this._propertyApplier,
                  t.showPipsPriceRange,
          ...
          j.push(
            (0, a.createPropertyDefinitionsCheckableListOptionsGroup)(
              ...
              void 0,
              [],
              'datePriceRangeCheckableListGroup',
              A,
            ),
          );
          const Y = (0, l.createTextStyleDefinition)(
            this._propertyApplier,
            {
            ...
            N,
            {
              isEditable: !0,
              isMultiLine: !0,
              customTitles: { text: R, backgroundTitle: I },
            },
          );
          return (
            j.push(Y),
          ...
          return {
            definitions: [
              (0, l.createTextStyleDefinition)(
                this._propertyApplier,
                { ...e, textColor: e.color, fontSize: e.fontsize },
                new r.TranslatedString(
                  this._source.name(),
                  this._source.translatedType(),
                ),
    ...
    27877: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          GeneralFiguresDefinitionsViewModel: () => f,
      ...
      class h extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = new r.TranslatedString(t, this._source.translatedType()),
            n = (0, o.createLineStyleDefinition)(
              this._propertyApplier,
              {
                lineColor: e.color,
                lineWidth: e.linewidth,
    ...
    96662: (e, t, i) => {
      (i.r(t), i.d(t, { GeneralTrendFiguresDefinitionsViewModel: () => g }));
      var n = i(11542),
        r = i(95804),
        o = i(67725),
        l = i(91445),
      ...
      class g extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = new r.TranslatedString(t, this._source.translatedType());
          return {
            definitions: [
              ...
              (0, a.createColorPropertyDefinition)(
                ...
                { id: (0, d.removeSpaces)(`${t}Background`), title: y },
              ),
            ],
          };
        }
          ...
          return {
            definitions: [
              (0, l.createTextStyleDefinition)(
                ...
                { isEditable: !0, isMultiLine: !0, alignmentVerticalItems: h },
              ),
            ],
          };
        }
    ...
    1486: (e, t, i) => {
      ...
      const c = new r.TranslatedString(
        ...
        P = n.t(null, void 0, i(45054)),
        T = n.t(null, void 0, i(333)),
        D = n.t(null, void 0, i(32163)),
        w = n.t(null, void 0, i(19788)),
        m = n.t(null, void 0, i(52648)),
        S = n.t(null, void 0, i(29566));
      class b extends o.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = (0, a.removeSpaces)(t),
            n = new r.TranslatedString(t, this._source.translatedType()),
    ...
    32548: (e, t, i) => {
      ...
      class u extends c.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            c = new o.TranslatedString(t, this._source.translatedType()),
            u = (0, r.removeSpaces)(t);
          return {
            definitions: [
    ...
    1162: (e, t, i) => {
      (i.r(t), i.d(t, { HorizontalLineDefinitionsViewModel: () => u }));
      var n = i(11542),
        r = i(95804),
        o = i(95338),
        l = i(97578),
        ...
        c = i(90700),
        d = i(91445);
      const p = n.t(null, { context: 'linetool point' }, i(37814));
    ...
    91509: (e, t, i) => {
      (i.r(t), i.d(t, { HorizontalRayDefinitionsViewModel: () => s }));
      var n = i(95804),
        r = i(14472),
        o = i(90700),
        l = i(91445);
      class s extends r.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs();
          return (0, o.getLinesStylesPropertiesDefinitions)(
            this._propertyApplier,
            e,
            new n.TranslatedString(
              this._source.name(),
    ...
    37120: (e, t, i) => {
      ...
      class d extends o.LineDataSourceDefinitionsViewModel {
        constructor(e, t) {
          super(e, t);
        }
        _stylePropertyDefinitions() {
    ...
    11375: (e, t, i) => {
      (i.r(t), i.d(t, { ImageDefinitionsViewModel: () => y }));
      var n = i(11542),
        r = i(95804),
        o = i(95338),
        l = i(14472),
      ...
      class y extends l.LineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          ...
          if (void 0 === this._customErrorProperty) {
            const t = new a.Property(f(e.url.value()));
            ((this._customErrorProperty = t),
              e.url.subscribe(this, (e) => {
                t.setValue(f(e.value()));
              }));
          }
          return {
            definitions: [
              (0, o.createImagePropertyDefinition)(
                {
                  url: (0, o.convertToDefinitionProperty)(
                    this._propertyApplier,
                    this._source.absoluteUserImageUrl(),
                    c,
                  ),
                  transparency: (0, o.convertToDefinitionProperty)(
                    this._propertyApplier,
                    e.transparency,
                    d,
                  ),
              ...
              (0, o.createTransparencyPropertyDefinition)(
                {
                  transparency: (0, o.convertToDefinitionProperty)(
                    this._propertyApplier,
                    e.transparency,
    ...
    83904: (e, t, i) => {
      (i.r(t), i.d(t, { ParallelChannelDefinitionsViewModel: () => C }));
      var n = i(11542),
        r = i(50151),
        o = i(95804),
        l = i(95338),
      ...
      const h = new o.TranslatedString(
        ...
        P = n.t(null, void 0, i(87430)),
        T = n.t(null, void 0, i(79468)),
        D = new o.TranslatedString(
          'change {title} level {index} line visibility',
      ...
      class C extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            t = this._source.properties(),
            s = t.childs(),
            a = this._source.name(),
            c = (0, d.removeSpaces)(a),
            p = new o.TranslatedString(a, this._source.translatedType()),
              ...
              o = (0, l.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(
                    this._propertyApplier,
                    n.visible,
                    D.format({ title: p, index: i }),
                  ),
                  color: (0, l.getColorDefinitionProperty)(
                    this._propertyApplier,
                    n.color,
                    null,
                    w.format({ title: p, index: i }),
                  ),
                  width: (0, l.convertToDefinitionProperty)(
                    this._propertyApplier,
                    n.lineWidth,
                ...
                { id: `${c}LineLevel${i}`, locked: 2 === i || 6 === i },
              );
            e.push(o);
          }
          const v = (0, l.createCheckablePropertyDefinition)(
              ...
              { id: `${c}ExtendLeft`, title: _ },
            ),
            C = (0, l.createCheckablePropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(
                  this._propertyApplier,
                  s.extendRight,
          ...
          return {
            definitions: [
              (0, c.createTextStyleDefinition)(
                ...
                { isEditable: !0, isMultiLine: !0, alignmentVerticalItems: v },
              ),
            ],
          };
        }
    ...
    29809: (e, t, i) => {
      (i.r(t), i.d(t, { PatternWithBackgroundDefinitionViewModel: () => y }));
      var n = i(11542),
        r = i(95804),
        o = i(67725),
        l = i(91445),
          ...
          return {
            definitions: [
              ...
              (0, a.createColorPropertyDefinition)(
                ...
                { id: (0, c.removeSpaces)(`${t}BackgroundColor`), title: f },
              ),
            ],
          };
        }
    ...
    52536: (e, t, i) => {
      (i.r(t),
        i.d(t, { PatternWithoutBackgroundDefinitionsViewModel: () => d }));
      var n = i(11542),
        r = i(95804),
        o = i(67725),
        l = i(91445),
    ...
    71530: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          PitchForkDefinitionsViewModel: () => u,
        }));
      var n = i(11542),
        r = i(95804),
        o = i(95338),
      ...
      class u extends l.PitchBaseDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = super._stylePropertyDefinitions(),
            t = this._source.properties().childs(),
            i = this._source.name(),
            n = new r.TranslatedString(i, this._source.translatedType()),
            l = (0, o.createOptionsPropertyDefinition)(
              {
                option: (0, o.convertToDefinitionProperty)(
                  this._propertyApplier,
                  t.style,
                  c.format({ title: n }),
                ),
    ...
    24457: (e, t, i) => {
      ...
      const c = new r.TranslatedString(
        ...
        P = n.t(null, void 0, i(88479)),
        T = n.t(null, void 0, i(14279)),
        D = n.t(null, void 0, i(64598)),
        w = n.t(null, void 0, i(59264)),
    ...
    9833: (e, t, i) => {
      (i.r(t), i.d(t, { RectangleDefinitionsViewModel: () => v }));
      var n = i(11542),
        r = i(95804),
        o = i(91682),
        l = i(50605),
      ...
      const p = new r.TranslatedString(
        ...
        h = n.t(null, void 0, i(25112)),
        f = n.t(null, void 0, i(68461)),
        y = n.t(null, void 0, i(68286)),
        g = [
      ...
      class v extends c.GeneralFiguresDefinitionsViewModelBase {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            l = new r.TranslatedString(t, this._source.translatedType()),
            c = super._stylePropertyDefinitions(),
            d = e.middleLine.childs(),
            g = (0, a.createLineStyleDefinition)(
              this._propertyApplier,
              {
                showLine: d.showLine,
            ...
            v = c.definitions.findIndex(
              (e) => e.id === (0, o.removeSpaces)(`${t}BackgroundColor`),
            );
          v < 0 ? c.definitions.push(g) : c.definitions.splice(v, 0, g);
          const _ = (0, s.createCheckablePropertyDefinition)(
              {
                checked: (0, s.convertToDefinitionProperty)(
                  this._propertyApplier,
                  e.extendLeft,
          ...
          return (
            c.definitions.unshift(
              (0, s.createPropertyDefinitionsCheckableListOptionsGroup)(
                [_, P],
                void 0,
                [],
                'lineExtend',
          ...
          return {
            definitions: [
              (0, d.createTextStyleDefinition)(
                ...
                { isEditable: !0, isMultiLine: !0, alignmentVerticalItems: g },
              ),
            ],
          };
        }
    ...
    29065: (e, t, i) => {
      ...
      const u = new o.TranslatedString(
          ...
          r.t(null, void 0, i(26598)),
        ),
        h = new o.TranslatedString(
          'change {title} target color',
          r.t(null, void 0, i(10504)),
        ),
        f = new o.TranslatedString(
          'change {title} price labels visibility',
          r.t(null, void 0, i(343)),
        ),
        y = new o.TranslatedString(
          'change {title} compact stats mode',
          r.t(null, void 0, i(49904)),
        ),
        g = new o.TranslatedString(
          'change {title} always show stats',
          r.t(null, void 0, i(80390)),
        ),
        v = new o.TranslatedString(
          'change {title} account size',
          r.t(null, void 0, i(99232)),
        ),
        _ =
          (new o.TranslatedString(
            'change {title} currency',
            r.t(null, void 0, i(91600)),
          ),
          new o.TranslatedString(
            'change {title} lot size',
            r.t(null, void 0, i(54087)),
          )),
        P = new o.TranslatedString(
          'change {title} risk',
          r.t(null, void 0, i(79875)),
        ),
        T = new o.TranslatedString(
          'change {title} risk display mode',
          r.t(null, void 0, i(60308)),
        ),
        D = new o.TranslatedString(
          'change {title} entry price',
          r.t(null, void 0, i(91534)),
        ),
        w = new o.TranslatedString(
          'change {title} profit level',
          r.t(null, void 0, i(64330)),
        ),
        m = new o.TranslatedString(
          'change {title} profit price',
          r.t(null, void 0, i(12073)),
        ),
        S = new o.TranslatedString(
          'change {title} stop level',
          r.t(null, void 0, i(45438)),
        ),
        b = new o.TranslatedString(
          'change {title} stop price',
          r.t(null, void 0, i(27503)),
        ),
        C = r.t(null, void 0, i(56982)),
        x = r.t(null, void 0, i(33310)),
        L = r.t(null, void 0, i(3560)),
        A = r.t(null, void 0, i(70320)),
        k = r.t(null, void 0, i(89735)),
        V = r.t(null, void 0, i(24821)),
        M = r.t(null, void 0, i(83840)),
        $ = r.t(null, void 0, i(6002)),
        W = r.t(null, void 0, i(67852)),
        B = r.t(null, void 0, i(23814)),
        R = r.t(null, void 0, i(97668)),
        I = r.t(null, void 0, i(74045)),
        z = r.t(null, void 0, i(63886)),
        N = r.t(null, void 0, i(93857)),
        E = r.t(null, void 0, i(42747)),
        U = r.t(null, void 0, i(75106)),
        O = r.t(null, void 0, i(87145));
      function G(e) {
        return [
          { value: d.RiskDisplayMode.Percentage, title: U },
          { value: d.RiskDisplayMode.Money, title: e || O },
        ];
      }
      class F extends a.LineDataSourceDefinitionsViewModel {
        constructor(e, t) {
          ...
          ((this._riskMaxWV = new p.WatchedValue(this._getRiskMax(n))),
            ...
            i.currency.subscribe(this, () => this._updateRiskUnit()),
            this._undoModel
              .model()
              .mainSeries()
              .dataEvents()
              .symbolResolved()
              .subscribe(this, this._updateRiskUnit));
        }
        destroy() {
          super.destroy();
          const e = this._source.properties().childs();
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            r = new o.TranslatedString(t, this._source.translatedType());
          return {
            definitions: [
    ...
    76399: (e, t, i) => {
      ...
      const p = new r.TranslatedString(
        ...
        y = n.t(null, { context: 'linetool point' }, i(87476)),
          ...
          return {
            definitions: [
              (0, s.createCoordinatesPropertyDefinition)(
                ...
                {
                  id: (0, o.removeSpaces)(`${t}Coordinates${y}`),
                  title: y,
                  ...i.info,
                  ...n.info,
                },
          ...
          return {
            definitions: [
              (0, s.createEmojiPropertyDefinition)(
                ...
                { id: (0, o.removeSpaces)(`${t}Emoji${g}`), title: g },
              ),
            ],
          };
        }
    ...
    58227: (e, t, i) => {
      ...
      class f extends l.LineDataSourceDefinitionsViewModel {
        _coordinatesPropertyDefinitions() {
          ...
          const r = (0, o.createNumberPropertyDefinition)(
            {
    ...
    85134: (e, t, i) => {
      ...
      const h = new o.TranslatedString(
        ...
        m = r.t(null, void 0, i(51574)),
        S = r.t(null, void 0, i(28683)),
        b = r.t(null, void 0, i(79468)),
        C = r.t(null, void 0, i(5119));
      class x extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            ...
            i = t.childs(),
            r = this._source.name(),
            a = (0, p.removeSpaces)(r),
            x = new o.TranslatedString(r, this._source.translatedType()),
          ...
          for (let i = 1; i <= k; i++) {
            const r = (0, n.ensureDefined)(t.child(`level${i}`)).childs(),
              o = (0, s.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(
                    this._propertyApplier,
    ...
    71192: (e, t, i) => {
      (i.r(t), i.d(t, { TrendLineDefinitionsViewModel: () => s }));
      var n = i(95804),
        r = i(14472),
        o = i(67621),
        l = i(91445);
      class s extends r.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs();
          return (0, o.getTrendLineToolsStylePropertiesDefinitions)(
            this._propertyApplier,
            e,
            new n.TranslatedString(
              this._source.name(),
    ...
    50105: (e, t, i) => {
      (i.r(t), i.d(t, { VerticalLineDefinitionsViewModel: () => u }));
      var n = i(11542),
        r = i(95804),
        o = i(95338),
        l = i(97578),
        ...
        c = i(14472),
        d = i(91445);
      const p = n.t(null, { context: 'linetool point' }, i(26381));
      class u extends c.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs();
    ...
    7750: (e, t, i) => {
      (i.r(t), i.d(t, { AnchoredVWAPDefinitionsViewModel: () => O }));
      var n = i(11542),
        r = i(95804),
        o = (i(40167), i(95338)),
        l = i(34108),
      ...
      const c = new r.TranslatedString(
        ...
        I = n.t(null, void 0, i(83301)),
        z = n.t(null, void 0, i(64848)),
        N = n.t(null, void 0, i(58375)),
        E = n.t(null, void 0, i(97273));
      function U(e, t, i, n, r, l, s, c, d) {
        return (0, o.createLinePropertyDefinition)(
          {
            ...
            width: (0, o.convertToDefinitionProperty)(
              e,
              t.linewidth,
              r.format({ title: d }),
            ),
      ...
      class O extends l.StudyLineDataSourceDefinitionsViewModel {
        constructor(e, t) {
          super(e, t);
        }
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            O = this._source.metaInfo();
          if (O.styles?.UpperBand && O.styles?.LowerBand) {
            const t = e.styles.childs().LowerBand.childs(),
              ...
              o = e.styles.childs().UpperBand.childs(),
              l = U(
                this._propertyApplier,
                o,
                f,
          ...
          if (O?.area) {
            const t = e.areaBackground.childs(),
              r = (0, o.createLinePropertyDefinition)(
                {
                  checked: (0, o.convertToDefinitionProperty)(
                    this._propertyApplier,
                    t.fillBackground,
                ...
                { id: `${i}Background`, title: N },
              );
            a.push(r);
          }
          if (
            O.styles?.UpperBand_2 &&
            O.styles?.LowerBand_2 &&
            O.styles?.UpperBand_3 &&
            O.styles?.LowerBand_3
          ) {
            const t = e.styles.childs().LowerBand_2.childs(),
              ...
              o = e.styles.childs().UpperBand_2.childs(),
              l = U(
                this._propertyApplier,
                o,
                T,
          ...
          const G = (0, o.createCheckablePropertyDefinition)(
            {
              checked: (0, o.convertToDefinitionProperty)(
                this._propertyApplier,
                e.axisLabelVisible,
    ...
    32823: (e, t, i) => {
      ...
      function c(e) {
        return (
          !e.groupId &&
          !e.isHidden &&
          e.id !== a.RangeDependentStudyInputNames.FirstBar &&
          e.id !== a.RangeDependentStudyInputNames.LastBar
        );
      }
      var d = i(48282);
      const p = (0, r.getLogger)(
      ...
      class u {
        ...
        getUserEditablePlots() {
          ...
          return t.plots.filter((i) => {
            if (
              (0, l.isColorerPlot)(i) ||
              (0, l.isTextColorerPlot)(i) ||
              (0, l.isDataOffsetPlot)(i) ||
              (0, l.isOhlcColorerPlot)(i) ||
              (0, l.isAlertConditionPlot)(i) ||
              (0, l.isDataPlot)(i)
            )
              return !1;
            if ((0, l.isOhlcPlot)(i)) {
              ...
              if (e.has(r)) return !1;
              e.add(r);
              const o = (0, n.ensureDefined)(t.ohlcPlots);
              return !(0, n.ensureDefined)(o[r]).isHidden;
            }
            {
    ...
    13098: (e, t, i) => {
      ...
      function o(e, t, i) {
        for (const r of Object.keys(e.levels ?? {}))
          if (e.levels[r] && (0, n.isSameType)(e.levels[r], t.typecheck())) {
            let n = t.tpl();
            (i.names.forEach((i, o) => {
              n = t.fill('' + o, i, e.levels[r], n);
            }),
              (e.levels[r] = n));
          }
        return e;
      ...
      class u extends s.LineDataSource {
        constructor(e, t, n, r) {
          (super(
            ...
            (this.version = 2),
            Promise.all([i.e(6290), i.e(986), i.e(6668), i.e(1583)])
              .then(i.bind(i, 5497))
              .then(({ GannComplexPaneView: e }) => {
                this._setPaneViews([new e(this, this.model())]);
              }));
          const o = this.properties();
          (this._adjustScaleRatio(o),
            o.subscribe(this, this._adjustScaleRatio),
            o.childs().scaleRatio.subscribe(this, this._correctFirstPoint),
        ...
        addPoint(e, t, i) {
          ...
          const n = super.addPoint(e, t, i),
            r = this.priceScale();
          return (
            !(0, o.ensureNotNull)(r).isLog() && n && this._correctFirstPoint(),
            n
          );
        }
        setPoint(e, t, i) {
        ...
        static _configureProperties(e) {
            ...
            n = e.childs();
          {
            ...
            for (let r = 0; r < e; r++) {
              const e = n.levels.childs()[r].childs();
          ...
          }
          {
            ...
            for (let r = 0; r < e; r++) {
              const e = n.fanlines.childs()[r].childs();
              (t.push(e.width), i.push(e.color));
            }
          }
          {
            ...
            for (let r = 0; r < e; r++) {
              const e = n.arcs.childs()[r].childs();
              (t.push(e.width), i.push(e.color));
            }
          }
        ...
        _migratePoint() {
          ...
          if (null === e) return;
          const t = (0, o.ensureNotNull)(this.screenPointToPoint(e[1]));
          (this.setPoint(1, t),
        ...
        _getScreenPoints() {
          ...
          const n = (0, o.ensureNotNull)(this.pointToScreenPoint(t)),
            l = (0, o.ensureNotNull)(this.pointToScreenPoint(i)),
            s = Math.sqrt(Math.pow(n.x - l.x, 2) + Math.pow(n.y - l.y, 2)),
            a = new r.Point(Math.cos(e), -Math.sin(e)),
            c = a.normalized(),
            d = c.x < 0 ? -1 : 1,
            p = c.y < 0 ? -1 : 1;
          return [n.addScaled(a, s), n.add(new r.Point(5 * s * d, 5 * s * p))];
        }
        _calcAngle() {
          const [e, t] = this.points(),
            i = (0, o.ensureNotNull)(this.pointToScreenPoint(e));
          let n = (0, o.ensureNotNull)(this.pointToScreenPoint(t)).subtract(i);
          if (n.length() > 0) {
            n = n.normalized();
            let e = Math.acos(n.x);
            return (n.y > 0 && (e = -e), e);
    ...
    62414: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        v = i(68335),
        _ = i(37103);
      const P = y.t(null, void 0, i(15402));
      var T = i(60709),
        D = i(78861);
      ...
      function S(e) {
        if ('LineToolImage' !== e)
          return (m?.then((e) => e()), void (m = null));
        (0, f.runOrSigninWithFeature)(
          () => {
            const e = 'LineToolImage';
            (D.tool.setValue(e),
              (0, h.trackDrawingToolSelected)(e, 'Left panel'),
              (m = w(b, () => {
                (m?.then((e) => e()),
                  (m = null),
                  D.tool.value() === e && (0, D.resetToCursor)(!0));
              })),
              (0, u.trackEvent)('Image', 'Open image dialog'));
          },
          { feature: 'drawings', source: 'Change drawing tool state' },
        );
      }
      function b(e) {
        const t = (0, T.chartWidgetCollectionService)();
        if (null === t) return;
        const r = !Boolean(p.getBool('hint.pasteImage')),
        ...
        (o
          ...
          .pasteImageAsLineTool(
            ...
            e.blobUrl,
            (0, n.ensureNotNull)(
              o.model().model().paneForSource(o.model().mainSeries()),
            ),
            e.transparency,
          ),
          r &&
            ...
            _.enabled('popup_hints') &&
              !g.CheckMobile.any() &&
              Promise.all([i.e(6195), i.e(628), i.e(2227), i.e(6166)])
                .then(i.bind(i, 91759))
                .then((e) => {
                  const t = new e.ChartEventHintRenderer(l),
                    i = P.format({
                      shortcut: (0, v.humanReadableHash)(v.Modifiers.Mod + 86),
                    });
                  let n = null;
                  (t.show(i, () => {
                    null !== n &&
      ...
      const C = (0, o.getLogger)('Chart.LineToolImage');
      var x;
      function L(e) {
      ...
      function k(e) {
        return L(e) || A(e) ? e : null;
      }
      function V(e) {
        return A(e) ? e : new URL(e).pathname;
      }
      class M extends c.LineDataSource {
        constructor(e, t, n, r) {
          ...
          ((this._absoluteUserImageUrl = new a.Property(
            k(this.properties().childs().url.value()) ?? '',
          )),
            this._absoluteUserImageUrl.subscribe(this, (e) => {
              const t = e.value();
              if (L(t)) return;
              const i = k(t);
              null !== i && o.setValue(V(i));
            }),
            o.subscribe(this, () => {
              const e = k(o.value());
        ...
        pointToScreenPoint({ index: e, price: t }, i, o) {
          const l = this._model.timeScale(),
            s = (0, n.ensureNotNull)(i ? i.priceScale() : this.priceScale()),
            a = (0, n.ensure)((i ?? this.ownerSource())?.firstValue()),
            c = l.indexToCoordinate(e) + (o ?? 0),
            d = s.priceToCoordinate(t, a);
          return new r.Point(c, d);
        }
        setPoint(e, t, i) {
          if (null === this._image) return;
          const { width: r, height: o } = this._image,
            l = (0, n.ensureNotNull)(this.pointToScreenPoint(t)),
            s = (0, n.ensureNotNull)(
              this.pointToScreenPoint(this._points[0], void 0, this.dOffsetX()),
            ),
            a = Math.max(Math.abs(s.x - l.x) / r, Math.abs(s.y - l.y) / o),
            c = Math.round(r * a),
            d = Math.round(o * a),
        ...
        startChanging(e, t) {
          (super.startChanging(e, t),
            this._changeOriginPoint(M._oppositePoints[e]));
        }
        endChanging(e, t) {
        ...
        _changeOriginPoint(e) {
          const t = this.originPoint(),
            i =
              4 === t
                ? M._correctOriginDirections[e]
                : M._correctOriginDirections[M._oppositePoints[t]],
            o = this.properties().childs().cssWidth.value() / 2,
            l = this.properties().childs().cssHeight.value() / 2,
            [s] = this._points,
            a = (0, n.ensureNotNull)(this.pointToScreenPoint(s)),
            c = new r.Point(a.x + o * i[0], a.y + l * i[1]),
        ...
        _createImage(e) {
          const t = L(e),
            i = k(e);
          if (null === i) return void C.logWarn(`Invalid image URL: ${e}`);
          ...
          ((r.crossOrigin = 'anonymous'),
            ...
            r.addEventListener('load', () => {
              ...
              if (!t) {
                const e = V(i);
                (o.url.setValue(e), (this._blobUrl = void 0));
              }
              if (o.cssWidth.value() && o.cssHeight.value())
              ...
              const l = e.timeScale().width() / 4,
                ...
                f = Math.round(h * a),
                y = Math.round(h * c);
              (o.cssWidth.setValue(f),
                o.cssHeight.setValue(y),
      ...
      ((M._correctOriginDirections = [
        ...
        (M._oppositePoints = [3, 2, 1, 0, 4]),
        (0, D.runOnDrawingStateReady)(() => {
          D.tool.subscribe(S);
        }));
    },
    11810: (e, t, i) => {
