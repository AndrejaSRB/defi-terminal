(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2704],
  {
    ...
    53885: (e, t, n) => {
      'use strict';
      n.d(t, { getStyleClasses: () => c, isCircleLogoWithUrlProps: () => l });
      var o = n(97754),
        r = n.n(o),
        i = n(52292),
        s = n(57554),
    ...
    87896: (e, t, n) => {
      ...
      function d(e, t, n = 'legacy') {
        const s = o.createElement(u, { renderMode: n }, e);
        if ('modern' === n) {
      ...
      function d(e) {
        ...
        return o.createElement(
          ...
          o.createElement(a.Icon, {
            className: i()(u.icon, r && u.mobile, v),
            icon: r ? l : c,
          }),
          h &&
            (!r || '' !== C.value) &&
    ...
    28587: (e, t, n) => {
            ...
            f &&
              (void 0 !== n
                ? o.createElement(A.CircleLogo, {
                    ...
                    className: p()(M.icon, x),
                  })
                : o.createElement('span', { className: p()(M.fakeIcon, x) })),
            o.createElement(
              'div',
              { className: p()(M.labelAndDescription, x) },
              o.createElement('span', { className: p()(M.label, x) }, E(t)),
              h && o.createElement('br', null),
              h &&
                o.createElement(
                  'span',
                  { className: p()(M.description, x) },
                  s ? E(s) : '',
                ),
            ),
            void 0 !== v &&
              o.createElement(
                'div',
                {
                  className: p()(
                    ...
                    v && M.action__favoriteIcon_active,
                  ),
                },
      ...
      var k = n(51417),
        ...
        I = n(72045),
        D = n(45602);
      const N = (0, x.mergeThemes)(C.DEFAULT_MENU_THEME, D);
      function F(e) {
        const {
            title: t,
            sections: r,
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(v.Icon, { icon: k, className: I.icon }),
              o.createElement('input', {
                size: 1,
                type: 'text',
                className: I.input,
                placeholder: f.t(null, void 0, n(8573)),
                autoComplete: 'off',
                'data-role': 'search',
                onChange: function (e) {
                  l(e.target.value);
          ...
          c
            ...
            : r.map((e, t) =>
                o.createElement(
                  o.Fragment,
                  { key: e.id },
                  Boolean(t) && o.createElement(E.PopupMenuSeparator, null),
                  e.name
                    ? o.createElement(
      ...
      function P(e) {
        ...
        return o.createElement(L.AdaptivePopupDialog, {
          title: t,
          onClose: r,
          render: function () {
            return o.createElement(
      ...
      function B(e) {
        const { element: t, ...n } = e,
          ...
          h = (0, o.useRef)(null),
          p = (0, o.useRef)(null),
          f = (0, o.useMemo)(() => (0, l.createRegExpList)(s), [s]),
        ...
        const C = (0, o.useMemo)(
          () => ({
            selectedId: Boolean(v >= 0 && r[v]) ? r[v].id : '',
            selectedRef: p,
            search: s,
            setSearch: a,
            searchRef: h,
          ...
          (e) =>
            e
              ...
              : o.createElement(F, {
                  ...n,
                  ...C,
                  position: (0, m.getPopupPositioner)(t, O),
                  doNotCloseOn: t,
                }),
        );
        function x() {
    ...
    36189: (e, t, n) => {
      ...
      function m(e) {
        const {
          ...
          [f, v] = (0, c.useActiveDescendant)(null),
          g =
            h ??
            (n
            ...
            return (
              n.forEach((e) => {
                ...
                if (Array.isArray(u))
                  for (const e of u)
                    if (s.test(e))
                      return ((m = 1), void (d = e.match(s)?.index));
              }),
          ...
          ? (n.forEach((e) => {
              ...
              if (((e.fuzzyHighlight = !s), a))
                if (e.fuzzyHighlight) {
                  ...
                  for (let e = 0; e < a[0].length; e++) o[a.index + e] = !0;
            }),
            o)
          : o;
      }
    ...
    20520: (e, t, n) => {
      ...
      function m(e) {
        const {
          ...
          y = (0, o.useContext)(c.CloseDelegateContext),
          w = o.useContext(d),
          A = (0, o.useContext)(l),
          b = (0, u.useOutsideEvent)({
            handler: function (e) {
              f && f(e);
              if (!h) return;
      ...
      function l(e, t) {
        return (n) => {
          ...
          let C = t.verticalAttachEdge ?? c.verticalAttachEdge,
            x = t.verticalDropDirection ?? c.verticalDropDirection;
          C === o.AutoStrict &&
            (d < m.y + m.height + v + u
              ? ((C = o.Top), (x = i.FromBottomToTop))
              : ((C = o.Bottom), (x = i.FromTopToBottom)));
          const E = C === o.Top ? -1 * v : v,
            y = h === r.Right ? m.right : m.left,
            w = C === o.Top ? m.top : m.bottom,
            A = {
              x: y - (p === s.FromRightToLeft ? l : 0) + f,
              y: w - (x === i.FromBottomToTop ? u : 0) + E,
            };
    ...
    27056: (e, t, n) => {
      ...
      function a(e, t, a) {
        ...
        if (null !== u) {
          const e = (0, o.ensureNotNull)(v.item(u)),
            t = (0, i.createAction)(
              u,
        ...
        const g = v.filterConvertible(m, (e) => e !== u && d.has(e));
        for (const e of g) {
        ...
        f.actions.length > 0 && c.push(f);
        const C = v.filterConvertible(m, (e) => e !== u && !d.has(e)),
          x = [],
          E = [];
        for (const e of C) {
          const n = (0, o.ensureNotNull)(v.item(e.id)),
        ...
        return (
          (E.length > 0 || x.length > 0) &&
            c.push({ id: 'second_section', actions: x.concat(E) }),
          c
        );
      }
    },
