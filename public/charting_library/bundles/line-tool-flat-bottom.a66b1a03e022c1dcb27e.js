...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    28121: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolFlatBottom: () => h }));
      var s = i(50151),
        n = i(41414),
        r = i(78176),
        o = i(87465),
      ...
      class h extends n.LineDataSource {
        ...
        _getAlertPlots() {
          ...
          const n = { price: s.price, time: e.time, index: e.index },
            r = [];
          let l, p, a, h;
          (s.index <= n.index ? (r.push(s), r.push(n)) : (r.push(n), r.push(s)),
            i[0].price > r[0].price
              ? ((l = i), (p = r))
              : r[0].price > i[0].price || r[1].price > i[1].price
                ? ((l = r), (p = i))
                : ((l = i), (p = r)));
          ...
          return (
            ...
            [
              this._linePointsToAlertPlot(l, 'Upper', a, h),
              this._linePointsToAlertPlot(p, 'Lower', d, h),
            ].filter(o.notNull)
          );
        }
        ...
        static _configureProperties(e) {
          (super._configureProperties(e),
            e.hasChild('labelText') ||
              e.addChild('labelText', new l.Property('')),
            e.addExcludedKey('labelText', 1),
            e.addChild(
              'textsColors',
              new a.LineToolColorsProperty([
                (0, s.ensureDefined)(e.child('labelTextColor')),
              ]),
            ));
        }
      }
