  ...
  [4731],
  {
    ...
    63117: (e, t, i) => {
      ...
      class m extends p.LineDataSource {
        ...
        editableTextStyle() {
          return { ...(this._isDarkBackground.value() ? g : v) };
        }
        ...
        _changeEditableTextUndoCommand(e, t) {
          return new b(this._model, this, e, t);
        }
    ...
    1086: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          Constants: () => c,
          LineToolTrendBasedFibExtension: () => u,
        }));
      var s = i(11542),
        n = i(95804),
        r = i(40226),
      ...
      class u extends l.LineToolFibWithInplaceTextBase {
        constructor(e, t, s, n) {
          (super(
            e,
