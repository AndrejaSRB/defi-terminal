(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2306],
  {
    ...
    97737: (t, e, o) => {
      ...
      function u(t) {
        return c.createElement(h.SquareButton, { ...d(t) });
      }
    },
    43814: (t, e, o) => {
      'use strict';
      o.d(e, { SquareButton: () => _ });
      var i = o(50959),
        n = o(97754),
        r = o.n(n),
        s = o(95604),
      ...
      function h(t) {
        ...
        return r()(
          ...
          y,
          p && l().grouped,
          p && !g && l().adjustPosition,
          p && m.isTop && l().firstRow,
          p && m.isLeft && l().firstCol,
          v && _ && l().multilineContent,
          f && l().link,
          c,
        );
      }
      function d(t) {
        ...
        if (e && s && o)
          return i.createElement(
            'span',
            { className: r()(l().slot, l().startSlotWrap) },
            e,
          );
        const d = o && (e ?? s),
          u = !e && !s && !o && !n && a && h;
        return i.createElement(
          ...
          n && !d && i.createElement('span', { className: l().content }, n),
          s &&
            i.createElement(
              'span',
              { className: r()(l().slot, l().endSlotWrap) },
              s,
            ),
          u &&
            !d &&
            (function (t) {
              return (
                ...
                i.createElement(
                  'div',
                  { className: r()(l().textWrap, c) },
                  i.createElement(
                    'span',
                    { className: l().primaryText },
                    ' ',
                    t.primaryText,
                    ' ',
                  ),
      ...
      function v(t) {
        ...
        return {
          ...d,
          ...(0, m.filterDataProps)(t),
          ...(0, m.filterAriaProps)(t),
        };
      }
      function _(t) {
        const {
          ...
          C =
            ...
            (t.primaryText
              ...
              : (0, u.getTextForTooltip)(t.children));
        return i.createElement(
          'button',
          {
            ...v(_),
            'aria-disabled': n || m,
            tabIndex: t.tabIndex ?? (n ? -1 : 0),
            className: b,
            ref: e,
            onClick: g(r, n),
            onMouseDown: g(l, n),
        ...
        return (
          (0, i.useEffect)(
            () => {
              ...
              let i = null;
              return (
                (0, n.respectAbort)(o.signal, t())
                  .then((t) => s((i = t)))
                  .catch(n.skipAbortError),
                () => {
                  (o.abort(), i && e && e(i));
                }
              );
            ...
            const t = (0, n.ensureNotNull)(e.current),
              o = () => {
                ...
                if (
                  0 === o.length ||
                  (o[0].parentElement &&
                    !m(o[0].parentElement, (0, n.ensureNotNull)(e.current)))
                ) {
                  const i = (function (t) {
                    const o = p(t).sort(r.navigationOrderComparator),
                      i = o.find((t) => m(t, (0, n.ensureNotNull)(e.current)));
                    if (!i) return null;
          ...
          [
            ...
            function (e) {
              ...
              if (t) {
                ...
                ((a = t ? Array.from(t.children) : []), (c = a.indexOf(i)));
              } else
                ((a = ((d = n),
                Array.from(
                  d.querySelectorAll(
              ...
              const m = (0, r.mapKeyCodeToDirection)(o);
              switch (m) {
                case 'inlinePrev':
                  if ((e.preventDefault(), !t && 0 === c)) break;
                  g(u(a, c, -1));
                  break;
                case 'inlineNext':
                  if ((e.preventDefault(), !t && c === a.length - 1)) break;
                  g(u(a, c, 1));
                  break;
                case 'blockPrev':
                case 'blockNext':
                  ((o) => {
                    ...
                    const a =
                      i[
                        'blockNext' === o ? i.indexOf(r) + 1 : i.indexOf(r) - 1
                      ];
                    if (!a) return;
                    e.preventDefault();
                    const l = Array.from(a.children);
                    l.length && (!t && s <= l.length - 1 ? g(l[s]) : g(l[0]));
                  })(m);
              }
            },
          ]
    ...
    16697: (t, e, o) => {
      ...
      function w(t) {
        const { color: e, selected: r, onSelect: a, onSwatchRemove: l } = t,
          [c, w] = (0, i.useState)(!1),
          [y, b] = (0, g.useRovingTabindexElement)(null),
        ...
        return i.createElement(
          ...
          i.createElement('button', {
            ...
            className: n(
              ...
              r && _.selected,
              !e && _.empty,
              String(e).toLowerCase() === m.white && _.white,
            ),
            onClick: function () {
              a(e);
            },
      ...
      function b(t) {
        ...
        return i.createElement(
          ...
          h.map((t, e) =>
            i.createElement(
              'div',
              { className: _.row, 'data-role': 'row', key: e },
              t.map((t, o) =>
                i.createElement(w, {
                  key: String(t) + o,
                  color: t,
      ...
      class M extends i.PureComponent {
          ...
          (super(...arguments),
            ...
            (this._handleKeyDown = (t) => {
              const {
                ...
                r = (0, L.hashFromEvent)(t);
              if (!n || !B.includes(r)) return;
              if (37 === r || 39 === r) {
                return void n({
                  h: e,
                  s: (0, P.clamp)(37 === r ? o - D : o + D, 0, 1),
                  v: i,
                });
              }
              n({
        ...
        render() {
          ...
          return i.createElement(
            ...
            {
              tabIndex: 0,
              className: r()(E.accessible, t),
              onKeyDown: this._handleKeyDown,
            },
            i.createElement(
              'div',
              {
                className: E.saturation,
      ...
      class W extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            {
              className: r()(A.hue, A.accessible, t),
              tabIndex: 0,
              onKeyDown: this._handleKeyDown,
            },
            i.createElement(
      ...
      var k = o(55778);
      const z = '#000000',
        N = s.t(null, { context: 'Color Picker' }, o(55517));
        ...
        constructor(t) {
          (super(t),
            ...
            (this._handleHSV = (t) => {
              ...
              (this.setState({ color: e, inputColor: R(e), hsv: t }),
                this.props.onSelect(e));
            }),
            (this._handleInput = (t) => {
              const e = R(t.currentTarget.value);
              try {
                const t = x(e),
                  o = `#${e}`;
          ...
          const e = t.color || z;
          this.state = { color: e, inputColor: R(e), hsv: x(e) };
        }
        componentDidMount() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('div', {
                className: r()(
                  k.swatch,
                  String(t).toLowerCase() === m.white && k.white,
                ),
      ...
      var F = o(30329);
      const V = s.t(null, { context: 'Color Picker' }, o(29619)),
        O = s.t(null, { context: 'Color Picker' }, o(80936));
      function H(t) {
        const {
            color: e,
            opacity: o,
          ...
          [p, g] = (0, i.useState)(!1),
          v = 'number' == typeof o ? o : 1,
          [_, f] = (0, a.useRowsNavigation)();
        return (
          (0, i.useLayoutEffect)(() => {
            u && u.update();
          }, [s, u]),
          p
            ...
            : i.createElement(
                ...
                i.createElement(
                  ...
                  i.createElement('div', { className: F.separator }),
                  i.createElement(
                    b,
                    {
                      colors: l,
                ...
                s &&
                  i.createElement(
                    i.Fragment,
                    null,
                    i.createElement('div', { className: F.sectionTitle }, O),
    ...
    77975: (t, e, o) => {
      'use strict';
      o.d(e, { useWatchedValueReadonly: () => n });
      var i = o(50959);
      const n = (t, e = !1, o = []) => {
        const n = 'watchedValue' in t ? t.watchedValue : void 0,
          r = 'defaultValue' in t ? t.defaultValue : t.watchedValue.value(),
          [s, a] = (0, i.useState)(n ? n.value() : r);
        return (
          (e ? i.useLayoutEffect : i.useEffect)(() => {
            if (n) {
              a(n.value());
              const t = (t) => a(t);
              return (n.subscribe(t), () => n.unsubscribe(t));
            }
            return () => {};
          }, [n, ...o]),
          s
    ...
    19836: (t) => {
      t.exports = { button: 'button-KTgbfaP5' };
    },
    74163: (t) => {
    ...
    63027: (t, e, o) => {
      'use strict';
      (o.r(e), o.d(e, { FavoriteDrawingToolbar: () => E }));
      var i = o(50959),
        n = o(32227),
        r = o(11542),
        s = o(35162),
      ...
      function P(t) {
        const { title: e, actions: o, className: n, onActionClick: r } = t,
          s = (0, T.useWatchedValueReadonly)({ watchedValue: d.tool }),
          a = o.map((t) =>
            (function (t, e, o) {
              return i.createElement(b.AccessibleMenuItem, {
                key: t,
                onClick: () => o(t),
                label: u.lineToolsInfo[t].localizedName,
                icon: u.lineToolsInfo[t].icon,
                isActive: t === e,
              });
            })(t, s, r),
          );
        return i.createElement(
          y.ToolWidgetMenu,
          {
            className: x(n, L.dots),
            arrow: !1,
            title: e,
            drawerBreakpoint: C.Mobile,
            content: i.createElement(w.Icon, { icon: S }),
            'data-name': 'more',
      ...
      o(54188);
      class E extends s.FloatingToolbar {
        constructor(t) {
          (super({
            allowSortable: !0,
            ...
            (this._canBeShownValue = new v.WatchedValue(!1)),
            (this._reactContainer = null),
            (this._onActionClick = async (t) => {
              (await (0, f.initLineTool)(t),
                h.ContextMenuManager.hideAll(),
                d.tool.value() !== t &&
                  (d.tool.setValue(t),
                  (0, g.trackDrawingToolSelected)(t, 'Favorites panel')));
            }),
        ...
        _createLinetoolWidget(t) {
          const e = `<span class="tv-favorited-drawings-toolbar__widget apply-common-tooltip ${t === d.tool.value() ? 'i-active' : ''}" title="${u.lineToolsInfo[t].localizedName}" data-name="FavoriteToolbar${t}">${u.lineToolsInfo[t].icon}</span>`,
        ...
        _loadVisibilityState() {
          ...
          (void 0 !== i
            ? (p.remove('ChartFavoriteDrawingToolbarWidget.visible', {
                forceFlush: !0,
              }),
              (o = 'false' !== i),
              m.TVLocalStorage.setItem(
    ...
    35162: (t, e, o) => {
        ...
        constructor(t) {
          ((this._helper = null),
            (this._handleDragStart = (t) => {
              ...
              const [o, i] = [(0, p.outerWidth)(e), (0, p.outerHeight)(e)];
              ((this._helper = {
        ...
        constructor(t) {
          ((this._items = []),
            ...
            (this._handleDragStart = (t) => {
              ...
              ((this._helper = {
                ...
                leftBorder:
                  n.left +
                  y(o, 'padding-left') +
                  y(o, 'border-left-width') -
                  i.left -
                  1,
                rightBorder:
                  n.right -
                  y(o, 'padding-right') -
                  y(o, 'border-right-width') -
                  i.right +
                  1,
                topBorder:
                  n.top +
                  y(o, 'padding-top') +
                  y(o, 'border-top-width') -
                  i.top -
                  1,
                bottomBorder:
                  n.bottom -
                  y(o, 'padding-bottom') -
                  y(o, 'border-bottom-width') -
                  i.bottom +
                  1,
              }),
            ...
            (this._handleDragMove = (t) => {
              ...
              if ('y' === c) {
                const t = (0, v.clamp)(d, e, o);
                s.style.transform = `translateY(${t}px)`;
              }
              if ('x' === c) {
                const t = (0, v.clamp)(h, i, n);
      ...
      class S {
        ...
        _preventWidgetTouchEndEvent() {
          const t = (e) => {
            (e.preventDefault(),
              this._widget.removeEventListener('touchend', t));
          };
    ...
    36699: (t, e, o) => {
      'use strict';
      (o.r(e), o.d(e, { LineToolPropertiesWidget: () => Se }));
      var i = o(50959),
        n = o(32227),
        r = o(11542),
        s = o(95804),
        ...
        L = o(66611),
        P = o(79951);
      const E = (0, y.mergeThemes)(w.DEFAULT_POPUP_MENU_ITEM_THEME, P),
        B = [
          { value: 1, icon: C },
          { value: 2, icon: T },
          { value: 3, icon: x },
      ...
      function D(t) {
        const {
          ...
          c = (0, f.useProperty)((0, g.ensureDefined)(e)),
          h = 'mixed' === c || !c,
          d = (function (t) {
        ...
        return i.createElement(
          _.ToolWidgetMenu,
          {
            ...
            verticalDropDirection: s
              ? b.VerticalDropDirection.FromBottomToTop
              : void 0,
            horizontalDropDirection: s
              ? b.HorizontalDropDirection.FromRightToLeft
              : void 0,
            horizontalAttachEdge: s ? b.HorizontalAttachEdge.Right : void 0,
            verticalAttachEdge: s ? b.VerticalAttachEdge.Top : void 0,
            content: i.createElement(
              ...
              h
                ? i.createElement(
                    'div',
                    { className: P.multiWidth },
                    i.createElement(v.Icon, { icon: L }),
                  )
                : i.createElement(
                    'div',
                    { className: P.buttonWrap },
                    !l && i.createElement(v.Icon, { icon: d }),
                    i.createElement(
                      'div',
                      { className: p(!l && P.buttonLabel) },
                      `${c}px`,
                    ),
                  ),
            ),
          ...
          B.map(({ value: t, icon: e }) =>
            i.createElement(w.PopupMenuItem, {
              key: t,
              theme: E,
              label: `${t}px`,
              icon: e,
      ...
      function I(t) {
        const {
          ...
          c = (0, f.useProperty)(e),
          h = (0, i.useRef)(null),
          d = c ? (0, M.parseRgba)(c)[3] : void 0,
          u = '' === c,
          p = String(T()).toLowerCase() === z.white,
          [w, y, C] = (0, W.useCustomColors)();
        return i.createElement(
          _.ToolWidgetMenu,
          {
            className: l,
            ...
            horizontalDropDirection: a
              ...
              : void 0,
            horizontalAttachEdge: a ? b.HorizontalAttachEdge.Left : void 0,
            verticalAttachEdge: a ? b.VerticalAttachEdge.Top : void 0,
            content: i.createElement(
              'div',
              { className: N.wrap },
              i.createElement(v.Icon, { className: N.icon, icon: o }),
              i.createElement(
                'div',
                { className: N.colorBg },
                i.createElement('div', {
                  className: m()(N.color, u && N.multicolor, p && N.white),
                  style: u ? void 0 : { backgroundColor: c },
                }),
              ),
            ),
            arrow: !1,
          ...
          i.createElement(k.ColorPicker, {
            color: T(),
            opacity: d,
            onColorChange: function (t, e) {
              const o = c
                ? (0, A.alphaToTransparency)((0, M.parseRgba)(c)[3])
                : 0;
              (x((0, A.generateColor)(String(t), o, true)),
                e || (0, g.ensureNotNull)(h.current).close());
            },
            onOpacityChange: function (t) {
              x((0, A.generateColor)(c, (0, A.alphaToTransparency)(t), !0));
            },
            selectOpacity: void 0 !== d,
            selectCustom: !0,
            customColors: w,
            onAddColor: function (t) {
              (y(t), (0, g.ensureNotNull)(h.current).close());
            },
            onRemoveCustomColor: C,
          }),
        );
        function T() {
          return c ? (0, M.rgbToHexString)((0, M.parseRgb)(c)) : null;
        }
        function x(t) {
          n.setProperty(e, t, s);
        }
      ...
      var V = o(44005),
        ...
        H = o(35162),
        Z = o(73986);
      const K = H.FLOATING_TOOLBAR_REACT_WIDGETS_CLASS + '__button';
      function U(t) {
        const {
            templateButton: e,
            cancelButton: o,
        ...
        return d && d.length
          ? i.createElement(
              ...
              {
                rules: {
                  isSmallWidth: Z.DialogBreakpoints.TabletSmall,
      ...
      function q(t) {
        ...
        return i.createElement($.ToolWidgetIconButton, {
          className: n,
          icon: G,
          title: e,
          onClick: async function () {
            (0, j.trackEvent)('GUI', 'Context action on drawings', 'Settings');
      ...
      function J(t) {
        ...
        return i.createElement(X.ToolButton, {
          className: p(e, Y.button),
      ...
      function et(t) {
        ...
        const a = s[0].properties().frozen,
          l = (0, f.useProperty)(a),
          c = l
            ? { tooltip: r.t(null, void 0, o(99894)), icon: Q }
            : { tooltip: r.t(null, void 0, o(5837)), icon: tt };
        return i.createElement(J, {
          className: n,
          isActive: Boolean(l),
          onClick: function () {
            ((0, j.trackEvent)('GUI', 'Context action on drawings', 'Lock'),
      ...
      function rt(t) {
        const { activeChartWidget: e, className: n } = t,
          ...
          l = (0, f.useProperty)(
            a?.properties().anchored ?? new R.Property(!1),
          ),
          c = (0, ot.usePromise)(
            async () => {
              const { ActionsProvider: t } = await (0,
              it.actionsProviderModule)();
              return new t(e).actionForLineTools(
                s,
        ...
        return c
          ? i.createElement(J, {
              ...
              icon: nt.icons.get('Chart.AnchorLineTool'),
              onClick: () => c.execute(),
      ...
      function at(t) {
        ...
        return i.createElement($.ToolWidgetIconButton, {
          ...
          'data-name': 'remove',
          onClick: function () {
            ((0, j.trackEvent)('GUI', 'Context action on drawings', 'Remove'),
      ...
      function dt(t) {
        ...
        const l = (0, f.useProperty)((0, h.alignTo45Degrees)()),
          c = l
            ? { tooltip: r.t(null, void 0, o(31145)), icon: ct }
            : { tooltip: r.t(null, void 0, o(83187)), icon: ct };
        return i.createElement(J, {
          className: n,
          isActive: Boolean(l),
          onClick: function () {
            ...
            ((0, h.alignTo45Degrees)().setValue(!t),
              t ||
                e
                  .model()
                  .alignToolTo45Degrees(
                    a,
                    (0, g.ensureNotNull)(a.ownerSource()),
                  ));
          },
          'data-name': Boolean(l)
      ...
      async function bt(t, e) {
        const {
            createVisualOrderAction: i,
            createChangeIntervalsVisibilitiesAction: n,
            createActionToggleVisibilityDataSources: s,
            createSyncDrawingActions: a,
          } = await (0, it.actionsProviderModule)(),
          l = [i(t, e), n(t, e)],
          c = (function (t, e) {
            const i = [],
              n = ft.isMacKeyboard ? ' +' : '',
              ...
              i.push(
                new yt.Action({
                  ...
                  options: {
                    ...
                    icon: o(36296),
                    shortcutHint:
                      ft.humanReadableModifiers(wt.Modifiers.Mod) + n + ' Drag',
            ...
            if (a.length > 0) {
              const e = {
                ...
                shortcutHint:
                  ft.humanReadableModifiers(wt.Modifiers.Mod) + n + ' C',
                onExecute: () => {
        ...
        if (
          (c.length && l.push(new yt.Separator(), ...c),
          e.some((t) => t.isSynchronizable()))
        ) {
          const o = a(t, e);
          o.length && l.push(new yt.Separator(), ...o);
        }
        if (1 === e.length && e[0].additionalActions) {
          ...
          o.actions.length &&
            (l.push(new yt.Separator()), l.push(...o.actions));
        }
        return (l.push(new yt.Separator(), s(t, e)), l);
      }
      var Ct = o(44996);
      function Tt(t) {
        const {
          ...
          d = (0, ot.usePromise)(
            async () => {
              const { ActionsProvider: t } = await (0,
                ...
                i = a[0],
                n = s.paneForSource(i);
              return n ? e.contextMenuActionsForSources(a, n) : [];
            },
            void 0,
            [o, a],
          ),
          ...
          p = (0, i.useCallback)(
            (t) => {
              if (!n || null === d) return;
              const e = xt(d);
              window.matchMedia(Z.DialogBreakpoints.TabletSmall).matches ||
              !mt.isAnyMobile
                ? _t.ContextMenuManager.showMenu(
                    e,
                    t,
                    {
                      mode: mt.isAnyMobile ? 'drawer' : 'menu',
                      'data-name': 'more-menu',
                    },
        ...
        return (
          ...
          i.createElement(
            _.ToolWidgetMenu,
            {
              ...
              onClick: p,
              title: e,
              content: i.createElement(v.Icon, { icon: Ct }),
              'data-name': 'more',
              menuDataName: 'more-menu',
              noMomentumBasedScroll: !0,
              closeOnEsc: !0,
            },
            i.createElement(vt.ActionsTable, { parentIsOpened: !0, items: l }),
          )
        );
      }
      function xt(t) {
        if (gt.touch && !window.matchMedia('(pointer:fine)').matches) {
      ...
      function Dt(t) {
            ...
            () => [
              new yt.Action({
                ...
                options: {
                  ...
                  active: St.LineStyle.Solid === h,
                  onExecute: () => n.setProperty(e, St.LineStyle.Solid, a),
                },
              }),
              new yt.Action({
                ...
                options: {
                  ...
                  active: St.LineStyle.Dashed === h,
                  onExecute: () => n.setProperty(e, St.LineStyle.Dashed, a),
                },
              }),
              new yt.Action({
                ...
                options: {
                  ...
                  active: St.LineStyle.Dotted === h,
                  onExecute: () => n.setProperty(e, St.LineStyle.Dotted, a),
                },
              }),
            ],
            [n, e, h],
        ...
        return i.createElement(
          _.ToolWidgetMenu,
          {
            className: c,
            arrow: !1,
            content: i.createElement(v.Icon, { icon: Mt(h) }),
            title: s,
            'data-name': t['data-name'],
            menuDataName: `${t['data-name']}-menu`,
            ...
            horizontalDropDirection: l
              ? b.HorizontalDropDirection.FromRightToLeft
              : void 0,
            horizontalAttachEdge: l ? b.HorizontalAttachEdge.Right : void 0,
            verticalAttachEdge: l ? b.VerticalAttachEdge.Top : void 0,
          },
          i.createElement(vt.ActionsTable, { items: d }),
        );
      }
      function Mt(t) {
        switch (t) {
          case St.LineStyle.Solid:
            return Lt;
          case St.LineStyle.Dashed:
            return Pt;
          case St.LineStyle.Dotted:
            return Et;
          case 'mixed':
            return Bt;
          default:
      ...
      const At = [8, 10, 11, 12, 14, 16, 18, 20, 22, 24, 28, 32, 40];
      function Wt(t) {
        const {
            property: e,
            propertyApplier: o,
        ...
        return i.createElement(
          ...
          i.createElement(vt.ActionsTable, { items: c }),
        );
      }
      var kt = o(9753),
        zt = o(26610),
        ...
        Ft = o(28245),
        Vt = o(46189);
      const Ot = (0, y.mergeThemes)(w.DEFAULT_POPUP_MENU_ITEM_THEME, Vt),
        Ht = [8, 12, 20, 32, 48, 64, 80, 96];
      function Zt(t) {
        const {
            multipleProperty: e,
            title: o,
        ...
        return i.createElement(
          _.ToolWidgetMenu,
          {
            ...
            content: i.createElement(
              'div',
              { className: m()(Vt.buttonWrap, l && Vt.small) },
              i.createElement(v.Icon, { icon: Ft }),
              !l &&
                'mixed' !== c &&
                i.createElement('div', { className: Vt.buttonLabel }, `${c}px`),
            ),
          },
          Ht.map((t) =>
            i.createElement(w.PopupMenuItem, {
      ...
      var Ut = o(5880),
        ...
        qt = o(48984),
        Xt = o.n(qt);
      const Yt = new s.TranslatedString(
          'change line tool(s) font size',
          r.t(null, void 0, o(37453)),
        ),
        Jt = new s.TranslatedString(
          'change line tool(s) line style',
          r.t(null, void 0, o(13423)),
        ),
        Qt = new s.TranslatedString(
          'change line tool(s) line width',
          r.t(null, void 0, o(81303)),
        ),
        te = new s.TranslatedString(
          'change line tool(s) color',
          r.t(null, void 0, o(78655)),
        ),
        ee = new s.TranslatedString(
          'change line tool(s) background color',
          r.t(null, void 0, o(50522)),
        ),
        oe = new s.TranslatedString(
          'change line tool(s) text color',
          r.t(null, void 0, o(96142)),
        ),
        ie = new s.TranslatedString(
          'line tool(s) line style',
          r.t(null, { context: 'line tool property name' }, o(64974)),
        ),
        ne = r.t(null, void 0, o(32514)),
        re = r.t(null, void 0, o(99919)),
        se = r.t(null, void 0, o(67410)),
        ae = r.t(null, void 0, o(4543)),
        le = r.t(null, void 0, o(37117)),
        ce = r.t(null, void 0, o(92516)),
        he = r.t(null, void 0, o(2573)),
        de = r.t(null, void 0, o(53002)),
        ue = r.t(null, void 0, o(75056)),
        pe = r.t(null, void 0, o(11989)),
        me = r.t(null, void 0, o(14097)),
        ge = r.t(null, void 0, o(81956)),
        ve = r.t(null, void 0, o(47370)),
        _e = r.t(null, void 0, o(77753)),
        fe = r.t(null, void 0, o(69715)),
        we = r.t(null, void 0, o(28736)),
        ye = r.t(null, void 0, o(65086)),
        be = r.t(null, void 0, o(46193)),
        Ce = r.t(null, void 0, o(7977)),
        Te = r.t(null, void 0, o(8111)),
        xe = lt.CheckMobile.any() || lt.CheckMobile.isIPad();
      class Se {
        constructor(t) {
          ((this._currentTool = null),
            ...
            (this._toolExceptionCases = null),
            (this._chartWidgetCollection = t),
            (this._floatingToolbar = new H.FloatingToolbar({
              defaultPosition: {
                top: kt.HEADER_TOOLBAR_HEIGHT_EXPANDED + 15,
            ...
            (this._selectedLineTool = (0, l.combine)(
              (...t) => {
                this._onToolChanged(h.tool.value());
              },
              h.tool.weakReference(),
              h.iconTool.weakReference(),
              h.emojiTool.weakReference(),
            )),
            (this._selectedLineDataSourcesSourcesSpawn = (0, l.combine)(
              (t) => t.filter(zt.isLineTool),
              this._chartWidgetCollection.selectedSources.weakReference(),
            )),
            (this._isToolMovingOrEditingNow = (0, l.combine)(
              (t, e) => {
                this._handleSourceEdit(t || e);
              },
              h.isToolMovingNow.weakReference(),
              h.isToolEditingNow.weakReference(),
            )),
        ...
        destroy() {
          (this._selectedLineTool.destroy(),
            this._isToolMovingOrEditingNow.destroy(),
            this._selectedLineDataSourcesSourcesSpawn.destroy());
        }
        async refresh() {
        ...
        _createWidthsButton(t, e) {
          ...
          if (e) {
            1 !==
              this._selectedLineDataSources().filter(
                (t) => t.properties().linesWidths,
              ).length && (o = ue);
          }
          return (
            this._addPropertyButton({
              ...
              props: {
                title: o,
                property: this._lineWidthsProperty,
        ...
        _createLineStyleButton(t, e) {
          const o = this._selectedLineDataSources();
          if (!o.length) return !1;
          let i,
            n = this._propertyApplierImpl();
          if (1 === o.length) {
            if (((i = o[0].properties().linesStyles || t), !i)) return !1;
          } else {
            const t = o
              .map(
                (t) =>
            ...
            ((i = new d.CollectiblePropertyUndoWrapper(
              new u.LineToolCollectedProperty(t),
              ie,
              this._propertyApplierImpl(),
            )),
              (n = { ...n, setProperty: (t, e) => t.setValue(e) }));
          }
          return (
            this._addPropertyButton({
              component: Dt,
        ...
        _createHighlighterWidthsButton(t, e) {
          if (
            (this._highlighterWidthsProperty &&
              ...
              (this._highlighterWidthsProperty = null)),
            (this._highlighterWidthsProperty =
              this._createProperty(t, e, 'widths', Qt) || null),
            !this._highlighterWidthsProperty)
          )
            return !0;
          const o =
        ...
        async _onToolChanged(t, e) {
          if (
            ((this._currentTool = t),
            await (0, Nt.ensureLineToolLoaded)(t),
            this._currentTool !== t)
          )
            return;
          if (this._isDrawingToolExcludingCustomUrlEventTool(t))
            return (
              (this._isDrawingFinished = !1),
              this._createCancelButton(),
              void this._updateVisibility()
            );
          const o = this._selectedLineDataSources();
          o.length
            ? (o.length > 1 && (this._isDrawingFinished = !0),
              await this._onSourceChanged(o))
            : this.hide();
        }
        async _onSourceChanged(t = this._selectedLineDataSources()) {
          try {
            if (!t.length)
              return (
                (this._propertiesVisible = !1),
                (this._toolbarVisible = !1),
                void this._clearProperties()
              );
            const e = t.reduce((t, e) => t.add(e.toolname), new Set());
            if (
              (await Promise.all(
                [...e].map(async (t) => (0, Nt.ensureLineToolLoaded)(t)),
              ),
              t !== this._selectedLineDataSources())
            )
              return;
            if (
              ...
              e.isAvailableInFloatingWidget() &&
                this._activeChartWidget()
                  .model()
                  .model()
                  .dataSourceForId(e.id()) &&
                (!e.userEditEnabled() ||
                  (!(0, It.isLineDrawnWithPressedButton)(e.toolname) &&
                    this._activeChartWidget().model().lineBeingCreated()) ||
                  (this._isDrawingFinished = !0),
                this._showPropertiesOf(e.toolname, e.properties(), !0),
                (this._toolbarVisible = !0));
            } else
              (this._clearProperties(),
                this._createWidthsButton(void 0, !0),
                this._createHighlighterWidthsButton(void 0, !0),
                this._createLineStyleButton(void 0, !0),
        ...
        _propertyApplierImpl() {
          return (
            this._propertyApplier ||
              (this._propertyApplier = new Rt.PropertyApplierWithoutSavingChart(
                () => this._activeChartWidget().model(),
              )),
            this._propertyApplier
          );
        }
        ...
        _createSettingsButton() {
          const t = {
            component: q,
            props: { title: ne, activeChartWidget: this._activeChartWidget() },
          };
        ...
        _createAlignTo45DegreesButton() {
          const t = {
            component: dt,
            props: { title: re, activeChartWidget: this._activeChartWidget() },
        ...
        _createRemoveButton() {
          if (
            xe &&
            null !== this._currentTool &&
            (0, It.isLineDrawnWithPressedButton)(this._currentTool)
          )
            return;
          const t = {
            component: at,
            props: { title: se, activeChartWidget: this._activeChartWidget() },
            showForSmallScreen: !0,
          };
          this._addCommonButton(t);
        }
        _createCancelButton() {
          if (
            ...
            !xe || null === this._currentTool)
          )
            return;
          if (!(0, It.isLineDrawnWithPressedButton)(this._currentTool)) return;
          const t = {
            component: pt,
            props: { title: ae, activeChartWidget: this._activeChartWidget() },
            showForSmallScreen: !0,
          };
        ...
        _createDotsButton() {
          this._addCommonButton({
            component: Tt,
            props: { title: le, activeChartWidget: this._activeChartWidget() },
            showForSmallScreen: !0,
          });
        }
        _createAlertButton() {}
        ...
        _prepareProperties(t) {
          const e = this._selectedLineDataSources().filter(
            (e) => e.properties()[t],
          );
        ...
        _shouldShowBackgroundProperty(t) {
          ...
          (this._updateVisibilityTimeout &&
            ...
            (this._updateVisibilityTimeout = setTimeout(() => {
              ((0, zt.unsetNewToolProperties)(!0),
                ...
                this._clearTemplatesButton(),
                (this._templatesList = void 0));
            }, 0)),
        ...
        _selectedLineDataSources() {
          return this._selectedLineDataSourcesSourcesSpawn.value();
        }
        _showTemplatesOf(t) {}
        _showPropertiesOf(t, e, o) {
          this._toolExceptionCases ||
            (this._toolExceptionCases = this._createToolExceptionCases());
          const i = this._toolExceptionCases[t] || this._getPossibleProperty(e);
          if (
            ...
            for (let t = 0; t < i.length; t++) {
              ...
              for (let t = 0; t < s.length; ++t) r = r && r.child(s[t]);
              const a = n.showIf;
              if (void 0 === a || a(e)) {
                if ('factory' in n && n.factory.call(this, r, o)) continue;
                if (!r) continue;
                const t = n;
                this._propertiesVisible = !0;
                const e = {
        ...
        _defaultToolProperties() {
          return [
            this._defaultLinesColorProperty(),
            {
              ...
              factory: this._createBackgroundsButton,
            },
            { name: 'textsColors', factory: this._createTextColorsButton },
            { name: 'linesWidths', factory: this._createWidthsButton },
            { name: 'linesStyles', factory: this._createLineStyleButton },
          ];
        }
        _defaultLinesColorProperty() {
          return { name: 'linesColors', factory: this._createColorsButton };
        }
        _createToolExceptionCases() {
          return {
            LineToolBrush: this._brushPropertiesExceptionCase(),
            LineToolBezierQuadro: this._bezierPropertiesExceptionCases(),
            LineToolBezierCubic: this._bezierPropertiesExceptionCases(),
            LineToolText: this._textPropertiesExceptionCases(),
            LineToolTextAbsolute: this._textPropertiesExceptionCases(),
            LineToolBalloon: this._textPropertiesExceptionCases(),
            LineToolComment: this._textPropertiesExceptionCases(),
            LineToolCallout: this._textPropertiesExceptionCases(),
            LineToolPriceLabel: this._textPropertiesExceptionCases(),
            LineToolDateRange: this._rangeExceptionCases(),
            LineToolPriceRange: this._rangeExceptionCases(),
            LineToolDateAndPriceRange: this._rangeExceptionCases(),
            LineToolNote: this._notePropertiesExceptionCases(),
            LineToolNoteAbsolute: this._notePropertiesExceptionCases(),
            LineToolRiskRewardLong: this._riskPropertiesExceptionCases(),
            LineToolRiskRewardShort: this._riskPropertiesExceptionCases(),
            LineToolPath: this._pathExceptionCases(),
            LineToolRegressionTrend: this._regressionToolExceptionCases(),
            LineToolBarsPattern: [
              {
                name: 'color',
                title: ve,
            ...
            LineToolSignpost: [
              {
                name: 'linesColors',
                factory: this._createBackgroundsButton,
                showIf: (t) => t && t.childs().showImage.value(),
              },
              { name: 'fontSize', factory: this._createFontSizeButton },
            ],
            LineToolHighlighter: this._highlighterPropertiesExceptionCase(),
          };
        }
        ...
        _pathExceptionCases() {
          return [
            this._defaultLinesColorProperty(),
            { name: 'linesWidths', factory: this._createWidthsButton },
            { name: 'lineStyle', factory: this._createLineStyleButton },
          ];
        }
        _regressionToolExceptionCases() {
          return [{ name: 'linesWidths', factory: this._createWidthsButton }];
        }
        _highlighterPropertiesExceptionCase() {
          return [
            this._defaultLinesColorProperty(),
            { name: 'widths', factory: this._createHighlighterWidthsButton },
          ];
        }
        _isWidthProperty(t) {
    ...
    18117: (t, e, o) => {
      ...
      const l = {
        ...
        demonstration: n.t(null, void 0, o(14939)),
        dot: n.t(null, void 0, o(57157)),
        performance: n.t(null, void 0, o(35553)),
        drawginmode: n.t(null, void 0, o(99901)),
      ...
      const u = (0, h.humanReadableModifiers)(h.Modifiers.Shift, !1).trim(),
        p = (0, h.humanReadableModifiers)(h.Modifiers.Alt, !1).trim(),
        m = (0, h.humanReadableModifiers)(h.Modifiers.Mod, !1).trim(),
        g = { keys: [u], text: n.t(null, void 0, o(23369)) },
        v = { keys: [u], text: n.t(null, void 0, o(13798)) },
        _ = { keys: [u], text: n.t(null, void 0, o(10539)) },
        f = {
          ...
          LineToolDateRange: {},
          LineToolDisjointAngle: { hotKey: (0, r.hotKeySerialize)(g) },
          ...
          LineToolFibWedge: {},
          LineToolFlagMark: {},
          LineToolFlatBottom: { hotKey: (0, r.hotKeySerialize)(g) },
          ...
          LineToolNote: {},
          LineToolSignpost: {},
          LineToolParallelChannel: { hotKey: (0, r.hotKeySerialize)(g) },
          LineToolPitchfan: {},
          LineToolPitchfork: {},
          LineToolPolyline: {},
          LineToolPath: {},
          LineToolPrediction: {},
          LineToolPriceLabel: {},
          LineToolPriceNote: { hotKey: (0, r.hotKeySerialize)(g) },
          LineToolTextNote: {},
          LineToolArrowMarker: {},
          LineToolPriceRange: {},
          LineToolProjection: {},
          ...
          LineToolRotatedRectangle: { hotKey: (0, r.hotKeySerialize)(g) },
          ...
          LineToolTimeCycles: {},
          LineToolTrendAngle: { hotKey: (0, r.hotKeySerialize)(g) },
          LineToolTrendBasedFibExtension: {},
          LineToolTrendBasedFibTime: {},
          LineToolTrendLine: { hotKey: (0, r.hotKeySerialize)(g) },
          LineToolInfoLine: {},
          LineToolTriangle: {},
          ...
          magnet: {
            hotKey: (0, r.hotKeySerialize)({ keys: [m], text: '{0}' }),
          },
          measure: {
            hotKey: (0, r.hotKeySerialize)({
              keys: [u],
      ...
      Object.entries(f)
        .map(([t, e]) => {
          const o = s.lineToolsIcons[t] ?? a.drawingToolsIcons[t];
          (0, i.assert)(!!o, `Icon is not defined for drawing "${t}"`);
          const n = c.lineToolsLocalizedNames[t] ?? l[t];
          (0, i.assert)(
            !!n,
            `Localized name is not defined for drawing "${t}"`,
          );
          return {
            ...e,
            name: t,
            icon: o,
            localizedName: n,
            selectHotkey: d.lineToolsSelectHotkeys[t],
          };
        })
        .forEach((t) => {
          w[t.name] = t;
    ...
    6519: (t, e, o) => {
      'use strict';
      o.d(e, { LinetoolsFavoritesStore: () => c });
      var i = o(48096),
        n = o(87465),
        r = o(1765);
      ...
      (!(function (t) {
        function e() {
          ...
          if (0 === l.length && i && 'undefined' != typeof window) {
            const t = JSON.parse(
              window.urlParams?.favorites ?? '{}',
            ).drawingTools;
            t && Array.isArray(t) && l.push(...t);
          }
          (l.forEach((i, n) => {
            const r = i.tool || i;
            o(r)
              ? s.includes(r)
                ? (e = !0)
                : t.favorites.push(r)
              : a && a.includes(r) && t.hiddenToolsPositions.set(r, n);
          }),
            e && n(),
            t.favoritesSynced.fire());
        }
        function o(t) {
          return 'string' == typeof t && '' !== t && !(a && a.includes(t));
        }
        function n(e) {
          const o = t.favorites.slice();
          (t.hiddenToolsPositions.forEach((t, e) => {
            o.splice(t, 0, e);
          }),
            (0, r.setJSON)('chart.favoriteDrawings', o, e));
        }
        ((t.favorites = []),
          (t.favoritesSynced = new i.Delegate()),
          (t.hiddenToolsPositions = new Map()),
          (t.favoriteIndex = function (e) {
            return t.favorites.indexOf(e);
          }),
          (t.isValidLineToolName = o),
          (t.saveFavorites = n),
          e(),
        ...
        (function (t) {
          function e(t) {
            return l.isValidLineToolName(t);
          }
          function o() {
            return l.favorites.length;
          }
          function n(t) {
            return -1 !== l.favoriteIndex(t);
          }
          ((t.favoriteAdded = new i.Delegate()),
            (t.favoriteRemoved = new i.Delegate()),
            (t.favoriteMoved = new i.Delegate()),
            (t.favoritesSynced = l.favoritesSynced),
            (t.favorites = function () {
              return l.favorites.slice();
            }),
            (t.isValidLineToolName = e),
            (t.favoritesCount = o),
            (t.favorite = function (t) {
              return t < 0 || t >= o() ? '' : l.favorites[t];
            }),
            (t.addFavorite = function (o, i) {
              return (
                !(n(o) || !e(o) || 'performance' === o) &&
                (l.favorites.push(o),
                l.saveFavorites(i),
                t.favoriteAdded.fire(o),
                !0)
              );
            }),
            (t.removeFavorite = function (e, o) {
              const i = l.favoriteIndex(e);
              if (-1 === i) return !1;
              ...
              return (
                ...
                l.saveFavorites(o),
                t.favoriteRemoved.fire(e),
                !0
              );
            }),
            (t.isFavorite = n),
            (t.moveFavorite = function (i, n, r) {
              if (n < 0 || n >= o() || !e(i)) return !1;
              const s = l.favoriteIndex(i);
              if (-1 === s || n === s) return !1;
              const a = l.hiddenToolsPositions;
              return (
                a.forEach((t, e) => {
                  (s < t && n > t ? t-- : n < t && s > t && t++, a.set(e, t));
                }),
                l.favorites.splice(s, 1),
                l.favorites.splice(n, 0, i),
                l.saveFavorites(r),
                t.favoriteMoved.fire(i, s, n),
                !0
              );
            }));
        })(c || (c = {})));
