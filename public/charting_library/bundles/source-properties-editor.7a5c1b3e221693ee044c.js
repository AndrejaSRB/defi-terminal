(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6780],
  {
    ...
    38546: (e, t, i) => {
      ...
      var s = i(50959),
        a = i(67829);
      const n = s.forwardRef(function (e, t) {
    ...
    75892: (e, t, i) => {
      ...
      (i.r(t),
        i.d(t, {
          SourcePropertiesEditorRenderer: () => B,
        }));
      var s = i(50959),
        a = i(76422),
        n = i(50151),
        ...
        y = i(37103),
        I = i(75146);
      const E = new x.TranslatedString(
        'change {sourceTitle} title to {newSourceTitle}',
        r.t(null, void 0, i(23687)),
      );
        ...
        constructor(e) {
          (super(e),
            ...
            (this._getTranslatedStringForSource = (e) =>
              new x.TranslatedString(
                e.name(),
                e.title(p.TitleDisplayTarget.StatusLine),
              )),
            (this._setTitle = (e) => {
              ...
              i.setProperty(
                ...
                e,
                s,
                C.lineToolsDoNotAffectChartInvalidation && (0, g.isLineTool)(t),
              );
            }),
            ...
            (this._handleResetToDefaults = () => {
              ...
              (0, b.isStudy)(e) && t.restorePropertiesForSource(e);
            }),
            (this._handleSaveAsDefaults = () => {
              const { source: e } = this.props;
              (0, b.isStudy)(e) && e.properties().saveDefaults();
            }),
            (this._renderFooterLeft = () => {
              const { source: e, model: t } = this.props;
              return (0, g.isLineTool)(e)
                ? s.createElement(d.FooterMenu, {
                    sources: [e],
                    chartUndoModel: t,
                  })
                : s.createElement(
                    ...
                    (t) =>
                      (0, b.isStudy)(e) &&
                      s.createElement(T.PropertyActions, {
            ...
            (this._getActiveTabSettingsName = () => {
              const { source: e } = this.props;
              return e instanceof f.Series
                ? 'properties_dialog.active_tab.chart'
                : e instanceof v.LineDataSource
          ...
          if (this._getActionPageById(this.props.activePageId))
            ...
            const e = l.default.getValue(this._getActiveTabSettingsName(), ''),
              s = this._getActionPageById(e);
            i = s ? s.id : t[0].id;
          }
          ((this.state = {
          ...
          return ({ requestResize: t }) => {
            ...
            return s.createElement(
              ...
              s.createElement(
                ...
                { className: I.scrollable, onScroll: this._handleScroll },
                s.createElement(m.PropertiesEditorTab, {
                  page: o,
      ...
      var P = i(38414),
        k = i(87896);
      class B extends P.DialogRenderer {
        constructor(e) {
          (super(),
            (this._timeout = null),
            (this._handleClose = () => {
        ...
        show(e) {
          this.isVisible() ||
            ((this._rootInstance = (0, k.createReactRoot)(
              s.createElement(A, {
                source: this._source,
                onSubmit: this._handleSubmit,
            ...
            a.emit('drawings_settings_dialog', {
              objectType: 'drawing',
              scriptTitle: this._source.title(p.TitleDisplayTarget.StatusLine),
            }));
        }
      ...
      function b(e) {
        ...
        return s.createElement(r.AdaptiveConfirmDialog, {
          ...
          footerLeftRenderer: function () {
            return s.createElement(c.FooterMenu, {
              sources: f,
              chartUndoModel: v,
            });
          },
    ...
    67829: (e, t, i) => {
            ...
            return (
              ...
              (0, a.useCallback)(() => {
                ...
                return {
                  ...
                  indentFromWindow: { top: R, bottom: R, left: R, right: R },
                };
              }, [t, e])
            );
          })(t, f);
      ...
      function U(e) {
        const {
            ...
            activationType: n,
            disabled: g,
            moreButtonContent: b = l.t(null, void 0, i(37117)),
            size: f = 'small',
            onActivate: v,
            isActive: _,
            className: x,
            ...
            tablistLabelId: y,
            tablistLabel: I,
            'data-name': E = 'underline-tabs-buttons',
            stretchTabs: A,
            equalTabSize: P,
            defaultKeyboardFocus: k,
            stopPropagationIfKeyboardActionHandled: B,
            keyboardNavigationLoop: z,
            focusableItemAttributes: R,
            dataQaId: D = 'underline-tabs-buttons',
          } = e,
          M = j(),
          F = (function (e) {
            const t = (0, Y.useSafeMatchMedia)(
                L['media-mf-phone-landscape'],
                !0,
              ),
              i = j();
          ...
          le = (0, a.useRef)(new Map()),
          {
            ...
            close: ue,
            onButtonClick: de,
          } = (0, d.useDisclosure)({ id: t, disabled: g }),
        ...
        })(le.current, Ce ?? _e, [Ce ?? _e, ae, f, U, F]);
        return a.createElement(
          p.Provider,
          { value: { size: f, overflowBehaviour: F } },
          a.createElement(
            'div',
            {
              ...ge,
              className: X({ size: f, overflowBehaviour: F, className: x }),
              style: S,
              'data-name': E,
              'data-qa-id': D,
            },
            a.createElement(
              ...
              {
                ...pe,
                className: o()(H['underline-tabs'], {
                  [H['make-grid-column']]: U || $,
                  [H['stretch-tabs']]: U,
                  [H['equal-tab-size']]: $,
                }),
              },
              ...
              Ee
                ? a.createElement(J, { ...Ee, disabled: g })
