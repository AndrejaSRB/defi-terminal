(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8890],
  {
    ...
    64388: (e, t, n) => {
      ...
      function u(e) {
        ...
        return i.createElement(
          i.Fragment,
          null,
          i.createElement('span', { className: r().background }),
          ...
          t &&
            i.createElement('span', { className: r()['visually-hidden'] }, t),
        );
      }
      const d = (0, i.forwardRef)((e, t) => {
        ...
        return i.createElement(
          'button',
          { ...d, className: c({ ...e, children: r }), ref: t, type: o },
          i.createElement(u, { icon: n }, r),
        );
      });
      ...
      (0, i.forwardRef)((e, t) => {
        const { icon: n, renderComponent: o, 'aria-label': a, ...s } = e,
          l = o ?? h.CustomComponentDefaultLink;
        return i.createElement(
          l,
          {
            ...s,
            className: c({ ...e, children: a, isLink: !0 }),
            reference: (0, p.isomorphicRef)(t),
          },
          i.createElement(u, { icon: n }, a),
        );
    ...
    70493: (e, t, n) => {
      ...
      function x(e) {
        const {
          ...
          { isSmallTablet: p, dialogCloseHandler: x } = (0, i.useContext)(y),
          C = (0, f.ensureNotNull)((0, i.useContext)(v.SlotContext)),
          D = (0, _.useIsMounted)(),
          [S, b] = (0, i.useState)(!1);
        return i.createElement(
          m.Button,
          {
            ...
            disabled: t,
            reference: c,
            className: a(E.actionButton, h, p && E.small),
            name: n,
            size: p ? 'l' : void 0,
            appearance: s,
            intent: l,
            ...
            onClick: function () {
              if (S) return;
              const e = r({ dialogClose: x, innerManager: C });
              e &&
                (b(!0),
                e.then(() => {
                  D.current && b(!1);
          ...
          i.createElement('span', { className: a(S && E.hiddenTitle) }, o),
          S && i.createElement(g.Loader, { color: 'white' }),
        );
      }
      var C = n(7720),
        D = n(64593);
            ...
            (l) =>
              i.createElement(
                ...
                i.createElement(
                  r.PopupDialog,
                  {
                    className: a(D.popupDialog, f),
                    componentRef: P,
                    isOpened: N,
                    backdrop: E,
                    dataQaId: g ?? void 0,
                    onClickBackdrop: M ? z : void 0,
                    onClickOutside: S ? z : void 0,
                    onKeyDown: A,
                    autofocus: !0,
                    fixedBody: !0,
                  },
                  i.createElement(
                    'div',
                    { className: a(D.wrap, v), 'data-name': m },
                    i.createElement(
                      'div',
                      {
                        className: a(
                          D.main,
                          !b && D.marginWithoutCloseButton,
                          l && D.small,
                        ),
                      },
                      t &&
                        i.createElement(
                          'div',
                          { className: a(D.title, l && D.small) },
                          t,
                        ),
                      (function (t) {
                        if ('html' in e)
                          return i.createElement(p.TouchScrollContainer, {
                            className: a(D.content, t && D.small, D.html, _),
                            dangerouslySetInnerHTML: { __html: e.html },
                          });
                        if ('content' in e)
                          return i.createElement(
                            p.TouchScrollContainer,
                            { className: a(D.content, t && D.small, _) },
                            e.content,
                          );
                        return null;
                      })(l),
                      o &&
                        ...
                        i.createElement(
                          'div',
                          { className: a(D.footer, l && D.small) },
                          o.map((e, t) =>
                            i.createElement(x, {
                              ...e,
                              key: e.name,
                              dataQaId: `${e.name}-btn`,
                              reference: 0 === t ? F : void 0,
                            }),
                          ),
                        ),
                    ),
                    b &&
                      i.createElement(s.NavButton, {
                        'aria-label': 'close',
                        size: 'medium',
                        preservePaddings: !0,
                        className: a(D.close, l && D.small),
                        icon: C,
                        onClick: z,
                        'data-name': 'close',
                        'data-role': 'button',
      ...
      function k(e) {
        const {
          ...
          { isSmallTablet: d } = (0, i.useContext)(y),
          h = (0, M.useAutoSelect)();
        return i.createElement(
          i.Fragment,
          null,
      ...
      function B(e) {
        const { buttonText: t, intentButton: i, actions: a, onConfirm: s } = e,
          l = [
            {
              name: 'ok',
        ...
        return (a && a.forEach((e) => l.push(e)), l);
      }
      var F = n(51826),
        P = n(87896);
      ...
      const z = function (e) {
          ...
          return i.createElement(S, {
            ...
            actions: [
              {
                name: 'yes',
                title: s || o.t(null, void 0, n(55512)),
                intent: l || 'success',
                handler: u,
              },
              {
        ...
        U = function (e, t, n) {
          ...
          if (
            ...
            return (0, f.ensureDefined)(A.getDialogPayload(a)).closeHandler;
          const s = document.createElement('div'),
            l = () => {
              (e.onClose?.(), r.unmount(), A.setAsClosed(a));
            },
          ...
          return (A.setAsOpened(a, { closeHandler: l }), l);
        };
    },
    51826: (e, t, n) => {
      'use strict';
    ...
    9722: (e, t, n) => {
      ...
      class h extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(l.Slot, { reference: this._handleSlot }),
          );
        }
        _createStyles() {
          const {
      ...
      class C {
        ...
        _moveDialog(e, t) {
          const n = this._dialog.getBoundingClientRect(),
            ...
            o = v(e, n.width, i ? 0 : -1 / 0, i ? window.innerWidth : 1 / 0),
            a = v(t, n.height, i ? 0 : -1 / 0, i ? window.innerHeight : 1 / 0);
      ...
      const N = (0, T.getLogger)('DialogEventDispatcher');
      class B {
        constructor() {
        ...
        dispatch(e) {
          if ('dialog-open' === e) {
            if (null !== this._openSessionId)
              return void N.logError('Multiple calls to open dialog');
            this._openSessionId = (0, k.randomHash)();
          }
          null !== this._openSessionId
            ...
            : N.logError('Empty open dialog session id');
        }
      }
      var F = n(84015),
        P = (n(37103), n(94489)),
        ...
        recalculateBounds() {
          ...
          if (this._isFullscreen) {
            ...
            const i = this._dialog.getBoundingClientRect(),
              o = t - 2 * n,
              a = v(i.left, i.width, 0, e),
              s = v(i.top, i.height, n, t);
            ((this._dialog.style.top = '0px'),
              (this._dialog.style.left = '0px'),
                ...
                i.createElement(
                  ...
                  i.createElement(
                    h,
                    {
                      ...
                      className: o(
                        A.dialog,
                        (0, F.isOnMobileAppPage)('any') &&
                          !this.props.noMobileAppShadows &&
                          A.mobile,
                        this.props.fullscreen && A.fullscreen,
        ...
        componentDidMount() {
          ...
          if ((this._eventDispatcher.dispatch('dialog-open'), e)) {
            ...
            if (e && e instanceof HTMLElement) {
              ...
              (this._cleanUpFunctions.push(() => o.destroy()),
                (this._drag = o));
            }
          }
        ...
        _applyAppearanceAnimation(e) {
          if (this._resize && this._dialog) {
            ...
            (this._dialog.style.setProperty(
              ...
              this._dialog.classList.add(A.dialogAnimatedAppearance));
          }
        }
        _handleTooltipFit() {
          0;
      ...
      const L = (0, m.makeOverlapable)(O, !0);
    },
    86431: (e, t, n) => {
      'use strict';
      ...
      function a(e, t) {
        return class extends i.PureComponent {
          render() {
            const { isOpened: n, root: a } = this.props;
            if (!n) return null;
