  ...
  [8949],
  {
    ...
    13238: (e, t, i) => {
      ...
      const g = {
        ...
        p = { sticker: 'bitcoin', angle: 0.5 * Math.PI },
        v = (0, h.extractAllPropertiesKeys)(g),
        f = (0, h.extractAllPropertiesKeys)(p),
        P = [...new Set([...f, ...v, ...d.commonLineToolPropertiesStateKeys])];
      class y extends c.LineDataSourceProperty {
        constructor(e) {
          super(e);
        }
        static create(e, t, i) {
          return new this({
            ...
            themedDefaultsKeys: [],
            allStateKeys: P,
            state: (0, l.default)({}, p, { sticker: i }, t ?? {}),
            theme: e,
          });
        }
      }
      const S = (0, o.getLogger)('Chart.LineToolSticker');
      var b;
      !(function (e) {
        e[(e.Version = 1)] = 'Version';
      })(b || (b = {}));
      class m extends r.LineToolSvgIconBase {
        constructor(e, t, i, s) {
          (super(
            e,
        ...
        static createProperties(e, t) {
          const i = y.create(e, t, s.stickerTool.value());
          return (m._configureProperties(i), i);
        }
        ...
        async _loadViews() {
          ...
          if (!this._isDestroyed) {
            ...
            (null === r &&
              S.logWarn(`Couldn't create svg renderer for sticker ${i}`),
      ...
      class h extends c.LineDataSource {
        ...
        startChanging(e, t) {
          ...
          if (t) l = (0, n.ensureNotNull)(this.pointToScreenPoint(t));
            ...
            const e = o / 2 + this.getAdditionalPadding();
            ((l = (0, r.point)(i.y + e, i.y + e)),
              (t = (0, n.ensureNotNull)(this.screenPointToPoint(l, !0))));
          }
        ...
        setPoint(e, t, i) {
          const {
            ...
            d = (0, n.ensureNotNull)(this.pointToScreenPoint(t)),
