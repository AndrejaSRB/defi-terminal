      ...
      ((e.rotationMatrix = function (t) {
        ...
        (e.transformPoint = function (t, e) {
          const i = [e.x, e.y, 1],
            s = [0, 0, 0];
          for (let e = 0; e < 3; e++)
            for (let n = 0; n < 3; n++) s[e] += i[n] * t[e][n];
          return new n.Point(s[0], s[1]);
        }));
      const n = i(10555);
    },
    20272: (t, e, i) => {
      (i.r(e), i.d(e, { LineToolArc: () => d }));
      var n,
        s = i(50151),
        o = i(2624),
        r = i(10555),
      ...
      class d extends c.LineDataSource {
        constructor(t, e, n, s) {
          (super(
            t,
            e ?? d.createProperties(t.backgroundTheme().spawnOwnership()),
            n,
            s,
          ),
        ...
        startChanging(t, e) {
          if ((super.startChanging(t, e), 0 === t || 1 === t)) {
            ...
            this._dist = (0, o.distanceToLine)(t, e, i).distance;
            const n = e.subtract(t),
              a = new r.Point(-n.y, n.x),
              l = t.add(e).scaled(0.5);
            i.subtract(l).dotProduct(a) < 0 && (this._dist = -this._dist);
          }
        }
        endChanging(t, e) {
          return ((this._dist = null), super.endChanging(t, e));
        }
        pointsCount() {
          return 3;
        }
          ...
          switch (t) {
            case 0: {
              const t = (0, s.ensureNotNull)(this._dist),
                e = (0, s.ensureNotNull)(this.pointToScreenPoint(i)),
                n = l.subtract(e),
                o = e.add(l).scaled(0.5);
              let a = new r.Point(-n.y, n.x);
              a = a.normalized();
              const h = o.add(a.scaled(t));
              ((this._points[0] = { ...i, interval: c }),
                (this._points[2] = {
            ...
            case 1: {
              const t = (0, s.ensureNotNull)(this._dist),
                e = (0, s.ensureNotNull)(this.pointToScreenPoint(i)),
                o = e.subtract(n),
                a = n.add(e).scaled(0.5),
                l = new r.Point(-o.y, o.x).normalized(),
                h = a.add(l.scaled(t));
              ((this._points[1] = { ...i, interval: c }),
                (this._points[2] = {
                  ...(0, s.ensureNotNull)(this.screenPointToPoint(h)),
                  interval: c,
                }));
            ...
            case 2: {
              let t = (0, s.ensureNotNull)(this.pointToScreenPoint(i));
              const e = (0, o.distanceToLine)(n, l, t).distance,
                h = l.subtract(n),
        ...
        migrateVersion(t, e, i) {
          if (1 === t && 2 === this._points.length) {
            const t = this._model.mainSeries().interval(),
              e = (2 * this._points[0].price + 3 * this._points[1].price) / 5;
            this._points.push({
              price: e,
