  ...
  [2891],
  {
    91445: (e, t, o) => {
      ...
      const a = new r.TranslatedString(
        ...
        T = i.t(null, void 0, o(79468)),
        C = i.t(null, void 0, o(38408)),
        x = i.t(null, void 0, o(7560)),
      ...
      function w(e, t, o, i) {
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (w.backgroundTitle =
              (i.customTitles && i.customTitles.backgroundTitle) || T),
          ...
          void 0 !== t.wrap &&
            ...
            (w.wrapTitle = (i.customTitles && i.customTitles.wrapTitle) || x)),
    ...
    14472: (e, t, o) => {
      ...
      const g = n.t(null, void 0, o(40091)),
        _ = n.t(null, void 0, o(78930)),
        y = n.t(null, void 0, o(92516)),
        b = n.t(null, void 0, o(70320)),
        m = n.t(null, void 0, o(21429)),
        f = n.t(null, { context: 'linetool point' }, o(80166));
      class P {
        constructor(e, t) {
        ...
        _createStylePropertyPage() {
          ...
          return null !== e ? (0, l.createPropertyPage)(e, 'style', y) : null;
        }
        ...
        _createTextPropertyPage() {
          ...
          return null !== e ? (0, l.createPropertyPage)(e, 'text', b) : null;
        }
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, l.createPropertyPage)(e, 'inputs', m) : null;
        }
    ...
    12891: (e, t, o) => {
      ...
      var i = o(50151),
        ...
        c = o(91445),
        u = o(14472);
      const p = r.t(null, void 0, o(70320));
      class h extends u.LineDataSourceDefinitionsViewModel {
        _textPropertyDefinitions() {
      ...
      class N extends D.MediaCoordinatesPaneRenderer {
        constructor() {
          (super(...arguments),
            (this._geometryCache = {
              innerHeight: NaN,
        ...
        hitTest(e) {
          ...
          return (0, x.pointInBox)(e, i)
            ? new T.HitTestResult(T.HitTarget.MovePoint, {
                areaName: T.AreaName.Text,
              })
            : null;
        }
        _drawImpl(e) {
          ...
          const o = this._measureInfo(t, this._data.label, this._data.fontSize),
            {
              ...
              innerHeight: r,
              innerWidth: n,
              textHorizontalPadding: s,
            } = o;
          t.textAlign = (0, S.isRtl)() ? 'right' : 'left';
          const a = this._data.points[0].x - (i + 20),
          ...
          (t.translate(a, l),
            ...
            t.fillText(this._data.label, i + s, r / 2));
        }
        _measureInfo(e, t, o) {
          if (this._geomertryCacheInvalidated) {
            const i = e.measureText(t),
              ...
              a = i.width + 2 * n,
              l = r + 2 * s,
              d = (0, w.calcTextHorizontalShift)(e, i.width);
            ((this._geometryCache = {
              paddingLeft: n,
              innerWidth: a,
              innerHeight: l,
      ...
      class V extends m.LineSourcePaneView {
        constructor(e, t) {
          (super(e, t),
            (this._balloonRenderer = new N()),
            (this._renderer = null));
        }
        renderer(e) {
        ...
        _updateImpl(e) {
          ...
          const t = this._source.properties().childs(),
            o = {
              ...
              backgroundColor: (0, _.generateColor)(
                t.backgroundColor.value(),
                t.transparency.value(),
              ),
              font: (0, y.makeFont)(t.fontsize.value(), b.CHART_FONT_FAMILY),
            ...
            return (
              ...
              e.append(
                new v.SelectionRenderer({
                  ...
                  hittestResult: T.HitTarget.MovePoint,
                }),
              ),
      ...
      const k = r.t(null, void 0, o(9818));
      class A extends s.InplaceTextLineDataSource {
        constructor(e, t, o, i) {
          (super(
            e,
        ...
        static _configureProperties(e) {
          (super._configureProperties(e),
            e.hasChild('text') ||
              e.addChild('text', new a.Property(this._defaultText)),
            e.addExcludedKey('text', 1),
            e.addChild(
              'linesColors',
              new l.LineToolColorsProperty([e.childs().borderColor]),
            ),
            e.addChild(
              'textsColors',
