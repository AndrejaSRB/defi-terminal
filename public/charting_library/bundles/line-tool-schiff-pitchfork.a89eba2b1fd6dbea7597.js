  ...
  [7175, 5055],
  {
    40226: (e, t, i) => {
      ...
      class P extends o.DefaultProperty {
        constructor(e) {
          const { levelsIterator: t = f, map: i = {}, ...r } = e,
            s = { ...a, ...i };
          (r.state && (r.state = u(r.state, s, t)),
            super(r),
            (this._map = s),
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, o.extractState)(
              (0, s.default)(
                (0, r.default)(t),
                u(e, this._map, this._levelsIterator),
              ),
              this._allStateKeys,
        ...
        merge(e, t) {
          return super.merge(
            this._map ? u(e, this._map, this._levelsIterator) : e,
            t,
          );
        }
        _options() {
        ...
        processErase(e, t) {
          const i = 'level' + t,
            s = (0, r.ensureDefined)(this.properties().child(i)).childs()
              .visible;
          e.setProperty(s, !1, f, a.lineToolsDoNotAffectChartInvalidation);
        }
    ...
    28216: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolSchiffPitchfork: () => n }));
      var r = i(40226),
        s = i(7029);
      class n extends s.LineToolPitchfork {
        ...
        static createProperties(e, t) {
          const i = new r.LevelsProperty({
            defaultName: 'linetoolschiffpitchfork',
            state: t,
            map: { range: [0, 8] },
            theme: e,
          });
