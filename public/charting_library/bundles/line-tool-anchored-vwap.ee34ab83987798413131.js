  ...
  [5500],
  {
    55157: (e, t, s) => {
      ...
      var i = s(50151),
        ...
        d = s(65045),
        u = s(63670);
      class h extends u.StudyPriceAxisView {
        _showPaneLabel() {
          return !1;
        }
        _showAxisLabel() {
      ...
      var y = s(9343),
        ...
        b = s(35107),
        S = s(5471);
      class A extends b.StudyLineDataSource {
        lastValueData(e, t, s) {
          const r = { noData: !0 },
            n = this.priceScale();
          if (
          ...
          if (null === o) return r;
          const d = a.contains(o.index),
            u = !t && d ? o : (0, i.ensureNotNull)(this.plots().last()),
            h = this.metaInfo().plots.findIndex((t) => t.id === e);
          if (h < 0 || !u || !(0, w.default)(u.value[h + 1])) return r;
          const c = u.value[h + 1];
          if (null == c) return r;
          const p = (0, i.ensureDefined)(l.childs().styles.child(e)),
            y = (0, i.ensureNotNull)(this.firstValue()),
            _ = n.priceToCoordinate(c, y);
          return {
            ...n.getFormattedValues(c, y),
            noData: !1,
            price: c,
      ...
      var g = s(69555),
        m = s(72972),
        V = s(91111);
      const I = (0, y.getLogger)('Chart.AnchoredVWAP'),
        v = (0, i.ensureDefined)(V.lineToolsStudyIds.LineToolAnchoredVWAP),
        C = !0;
      function R(e, t, s, r) {
        return (
          ...
          t.styles &&
            (x(t.styles.VWAP, r.defaults.styles?.VWAP?.display),
            x(t.styles.UpperBand, r.defaults.styles?.UpperBand?.display),
            x(t.styles.LowerBand, r.defaults.styles?.LowerBand?.display),
            x(t.styles.UpperBand_2, r.defaults.styles?.UpperBand_2?.display),
            x(t.styles.LowerBand_2, r.defaults.styles?.LowerBand_2?.display),
            x(t.styles.UpperBand_3, r.defaults.styles?.UpperBand_3?.display),
            x(t.styles.LowerBand_3, r.defaults.styles?.LowerBand_3?.display)),
          t
        );
      }
      function x(e, t) {
        if (void 0 !== e && void 0 !== e.visible) {
          if (void 0 !== e.display && e.display !== t) return;
      ...
      class L extends A {
        constructor(e, t, s, r, n) {
          s =
            s ||
            (0, i.ensureNotNull)(
              (0, m.studyMetaInfoRepository)().findByIdSync({
                type: 'java',
                studyId: v,
              }),
            );
          ...
          (super(e, s, 'anchoredvwap', a, r, n),
            (this._onVisibleBarsStrictRangeChanged = (e) => {
              const t = this._getPointsetPoints()?.[0].index ?? null;
              null !== t &&
                null !== e &&
                e.contains(t) &&
                this._onStudyInputsMayChange();
            }));
          const [l, o, d, u, y, _, P] = this.metaInfo().plots,
            w = e.mainSeries(),
            b = [new p(this, w, e, l.id)];
          (o &&
            d &&
            (b.push(new c.StudyPlotPaneView(this, w, e, o.id)),
            b.push(new c.StudyPlotPaneView(this, w, e, d.id))),
            u &&
              y &&
              _ &&
              P &&
              (b.push(new c.StudyPlotPaneView(this, w, e, u.id)),
              b.push(new c.StudyPlotPaneView(this, w, e, y.id)),
              b.push(new c.StudyPlotPaneView(this, w, e, _.id)),
              b.push(new c.StudyPlotPaneView(this, w, e, P.id))),
            this._properties.childs().areaBackground &&
              b.splice(0, 0, new f.AreaBackgroundPaneView(this, e)),
            (this._priceAxisViews = this.metaInfo().plots.map(
              (e) => new h(this, { plotIndex: e.id }),
            )),
            b.push(
              ...this._priceAxisViews.map(
                (e) => new g.PanePriceAxisView(e, this, this._model),
              ),
            ),
            (this._anchorPriceCalculated = !1),
            (this._onInputsReadyCallbacks = []),
            this._setPaneViews(b),
            e
              .properties()
              .childs()
        ...
        static createProperties(e, t) {
          const s = r.StudyMetaInfo.getStudyPropertyRootNameById(v),
            a = (0, i.ensureNotNull)(
              (0, m.studyMetaInfoRepository)().findByIdSync({
                type: 'java',
                studyId: v,
            ...
            l = (0, _.createDefaultsState)(
              !0,
              s,
              [],
              (0, m.studyMetaInfoRepository)().studyVersioning(),
            );
        ...
        static createPropertiesFromStudyMetaInfoAndState(e, t, s, i, r) {
          const n = (0, l.prepareStudyPropertiesForLoadChart)(e, t, s, i, R, r);
        ...
        static _configureProperties(e) {
          ...
          (e.addChild('linesWidths', new d.LineToolWidthsProperty([t])),
            e.addChild('linesColors', new d.LineToolColorsProperty([s])));
        }
        _onInputsReady(e) {
          null !== this._inputs
            ? e(this._inputs)
        ...
        _onShowStudyLastValueChanged() {
          (this._priceAxisViews.forEach((e) =>
            e.update((0, P.sourceChangeEvent)(this.id())),
          ),
