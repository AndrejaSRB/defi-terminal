...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2816],
  {
    40226: (e, t, i) => {
      ...
      function p(e, t, i) {
        return i(e, { tpl: u, fill: d, typecheck: t.typecheck.unpack }, t);
      }
      class g extends o.DefaultProperty {
        constructor(e) {
    ...
    33985: (e, t, i) => {
      ...
      class u extends c.InplaceTextLineDataSource {
        constructor(e, t, n, s) {
          (super(
            e,
        ...
        processErase(e, t) {
          const i = `level${t}`,
            s = (0, n.ensureDefined)(this.properties().child(i)).childs()
              .visible;
        ...
        static _configureProperties(e) {
          ...
          const t = e.childs(),
            ...
            s = [t.trendline.childs().color];
          for (let t = 1; t <= 11; t++)
            (i.push(
              (0, n.ensureDefined)(e.child('level' + t)?.child('linewidth')),
            ),
              s.push(
                (0, n.ensureDefined)(e.child('level' + t)?.child('color')),
              ));
          (e.addChild('linesColors', new a.LineToolColorsProperty(s)),
    ...
    63117: (e, t, i) => {
      ...
      class T extends _.LineDataSource {
        ...
        editableTextStyle() {
          return { ...(this._isDarkBackground.value() ? x : w) };
        }
