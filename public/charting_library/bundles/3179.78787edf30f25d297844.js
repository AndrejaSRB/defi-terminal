(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3179],
  {
        ...
        return (
          (0, i.useIsomorphicLayoutEffect)(() => {
            const e = { click: t, mouseDown: n, touchEnd: r, touchStart: a },
              s = u ? u.current : c.current;
            return (0, o.addOutsideEventListener)(d.current, s, l, document, e);
          }, [t, n, r, a, l]),
          u || c
        );
      }
      ...
      const s = (() => {
        ...
        return () => {
          if (void 0 === e) {
            ...
            (t.parentNode?.removeChild(t), (e = s - o));
          }
          return e;
        };
      })();
          ...
          (super(e),
            ...
            (this._handleMeasure = ({
              ...
              const { position: n } = this.props,
                s = (0, r.ensureNotNull)(this._containerRef);
              ...
              const { width: h, height: p } = i,
                ...
                g = (0, a.clamp)(m.x, f, Math.max(f, _)),
                v = (m?.indentFromWindow?.top ?? 0) + u,
                y =
                  o -
                  (m.overrideHeight ?? p) -
                  (m?.indentFromWindow?.bottom ?? 0);
              let w = (0, a.clamp)(m.y, v, Math.max(v, y));
              if (
              ...
              const b = m.overrideHeight ?? (d ? c : void 0);
              this.setState(
                {
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(
                    ...
                    s.createElement(y, { className: g.menuBox }, h),
                  ),
                ),
              ),
            ...
            onMouseOver: function (e) {
              if (
                !(
                  ...
                  ((s = e.target), n.current?.contains(s))
                )
              )
                return;
              var s;
    ...
    65718: (e, t, n) => {
      'use strict';
      n.d(t, { Portal: () => s.Portal, PortalContext: () => s.PortalContext });
      var s = n(19250);
    },
    50655: (e, t, n) => {
      'use strict';
