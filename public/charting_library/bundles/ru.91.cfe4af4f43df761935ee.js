(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    22233: (r) => {
      r.exports = { en: ['auto'], ru: ['авто'] };
    },
    4161: (r) => {
      r.exports = { en: ['log'], ru: ['лог'] };
    },
    1495: (r) => {
      r.exports = { en: ['All data'], ru: ['Все данные'] };
    },
    19273: (r) => {
      r.exports = { en: ['Year to day'], ru: ['Данные с начала года'] };
    },
    58426: (r) => {
      r.exports = {
    ...
    42432: (r) => {
      r.exports = { en: ['Go to'], ru: ['Перейти к дате'] };
    },
    92966: (r) => {
      r.exports = {
    ...
    67092: (r) => {
      r.exports = { en: ['Fullscreen mode'], ru: ['Полноэкранный режим'] };
    },
    61206: (r) => {
      r.exports = { en: ['Maximize chart'], ru: ['Развернуть график'] };
    },
    2031: (r) => {
      r.exports = {
    ...
    27665: (r) => {
      r.exports = { en: ['Sessions'], ru: ['Сессии'] };
    },
    31142: (r) => {
      r.exports = { en: ['Restore chart'], ru: ['Восстановить график'] };
    },
    41888: (r) => {
      r.exports = {
    ...
    77073: (r) => {
      r.exports = { en: ['Timezone'], ru: ['Часовой пояс'] };
    },
    49545: (r) => {
      r.exports = {
