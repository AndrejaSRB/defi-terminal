(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6166],
  {
    ...
    67961: (e, t, r) => {
      'use strict';
      r.d(t, { OverlapManager: () => a, getRootOverlapManager: () => l });
      var o = r(50151),
        n = r(34811);
      class s {
        constructor() {
    ...
    91759: (e, t, r) => {
      'use strict';
      (r.r(t), r.d(t, { ChartEventHintRenderer: () => l }));
      var o = r(50959),
        n = r(32227),
        s = r(65551),
        a = r(22496);
      function i(e) {
        const { bottomOffset: t, text: r, onClose: n } = e;
        return o.createElement(
          'div',
          { className: a.container, style: { bottom: t } },
          o.createElement(
            'div',
            { className: a.centerElement },
            o.createElement(
              s.TooltipWidget,
              { arrow: !1, onClose: n },
              o.createElement('div', { className: a.text }, r),
            ),
          ),
        );
      }
      class l {
        ...
        show(e, t) {
          ...
          n.render(o.createElement(i, { ...r }), this._wrap);
        }
        hide() {
          this._wrap &&
            (n.unmountComponentAtNode(this._wrap), this._wrap.remove());
        }
        destroy() {
    ...
    65551: (e, t, r) => {
      'use strict';
      r.d(t, { TooltipWidget: () => c, TooltipWizard: () => d });
      var o = r(50959),
        n = r(97754),
        s = r(9745),
        a = r(65718),
      ...
      function c(e) {
        ...
        return o.createElement(
          'div',
          { ...v, className: t, ref: d, style: c, 'data-role': _ },
          h && o.createElement('div', { className: p, ref: m, style: f }),
          o.createElement(
            'div',
            { className: n(l.container, r) },
            o.createElement('div', { className: n(l.content, a) }, w),
            u &&
