(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9928],
  {
    ...
    73893: (t) => {
      t.exports = {
        errors: 'errors-UKx97h9K',
        show: 'show-UKx97h9K',
        error: 'error-UKx97h9K',
        'visually-hidden': 'visually-hidden-UKx97h9K',
      };
    },
    41765: (t) => {
      t.exports = {
    ...
    97737: (t, e, n) => {
      ...
      function d(t) {
        ...
        return { ...c, color: i(e), size: l(n), variant: a(r), stretch: o };
      }
      function h(t) {
        return c.createElement(u.SquareButton, { ...d(t) });
      }
    },
    43814: (t, e, n) => {
      'use strict';
      n.d(e, { SquareButton: () => b });
      var r = n(50959),
        o = n(97754),
        s = n.n(o),
        a = n(95604),
      ...
      function u(t) {
        const {
          ...
          R = (function (t) {
            ...
            return (
              0 !== t &&
                (1 & t && (e = s()(e, l()['no-corner-top-left'])),
                2 & t && (e = s()(e, l()['no-corner-top-right'])),
                4 & t && (e = s()(e, l()['no-corner-bottom-right'])),
                8 & t && (e = s()(e, l()['no-corner-bottom-left']))),
              e
            );
        ...
        return s()(
          ...
          R,
          m && l().grouped,
          m && !g && l().adjustPosition,
          m && p.isTop && l().firstRow,
          m && p.isLeft && l().firstCol,
          f && b && l().multilineContent,
          v && l().link,
          c,
        );
      }
      ...
      function g(t, e) {
        return (n) => {
          if (e) return (n.preventDefault(), void n.stopPropagation());
          t?.(n);
        };
      }
      function f(t) {
      ...
      function b(t) {
        const {
          ...
          } = (0, r.useContext)(m.ControlGroupContext),
          C = u({
            ...b,
            isGrouped: v,
            cellState: w,
          ...
          y =
            ...
            (t.primaryText
              ...
              : (0, h.getTextForTooltip)(t.children));
        return r.createElement(
          'button',
          {
            ...f(b),
            'aria-disabled': o || p,
            tabIndex: t.tabIndex ?? (o ? -1 : 0),
            className: C,
            ref: e,
            onClick: g(s, o),
            onMouseDown: g(l, o),
    ...
    95604: (t, e, n) => {
      ...
      n.d(e, { getGroupCellRemoveRoundBorders: () => r });
    },
    67029: (t, e, n) => {
      'use strict';
      n.d(e, { ControlSkeleton: () => w, InputClasses: () => f });
      var r = n(50959),
        o = n(97754),
        s = n.n(o),
        a = n(50151),
      ...
      function m(t) {
        ...
        return (
          0 !== t &&
            (1 & t && (e = s()(e, h()['no-corner-top-left'])),
            2 & t && (e = s()(e, h()['no-corner-top-right'])),
            4 & t && (e = s()(e, h()['no-corner-bottom-right'])),
            8 & t && (e = s()(e, h()['no-corner-bottom-left']))),
          e
        );
      }
      function p(t, e, n, r) {
        const {
          ...
          w = m(o ?? (0, u.getGroupCellRemoveRoundBorders)(n));
        return s()(
          h().container,
          h()[`container-${c}`],
          h()[`intent-${i}`],
      ...
      function g(t, e, n) {
        const { highlight: r, highlightRemoveRoundBorder: o } = t;
        if (!r) return h().highlight;
        const a = m(o ?? (0, u.getGroupCellRemoveRoundBorders)(e));
        return s()(h().highlight, h().shown, h()[`size-${n}`], a);
      }
      const f = {
          FontSizeMedium: (0, a.ensureDefined)(h()['font-size-medium']),
          FontSizeLarge: (0, a.ensureDefined)(h()['font-size-large']),
        },
        b = {
          passive: !1,
        };
      function v(t, e) {
        const {
          ...
          Z = (function (t, e = null, n) {
            const o = (0, r.useRef)(null),
              s = (0, r.useRef)(null),
              a = (0, r.useCallback)(() => {
                if (null === o.current || null === s.current) return;
                const [t, e, n] = s.current;
                null !== e && o.current.addEventListener(t, e, n);
              }, []),
              i = (0, r.useCallback)(() => {
                if (null === o.current || null === s.current) return;
                const [t, e, n] = s.current;
                null !== e && o.current.removeEventListener(t, e, n);
              }, []),
              l = (0, r.useCallback)((t) => {
                (i(), (o.current = t), a());
              }, []);
        ...
        return r.createElement(
          A,
          {
            ...
            onClick: w,
            onWheel: P,
            ...(0, l.filterDataProps)(t),
            ...(0, l.filterAriaProps)(t),
          },
          C,
          y,
          S,
          r.createElement('span', { className: g(t, W, E) }),
        );
      }
      v.displayName = 'ControlSkeleton';
      const w = r.forwardRef(v);
    },
    78274: (t, e, n) => {
      'use strict';
      n.d(e, {
      ...
      function c(t) {
        ...
        return r.createElement(
          'span',
          { className: s()(i()['inner-slot'], i()['inner-middle-slot'], e) },
          n,
        );
      }
      function u(t) {
      ...
      function d(t) {
        const { className: e, children: n, dataQaId: o } = t;
        return r.createElement(
          'span',
          { className: s()(i()['after-slot'], e), 'data-qa-id': o },
          n,
        );
      }
    },
    31261: (t, e, n) => {
      ...
      var r = n(50959),
        ...
        b = n.n(f);
      function v(t) {
        return !(0, i.isAriaAttribute)(t) && !(0, i.isDataAttribute)(t);
      }
      function w(t) {
        const {
            id: e,
        ...
        return r.createElement(p.ControlSkeleton, {
          ...
          endSlot: U,
          'data-qa-id': (0, a.dataQaIds)('ui-lib-Input', G),
        });
      }
      function R(t) {
        t = (0, d.useControl)(t);
        const {
          ...
          E = (0, l.createSafeMulticastEventHandler)(
            R.onFocus,
            function (t) {
              n && !S.current && (0, c.selectAllContent)(t.currentTarget);
            },
            s,
          ),
          x = (0, l.createSafeMulticastEventHandler)(R.onBlur, a),
          B = (0, r.useCallback)(
            (t) => {
              ((f.current = t),
                i &&
        ...
        return r.createElement(w, {
          ...
          containerTabIndex: C,
          tabIndex: y,
          onContainerFocus: function (t) {
            b.current === t.target && null !== f.current && f.current.focus();
          },
          onFocus: E,
          onBlur: x,
          reference: B,
          containerReference: (0, u.useMergedRefs)([b, p]),
          onMouseDown: P,
          onMouseUp: D,
          dataQaId: g,
        });
    ...
    48027: (t, e, n) => {
      ...
      function s(t) {
        const {
          ...
          [l, c] = (0, o.useFocus)(void 0, i),
          u = (0, r.createSafeMulticastEventHandler)(i ? void 0 : c.onFocus, e),
          d = (0, r.createSafeMulticastEventHandler)(i ? void 0 : c.onBlur, n);
        return {
          ...t,
    ...
    45812: (t, e, n) => {
      ...
      function o() {
        ...
        return { isMouseDown: t, handleMouseDown: e, handleMouseUp: n };
      }
    },
    48907: (t, e, n) => {
      'use strict';
      function r(t) {
        null !== t && t.setSelectionRange(0, t.value.length);
      }
      n.d(e, { selectAllContent: () => r });
    },
    50182: (t, e, n) => {
      'use strict';
      n.d(e, { AdaptiveConfirmDialog: () => m });
      var r,
        o = n(50959),
        s = n(97754),
        a = n.n(s),
        ...
        h = n(78195);
      !(function (t) {
        ((t.Submit = 'submit'), (t.Cancel = 'cancel'), (t.None = 'none'));
      })(r || (r = {}));
    ...
    1405: (t, e, n) => {
      ...
      n(50959);
      !(function (t) {
        ((t.Top = 'top'), (t.Bottom = 'bottom'), (t.TopRight = 'topRight'));
      })(r || (r = {}));
      const o = {
        bottom: {
    ...
    86623: (t, e, n) => {
      ...
      function c(t) {
        const {
            ...
            iconHidden: C,
            messagesPosition: y,
            messagesAttachment: S,
            customErrorsAttachment: P,
            messagesRoot: D,
            inheritMessagesWidthFromTarget: E,
            disableMessagesRtlStyles: x,
            'aria-required': B,
            'aria-invalid': M,
            'aria-label': W,
            inputDescription: N,
          ...
          I = (0, s.useControlValidationLayout)({
            hasErrors: p,
            hasWarnings: g,
            hasSuccessMessages: f,
            errors: b,
          ...
          F = (0, i.createSafeMulticastEventHandler)(n, I.onFocus),
          T = (0, i.createSafeMulticastEventHandler)(c, I.onBlur),
          k = (0, i.createSafeMulticastEventHandler)(u, I.onMouseOver),
          z = (0, i.createSafeMulticastEventHandler)(d, I.onMouseOut);
        return r.createElement(
          r.Fragment,
          null,
          r.createElement(o.InputControl, {
            ...A,
            intent: I.intent ?? e,
            onFocus: F,
            onBlur: T,
            onMouseOver: k,
            onMouseOut: z,
            containerReference: (0, l.useMergedRefs)([h, I.containerReference]),
            endSlot: r.createElement(
              ...
              I.icon &&
                r.createElement(
                  a.EndSlot,
                  { dataQaId: 'validation-input-icon', icon: !0 },
                  I.icon,
                ),
              m,
            ),
    ...
    1140: (t, e, n) => {
      ...
      class p extends r.PureComponent {
        render() {
          const {
            ...
            l = o(h.errors, { [h.show]: e }, n),
            c = t.map((t, e) =>
              r.createElement(v, { key: e, messageIdCallback: a }, t),
            );
          let u = {
            position: 'absolute',
            top: this.props.top,
          ...
          if ((0, m.isRtl)() && !s) {
            const { left: t, right: e } = u;
            u = { ...u, left: e, right: t };
          }
          return r.createElement(
            'div',
            { 'data-qa-id': i, style: u, className: l },
            c,
          );
        }
      }
      const g = (0, u.makeOverlapable)(
        ((f = p),
        ((b = class extends r.PureComponent {
          constructor(t) {
            (super(t),
          ...
          componentDidMount() {
            ((this._instanceElem = d.findDOMNode(this._instance)),
          ...
          _calcProps(t) {
            if (t.target && t.attachment && t.targetAttachment) {
              ...
              const {
                ...
                s = { width: r ? e.width : n, maxWidth: o ? e.width : void 0 };
      ...
      var f, b;
      function v(t) {
        const { children: e, messageIdCallback: n, ...o } = t;
        return r.createElement('div', { ...o, className: h.error }, e);
      }
      function w(t) {
        const { children: e, messageIdCallback: n, ...o } = t,
          a = r.useId();
        return (
          ...
          r.createElement(
            'span',
            { ...o, className: h['visually-hidden'], id: a },
            e,
          )
        );
      }
      ...
      function S(t) {
        ...
        return r.createElement(R.Icon, {
          icon: C,
          className: o(y['error-icon'], y[`intent-${e}`]),
        });
      }
      var P,
        D,
      ...
      function B(t) {
        ...
        return r.createElement(
          ...
          r.createElement(w, { messageIdCallback: u }, c),
        );
      }
      function M(t, e) {
      ...
      function W(t, e, n) {
        return t === P.Attached && M(e, n);
      }
      function N(t, e, n) {
        return t === P.Static && M(e, n);
      }
      function Z(t, e, n) {
        const {
            hasErrors: r,
            hasWarnings: o,
            hasSuccessMessages: s,
            alwaysShowAttachedErrors: a,
            iconHidden: i,
            errors: l,
            warnings: c,
            successMessages: u,
            messagesPosition: d = P.Static,
          } = t,
          h = W(d, r, l),
          m = W(d, o, c),
          p = h && (e || n || Boolean(a)),
      ...
      function A(t) {
        const {
            ...
            customErrorsAttachment: u,
            messagesRoot: d,
            inheritMessagesWidthFromTarget: h,
            disableMessagesRtlStyles: m,
            inputDescription: p,
          } = t,
          [g, f] = (0, a.useFocus)(),
          [b, v] = (0, i.useHoverDeprecated)(),
          w = (0, r.useRef)(null),
          [R, C] = r.useState(void 0),
          y = (0, r.useRef)(new Map()),
          P = r.useCallback(
            (t) => {
              if (!t) return;
              const e = y.current;
              (e.has(t) ? e.delete(t) : e.set(t, t),
                0 !== e.size ? C(Array.from(e.keys()).join(' ')) : C(void 0));
            },
            [C, y.current],
          ),
          {
            hasAttachedErrorMessages: D,
            hasAttachedWarningMessages: x,
            showAttachedErrorMessages: M,
            showAttachedWarningMessages: W,
            showStaticErrorMessages: N,
            showStaticWarningMessages: A,
          ...
          O =
            T || k
              ? r.createElement(S, { intent: T ? 'danger' : 'warning' })
              : void 0,
          _ = D
            ? r.createElement(B, {
                errorAttachment: c,
                ...
                target: w.current,
                root: d,
                inheritWidthFromTarget: h,
                disableRtlStyles: m,
                children: e,
                messageIdCallback: P,
                dataQaId: 'attached-error-box',
              })
            : void 0,
          K = x
            ? r.createElement(B, {
          ...
          L = N
            ? r.createElement(
                l.AfterSlot,
                {
                  dataQaId: 'static-errors',
                  className: o(E['static-messages'], E.errors),
                },
                e?.map((t, e) =>
                  r.createElement(I, { key: e, messageIdCallback: P }, t),
                ),
              )
            : void 0,
          j = A
          ...
          U = F
            ? r.createElement(
                l.AfterSlot,
                {
                  dataQaId: 'success-message',
                  className: o(E['static-messages'], E['success-mesages']),
                },
                s?.map((t, e) =>
                  r.createElement(I, { key: e, messageIdCallback: P }, t),
                ),
          ...
          Q =
            !N && !A && !F && p
              ? r.createElement(
                  l.AfterSlot,
                  {
                    dataQaId: 'success-messages',
                    className: o(E['static-messages'], E['input-description']),
                  },
                  r.createElement(I, { messageIdCallback: P }, p),
                )
              : void 0;
        return {
          ariaIds: R,
          icon: O,
          renderedErrors: _ ?? K ?? L ?? j ?? U ?? Q,
      ...
      function I(t) {
        ...
        return (
          ...
          r.createElement(
            'span',
            { ...o, className: E.message, 'aria-live': 'assertive', id: a },
            e,
          )
        );
      }
