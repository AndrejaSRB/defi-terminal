...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    94512: (e, t, i) => {
      i.d(t, { LineToolHorzLinePriceAxisView: () => o });
      var r = i(36281),
        s = i(52859);
      class o extends r.PriceAxisView {
        ...
        _updateRendererData(e, t, i) {
          ...
          if (0 === r.length || null === o || o.isEmpty()) return;
          const n = r[0];
          ...
          ((i.background = c),
            ...
            (i.coordinate = o.priceToCoordinate(n.price, a)),
            (e.text = o.formatPrice(n.price, a)),
            (e.visible = !0));
        }
      }
    },
    80102: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolHorzRay: () => c }));
      var r = i(50151),
        s = i(78176),
        o = i(43337),
        n = i(94512),
