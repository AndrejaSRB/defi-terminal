...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    45135: (s, e, t) => {
      (t.r(e), t.d(e, { study_MovingAverage: () => c }));
      var r = t(67455),
        l = t(22613),
        o = t(43337),
        i = t(95059),
        ...
        y = t(77380),
        m = t(48943);
      class c extends u.Study {
        constructor(s, e, t, i, n, u) {
          (super(
            s,
            (function (s) {
              return (
                s.hasChild('currencyId') ||
                  s.addChild('currencyId', new o.Property(null)),
                s.hasChild('unitId') ||
                  s.addChild('unitId', new o.Property(null)),
                s.addExcludedKey('currencyId', 1),
                s.addExcludedKey('unitId', 1),
                s
              );
            })(e),
            t,
          ...
          const a = this.properties().childs().inputs.childs().symbol;
          ((this._previousSymbolInputValue = a.value()),
            (this._symbolInfoWV = (0, r.createWVFromGetterAndSubscriptions)(
              () => this.symbolInfo(),
              [this.symbolResolved(), this.onStatusChanged()],
            )),
            (this._symbolSourceWV = (0, m.combine)(
              (s) => (s ? this : super.symbolSource()),
        ...
        symbolParams() {
          return (0, a.symbolParams)(this);
        }
        compareSymbolParams(s) {
          return (0, a.compareSymbolParams)(
            this,
            s,
            this._model.unitConversionEnabled(),
          );
        }
        async setSymbolParams(s) {
          this._setSymbolParamsInternal(s);
        }
        setSymbol(s) {
          this.setSymbolParams({ symbol: s });
        }
        symbolInfo() {
          if (!this._isActingAsSymbolSource.value())
            return super.symbolSource().symbolInfo();
          const s = this._getSymbolForResolve(this.symbol());
          return this._resolvedSymbols[s] ?? null;
        }
        symbolInfoWV() {
        ...
        isVisible() {
          const s = super.isVisible();
          return (this._symbolHibernated.setValue(!s), s);
        }
        symbolSameAsCurrent(s) {
          return (0, a.symbolSameAsCurrent)(s, this.symbolInfo());
        }
        symbolSameAsResolved(s) {
          return (0, y.symbolSameAsResolved)(
            s,
            this._lastResolvedSymbolSource,
            this.symbol(),
          );
        ...
        async _tryChangeInputs() {
          const s = this._resolvedSymbolsByInput[this.symbol()] || null;
          ((0, a.symbolSameAsCurrent)(this._previousSymbolInputValue, s) ||
        ...
        _onSymbolResolved(s, e, t) {
          (super._onSymbolResolved(s, e, t),
            this._recreatePriceFormattingDependencies());
          const r =
            e === this.symbol()
              ? (0, n.extractSymbolNameFromSymbolInfo)(t, this.symbol())
              : null;
          null !== r && (this._previousSymbolInputValue = r);
          const l = (0, i.symbolCurrency)(t),
            o = (0, i.symbolUnit)(t, this._model.unitConversionEnabled());
          (this._setSymbolParamsInternal(
            { symbol: r ?? void 0, currency: l, unit: o },
            t,
          ),
            this._symbolResolvingActive.setValue(!1));
        }
        _onSymbolResolvingStart(s, e) {
          ((this._lastResolvedSymbolSource = e),
            super._onSymbolResolvingStart(s, e),
        ...
        _recalculateIsActingAsSymbolSource() {
          ...
          this._isActingAsSymbolSource.setValue(s);
        }
        _setSymbolParamsInternal(s, e) {
          const { symbol: t, currency: r, unit: l } = s,
          ...
          if (
            ...
            void 0 !== r && o.currencyId.setValueSilently(r),
            void 0 !== l && o.unitId.setValueSilently(l),
            e)
          )
            ((this._resolvedSymbolsByInput[this.symbol()] = e),
            ...
            null !== s &&
              (o.currencyId.setValueSilently((0, i.symbolCurrency)(s)),
              o.unitId.setValueSilently(
                (0, i.symbolUnit)(s, this._model.unitConversionEnabled()),
              ));
          }
        ...
        _realignLineToolsIfParamsChanged() {
          let s = null === this._realignToolsLastParams;
          if (null !== this._realignToolsLastParams) {
            const e = this.compareSymbolParams(this._realignToolsLastParams);
            s =
              e.symbolChanged ||
              e.intervalChanged ||
              e.currencyChanged ||
