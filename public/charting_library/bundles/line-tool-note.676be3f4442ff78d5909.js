(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3248],
  {
    91445: (e, t, o) => {
      'use strict';
      o.d(t, { createTextStyleDefinition: () => w });
      var i = o(11542),
        r = o(95804),
        n = o(95338),
        s = o(91682);
      const l = new r.TranslatedString(
        ...
        x = i.t(null, void 0, o(79468)),
        C = i.t(null, void 0, o(38408)),
        P = i.t(null, void 0, o(7560)),
        S = i.t(null, void 0, o(6060));
      function w(e, t, o, i) {
        const r = {},
          w = {
            id: `${(0, s.removeSpaces)(o.originalText())}Text`,
            title: (i.customTitles && i.customTitles.text) || '',
            placeholder: i.placeholder ?? S,
          };
        if (
          (void 0 === t.showText ||
            i.hideTextCheckbox ||
          ...
          const s = u.format({ toolName: o });
          ((r.text = (0, n.convertToDefinitionProperty)(e, t.text, s, void 0)),
            (w.isEditable = Boolean(i.isEditable)),
            (w.isMultiLine = Boolean(i.isMultiLine)));
        }
        if (
          (void 0 !== t.vertLabelsAlign &&
            ...
            (w.alignmentVerticalItems = i.alignmentVerticalItems)),
          void 0 !== t.horzLabelsAlign &&
            ...
            (w.alignmentHorizontalItems = i.alignmentHorizontalItems)),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (w.backgroundTitle =
              (i.customTitles && i.customTitles.backgroundTitle) || x),
          ...
          void 0 !== t.wrap &&
            ...
            (w.wrapTitle = (i.customTitles && i.customTitles.wrapTitle) || P)),
    ...
    14472: (e, t, o) => {
      ...
      (o.r(t),
        o.d(t, {
          LineDataSourceDefinitionsViewModel: () => _,
          LineDataSourceTabTypes: () => i,
      ...
      const g = n.t(null, void 0, o(40091)),
        f = n.t(null, void 0, o(78930)),
        b = n.t(null, void 0, o(92516)),
        m = n.t(null, void 0, o(70320)),
        T = n.t(null, void 0, o(21429)),
        y = n.t(null, { context: 'linetool point' }, o(80166));
      class _ {
        constructor(e, t) {
        ...
        _createPropertyRages() {
          ...
          const o = this._createTextPropertyPage();
          null !== o && this._propertyPages.push(o);
          const i = this._createCoordinatesPropertyPage();
          null !== i &&
            ((i.visible = this._source.hasEditableCoordinates()),
        ...
        _createTextPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'text', m) : null;
        }
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'inputs', T) : null;
        }
    ...
    77977: (e, t, o) => {
      'use strict';
      (o.r(t),
        o.d(t, { LineToolNote: () => se, LineToolNoteAbsolute: () => le }));
      var i = o(3156),
        r = o(11542),
        n = o(95804),
        s = o(91445),
      ...
      function I(e) {
        ...
        if (
          ...
          const e = b,
            o = b - _;
          (t.lineTo(v - w, e),
            t.arcTo(v, e, v + P, e - S, w),
            t.lineTo(p - 1.2 * P, o + 1.2 * S),
            t.arcTo(p, o, p + 1.2 * P, o + 1.2 * S, 1.2 * P),
            t.lineTo(x - P, e - S),
            t.arcTo(x, e, x + w, e, w));
        }
        if (
          (t.lineTo(f + T - w, b),
          t.arcTo(f + T, b, f + T, b + w, w),
          t.lineTo(f + T, b + m - w),
          t.arcTo(f + T, b + m, f + T - w, b + m, w),
          'bottom' === a)
        ) {
          const e = b + m,
            o = e + _;
          (t.lineTo(x + w, e),
            t.arcTo(x, e, x - P, e + S, w),
            t.lineTo(p + 1.2 * P, o - 1.2 * S),
            t.arcTo(p, o, p - 1.2 * P, o - 1.2 * S, 1.2 * P),
            t.lineTo(v + P, e + S),
            t.arcTo(v, e, v - w, e, w));
      ...
      const W = (0, M.svgRenderer)(B);
      class R {
        constructor(e) {
          ((this._data = null),
            (this._tooltipHitTest = new v.HitTestResult(v.HitTarget.MovePoint, {
              ...e,
              areaName: v.AreaName.Text,
            })));
        }
        setData(e) {
          this._data = e;
        ...
        draw(e, t) {
          ...
          const { horizontalPixelRatio: o, verticalPixelRatio: i } = t,
            ...
            { point: s, markerColor: l } = this._data,
            a = Math.round(s.x * o) + r,
            d = Math.round(s.y * i) + n,
            c = W.viewBox();
          ((e.fillStyle = l),
            W.render(e, {
              targetViewBox: {
        ...
        hitTest(e, t) {
          if (null !== this._data) {
            const {
              ...
              d = W.viewBox(),
              c = (0, D.box)(
                (0, D.point)(l - d.width / 2, a - d.height),
                (0, D.point)(l + d.width / 2, a),
              );
            if ((0, V.pointInBox)(e, c))
              return new v.HitTestResult(v.HitTarget.MovePoint);
            if (s) {
              const t = (0, D.box)(
                (0, D.point)(o, i),
                (0, D.point)(o + r, i + n),
              );
              if ((0, V.pointInBox)(e, t)) return this._tooltipHitTest;
              const s = t.min.y < c.min.y ? t.max.y : c.max.y,
                l = t.min.y < c.min.y ? c.min.y : t.min.y,
                a = (0, D.box)(
                  (0, D.point)(c.min.x - 8, s),
                  (0, D.point)(c.max.x + 8, l),
                );
              if ((0, V.pointInBox)(e, a))
                return new v.HitTestResult(v.HitTarget.MovePoint);
            }
          }
          return null;
        ...
        getTextInfo() {
          ...
          return {
            ...
            textLeft: i + 12,
            textRight: i + o - 12,
            textAlign: (0, k.isRtl)() ? 'right' : 'left',
          };
        }
        positionToCoordinate(e, t) {
          ...
          return { x: r + i.textLeft, y: n + i.textTop, lineNumber: s };
        }
        _drawTooltipOn(e, t) {
          e.save();
          const o = (0, f.ensureNotNull)(this._data),
          ...
          e.font = n;
          const { horizontalPixelRatio: _, verticalPixelRatio: v } = t;
          if (l) {
            e.fillStyle = l;
            let o = !1;
            (d &&
          ...
          (a &&
            ((e.lineWidth = Math.max(1, 1 * Math.floor(_))),
            (e.strokeStyle = a),
            I({
              ctx: e,
              renderingInfo: t,
            ...
            (e.fillStyle = r),
            (e.textAlign = (0, k.isRtl)() ? 'right' : 'left'));
          const x = u + 12 + (0, N.calcTextHorizontalShift)(e, h);
          let C = p + 12 + s / 2;
          ((0, N.drawScaled)(e, _, v, () => {
            if (y) {
              const t = this.positionToCoordinate(!1, y.start),
                i = this.positionToCoordinate(!1, y.end),
                r = this.getTextInfo();
              (0, L.drawSelection)(e, A.dpr1PixelRatioInfo, {
            ...
            for (const t of T) (e.fillText(t, x, C), (C += s + b));
          }),
            e.restore());
        }
      }
      const z = (0, m.generateColor)(
          (0, b.getHexColorByName)('color-black'),
          80,
        ),
        H = (0, m.generateColor)((0, b.getHexColorByName)('color-black'), 60);
      class F extends w.InplaceTextLineSourcePaneView {
        constructor(e, t, o, i) {
          (super(e, t, o, i),
            (this._renderer = null),
            (this._textWidthCache = new P.TextWidthCache()),
            (this._noteRenderer = new R(
        ...
        _updateImpl(e) {
          ...
          const i = new y.CompositeRenderer(),
          ...
          const d = Math.min(236, e.mediaSize.width),
            ...
            b = n.fontSize.value();
          let P = g.length * b + 24;
          g.length > 1 && (P += 5 * (g.length - 1));
          let w = Math.round(h.x - d / 2);
          const D = W.viewBox();
          let V = Math.round(h.y - D.height - P - 13);
          const k = h.x < 24 || h.x + 24 > u.width;
          let N = k ? null : 'top';
          (V < 10 ? (V = h.y + 13) : k || (N = 'bottom'),
            w < 10 ? (w = 10) : w + d + 10 > u.width && (w = u.width - d - 10),
            ...
            i.append(
              new _.SelectionRenderer({
                ...
                hittestResult: v.HitTarget.MovePoint,
              }),
            ),
            (this._renderer = i));
        }
      ...
      var O = o(18712),
        ...
        j = o(88636);
      const q = {
          intervalsVisibilities: { ...o(37293).intervalsVisibilitiesDefaults },
          fontSize: 14,
          bold: !1,
          italic: !1,
          drawBackground: !0,
        ...
        J = new Map([
          [
            X.StdTheme.Light,
            {
              textColor: b.colorsPalette['color-cold-gray-900'],
              backgroundColor: b.colorsPalette['color-white'],
              backgroundTransparency: 0,
              borderColor: b.colorsPalette['color-cold-gray-150'],
              markerColor: b.colorsPalette['color-tv-blue-500'],
            },
          ],
          [
            X.StdTheme.Dark,
            {
              textColor: b.colorsPalette['color-cold-gray-200'],
              backgroundColor: b.colorsPalette['color-cold-gray-800'],
              backgroundTransparency: 0,
              borderColor: b.colorsPalette['color-cold-gray-700'],
              markerColor: b.colorsPalette['color-tv-blue-500'],
            },
          ],
        ]),
        Q = (0, G.extractThemedColors)(
          (0, f.ensureDefined)(J.get(X.StdTheme.Light)),
          (0, f.ensureDefined)(J.get(X.StdTheme.Dark)),
        ),
        ee = (0, G.extractAllPropertiesKeys)(
          (0, f.ensureDefined)(J.get(X.StdTheme.Light)),
        ),
        te = (0, G.extractAllPropertiesKeys)(q),
        oe = [
          ...new Set([
            ...ee,
            ...te,
            ...U.commonLineToolPropertiesStateKeys,
            'text',
            'anchored',
          ]),
        ],
        ...
        static create(e, t, o, i) {
          return new this(t, {
            ...
            factoryDefaultsSupplier: () =>
              (0, Z.factoryDefaultsForCurrentTheme)(q, J),
      ...
      class se extends Y.InplaceTextLineDataSource {
        constructor(e, t, o, i) {
          const r =
            t ?? se.createProperties(e.backgroundTheme().spawnOwnership());
          (super(e, r, o, i),
            (this.version = 1),
            this._setPaneViews([
              new F(
    ...
    70031: (e, t, o) => {
      'use strict';
      o.d(t, { factoryDefaultsForCurrentTheme: () => a });
      var i = o(16738),
        r = o(90054),
        n = o(50151),
        s = o(45345),
        l = o(24633);
      function a(e, t) {
        const o = s.watchedTheme.value() ?? l.StdTheme.Light,
          a = (0, r.default)(e);
        return ((0, i.default)(a, (0, n.ensureDefined)(t.get(o))), a);
      }
    },
    3156: (e, t, o) => {
      'use strict';
      o.d(t, { generateColorCached: () => s });
      var i = o(59332),
        r = o(52859),
        n = o(16659);
      function s(e = 1e3) {
        const t = i.default.Cache;
        i.default.Cache = n.CircularCacheBuffer.bind(n.CircularCacheBuffer, e);
        const o = (0, i.default)(
          r.generateColor,
          (e, t, o) => `${e}_${t}_${o}`,
        );
