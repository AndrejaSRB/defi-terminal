  ...
  [5456],
  {
    55456: (e, t, s) => {
      ...
      var i = s(50151),
        ...
        y = s(52945),
        b = s(52859);
      const _ = h.enabled('force_exchange_as_title');
      class p extends m.PriceAxisView {
        constructor(e, t) {
        ...
        _updateRendererData(e, t, s) {
          ...
          const r = this._studyCompare.priceScale(),
            l = this._studyCompare.lastValueData(this._data.plotIndex, !1);
          if (l.noData || null === r || r.isEmpty()) return;
          const o = this._studyCompare.model(),
            n = o.timeScale().visibleBarsStrictRange(),
            a = o.mainSeries().bars().lastIndex();
          if (null === n || null === a) return;
          if (a <= n.lastBar())
            ((s.background = (0, b.resetTransparency)(l.color)),
              (s.textColor = this.generateTextColor(s.background)),
              (s.borderColor = void 0),
              (e.borderVisible = !1),
              (t.borderVisible = !1));
          else {
            const r = o.backgroundColorAtYPercentFromTop(
              l.coordinate /
                (0, i.ensureNotNull)(
                  o.paneForSource(this._studyCompare),
                ).height(),
            );
            ((s.background = r),
              (s.textColor = (0, b.resetTransparency)(l.color)),
              (s.borderColor = s.textColor),
              (e.borderVisible = !0),
              (t.borderVisible = !0));
          }
          ((s.coordinate = l.coordinate),
            (s.floatCoordinate = l.floatCoordinate));
          const u = o.properties().childs().scalesProperties.childs();
          (u.showSeriesLastValue.value() &&
            ((e.text = (0, y.getCurrentModePriceText)(r, l)),
            u.seriesLastValueMode.value() !==
            c.PriceAxisLastValueMode.LastPriceAndPercentageValue
              ? (e.secondLine = '')
              : (e.secondLine = (0, y.getOppositeModePriceText)(r, l)),
            (e.visible = !0)),
            (t.text = ''),
            u.showSymbolLabels.value() &&
        ...
        _paneText() {
          ...
          return (
            _
              ? (e = (0, n.displayedSymbolExchange)(t))
              : this._studyCompare
                  .model()
                  .properties()
                  .childs()
      ...
      var S = s(13212),
        ...
        P = s(87465),
        f = s(36313);
      const V = C.CheckMobile.any();
      class T extends g.StudyValuesProvider {
        constructor(e, t) {
          (super(e, t),
            (this._emptyValues[0].title = e.guiPlotName(
            ...
            (0, P.isNumber)(e) ||
              (this._showLastPriceAndChangeOnly()
                ...
                : ((e = this._model.crosshairSource().appliedIndex()),
                  (0, P.isNumber)(e) || (e = this._study.data().lastIndex()))),
            super.getValues(e)
          );
        }
        _hideValues() {
        ...
        _showLastPriceAndChangeOnly() {
          return (
            ...
            (null === this._model.crosshairSource().pane ||
              (0, I.isLineToolName)(v.tool.value()) ||
              null !== this._model.lineBeingEdited())
          );
        }
      }
      class w extends S.StudyDataWindowView {
        constructor(e, t) {
      ...
      class L extends w {
        constructor(e, t) {
          (super(e, t),
            ...
            (this._showSeriesOHLC = t
              .properties()
              .childs()
              .paneProperties.childs()
              .legendProperties.childs().showSeriesOHLC),
            this._showSeriesOHLC.subscribe(this, () =>
              this.update((0, x.sourceChangeEvent)(e.id())),
            ));
        }
        areValuesVisible() {
      ...
      var A = s(80671),
        R = s(35727),
        O = s(12965);
      class E extends O.StudyStatusProvider {
        getSplitTitle() {
        ...
        text() {
          return this._source.isActualInterval()
            ? this._source.isFailed()
              ? `${this._source.title(f.TitleDisplayTarget.StatusLine, !0, void 0, !1, !1)}: ${this.sourceStatusText()}`
              : `${this._source.title(f.TitleDisplayTarget.StatusLine, !0, void 0, !1, !1)} ${this.sourceStatusText()}`
            : this._source.title(
                f.TitleDisplayTarget.StatusLine,
                !0,
      ...
      var F = s(36597),
        k = s(77380),
        W = s(67455);
      const U = h.enabled('study_overlay_compare_legend_option'),
        D = h.enabled('force_exchange_as_title'),
        H = !h.enabled('hide_study_compare_legend_item'),
        N = h.enabled('hide_unresolved_symbols_in_legend'),
        B = h.enabled('symbol_info_price_source');
      var M;
      !(function (e) {
        e.SnapShotSymbolInfoKey = '___snapshot';
      })(M || (M = {}));
      class $ extends o.Study {
        constructor(e, t, s, i, l, o) {
          (super(
            e,
            (function (e) {
              return (
            ...
            (this._isActingAsSymbolSource = new r.WatchedValue(!0)),
            (this._realignToolsLastParams = null),
            (this._lastResolvedSymbolSource = ''),
            (this._symbolSourceWV = new r.WatchedValue(this)),
            this.properties()
              .childs()
              .minTick.subscribe(null, () =>
                this._recreatePriceFormattingDependencies(),
              ),
            this.properties()
              .childs()
              .minTick.subscribe(null, () => this._model.fullUpdate()),
            this.properties()
              .childs()
              .currencyId.subscribe(this, this._onCurrencyChanged),
            this.properties()
              .childs()
              .unitId.subscribe(this, this._onUnitChanged),
            (this._symbolResolvingActive = new r.WatchedValue(!1)),
            (this._symbolHibernated = new r.WatchedValue(!1)),
            e
              .mainSeries()
              .onIntervalChanged()
              .subscribe(this, () => e.realignLineTools(this)),
            (this._symbolInfoWV = (0, W.createWVFromGetterAndSubscriptions)(
              () => this.symbolInfo(),
        ...
        symbolParams() {
          return (0, F.symbolParams)(this);
        }
        compareSymbolParams(e) {
          return (0, F.compareSymbolParams)(
            this,
            e,
        ...
        symbolSameAsCurrent(e) {
          return (0, F.symbolSameAsCurrent)(e, this.symbolInfo());
        }
        symbolSameAsResolved(e) {
          return (0, k.symbolSameAsResolved)(
            e,
            this._lastResolvedSymbolSource,
            this.symbol(),
          );
        ...
        isConvertedToOtherUnit() {
          return (0, n.isConvertedToOtherUnit)(
            this.symbolInfo(),
            this._model.unitConversionEnabled(),
          );
        }
        ...
        state(e, t) {
          ...
          const r = this.symbol();
          return (
            (s.state.inputs.symbol = (0, n.symbolToSaveInState)(
              this.symbolInfo() ??
        ...
        statusView() {
          return H ? super.statusView() : null;
        }
        guiPlotName(e, t) {
          return this.properties().childs().inputs.childs().symbol.value();
        }
        ...
        getSymbolString(e) {
          return (
            void 0 === e && (e = this._getSymbolForApi(this.symbol())),
        ...
        _createPriceAxisView(e) {
          return new p(this, { plotIndex: 'compare' });
        }
        _createViews() {
          (this._legendView || (this._legendView = new L(this, this._model)),
            this._dataWindowView ||
              (this._dataWindowView = new w(this, this._model)),
            this._statusView ||
              (this._statusView = new A.StudyStatusView(this)),
            super._createViews());
        }
        _onUnitChanged() {
          ('alwaysOff' !== (0, l.currencyUnitVisibilityProperty)().value() &&
        ...
        _onSymbolResolved(e, t, s) {
          ...
          const i =
              t === this.symbol()
                ? (0, a.extractSymbolNameFromSymbolInfo)(s, this.symbol())
                : null,
            r = (0, n.symbolCurrency)(s),
            l = (0, n.symbolUnit)(s, this._model.unitConversionEnabled());
        ...
        _tryCreateFormatter() {
          const e =
            R.customFormatters?.priceFormatterFactory?.(
              this.symbolInfo(),
              this.properties().childs().minTick.value(),
            ) ?? null;
          return null !== e
            ? e
            : (0, n.createSeriesFormatter)(
                this.symbolInfo(),
                this.properties().childs().minTick.value(),
              );
        }
        _tryCreateDefaultFormatter() {
          return (0, n.createSeriesFormatter)(this.symbolInfo(), 'default');
        }
        ...
        _getSymbolTitlePart(e) {
          ...
          const t = (0, n.getSymbolListedExchange)(e);
          if (D && void 0 !== t) return t;
          if (U)
            switch (
        ...
        _getExchangeTitlePart(e, t) {
          return null === e || t ? null : (0, n.getSymbolListedExchange)(e);
        }
        ...
        _setSymbolCurrencyUnitInternal(e, t) {
          const { symbol: s, currency: i, unit: r } = e,
            l = this.properties().childs(),
            o = l.inputs.childs().symbol.value(),
            a = l.currencyId.value(),
            u = l.unitId.value();
          if (
            (void 0 !== s && l.inputs.childs().symbol.setValueSilently(s),
            void 0 !== i && l.currencyId.setValueSilently(i),
            void 0 !== r && l.unitId.setValueSilently(r),
            t)
          )
            ...
            null !== e &&
              (l.currencyId.setValueSilently((0, n.symbolCurrency)(e)),
              l.unitId.setValueSilently(
                (0, n.symbolUnit)(e, this._model.unitConversionEnabled()),
              ));
          }
          (l.inputs.childs().symbol.value() !== o &&
            l.inputs.childs().symbol.fireChanged(),
            l.currencyId.value() !== a && l.currencyId.fireChanged(),
            l.unitId.value() !== u && l.unitId.fireChanged(),
            this._realignLineToolsIfParamsChanged());
        }
