...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    18429: (e, t, o) => {
      o.d(t, { SEPARATOR_PREFIX: () => s, isSeparatorItem: () => r });
      const s = '###';
      function r(e) {
      ...
      !(function (e) {
        ...
        ((e.fromQuotesSnapshot = function (e) {
          ...
          (e.fromQuotesResponse = function (e) {
            const { values: o, symbolname: s, status: r } = e;
            return 'error' === r && s ? s : t(o);
          }),
          (e.fromQuotes = t),
          (e.fromSymbolSearchResult = function (e, t) {
            {
              const { ticker: o, symbol: s } = t ?? e;
              return n.enabled('pay_attention_to_ticker_not_symbol')
                ? (0, r.ensureDefined)(o ?? s)
                : (0, r.ensureDefined)(s);
            }
          }),
          (e.fromSymbolInfo = o),
        ...
        includes(e) {
          return (function (e, t) {
            const o = t.toLowerCase(),
              { name: s, desc: r, searchTerms: n } = e;
            return (
              s.toLowerCase().includes(o) ||
              r.toLowerCase().includes(o) ||
              (void 0 !== n && n.some((e) => e.toLowerCase().includes(o)))
            );
          })(this._exchange, e);
        }
      ...
      class I {
        constructor(e) {
          ((this._contentItemList = new a.WatchedValue([])),
            ...
            (this._chartSession = this._chartWidget
              .model()
              .model()
              .chartApi()));
        ...
        _handleInitProcess(e, t, o, s) {
          ...
          for (const n of e) {
            ...
            if (void 0 === a || c)
              this._recentSymbolsEnabled && r.push(s(e, i, !1));
            else
              for (const t of a) r.push(s(e, i, !0, this._idToStudyMap.get(t)));
          }
        ...
        _updateChecked(e) {
          const t = this._checkedSymbols.get(e.symbol),
            o = e.study?.id();
          return o ? { ...e, checked: Boolean(t && t.includes(o)) } : e;
        }
