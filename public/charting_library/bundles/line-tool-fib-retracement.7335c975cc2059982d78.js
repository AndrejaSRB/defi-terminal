...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3723],
  {
          ...
          return i
            ...
            : ((n = s),
              ...
              (0, this._levelsIterator)(
                n,
                { tpl: u, fill: d, typecheck: r.typecheck.pack },
                r,
              ));
          var n, r;
        }
    ...
    91308: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolFibRetracement: () => h }));
      var s,
        n,
        r = i(11542),
        o = i(95804),
      ...
      class h extends c.LineToolFibWithInplaceTextBase {
        constructor(e, t, s, n) {
          (super(
            e,
        ...
        processErase(e, t) {
          ...
          e.setProperty(s, !1, u, l.lineToolsDoNotAffectChartInvalidation);
        }
    ...
    63117: (e, t, i) => {
      ...
      class T extends p.LineDataSource {
        constructor(e, t, s, n) {
          (super(e, t, s, n),
        ...
        editableTextStyle() {
          return { ...(this._isDarkBackground.value() ? m : v) };
        }
        ...
        async _openTextEditor(e, t, s, o, a) {
          ...
          const v = this.isFixed()
              ? (0, n.ensureDefined)(this.fixedPoint(e))
              : (0, n.ensureNotNull)(
                  this.pointToScreenPoint(this._points[0], e),
                ),
            m = {
              position: (0, r.point)(v.x, v.y),
              textInfo: s,
              placeholder: o,
