  ...
  [9754, 1754, 9685, 3179],
  {
          ...
          ((e.disableBodyScroll = function (e, o) {
            if (s) {
              ...
              if (
                ...
                var u = { targetElement: e, options: o || {} };
                ((i = [].concat(t(i), [u])),
    ...
    70673: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        c = n.n(r);
      function h(e) {
        const t = i()(c().wrapper, e.className);
        return o.createElement(
          ...
          o.createElement('input', {
            id: e.id,
            tabIndex: e.tabIndex,
            className: i()(e.intent && c()[e.intent], c().input),
            type: 'checkbox',
            name: e.name,
            checked: e.checked,
            disabled: e.disabled,
      ...
      function d(e) {
        const {
          ...
          g = i()(
            ...
            n && h().checked,
            c && h().disabled,
            d && h().disableActiveStyles,
          );
        return o.createElement(
          'span',
          { className: g, ...m },
          o.createElement(l.Icon, { icon: p, className: h().icon }),
        );
      }
    },
    43010: (e, t, n) => {
      ...
      function l(e) {
        ...
        return (
          (0, s.useIsomorphicLayoutEffect)(() => {
            const e = { click: t, mouseDown: n, touchEnd: l, touchStart: a },
              o = c ? c.current : h.current;
            return (0, i.addOutsideEventListener)(d.current, o, r, document, e);
          }, [t, n, l, a, r]),
          c || h
        );
      }
    ...
    26996: (e, t, n) => {
      ...
      function c(e) {
        ...
        return s.createElement(
          'span',
          { className: l()(r().loader, o && r().static, t) },
    ...
    19250: (e, t, n) => {
      'use strict';
      n.d(t, { Portal: () => c, PortalContext: () => h });
      var o = n(50959),
        s = n(32227),
        i = n(25931),
        l = n(67961),
      ...
      class c extends o.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            s.createPortal(
              o.createElement(h.Provider, { value: this }, this.props.children),
              e,
            )
          );
        }
    ...
    67961: (e, t, n) => {
      'use strict';
      n.d(t, { OverlapManager: () => l, getRootOverlapManager: () => r });
      var o = n(50151),
        s = n(34811);
      class i {
        constructor() {
    ...
    89324: (e, t, n) => {
      ...
      function c(e) {
        ...
        const t = (0, i.getSymbolSearchCompleteOverrideFunction)(),
          ...
          v = {
            ...u,
            showSpreadActions: r ?? (0, s.canShowSpreadActions)(),
    ...
    1861: (e, t, n) => {
      ...
      function r(e) {
        const {
          ...
          manager: I,
          shouldReturnFocus: T,
          onSymbolFiltersParamsChange: A,
          onEmptyResults: D,
          customSearchSymbols: L,
          enableOptionsChain: H,
          disableRecents: R,
          overrideQueryParams: N,
          hiddenFilterIds: P,
          showRecents: O,
          searchInitiationPoint: z,
          selectedSymbolSettingsKey: F,
          filterValuesSettingsKey: B,
        } = e;
        if (
    ...
    11065: (e, t, n) => {
      'use strict';
      (n.r(t), n.d(t, { GlobalSearchDialogRenderer: () => je }));
      var o = n(50959),
        s = n(60709),
        i = n(38414),
        l = n(90484),
        ...
        w = n(31841);
      function y(e) {
        const { text: t, showIcon: n = !0, className: s } = e,
          i = g.watchedTheme.value() === p.StdTheme.Dark ? f : b;
        return o.createElement(
          'div',
          { className: u(w.wrap, s) },
          n && o.createElement(m.Icon, { icon: i, className: w.image }),
      ...
      var S = n(79418),
        ...
        M = n(74670),
        k = n(80329);
      const I = (0, _.mergeThemes)(E.DEFAUL_CONTEXT_MENU_ITEM_THEME, k);
      function T(e) {
        const { action: t, onExecute: n } = e,
          [s, i] = (0, M.useActiveDescendant)(null);
        return o.createElement(C.ContextMenuAction, {
          theme: I,
      ...
      var A = n(74765);
      function D(e) {
        const { heading: t, items: n, onExecute: s, getActionIndex: i } = e;
        return o.createElement(
          'table',
          { className: A.section },
          o.createElement(
            ...
            o.createElement(
              'tr',
              null,
              o.createElement('td', { className: A.heading }, t),
            ),
            n.map((e) =>
              o.createElement(T, {
                key: e.id,
      ...
      var L = n(56096);
      const H = [
        { name: 'drawingsActions', label: a.t(null, void 0, n(74385)) },
        { name: 'functionActions', label: a.t(null, void 0, n(83576)) },
        { name: 'settingsActions', label: a.t(null, void 0, n(32514)) },
      ];
      function R(e) {
        const { dialogId: t, items: s, onClose: i, shouldReturnFocus: u } = e,
          [v, m] = (0, o.useState)(''),
          [p, g] = (0, o.useState)([]),
          b = (0, o.useRef)(null),
          f = (0, o.useRef)(null),
        ...
        const x = (0, o.useCallback)(
          ...
          _ = (0, o.useCallback)((0, l.default)(i, 200), []);
        (0, o.useEffect)(
          () => () => {
            (x.flush(), _.cancel());
          },
        ...
        const E = (0, o.useMemo)(() => {
            const e = new Set(r.getJSON('GlobalSearchDialog.recent', [])),
              t = [];
            for (const n of e) {
              const e = s.find((e) => e.getState().id === n);
              e && t.push(e);
            }
            return (t.reverse(), t);
          }, []),
            ...
            () =>
              H.reduce(
                (e, t) => (
                  e.set(
                    t.name,
                    p.filter((e) => e.getState().category === t.name),
                  ),
                  e
                ),
                new Map(),
          ...
          ),
          {
            handleKeyDown: M,
            handleForceFocus: k,
            handleSearchRefBlur: I,
            onDialogClick: T,
            resetFocusState: A,
          } = (0, c.useSearchDialogKeyboardNavigation)({
            dialogRef: f,
            searchInputRef: b,
            contentContainerRef: w,
            getNextFocusedItemIndex: function (e, t) {
              const n = null === e ? (1 === t ? -1 : 0) : e;
              for (let e = 1; e <= p.length; e++) {
                const o = (p.length + e * t + n) % p.length;
                if (!p[o].isDisabled()) return o;
              }
              return null;
            },
            isNavigationDisabled: !p.length,
            scrollToFocusedItem: function (e) {
              e?.scrollIntoView({ block: 'nearest' });
            },
            onEscapeClick: i,
            getElementIdByIndex: function (e, t) {
              let n = p[e].id;
              null != t && (n += '-favorite');
              return CSS.escape(n);
            },
          });
        return o.createElement(S.AdaptivePopupDialog, {
          ref: f,
          dataName: t,
          title: a.t(null, void 0, n(79354)),
          onClose: i,
          onClickOutside: i,
          shouldReturnFocus: u,
          render: () =>
            o.createElement(
              o.Fragment,
              null,
              o.createElement(d.DialogSearch, { reference: b, onBlur: I }),
              o.createElement(
                'div',
                { className: L.wrap, ref: w },
                v
                  ? o.createElement(
                      o.Fragment,
                      null,
                  ...
                  : o.createElement(
                      ...
                      Boolean(p.length)
                        ? o.createElement(D, {
                            heading: a.t(null, void 0, n(76753)),
                            items: p,
                            onExecute: R,
                            getActionIndex: O,
                          })
                        : o.createElement(y, {
                            text: a.t(null, void 0, n(27463)),
                            showIcon: !1,
                            className: L.emptyState,
                          }),
                    ),
        ...
        function O(e) {
          return p.findIndex((t) => t.id === e.id);
        }
      }
      var N,
        P = n(68335),
      ...
      function ee(e) {
        ...
        if (!t) return null;
        const [, n, o, s] = t;
        return [parseInt(n), parseInt(o), parseInt(s)];
      }
      function te(e) {
        ...
        return (
          ...
          (function (e, t) {
            ...
            const [s, i, l] = n,
              [a, r, c] = o;
            return s !== a ? s < a : i !== r ? i < r : l !== c && l < c;
          })(t, e)
        );
      }
      const ne = (e) => {
        const t = (t) => {
          ...
          if (
              ...
              t.forEach((t) => {
                o.push(
                  new V({
                    ...
                    label: `${a.t(null, void 0, n(53438))} ${j.translateStdThemeName(t)}`,
                    onExecute: () => {
                      (0, Y.loadTheme)(e.chartWidgetCollection(), {
                        themeName: t,
                        standardTheme: !1,
                      }).then(() => {
            ...
            !(0, G.isDesktopApp)() || te('1.0.10'))
          ) {
            const [, t] = j.getStdThemeNames();
            o.push(
              new V({
                id: 'DarkColorTheme',
                category: 'settingsActions',
                label: a.t(null, void 0, n(25848)),
                checkable: !0,
                checked: j.getCurrentTheme().name === t,
                onExecute: () => {
                  !(function (e) {
                    const t =
                        (0, j.getCurrentTheme)().name === p.StdTheme.Dark
                          ? p.StdTheme.Light
                          : p.StdTheme.Dark,
                      o = e
                        .chartModels()
                    ...
                    if (o) s();
                      ...
                      const e = a
                        .t(null, void 0, n(78659))
                        .format({ name: (0, Q.capitalizeFirstLetter)(t) });
                      (0, $.showConfirm)({
                        text: e,
                        ...
                        onCancel: ({ dialogClose: e }) => {
                          ((0, g.setTheme)(t), (0, j.syncTheme)(), e());
                        },
                      });
                    }
      ...
      const { DrawingSyncMode: re } = oe,
        ...
        he = new U.TranslatedString(
          'stay in drawing mode',
          a.t(null, void 0, n(4114)),
        ),
        de = new U.TranslatedString(
          'sync drawings',
          a.t(null, void 0, n(94521)),
        ),
        ue = a.t(null, void 0, n(99901)),
        ve = a.t(null, void 0, n(23391)),
        me =
          (a.t(null, void 0, n(93027)),
          a.t(null, void 0, n(3521)),
          a.t(null, void 0, n(79451))),
        pe = a.t(null, void 0, n(3519)),
        ge = a.t(null, void 0, n(94593));
      var be = n(84526),
        fe = n(92572),
        we = n(89324);
      class ye extends V {
        constructor(e) {
          (super({
            ...
            shortcutHint: (0, P.humanReadableHash)(P.Modifiers.Alt + 73),
          }),
            (this._model = e));
      ...
      class Se extends V {
        constructor(e) {
          (super({
            ...
            shortcutHint: (0, P.humanReadableHash)(P.Modifiers.Alt + 80),
            disabled:
      ...
      class xe extends V {
        constructor(e) {
          (super({
            ...
            shortcutHint: (0, P.humanReadableHash)(P.Modifiers.Alt + 76),
            disabled:
              e.mainSeries().priceScale().isLockScale() ||
              6 === e.mainSeries().properties().childs().style.value(),
      ...
      var _e = n(91572);
      const Ee = B.enabled('show_average_close_price_line_and_label'),
        Ce = new U.TranslatedString(
          'change session',
          a.t(null, void 0, n(87041)),
        ),
        Me = new U.TranslatedString(
          'change plus button visibility',
          a.t(null, void 0, n(96379)),
        ),
        ke = new U.TranslatedString(
          'change countdown to bar close visibility',
          a.t(null, void 0, n(39383)),
        ),
        Ie = new U.TranslatedString(
          'scale price chart only',
          a.t(null, void 0, n(63796)),
        ),
        Te = new U.TranslatedString(
          'change symbol last value visibility',
          a.t(null, void 0, n(67453)),
        ),
        Ae = new U.TranslatedString(
          'change high and low price labels visibility',
          a.t(null, void 0, n(24226)),
        ),
        De = new U.TranslatedString(
          'change average close price label visibility',
          a.t(null, void 0, n(76852)),
        ),
        Le = new U.TranslatedString(
          'change indicators and financials value labels visibility',
          a.t(null, void 0, n(71161)),
        ),
        He = new U.TranslatedString(
          'change indicators and financials name labels visibility',
          a.t(null, void 0, n(35111)),
        ),
        Re = new U.TranslatedString(
          'change high and low price lines visibility',
          a.t(null, void 0, n(80692)),
        ),
        Ne = new U.TranslatedString(
          'change average close price line visibility',
          a.t(null, void 0, n(1022)),
        ),
        Pe = new U.TranslatedString(
          'change symbol labels visibility',
          a.t(null, void 0, n(73357)),
        ),
        Oe =
          (new U.TranslatedString(
            'change pre/post market price label visibility',
            a.t(null, void 0, n(30870)),
          ),
          new U.TranslatedString(
            'change symbol previous close value visibility',
            a.t(null, void 0, n(4729)),
          ),
          new U.TranslatedString(
            'change previous close price line visibility',
            a.t(null, void 0, n(58419)),
          )),
        ze =
          (new U.TranslatedString(
            'change bid and ask labels visibility',
            a.t(null, void 0, n(69362)),
          ),
          new U.TranslatedString(
            'change bid and ask lines visibility',
            a.t(null, void 0, n(52919)),
          ),
          new U.TranslatedString(
            'change pre/post market price lines visibility',
            a.t(null, void 0, n(91978)),
          ),
          new U.TranslatedString(
            'change price line visibility',
            a.t(null, void 0, n(8662)),
          )),
        Fe = new U.TranslatedString(
          'change session breaks visibility',
          a.t(null, void 0, n(38413)),
        ),
        Be =
          (new U.TranslatedString(
            'change ideas visibility on chart',
            a.t(null, void 0, n(13489)),
          ),
          new U.TranslatedString('show all ideas', a.t(null, void 0, n(13336))),
          new U.TranslatedString(
            'show ideas of followed users',
            a.t(null, void 0, n(91395)),
          ),
          new U.TranslatedString(
            'show my ideas only',
            a.t(null, void 0, n(57460)),
          ),
          new U.TranslatedString(
            'change events visibility on chart',
            a.t(null, void 0, n(6119)),
          ),
          new U.TranslatedString(
            'change earnings visibility',
            a.t(null, void 0, n(6819)),
          ),
          new U.TranslatedString(
            'change dividends visibility',
            a.t(null, void 0, n(53929)),
          ),
          new U.TranslatedString(
            'change splits visibility',
            a.t(null, void 0, n(47474)),
          ),
          {
            0: a.t(null, void 0, n(19265)),
            1: a.t(null, void 0, n(64526)),
            9: a.t(null, void 0, n(44958)),
            2: a.t(null, void 0, n(92911)),
            14: a.t(null, void 0, n(35458)),
            15: a.t(null, void 0, n(40447)),
            3: a.t(null, void 0, n(9537)),
            16: a.t(null, void 0, n(39883)),
            4: a.t(null, void 0, n(80082)),
            7: a.t(null, void 0, n(11604)),
            5: a.t(null, void 0, n(47189)),
            6: a.t(null, void 0, n(22027)),
            8: a.t(null, void 0, n(62423)),
            10: a.t(null, void 0, n(19579)),
            11: a.t(null, void 0, n(49942)),
            12: a.t(null, void 0, n(70405)),
            13: a.t(null, void 0, n(56281)),
            17: a.t(null, void 0, n(21190)),
            18: a.t(null, void 0, n(94861)),
            19: a.t(null, void 0, n(13618)),
            20: a.t(null, void 0, n(67346)),
            21: a.t(null, void 0, n(67579)),
          });
      async function We(e) {
        const t = [],
          [o, s] = await Promise.all([ne(e), Promise.resolve(null)]),
          i = ((e) => {
            const t = [],
              {
                stayInDrawingMode: n,
            ...
            (t.push(
              new V({
                ...
                category: 'settingsActions',
                onExecute: () => {
                  e.model().setProperty(n, !n.value(), he);
                },
              }),
            ),
              t.push(
                new V({
                  ...
                  onExecute: () => {
                    e.model().setProperty(o, !o.value(), de);
                  },
                }),
              ));
            const i = oe.lockDrawings();
            t.push(
              new V({
                label: me,
                checkable: !0,
                ...
                checked: i.value(),
                onExecute: () => {
                  oe.lockDrawings().setValue(!oe.lockDrawings().value());
                },
              }),
            );
            const l = (0, ae.getSavedHideMode)();
            t.push(
              ...Array.from((0, ae.getHideOptions)()).map(
                ([e, t]) =>
                  new V({
                    ...
                    id: ce[e],
                    category: 'settingsActions',
                    checked: l === e && (0, ae.getHideModeStateValue)(e),
                    onExecute: () => (0, ae.toggleHideMode)(e),
                  }),
              ),
            );
            const { magnet: a, magnetMode: r } = oe.properties().childs();
            return (
              t.push(
                new V({
                  label: pe,
                  ...
                  checked: a.value() && r.value() === ie.MagnetMode.WeakMagnet,
                  icon: le.drawingToolsIcons.magnet,
                  onExecute: () => {
                    a.value() && r.value() === ie.MagnetMode.WeakMagnet
                      ? (0, se.setIsMagnetEnabled)(!1)
                      : (0, se.setMagnetMode)(ie.MagnetMode.WeakMagnet);
                  },
                }),
              ),
              t.push(
                new V({
                  ...
                  category: 'functionActions',
                  checked:
                    a.value() && r.value() === ie.MagnetMode.StrongMagnet,
                  icon: le.drawingToolsIcons.strongMagnet,
                  onExecute: () => {
                    a.value() && r.value() === ie.MagnetMode.StrongMagnet
                      ? (0, se.setIsMagnetEnabled)(!1)
                      : (0, se.setMagnetMode)(ie.MagnetMode.StrongMagnet);
                  },
                }),
              ),
              t
          ...
          l = (function (e) {
            const t = [];
            return (
              B.enabled('header_widget') &&
                B.enabled('header_compare') &&
                t.push(
                  new V({
                    icon: n(1393),
                    label: (0, F.appendEllipsis)(a.t(null, void 0, n(57e3))),
                    id: 'Compare',
                    category: 'functionActions',
              ...
              B.enabled('header_widget') &&
                B.enabled('header_indicators') &&
                t.push(
                  new V({
                    icon: n(39681),
                    label: (0, F.appendEllipsis)(a.t(null, void 0, n(87829))),
                    id: 'InsertIndicator',
                    category: 'functionActions',
                    onExecute: () => {
                      e.showIndicators([]);
                    ...
                    shortcutHint: e.options().indicatorsDialogShortcutEnabled
                      ? (0, P.humanReadableHash)(47)
                      : void 0,
                  }),
                ),
              B.enabled('show_object_tree') &&
                t.push(
                  new V({
                    icon: n(30192),
                    label: a.t(null, void 0, n(27077)),
              ...
              B.enabled('header_widget') &&
                B.enabled('header_settings') &&
                t.push(
                  new V({
                    label: (0, F.appendEllipsis)(a.t(null, void 0, n(32514))),
                    icon: n(34369),
                    id: 'ChartProperties',
                    category: 'functionActions',
                    onExecute: () => {
              ...
              B.enabled('header_widget') &&
                B.enabled('header_symbol_search') &&
                t.push(
                  new V({
                    icon: n(6347),
                    label: (0, F.appendEllipsis)(a.t(null, void 0, n(63245))),
                    id: 'ChangeSymbol',
                    category: 'functionActions',
                    onExecute: () => {
                      (0, we.showDefaultSearchDialog)({
                        defaultValue: '',
                        trackResultsOptions: void 0,
                        enableOptionsChain: B.enabled(
              ...
              B.enabled('symbol_info') &&
                t.push(
                  new V({
                    label: (0, F.appendEllipsis)(a.t(null, void 0, n(75594))),
                    icon: n(37924),
                    id: 'SymbolInfo',
                    category: 'functionActions',
                    onExecute: () => {
                      {
                        ...
                        return void (0, be.showSymbolInfoDialog)(s);
                      }
                    },
                  }),
                ),
              e.options().goToDateEnabled &&
                t.push(
                  new V({
                    label: (0, F.appendEllipsis)(a.t(null, void 0, n(54280))),
                    icon: n(90752),
                    id: 'GoToDate',
                    category: 'functionActions',
                    onExecute: () => {
                    ...
                    shortcutHint: (0, P.humanReadableHash)(
                      P.Modifiers.Alt + 71,
                    ),
                  }),
                ),
        ...
        (t.push(
          new V({
            id: 'ResetPriceScale',
            category: 'functionActions',
            label: a.t(null, void 0, n(15332)),
            icon: n(39267),
            onExecute: () => {
              d && e.model().resetPriceScale(d, c);
            },
            shortcutHint: (0, P.humanReadableHash)(P.Modifiers.Alt + 82),
          }),
        ),
          t.push(new ye(e.model())),
          t.push(new Se(e.model())),
          t.push(new xe(e.model())));
        const u = c.isLockScale(),
          v = 6 === h.style.value();
        (t.push(
          new V({
            label: a.t(null, void 0, n(28051)),
            checkable: !0,
          ...
          t.push(
            new V({
              label: a.t(null, { context: 'scale_menu' }, n(55300)),
              checkable: !0,
        ...
        const m = e.model().model().priceScaleSlotsCount(),
          p = 0 === m.left;
        (t.push(
          new V({
            label: p
              ? a.t(null, void 0, n(26493))
              : a.t(null, void 0, n(40789)),
            id: 'MoveScaleToSide',
            category: 'functionActions',
            disabled: m.left + m.right !== 1,
            onExecute: () => {
              e.model().mergeAllScales(p ? 'left' : 'right');
            },
          }),
        ),
          t.push(
            new V({
              label: a.t(null, void 0, n(7276)),
          ...
          t.push(
            new V({
              label: a.t(null, void 0, n(71566)),
              checkable: !0,
              checked: K.addPlusButtonProperty.value(),
              id: 'ToggleAddOrderPlusButton',
              category: 'settingsActions',
              onExecute: () => {
                e.model().setProperty(
                  K.addPlusButtonProperty,
                  !K.addPlusButtonProperty.value(),
                  Me,
                );
              },
            }),
          ));
        const g = e.properties().childs().scalesProperties.childs(),
          b = h.showCountdown;
        t.push(
          new V({
            label: a.t(null, void 0, n(83140)),
            checkable: !0,
            id: 'ToggleCountdown',
            category: 'settingsActions',
            checked: b.value(),
            onExecute: () => {
              e.model().setProperty(b, !b.value(), ke);
            },
          }),
        );
        const f = g.scaleSeriesOnly;
        t.push(
          new V({
            label: a.t(null, void 0, n(43758)),
            checkable: !0,
            id: 'ScalePriceChartOnly',
            category: 'settingsActions',
            checked: f.value(),
            onExecute: () => {
              e.model().setProperty(f, !f.value(), Ie);
            },
          }),
        );
        const w = g.showSeriesLastValue;
        t.push(
          new V({
            label: a.t(null, void 0, n(10127)),
            checkable: !0,
            id: 'ToggleSymbolLastValue',
            category: 'settingsActions',
            checked: w.value(),
            onExecute: () => {
              e.model().setProperty(w, !w.value(), Te);
            },
          }),
        );
            ...
            t.push(
              new V({
                ...
                onExecute: () => {
                  ...
                  e.model().setProperty(y.averageClosePriceLabelVisible, t, De);
                },
              }),
            ));
        const S = g.showSymbolLabels;
        t.push(
          new V({
            label: a.t(null, void 0, n(32390)),
            checkable: !0,
            id: 'ToggleSymbolLabels',
            category: 'settingsActions',
            checked: S.value(),
            onExecute: () => {
              e.model().setProperty(S, !S.value(), Pe);
            },
          }),
        );
        const x = (0, q.combineProperty)(
          (e, t) => e || t,
          g.showStudyLastValue.weakReference(),
          g.showFundamentalLastValue.weakReference(),
        );
        t.push(
          new V({
            label: a.t(null, void 0, n(46850)),
            checkable: !0,
            ...
            onExecute: () => {
              const t = !x.value();
              (e.model().beginUndoMacro(Le),
                e.model().setProperty(g.showStudyLastValue, t, null),
                e.model().setProperty(g.showFundamentalLastValue, t, null),
        ...
        const _ = (0, q.combineProperty)(
          (e, t) => e || t,
          g.showStudyPlotLabels.weakReference(),
          g.showFundamentalNameLabel.weakReference(),
        );
        (t.push(
          new V({
            label: a.t(null, void 0, n(54418)),
            checkable: !0,
            ...
            onExecute: () => {
              ...
              const t = !_.value();
              (e.model().setProperty(g.showStudyPlotLabels, t, null),
                e.model().setProperty(g.showFundamentalNameLabel, t, null),
                e.model().endUndoMacro());
            },
            onDestroy: () => {
              _.destroy();
            ...
            t.push(
              new V({
                ...
                onExecute: () => {
                  ...
                  e.model().setProperty(y.averageClosePriceLineVisible, t, Ne);
                },
              }),
            ));
        const E = h.showPriceLine;
        t.push(
          new V({
            label: a.t(null, void 0, n(72926)),
            checkable: !0,
            id: 'TogglePriceLine',
            category: 'settingsActions',
            checked: E.value(),
            onExecute: () => {
              e.model().setProperty(E, !E.value(), ze);
            },
          }),
        );
        ...
        (t.push(
          new V({
            ...
            checked: C.value(),
            onExecute: () => {
              e.model().setProperty(C, !C.value(), Oe);
            },
          }),
        ),
          t.push(
            new V({
              label: a.t(null, void 0, n(54170)),
              icon: n(39267),
              id: 'ResetTimeScale',
              category: 'functionActions',
              onExecute: () => {
              ...
              shortcutHint: (0, P.humanReadableHash)(
                P.Modifiers.Mod + P.Modifiers.Alt + 81,
              ),
            }),
          ));
        const M = e
          ...
          k = (0, q.createWVFromProperty)(
            e.model().mainSeries().isDWMProperty(),
          ),
          I = new V({
            label: a.t(null, void 0, n(66707)),
            checkable: !0,
            ...
            checked: M.value(),
            onExecute: () => {
              e.model().setProperty(M, !M.value(), Fe);
            },
            onDestroy: () => k.destroy(),
          });
        if (
          (k.subscribe(() => I.update({ disabled: k.value() })),
          t.push(I),
          t.push(
            new V({
              label: a.t(null, void 0, n(49153)),
              icon: n(39267),
              id: 'ResetChart',
              category: 'functionActions',
          ...
          B.enabled('header_widget') &&
            B.enabled('header_undo_redo') &&
            (t.push(
              new V({
                id: 'Undo',
                category: 'functionActions',
                icon: n(77665),
                label: a.t(null, void 0, n(14804)),
                onExecute: () => {
                  e.model().undoHistory().undo();
                },
                disabled: e.model().undoHistory().undoStack().isEmpty(),
                shortcutHint: (0, P.humanReadableHash)(P.Modifiers.Mod + 90),
              }),
            ),
            t.push(
              new V({
                ...
                category: 'functionActions',
                icon: n(96052),
                label: a.t(null, void 0, n(48236)),
                onExecute: () => {
                  e.model().undoHistory().redo();
                },
                disabled: e.model().undoHistory().redoStack().isEmpty(),
                shortcutHint: (0, P.humanReadableHash)(P.Modifiers.Mod + 89),
              }),
            )),
          t.push(
            new V({
              label: a.t(null, void 0, n(12754)),
              id: 'MoveChartRight',
              category: 'functionActions',
              disabled: !e
          ...
          B.enabled('header_widget') && B.enabled('header_chart_type'))
        ) {
          const n = (0, X.allChartStyles)();
          for (const o of n)
            t.push(
              new V({
                id: `ChartStyle_${o}`,
                category: 'functionActions',
                disabled: !O.linking.supportedChartStyles.value()?.includes(o),
                onExecute: () => {
                  e.chartWidgetCollection().setChartStyleToWidget(o);
                },
                icon: J.SERIES_ICONS[o],
                label: Be[o],
              }),
            );
        }
        return (
          B.enabled('header_widget') &&
            (0, _e.shouldShowFullscreen)() &&
            t.push(
              new V({
                label: a.t(null, void 0, n(67092)),
                id: 'Fullscreen mode',
                icon: n(49697),
                category: 'functionActions',
                checkable: !0,
                ...
                shortcutHint: (0, P.humanReadableHash)(P.Modifiers.Shift + 70),
              }),
            ),
          t
        );
      ...
      var Ve = n(97995),
        ...
        Ge = n(84902);
      function Ke() {
        return Ge.lineToolsFlat.filter(Ge.isLineTool).map((e) =>
          (function (e) {
            const t = Ue.lineToolsInfo[e],
              o = t.selectHotkey?.hash,
              s = {
                id: e,
                category: 'drawingsActions',
                label: t.localizedName,
                icon: t.icon,
                shortcutHint: o ? (0, P.humanReadableHash)(o) : void 0,
                payload: e,
                onExecute: () => {
                  (oe.tool.setValue(e),
                    (0, Ve.trackDrawingToolSelected)(e, 'Global action'));
                },
            ...
            return (
              e.toLowerCase().includes('fib') &&
                (s.aliases = [a.t(null, void 0, n(26578))]),
              new V(s)
            );
          })(e.name),
        );
      ...
      var Xe = n(16216),
        Je = n(87896);
      class je extends i.DialogRenderer {
        constructor(e) {
          (super(),
            (this._actions = []),
            (this.show = (e) => {
              this.visible().value() ||
                (async function (e, t) {
                  ...
                  if (
                    B.enabled('header_widget') &&
                    B.enabled('header_resolutions')
                  ) {
                    const t = {
                      label: (0, F.appendEllipsis)(a.t(null, void 0, n(2569))),
                      id: 'ChangeInterval',
                      category: 'functionActions',
                      onExecute: () => {
                        (0, z.showChangeIntervalDialogAsync)({
                          initVal: O.linking.interval.value(),
                          selectOnInit: !0,
                        });
                      },
                    };
                    (!B.enabled('show_interval_dialog_on_key_press') ||
                      e.readOnly() ||
                      e.options().hideSymbolSearch ||
                      (t.shortcutHint = (0, P.humanReadableHash)(188)),
                      o.push(new V(t)));
                  }
                  if (
                    t &&
                    B.enabled('header_widget') &&
                    B.enabled('header_saveload')
                  ) {
                    o.push(
                      new V({
                        id: 'LoadChartLayout',
                    ...
                    s &&
                      ...
                      o.push(
                        new V({
                          ...
                          icon: n(53707),
                          label: (0, F.appendEllipsis)(
                            a.t(null, void 0, n(41569)),
                          ),
                          disabled: !s.hasChanges(),
                          onExecute: () => {
                            s.saveChartOrShowTitleDialog();
                          },
                          shortcutHint: (0, P.humanReadableHash)(
                            P.Modifiers.Mod + 83,
                          ),
                  ...
                  (t) => {
                    ((this._actions = t
                      .concat(
                        (() => {
                          const e = B.enabled('left_toolbar') ? [...Ke()] : [];
                          return e;
                        })(),
                      )
                      .sort(qe)),
                      (this._rootInstance = (0, Je.createReactRoot)(
                        o.createElement(R, {
          ...
          const t = (0, Xe.service)(s.CHART_WIDGET_COLLECTION_SERVICE);
    ...
    10087: (e, t, n) => {
      ...
      function h(e) {
        const {
            ...
            onEscapeClick: v,
            scrollToFocusedItem: m,
            getElementIdByIndex: p = d,
          } = e,
          [g, b] = (0, o.useState)(null),
          [f, w] = (0, o.useState)(null),
          y = (0, o.useRef)({ itemIndex: null, actionIndex: null }),
          [S, x] = (0, o.useState)(!1);
        function _() {
          (x(!1), w(null), b(null));
        }
        return (
          (0, o.useLayoutEffect)(() => {
            if (null === g || !S) return;
            const e = p(g, f),
              n = t.current?.querySelector(`#${e}`);
            return (
              n?.dispatchEvent(new CustomEvent('active-descendant-focus')),
              () => {
          ...
          }, [g, S, f]),
          {
            handleKeyDown: function (e) {
              ...
              if (27 === o && v) return void v(e);
              const s = t.current;
              if (!s || e.target !== n.current) return;
              if (32 === o || 13 === o) {
                if (null === g) return;
                e.preventDefault();
                const t = s.querySelector(`#${p(g, f)}`);
                if (!(t instanceof HTMLElement)) return;
                return void t.click();
              }
              const l = (0, a.mapKeyCodeToDirection)(o);
              if (!l || u) return;
              const c = null !== g ? s.querySelector(`#${p(g)}`) : null;
              switch (l) {
                case 'blockNext':
                case 'blockPrev': {
                  e.preventDefault();
                  const t = h(g, 'blockNext' === l ? 1 : -1);
                  if (null === t) return;
                  (b(t), x(!0), (y.current.itemIndex = t));
                  const n = s.querySelector(`#${p(t)}`);
                  if ((m(n, t), null !== f && n instanceof HTMLElement)) {
                    const e = Array.from(
                      n.querySelectorAll('[data-role="list-item-action"]'),
                    );
                    if (!e.length)
                      return (w(null), void (y.current.actionIndex = null));
                    const t = (0, r.clamp)(f, 0, e.length - 1);
                    (w(t), (y.current.actionIndex = t));
                  }
                  return;
                }
                case 'inlineNext': {
                  ...
                  return null === f
                    ? (w(0), void (y.current.actionIndex = 0))
                    : f === t.length - 1
                      ? (w(null), void (y.current.actionIndex = null))
                      : (w(f + 1), void (y.current.actionIndex = f + 1));
                }
                case 'inlinePrev': {
                  if (!c) return;
                  e.preventDefault();
            ...
            handleForceFocus: function () {
              (0, a.updateTabIndexes)();
            },
            handleSearchRefBlur: function (e) {
              (_(),
                b(g),
                c.CheckMobile.any() ||
                  e.relatedTarget !== s.current?.getElement() ||
                  e.target.focus());
            },
            resetFocusState: _,
            restoreFocusState: function () {
              (w(y.current.actionIndex), b(y.current.itemIndex), x(!0));
            },
            focusVisible: S,
            focusedItemIndex: g,
            focusedActionIndex: f,
            setFocusedItemIndex: b,
            setFocusedActionIndex: w,
            onDialogClick: function (e) {
              (0, l.isKeyboardClick)(e) || (x(!1), w(null));
            },
          }
        );
      }
      function d(e, t) {
        return (0, s.isNumber)(t) && -1 !== t
    ...
    10772: (e, t, n) => {
      ...
      function v(e) {
        ...
        return o.createElement(d.ContextMenuItem, {
          size: t,
          jsxLabel: o.createElement(
            'div',
            { className: c()(u.loaderWrap, u[t]) },
            o.createElement(h.Loader, { className: u.loader }),
          ),
          noInteractive: !0,
      ...
      const b = (0, o.forwardRef)(function (e, t) {
        const { className: n, ...s } = e,
          [i, l] = (0, p.useRovingTabindexElement)(t);
        return o.createElement(d.ContextMenuItem, {
          ...s,
          className: c()(g.accessible, n),
          reference: i,
          tabIndex: l,
          onKeyDown: function (e) {
            if (e.target !== e.currentTarget) return;
            const t = (0, m.hashFromEvent)(e);
            (13 !== t && 32 !== t) ||
              (e.preventDefault(),
              ...
              (function (e, t, n = { x: 0, y: 10 }) {
                if (t) {
                  const {
                    ...
                    l = { x: n - e, y: s },
                    a = { x: o, y: s };
                  return (0, f.isRtl)() ? (n <= e ? a : l) : i - o >= e ? a : l;
                }
                return n;
        ...
        render() {
          ...
          return this.state.loading
            ...
            : o.createElement(
                b,
                {
                  ...(0, i.filterDataProps)(this.props),
      ...
      S.contextType = l.SubmenuContext;
    },
    5304: (e, t, n) => {
      'use strict';
      n.d(t, {
      ...
      var o = n(50959),
        ...
        b = n(47429);
      const f = b,
        w = u.enabled('items_favoriting');
      class y extends o.PureComponent {
        constructor() {
          (super(...arguments),
            (this._handleMouseOver = (e) => {
              (0, a.isTouchEvent)(e.nativeEvent) ||
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              w &&
                ...
                o.createElement(
                  'td',
                  { className: r.favoriteActionCell },
              ...
              o.createElement(
                'td',
                { className: s(r.iconCell), 'data-icon-cell': !0 },
                this._icon(r),
              ),
              o.createElement(
                'td',
                ...
                o.createElement(
                  ...
                  o.createElement(
                    'span',
                    {
                      className: s(r.label, this.props.checked && r.checked),
                      'data-label': !0,
                    },
                    !p && f
                      ? f.map(({ text: e, ...t }, n) =>
                  ...
                  !e &&
                    ...
                    o.createElement(h.Hint, {
                      className: s(i && r.invisibleHotkey),
                      text: t,
                    }),
    ...
    91561: (e, t, n) => {
      'use strict';
      n.d(t, { ContextMenu: () => C, OverlapContextMenu: () => M });
      var o = n(50959),
        s = n(97754),
        i = n.n(s),
        l = n(86431),
          ...
          o.createElement(
            ...
            n &&
              o.createElement(
                o.Fragment,
                null,
                o.createElement(p.ContextMenuItem, {
            ...
            t.map((e) => {
              switch (e.type) {
                ...
                case 'separator':
                  return o.createElement(m, { key: e.id });
              }
            }),
          ),
        );
          ...
          (super(e),
            ...
            (this._handleFocus = (e) => {
              this.props.isKeyboardEvent &&
                e.target &&
                (0, _.focusFirstMenuItem)(e.target);
            }),
            (this.state = {}));
        }
        render() {
                            ...
                            (t) =>
                              o.createElement(
                                a.Menu,
                                {
                                  ...p,
                                  reference: t,
                                  className: i()(E.menu, 'context-menu'),
                                  onClose: this._handleClose,
                                  ...
                                  onKeyDown: _.handleAccessibleMenuKeyDown,
                                },
    ...
    99025: (e, t, n) => {
      ...
      function a(e) {
        ...
        return o.createElement('span', { className: i()(l.shortcut, n) }, t);
      }
    },
    23829: (e, t, n) => {
      'use strict';
      ...
      function m(e) {
        const {
          ...
          A = (0, o.useContext)(r.EmptyIconsContext),
          D = !!x.length;
        return s
          ? o.createElement(
              'li',
              { className: i()(t, v.item, v.loading, v[T]) },
          ...
          : o.createElement(
              ...
              !D &&
                S &&
                o.createElement(c.Hint, { className: v.shortcut, text: S }),
              D && o.createElement(l.Icon, { className: v.nested, icon: d }),
              M,
            );
      }
    },
    ...
    37558: (e, t, n) => {
      'use strict';
      n.d(t, { DrawerContext: () => l, DrawerManager: () => i });
      var o = n(50959),
        s = n(99054);
    ...
    41590: (e, t, n) => {
      ...
      function v(e) {
        const {
          ...
          g = (0, s.ensureNotNull)((0, o.useContext)(r.DrawerContext)),
          [b] = (0, o.useState)(() => (0, l.randomHash)()),
          f = (0, o.useRef)(null),
        ...
        return (
          (0, o.useLayoutEffect)(
            () => (
              ...
              g.addDrawer(b),
              () => {
                (g.removeDrawer(b), w.unsubscribe(g, n));
              }
            ),
            [],
          ),
          o.createElement(
            ...
            o.createElement(
              'div',
              { ref: u, className: i(d.wrap, d[`position${t}`]) },
              b === g.currentDrawer &&
                o.createElement('div', { className: d.backdrop, onClick: n }),
              o.createElement(
                m,
                {
                  className: i(p.drawer, d[`position${t}`], v),
                  ref: f,
    ...
    27317: (e, t, n) => {
      'use strict';
      n.d(t, { DEFAULT_MENU_THEME: () => g, Menu: () => f });
      var o = n(50959),
        s = n(97754),
        i = n.n(s),
        l = n(50151),
          ...
          (super(e),
            ...
            (this._handleMeasure = ({
              ...
              const { position: n } = this.props,
                o = (0, l.ensureNotNull)(this._containerRef);
              ...
              const d = s.height > h;
              if (d) {
                (((0, l.ensureNotNull)(this._scrollWrapRef).style.overflowY =
                  'scroll'),
                  (s = o.getBoundingClientRect()));
              }
              const { width: u, height: v } = s,
                m =
                  'function' == typeof n
                    ? n({
                        contentWidth: u,
                ...
                b = (0, a.clamp)(m.x, p, Math.max(p, g)),
                f = (m?.indentFromWindow?.top ?? 0) + c,
                w =
                  i -
                  (m.overrideHeight ?? v) -
                  (m?.indentFromWindow?.bottom ?? 0);
              let y = (0, a.clamp)(m.y, f, Math.max(f, w));
              if (
              ...
              const S = m.overrideHeight ?? (d ? h : void 0);
              this.setState(
                {
            ...
            (this._restoreScrollPosition = () => {
              ...
              if (null !== e && t.contains(e))
                ...
                (0, l.ensureNotNull)(this._scrollWrapRef).scrollTop =
                  this._scroll;
            }),
            (this._resizeForced = () => {
              this.setState({
            ...
            (this._handleScroll = () => {
              this._scroll = (0, l.ensureNotNull)(
                this._scrollWrapRef,
              ).scrollTop;
            }),
              ...
              o.createElement(
                ...
                o.createElement(
                  'div',
                  {
                    ...
                    'aria-describedby': h,
                    'aria-invalid': d,
                    className: i()(f, b.menuWrap, !T && b.isMeasuring),
                    style: {
                      height: M,
                      left: I && I.x,
                      minWidth: g,
                  ...
                  o.createElement(
                    ...
                    o.createElement(w, { className: b.menuBox }, u),
                  ),
                ),
              ),
      ...
      function w(e) {
        const t = (0, l.ensureNotNull)((0, o.useContext)(v.SubmenuContext)),
          n = o.useRef(null);
        return o.createElement(
          'div',
          {
    ...
    96040: (e, t, n) => {
      ...
      function d(e) {
        const {
          ...
          [f, w] = (0, r.useActiveDescendant)(null);
      ...
      class a extends o.PureComponent {
        ...
        _item(e) {
          switch (e.type) {
            ...
            case 'action':
              const t = e.custom() ?? e;
              return o.createElement(l.ContextMenuAction, {
                key: t.id,
                action: t,
    ...
    91572: (e, t, n) => {
      'use strict';
      n.d(t, { shouldShowFullscreen: () => s });
      var o = n(37103);
      function s() {
        return o.enabled('header_fullscreen_button');
      }
    },
    99678: (e, t, n) => {
      'use strict';
      (n.r(t), n.d(t, { SERIES_ICONS: () => g }));
      var o = n(4475),
        s = n(94670),
        i = n(87778),
        l = n(39956),
