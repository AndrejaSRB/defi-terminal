...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3952],
  {
    63136: (e, t, i) => {
      i.d(t, {
        LineToolRiskRewardBase: () => D,
        registerReversibleTool: () => N,
        roundValue: () => A,
      });
      var r = i(50279),
        s = i(50151),
        ...
        p = i(36281),
        d = i(52859);
      class P extends p.PriceAxisView {
        constructor(e, t) {
        ...
        _updateRendererData(e, t, i) {
          ...
          if (0 === this._source.points().length || null === r || r.isEmpty())
            return;
          const s = this._source.ownerSource(),
            n = null !== s ? s.firstValue() : null;
          if (null === n) return;
          const o = this._data.priceProperty.value(),
            c = (0, d.resetTransparency)(this._data.colorProperty.value());
          ((i.background = c),
            (i.textColor = this.generateTextColor(c)),
            (i.coordinate = r.priceToCoordinate(o, n)),
            (e.text = r.formatPrice(o, n)),
            (e.visible = !0));
        }
        _showAxisLabel() {
          return (
      ...
      class y extends _.Property {
        ...
        _formatAndParsePrice(e) {
          const t = (0, s.ensureNotNull)(this._lineSource.ownerSource()),
      ...
      class S extends y {
        ...
        setValue(e) {
          if (this._lineSource.isSourceHidden()) {
            ...
            return (
              (t[this._pointIndex].price = parseFloat(e.toString())),
      ...
      const T = new k.TranslatedString(
        'reverse {tool}',
        n.t(null, void 0, i(66643)),
      );
      function E(e, t) {
        (Number.isFinite(t) || Number.isFinite(e.value())) && e.setValue(t);
      }
      class D extends l.LineDataSource {
        constructor(e, t, r, n) {
          (super(e, t, r, n),
          ...
          (o &&
            !o.options.includes(a) &&
            t.childs().currency.setValue(o.defval),
              ...
              this.ownerSourceChanged().subscribe(
                ...
                () => {
                  const i = (0, s.ensureNotNull)(
                    ...
                    r = i.firstBar(),
                    n = i.lastBar(),
                    o = (0, s.ensureNotNull)(this.ownerSource()),
                    a = o.priceScale();
                  if (a) {
                    let e = (0, s.ensureNotNull)(
                      o.priceRange(r, n, {
                        targetPriceScale: a,
        ...
        availableCurrencies() {
          ...
          return (0, s.ensureDefined)(e.options);
        }
        setOwnerSource(e) {
        ...
        setPoint(e, t, i, r) {
          ...
          switch ((this._muteSyncLineStyle(), e)) {
            case 0:
              ...
              break;
            case 2:
              s.stopPrice.setValue(this.prepareStopPrice(t.price));
              break;
            case 3:
              s.targetPrice.setValue(this.prepareProfitPrice(t.price));
              break;
            case 1:
        ...
        startMoving(e, t, i, r) {
          const n = (0, s.ensureDefined)(e.logical);
        ...
        recalculate() {
          ...
          const e = this.properties().childs(),
            ...
            i = e.stopPrice.value(),
            r = [this._points[0], this._points[1]],
            s = this._calculateActualEntry(this.points()[0], this.points()[1]),
            n = this._model.mainSeries().interval();
          if (s) {
            r.push({ ...s, interval: n });
            const e = this._findClosePoint(s, this.points()[1]);
            e && r.push({ ...e, interval: n });
          }
          ((this._points = r),
                ...
                options: {
                  ...
                  onExecute: () => {
                    ...
                    const i = (function (e, t) {
                      const i = e.points(),
                        r = e.zorder(),
                        n = (0, s.ensureNotNull)(t.model().paneForSource(e)),
                        o = (0, s.ensureNotNull)(e.ownerSource()),
                        c = (0, s.ensureDefined)(I.get(e.toolname)),
                        ...
                        l = e.linkKey().value(),
                        u = l
                          ? x.CreateLineToolSyncMode.ForceOn
                          : x.CreateLineToolSyncMode.ForceOff,
                        h = t.createLineTool({
                          pane: n,
                          point: i[0],
                      ...
                      return (
                        h &&
                          (t.startChangingLinetool(
                            h,
                            (0, s.ensureNotNull)(h.ownerSource()),
                            h.points()[1],
                            1,
                          ),
        ...
        _applyTemplateImpl(e) {
          const { targetPrice: t, stopPrice: i, entryPrice: r, ...s } = e;
          super._applyTemplateImpl(s);
        ...
        _recalculateRiskSize() {
          ...
          i === u.RiskDisplayMode.Percentage
            ? e.riskSize.setValue((t / 100) * r)
            : t > r
              ? (e.risk.setValue(r), e.riskSize.setValue(r))
        ...
        _handleRestoringFactoryDefaults() {
          this.properties()
            .childs()
            .risk.setValue(this.properties().factoryDefaults().risk);
        }
        ...
        _recalculateRisk() {
          ...
          ((s =
            ...
            e.risk.setValue(
              parseFloat(
                this._riskFormatter(t).format(s, {
        ...
        _recalculateAmount() {
          ...
          (E(e.amountTarget, this._amountTarget(t, n, i, r, o)),
            E(e.amountStop, this._amountStop(t, s, i, r, o)));
        }
        _recalculateQty() {
          if (0 === this.points().length) return;
          const e = this.properties().childs(),
            ...
            i = e.stopPrice.value(),
            r = e.riskSize.value(),
            s = this._entryPointCurrencyRate(),
            n =
              null === s
                ? NaN
                : r / (Math.abs(t - i) * this._ownerSourcePointValue() * s);
          E(e.qty, n);
        }
        _calculateActualEntry(e, t) {
          ...
          const n = (0, s.ensureNotNull)(r.firstIndex()),
            o = Math.max(e.index, n),
            c = e.price,
            a = (0, s.ensureNotNull)(r.lastIndex()),
            l = Math.min(a, t.index - 1);
          for (const e of r.rangeIterator(o, l + 1)) {
            const t = e.value;
            if (
              null !== t &&
              (0, s.ensure)(t[2]) >= c &&
        ...
        _findClosePoint(e, t) {
          ...
          if (!i) return null;
          const r = i.barsProvider().bars(),
            n = (0, s.ensureNotNull)(r.firstIndex()),
            o = Math.max(e.index, n),
            c = (0, s.ensureNotNull)(r.lastIndex()),
            a = Math.min(c, t.index - 1);
          for (const e of r.rangeIterator(o, a + 1)) {
            const t = e.value;
            if (null === t) continue;
        ...
        _changeEntryPoint(e) {
          const t = this.properties().childs(),
            i = t.stopPrice.value(),
            r = t.targetPrice.value(),
            s = 1 / this.ownerSourceBase(),
            n = Math.min(i, r) + s,
            o = Math.max(i, r) - s;
        ...
        _updateStudySource() {
          ...
          if (
            ...
            const i = this._model.timeScale(),
              s = t.data().bars().firstIndex(),
              n = t.data().bars().lastIndex();
            if (null === s || null === n) return;
            const o = Math.min(n, Math.max(s, this._points[0].index)),
              c = Math.min(n, Math.max(s, this._points[1].index)),
            ...
            if (null !== a && null !== l) {
              ...
              ((0, r.default)(t, this._studySource.inputs()) ||
    ...
    11810: (e, t, i) => {
      var r;
      (i.d(t, { RiskDisplayMode: () => r }),
        (function (e) {
          ((e.Percentage = 'percents'), (e.Money = 'money'));
        })(r || (r = {})));
    },
    85834: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolRiskRewardLong: () => o }));
      var r = i(50151),
        s = i(63136),
        n = i(78176);
      class o extends s.LineToolRiskRewardBase {
        constructor(e, t, i, r) {
          super(
            e,
        ...
        _amountTarget(e, t, i, r, n) {
          const o = this._closePointCurrencyRate();
          return null === o
            ? NaN
            : (0, s.roundValue)(e + ((t - i) * r * n) / o);
        }
        _amountStop(e, t, i, r, n) {
          const o = this._closePointCurrencyRate();
          return null === o
            ? NaN
            : (0, s.roundValue)(e - ((i - t) * r * n) / o);
        }
        _checkStopPrice(e) {
          const t = this.stopPrice(),
            i = this.profitPrice();
          return (0, r.ensure)(e[3]) <= t
            ? this.stopPrice()
            : (0, r.ensure)(e[2]) >= i
              ? this.profitPrice()
              : null;
      ...
      (0, s.registerReversibleTool)('LineToolRiskRewardShort', {
        targetToolName: 'LineToolRiskRewardLong',
        propertiesFactory: (e, t) => o.createProperties(e, t),
      });
    },
    348: (e, t, i) => {
      var r;
      (i.d(t, { RiskRewardPointIndex: () => r }),
        (function (e) {
          ((e[(e.Entry = 0)] = 'Entry'),
            (e[(e.Close = 1)] = 'Close'),
    ...
    92483: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolRiskRewardShort: () => o }));
      var r = i(50151),
        s = i(63136),
        n = i(78176);
      class o extends s.LineToolRiskRewardBase {
        ...
        static createProperties(e, t) {
          const i = new n.DefaultProperty({
            defaultName: 'linetoolriskrewardshort',
            state: t,
            theme: e,
          });
          return (this._configureProperties(i), i);
      ...
      (0, s.registerReversibleTool)('LineToolRiskRewardLong', {
        targetToolName: 'LineToolRiskRewardShort',
        propertiesFactory: (e, t) => o.createProperties(e, t),
      });
    },
  },
