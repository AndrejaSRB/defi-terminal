  ...
  [7260],
  {
          ...
          ((e.disableBodyScroll = function (e, s) {
            if (i) {
              ...
              if (
                ...
                var d = { targetElement: e, options: s || {} };
                ((a = [].concat(t(a), [d])),
    ...
    26996: (e, t, n) => {
      ...
      function c(e) {
        ...
        return i.createElement(
          'span',
          { className: o()(l().loader, s && l().static, t) },
          i.createElement('span', { className: r }),
          i.createElement('span', { className: r }),
          i.createElement('span', { className: r }),
        );
      }
    ...
    99025: (e, t, n) => {
      ...
      function r(e) {
        ...
        return s.createElement('span', { className: a()(o.shortcut, n) }, t);
      }
    },
    23829: (e, t, n) => {
      'use strict';
      ...
      function p(e) {
        const {
          ...
          T = (0, s.useContext)(l.EmptyIconsContext),
          A = !!x.length;
        return i
          ? s.createElement(
              'li',
              { className: a()(t, m.item, m.loading, m[k]) },
          ...
          : s.createElement(
              ...
              !A &&
                C &&
                s.createElement(c.Hint, { className: m.shortcut, text: C }),
              A && s.createElement(o.Icon, { className: m.nested, icon: h }),
              M,
            );
      }
    },
    ...
    78748: (e) => {
      e.exports = {
        ...
        fullscreenButton: 'fullscreenButton-BXXUwft2',
        hidden: 'hidden-BXXUwft2',
        collapsed: 'collapsed-BXXUwft2',
        fullscreenBtn: 'fullscreenBtn-BXXUwft2',
      };
    },
    85158: (e) => {
    ...
    97465: (e) => {
      e.exports = { wrap: 'wrap-k2h4OAz8', item: 'item-k2h4OAz8' };
    },
    43845: (e, t, n) => {
      'use strict';
    ...
    40610: (e, t, n) => {
      'use strict';
      n.d(t, { DEFAULT_TOOLBAR_BUTTON_THEME: () => o, ToolbarButton: () => r });
      var s = n(50959),
        i = n(46003),
        a = n(50238);
      const o = i.DEFAULT_TOOL_WIDGET_BUTTON_THEME,
        r = (0, s.forwardRef)(function (e, t) {
          const { tooltip: n, ...o } = e,
            [r, l] = (0, a.useRovingTabindexElement)(t);
          return s.createElement(i.ToolWidgetButton, {
            'aria-label': n,
            ...o,
            tag: 'button',
            ref: r,
    ...
    58169: (e, t, n) => {
      'use strict';
      n.d(t, { ToolbarIconButton: () => r });
      var s = n(50959),
        i = n(50238),
        a = n(21618);
      const o = (0, s.forwardRef)(function (e, t) {
          const { tooltip: n, ...i } = e;
          return s.createElement(a.ToolWidgetIconButton, {
            'aria-label': n,
            ...i,
            tag: 'button',
            ref: t,
        ...
        r = (0, s.forwardRef)(function (e, t) {
          const [n, a] = (0, i.useRovingTabindexElement)(t);
          return s.createElement(o, { ...e, ref: n, tabIndex: a });
        });
    },
    34788: (e, t, n) => {
      'use strict';
      ...
      const c = (0, s.forwardRef)(function (e, t) {
          const { tooltip: n, tag: a, buttonRef: o, reference: c, ...u } = e,
            h = (0, i.useFunctionalRefObject)(c ?? null);
          return s.createElement(r.ToolWidgetMenu, {
            'aria-label': n,
            ...u,
            ref: t,
            tag: a ?? 'button',
            ...
            onMenuFocus: (e) => (0, l.handleAccessibleMenuFocus)(e, o ?? h),
          });
        }),
        u = (0, s.forwardRef)(function (e, t) {
          const { tooltip: n, menuReference: r = null, ...l } = e,
            [u, h] = (0, a.useRovingTabindexElement)(null),
            d = (0, i.useFunctionalRefObject)(r);
          return s.createElement(c, {
            'aria-label': n,
            'aria-haspopup': 'menu',
            ...o.MouseClickAutoBlurHandler.attributes(),
            ...l,
            ref: t,
            tag: 'button',
            buttonRef: u,
    ...
    12062: (e, t, n) => {
      'use strict';
      (n.r(t), n.d(t, { BottomToolbarRenderer: () => Rt }));
      var s = n(50959),
        i = n(32227),
        a = n(11542),
        o = n(19036),
      ...
      const x = (e) =>
        ...
        w = (e) => e,
        M = {
          [w('1')]: { resolution: '1', text: x(1) },
          [w('3')]: { resolution: '3', text: x(3) },
          [w('5')]: { resolution: '5', text: x(5) },
          [w('15')]: { resolution: '15', text: x(15) },
          [w('30')]: { resolution: '30', text: x(30) },
          [w('45')]: { resolution: '45', text: x(45) },
          [w('60')]: { resolution: '60', text: S(1) },
          [w('120')]: { resolution: '120', text: S(2) },
          [w('180')]: { resolution: '180', text: S(3) },
          [w('240')]: { resolution: '240', text: S(4) },
          [w('1D')]: {
            resolution: '1D',
            text:
              ((k = 1),
              a.t(
                null,
                { plural: '{str} days', count: k, replace: { str: `${k}` } },
                n(62368),
              )),
          },
          [w('1W')]: {
            ...
            text:
              ...
              a.t(
                null,
                { plural: '{str} weeks', count: B, replace: { str: `${B}` } },
                n(49306),
              )),
          },
          ...
          [w('12M')]: {
            ...
            text:
              ...
              a.t(
                null,
                { plural: '{str} years', count: R, replace: { str: `${R}` } },
                n(91549),
              )),
          },
        };
      ...
      function T(e) {
        const t = (function (e) {
            ...
            if (!s.isValid()) {
              if ('YTD' === t)
                return a.t(null, { context: 'timeframe_title' }, n(19273));
              if ('ALL' === t)
                return a.t(null, { context: 'timeframe_title' }, n(1495));
              if ('LASTSESSION' === t) return D(1);
            }
            if (s.isMinutes()) {
              const e = s.multiplier();
              return e % 60 != 0 ? A(e) : W(e / 60);
            }
            if (s.isDays()) return D(s.multiplier());
            if (s.isWeeks()) return N(s.multiplier());
            if (s.isMonths()) {
              const e = s.multiplier();
              return e % 12 != 0 ? z(e) : F(e / 12);
            }
          ...
          s = (function (e) {
            ...
            if (n.isMinutes()) {
              ...
              return e % 60 != 0 ? L(e) : P(e / 60);
            }
            if (n.isDays()) return I(n.multiplier());
            if (n.isWeeks()) return H(n.multiplier());
            if (n.isMonths()) {
              const e = n.multiplier();
              return e % 12 != 0 ? O(e) : U(e / 12);
            }
            return M[t].text;
          })(e);
        return a.t(
      ...
      class X {
        constructor(e) {
          ((this._state = { ranges: [] }),
            (this._firstBarTime1D = null),
            (this._waitingUpdateAfterSymbolResolved = !0),
          ...
          t.withModel(null, () => {
            ...
            (n.onStatusChanged().subscribe(this, this._updateAvailableRanges),
              n
                .dataEvents()
                .symbolResolved()
                .subscribe(this, () => this._updateRangesByQuotesData()),
              n
                .priceScale()
                .properties()
                .childs()
                .lockScale.subscribe(this, () =>
            ...
            (s.subscribe(this._rangeChangedListenerBound),
              ...
              this._updateRangesByQuotesData());
          });
        }
        state() {
          return this._state;
        ...
        destroy() {
          ...
          (e.withModel(null, () => {
            const t = e.model(),
              n = t.mainSeries();
            (n.onStatusChanged().unsubscribeAll(this),
              n.dataEvents().symbolResolved().unsubscribeAll(this),
              n.quotesProvider().quotesUpdate().unsubscribeAll(this),
              n
                .priceScale()
                .properties()
                .childs()
                .lockScale.unsubscribeAll(this),
              t
                .model()
                .appliedTimeFrame()
        ...
        _updateRangesByQuotesData() {
          const { chartWidget: e } = this._context;
          if (!e.hasModel()) return;
          this._lastAbortController?.abort();
          const t = new AbortController();
          this._lastAbortController = t;
          ...
          (n.quotesProvider().quotesUpdate().unsubscribeAll(this),
            ...
            Promise.race([
              ...
              new Promise((e) => {
                const t = () => {
                  void 0 !== n.quotes()?.open_price &&
                    (n.quotesProvider().quotesUpdate().unsubscribeAll(this),
                    e());
                };
                (n.quotesProvider().quotesUpdate().subscribe(this, t), t());
              }),
            ]).then(() => {
              t.signal.aborted ||
                ((this._waitingUpdateAfterSymbolResolved = !1),
                this._updateAvailableRanges());
            }));
        }
        _updateAvailableRanges(e) {
          ...
          if (
            2 === a ||
            1 === a ||
            this._waitingUpdateAfterSymbolResolved ||
            (e && !i)
          )
            return;
          const o = s.quotes()?.first_bar_time_1d ?? -1 / 0;
          if (this._firstBarTime1D === o) return;
          this._firstBarTime1D = o;
          const r = t(i, a, o).map((e) => ({
            ...e,
            description: '' === e.description ? T(e) : e.description,
          }));
          this._setState({ ranges: r });
        }
      }
          ...
          ((t = class extends s.PureComponent {
            constructor(e, t) {
              (super(e, t),
                ...
                q.has(t.chartWidget) || q.set(t.chartWidget, new X(t)));
      ...
      function Y(e) {
        ...
        return s.createElement(
          ...
          null,
          t.map((e) =>
            s.createElement(J.ContextMenuItem, {
              key: e.value.value,
      ...
      function ee(e) {
        ...
        return s.createElement(
          s.Fragment,
          null,
          s.createElement($.Separator, {
            className: Q.separator,
          }),
          s.createElement(J.ContextMenuItem, {
            icon: K,
            label: (0, Z.appendEllipsis)(a.t(null, void 0, n(42432))),
            onClick: t,
            active: !1,
            checked: !1,
            checkable: !1,
      ...
      const te = {
          title: a.t(null, void 0, n(85444)),
          goToDate: (0, Z.appendEllipsis)(a.t(null, void 0, n(42432))),
        },
        ne = (0, f.registryContextType)();
      class se extends s.PureComponent {
        constructor(e, t) {
          (super(e, t),
            (this._handleGoToDateClick = () => {
              const { chartWidget: e } = this.context;
              ((0, G.showGoToDateDialog)(e), (0, d.globalCloseMenu)());
            }),
          ...
          return s.createElement(
            ...
            (e) =>
              s.createElement(
                u.ToolbarMenuButton,
                {
                  className: l()(Q.button, this.props.className),
                  content: te.title,
                  arrow: !0,
      ...
      var ae = n(40610),
        oe = n(97465);
      const re = V(function (e) {
        const { className: t, ranges: n, activeRange: i, onSelectRange: a } = e;
        return s.createElement(
          'div',
          { className: r(oe.wrap, t), 'data-name': 'date-ranges-tabs' },
          n.map((e) =>
            s.createElement(ae.ToolbarButton, {
              key: e.value.value,
              className: oe.item,
      ...
      var le = n(61814),
        ...
        he = n(92574),
        de = n(49449);
      const me = (0, le.hotKeySerialize)({
          keys: [(0, ce.humanReadableModifiers)(ce.Modifiers.Alt, !1), 'G'],
          text: '{0} + {1}',
        }),
        pe = (0, f.registryContextType)();
      class ge extends s.PureComponent {
        ...
        render() {
          ...
          return s.createElement(ue.ToolbarIconButton, {
            icon: he,
            onClick: this._handleClick,
            'data-tooltip-hotkey': me,
            tooltip: a.t(null, void 0, n(42432)),
            'data-name': 'go-to-date',
            className: r(de.button, e),
          });
        }
      }
      ge.contextType = pe;
      ...
      var be = n(76460),
        ...
        we = n(40173),
        Me = n(15573);
      const Re = (0, we.mergeThemes)(ae.DEFAULT_TOOLBAR_BUTTON_THEME, {
        isDisabled: Me.disabled,
        button: Me.button,
      });
      const Be = (0, f.registryContextType)();
      class ke extends s.PureComponent {
        constructor(e, t) {
          (super(e, t),
            (this._timeFormatter = new ye.TimeFormatter(
              (0, xe.getHourMinuteSecondFormat)(
                Se.timeHoursFormatProperty.value(),
              ),
            )),
            ...
            (this._tickClock = () => {
              ...
              if (void 0 !== this._timezone) {
                const t = (0, fe.utc_to_cal)(this._timezone, e.serverTime());
            ...
            (this._getActions = () => {
              ...
              return (function (e) {
                const t = e.actions();
                return t && t.applyTimeZone instanceof Ce.Action
            ...
            (this._showMenu = (e) => {
              if (this._preventShowingMenu)
                return void Ee.ContextMenuManager.hideAll();
              const t = (0, v.ensureNotNull)(this._element),
                n = this._getActions();
              if (0 === n.length) return;
              const s = t.getBoundingClientRect();
              Ee.ContextMenuManager.showMenu(
                n,
                { clientX: s.left, clientY: s.top, attachToYBy: 'bottom' },
                {
                  returnFocus: !0,
                  takeFocus: !0,
                  isKeyboardEvent: (0, be.isKeyboardClick)(e),
                },
                { menuName: 'TimezoneMenuContextMenu' },
                () => {
                  ((this._menuShown = !1), this.setState({ isMenuOpened: !1 }));
                },
              ).then(() => {
                ((this._menuShown = !0), this.setState({ isMenuOpened: !0 }));
              });
            }),
            (0, f.validateRegistry)(t, {
              chartWidget: o.any.isRequired,
            ...
            (this.state = { time: '', isMenuOpened: !1 }));
        }
        componentDidMount() {
          const { chartWidget: e } = this.context;
          ((this._tickInterval = setInterval(this._tickClock, 1e3)),
            e.withModel(null, () => {
              ...
              (t
                ...
                Se.timeHoursFormatProperty.subscribe(
                  this,
          ...
          (clearInterval(this._tickInterval),
            e.withModel(null, () => {
              ...
              (t
                ...
                Se.timeHoursFormatProperty.unsubscribe(
                  this,
                  this._timeHoursFormatPropertyChanged,
                ));
            }));
        ...
        render() {
          const { className: e, withMenu: t } = this.props,
            { time: i, isMenuOpened: o } = this.state,
            r =
              void 0 !== this._timezone
                ? (0, _e.parseTzOffset)(this._timezone.name()).string
                : null;
          return s.createElement(ae.ToolbarButton, {
            ...
            tooltip: t ? a.t(null, void 0, n(77073)) : void 0,
            className: e,
            text: i && r && `${i} ${r}`,
          });
        }
        updateTimezonesButton() {
          ...
          ((this._timezone = (0, fe.get_timezone)(t)), this._tickClock());
        }
      ...
      function Ae(e) {
        return s.createElement('span', {
          className: r(Te.separator, e.className),
        });
      }
      var We = n(26981),
        De = n(95804),
      ...
      class ze {
        ...
        _setHighlight() {
          ...
          if (null !== s) {
            ...
            let i = null;
            null !== t && (i = t.axisInfo());
            const a = s.leftPriceAxisesContainer().findAxisWidgetForScale(n);
            if ((null !== a && (i = a.axisInfo()), i)) {
              const t = s.highlightedPriceAxises(),
                n = t.value();
              n.find((e) => e.axis.label === i.label) ||
                (t.setValue([...n, { owner: this._owner, axis: i }]),
                e.lightUpdate(),
                (this._highlighted = !0));
            }
          }
          ...
          if (null !== s) {
            ...
            if ((null !== a && (i = a.axisInfo()), i)) {
              const t = s.highlightedPriceAxises(),
                n = t.value().slice(),
                a = n.findIndex(
                  (e) => i.label === e.axis.label && e.owner === this._owner,
                );
              -1 !== a &&
                (n.splice(a, 1),
                t.setValue(n),
      ...
      const Fe = (0, f.registryContextType)(),
        Le = new De.TranslatedString(
          'toggle log scale',
          a.t(null, void 0, n(49403)),
        );
      const Pe = (0, f.registryContextType)(),
        Ie = new De.TranslatedString(
          'toggle auto scale',
          a.t(null, void 0, n(42240)),
        );
      const He = (0, f.registryContextType)(),
        Oe = new De.TranslatedString(
          'toggle percentage scale',
          a.t(null, void 0, n(98994)),
        );
      const Ue = (0, f.registryContextType)();
      var Xe = n(42142),
        je = n(26867),
        Ve = n(3343),
        qe = n(43845),
        Ge = n(95772),
        Je = n(84242);
      const $e = new De.TranslatedString(
          'change session',
          a.t(null, void 0, n(87041)),
        ),
        Ze = {
          hint: a.t(null, void 0, n(94031)),
          headerMenuText: a.t(null, void 0, n(27665)),
        },
        Ke = (0, le.hotKeySerialize)({
          keys: [
            (0, Ve.humanReadableModifiers)(Ve.Modifiers.Alt, !1),
            (0, Ve.humanReadableModifiers)(Ve.Modifiers.Shift, !1),
            'E',
          ],
          text: '{0} + {1} + {2}',
        }),
      ...
      class Ye extends s.PureComponent {
        ...
        updateSessionButton() {
          ...
          this.setState({
            sessionId: n,
            sessionName: (0, Ge.translateSessionShortDescription)(
              i?.description || '',
            ),
            sessionDescription: (0, Ge.translateSessionDescription)(
              i?.description || '',
            ),
            availableSessions: s,
          });
        ...
        _menuItems() {
          ...
          const n = e.model().mainSeries(),
            i = [
              s.createElement(
                qe.ToolWidgetMenuSummary,
                { key: 'header_menu_text', className: Je.headerMenuText },
                Ze.headerMenuText.toUpperCase(),
              ),
            ];
          for (const a of t) {
            ...
            i.push(
              s.createElement(p.AccessibleMenuItem, {
                key: a.id,
                label: (0, Ge.translateSessionDescription)(a.description),
      ...
      const ot = {
        extLabel: a.t(null, void 0, n(8586)),
        extHint: a.t(null, void 0, n(92966)),
        percentageHint: a.t(null, void 0, n(81649)),
        logLabel: a.t(null, { context: 'scale' }, n(4161)),
        logHint: a.t(null, void 0, n(1e4)),
        autoLabel: a.t(null, { context: 'scale' }, n(22233)),
        autoHint: a.t(null, void 0, n(41888)),
        maximizeChartHint: a.t(null, void 0, n(61206)),
        restoreChartHint: a.t(null, void 0, n(31142)),
        adjLabel: a.t(null, { context: 'adjustments' }, n(94920)),
        adjHint: a.t(null, void 0, n(93020)),
        adjForDividendsOnlyHint: a.t(null, void 0, n(2031)),
        adjForSplitsOnlyHint: a.t(null, void 0, n(95739)),
        backAdjustLabel: a.t(null, { context: 'adjustments' }, n(16755)),
        backAdjustHint: a.t(null, void 0, n(68921)),
        settlementAsCloseLabel: a.t(null, { context: 'adjustments' }, n(82631)),
        settlementAsCloseHint: a.t(null, void 0, n(49545)),
      };
      var rt, lt;
      (!(function (e) {
        ((e.Separator = 'separator'),
          ...
          (e.Auto = 'auto'),
          (e.LayoutFullscreen = 'layoutFullscreen'),
      ...
      const ct =
        ((ut = (e) =>
          s.createElement(ae.ToolbarButton, {
            ...
            onClick: yt(e.onClick, 'log', e.isLogarithm),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            'data-name': 'logarithm',
          })),
        ((ht = class extends s.PureComponent {
          constructor(e, t) {
            (super(e, t),
              ...
              (this._handleSelect = () => {
                ...
                t.priceScale().isLockScale() ||
                  e.setPriceScaleMode({ log: !s.log }, n, Le);
              }),
              (0, f.validateRegistry)(t, { chartWidget: o.any.isRequired }),
      ...
      const dt = (function (e) {
                ...
                (super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      ...
                      n = t.mode();
                    e.setPriceScaleMode({ autoScale: !n.autoScale }, t, Ie);
                  }),
                  (0, f.validateRegistry)(t, { chartWidget: o.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new ze(
          ...
          s.createElement(ae.ToolbarButton, {
            ...
            onClick: yt(e.onClick, 'auto', e.isAuto),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            'data-name': 'auto',
          }),
        ...
        mt = (function (e) {
                ...
                (super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      ...
                      s = n.mode();
                    t.priceScale().isLockScale() ||
                      e.setPriceScaleMode({ percentage: !s.percentage }, n, Oe);
                  }),
                  (0, f.validateRegistry)(t, { chartWidget: o.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new ze(
          ...
          s.createElement(ae.ToolbarButton, {
            icon: nt,
            tooltip: ot.percentageHint,
            className: e.className,
            isActive: e.isPercentage,
            'aria-pressed': e.isPercentage,
            isDisabled: e.isDisabled,
            onClick: yt(e.onClick, 'percent', e.isPercentage),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            'data-name': 'percentage',
          }),
        );
      const pt = (0, le.hotKeySerialize)({
          keys: [(0, ce.humanReadableModifiers)(ce.Modifiers.Alt, !1), 'Enter'],
          text: '{0} + {1}',
        }),
        gt = (function (e) {
          var t;
          ...
          s.createElement(ae.ToolbarButton, {
            icon: e.isFullscreen ? it : st,
            tooltip: e.isFullscreen
              ? ot.restoreChartHint
              : ot.maximizeChartHint,
            className: r(e.className, at.fullscreenButton),
            isActive: e.isFullscreen,
            onClick: yt(e.onClick, 'maximize chart', e.isFullscreen),
            'data-tooltip-hotkey': pt,
            'data-name': 'layoutFullscreen',
          }),
        ),
        vt = { layoutFullscreen: !0, preventPhoneLayout: !0 },
        bt = {
          layoutFullscreen: Number.MIN_SAFE_INTEGER,
        ...
        ft = (() => {
          ...
          return (
            ...
            e.set(dt, 'auto'),
            e.set(Ye, 'session'),
            e.set(gt, 'layoutFullscreen'),
            Ne.CheckMobile.any() &&
              e.set(tt.ToolWidgetFullscreen, 'fullscreen'),
            e
          );
        })();
      function _t(e) {
      ...
      class St extends s.PureComponent {
        constructor(e, t) {
          ...
          (super(e, t),
                ...
                if (s.isValidElement(e) && 'string' != typeof e.type) {
                  ...
                  if ('string' == typeof t.className) {
                    const i = { className: t.className },
                      o = n(),
                      l = (0, v.ensureDefined)(ft.get(e.type));
                    return s.createElement(
                      'div',
                      {
                        key: null === e.key ? void 0 : e.key,
                        className: r(at.inline, o[l] && at.collapsed),
                        ref: (e) => a(e, l),
                        onClick: () => _t(),
                      },
                      s.cloneElement(e, i),
              ...
              const e = this._layout,
                ...
                s =
                  ...
                  Object.keys(a)
                    ...
                    .sort((e, t) => bt[e.name] - bt[t.name]));
              var a;
              const o = t.offsetWidth,
                r = s.reduce((e, t) => e + t.width, 0),
                l = n.offsetWidth,
                c = !Boolean(n.textContent),
                u = o - r - l <= 0 ? 'collapsed' : 'expanded';
              if (
            ...
            (this._handleLayoutFullscreenableChange = (e) => {
              this._setStateWithResize({ isLayoutFullscreenable: e });
            }),
          ...
          ((this.state = {
            isLayoutFullscreenable: l.fullscreenable.value(),
        ...
        componentDidMount() {
          ...
          (e.subscribe(this, this._resizeByRaf),
            n.fullscreen().subscribe(this._handleFullscreenChange),
            t.fullscreenable.subscribe(this._handleLayoutFullscreenableChange),
            s.withModel(null, () => {
              const e = s.model(),
                t = e.model();
              (e
        ...
        componentWillUnmount() {
          ...
          (n.fullscreen().unsubscribe(this._handleFullscreenChange),
            e.unsubscribe(this, this._resizeByRaf),
            t.fullscreenable.unsubscribe(
              this._handleLayoutFullscreenableChange,
            ),
          ...
          const e = this._layout,
            {
              ...
              layoutFullscreenButtonEnabled: l,
            } = this.props;
          return s.createElement(
            We.Toolbar,
            {
              className: at.toolbar,
              onContextMenu: je.preventDefault,
              ...
              s.createElement(
                ...
                s.createElement(
                  'div',
                  {
                    className: r(
                      at.dateRangeWrapper,
                      'collapsed' !== e.dateRangeMode && at.collapsed,
                    ),
                    ref: this._handleRangeCollapsedRef,
                  },
                  s.createElement(
                    'div',
                    { className: r(at.dateRangeCollapsed) },
                    s.createElement(ie, {
                ...
                s.createElement(
                  'div',
                  {
                    className: r(
                      at.dateRangeWrapper,
                      'expanded' !== e.dateRangeMode && at.collapsed,
                      e.noRanges && at.noranges,
                    ),
                    ref: this._handleRangeExpandedRef,
                  },
                  s.createElement(
                    'div',
                    { className: r(at.dateRangeExpanded) },
                    s.createElement(re, {
                      onSelectRange: this._trackRangeButtonClick,
                      className: at.dateRange,
                    }),
                    this.props.goToDateEnabled &&
                      s.createElement(Ae, { className: r(at.separator) }),
                    this.props.goToDateEnabled && s.createElement(ve, null),
                  ),
                ),
              ),
            s.createElement(
              'div',
              { className: at.seriesControlWrapper },
              n &&
                s.createElement(
                  'div',
                  {
                    className: r(at.inline, e.timeZones && at.collapsed),
              ...
              this.props.sessionIdButtonEnabled &&
                ...
                s.createElement(
                  'div',
                  {
                    className: r(at.inline, e.session && at.collapsed),
              ...
              s.createElement(
                'div',
                {
                  ...
                  className: r(at.inline, e.separator && at.collapsed),
                },
              ...
              s.createElement(
                ...
                i &&
                  ...
                  s.createElement(mt, { className: at.item }),
                a && s.createElement(ct, { className: at.item }),
                o && s.createElement(dt, { className: at.item }),
                l &&
                  this.state.isLayoutFullscreenable &&
                  s.createElement(gt, {
                    className: at.item,
                ...
                Ne.CheckMobile.any() &&
                  this.state.isFullscreen &&
                  s.createElement(tt.ToolWidgetFullscreen, {
                    id: 'bottom-toolbar-fullscreen',
                    clickArea: 'bottom toolbar',
                    isActive: !0,
                    className: at.fullscreenBtn,
                  }),
              ),
            ),
          );
        ...
        _applyResizing() {
          ...
          (this._rangeExpanded &&
            ...
            this._rangeExpanded.classList.toggle(at.noranges, t)),
            ...
            if ('separator' !== t) {
              ...
              e &&
                ('timeZones' === t || 'session' === t
                  ? (s = s || !a)
                  : (i = i || !a),
                e.classList.toggle(at.collapsed, a));
            }
          });
          const a = this._seriesComponents.separator;
          if (a) {
            const e = !s || !i || !0 === n.separator;
            a.classList.toggle(at.collapsed, e);
          }
        }
      ...
      class wt extends s.PureComponent {
        constructor(e) {
          (super(e),
        ...
        render() {
          ...
          const { options: t } = this.props,
            n = {
              ...
              layoutFullscreenButtonEnabled: t.layoutFullscreenButtonEnabled,
              mobileChangeLayoutEnabled: t.mobileChangeLayoutEnabled,
            };
          return s.createElement(
            f.RegistryProvider,
            { validation: Et, value: this._registry },
            s.createElement(St, { key: e.id(), ...n }),
          );
        }
        _defineRegistry(e) {
          const {
    ...
    69830: (e, t, n) => {
      ...
      const m = (0, c.hotKeySerialize)({
          keys: [(0, u.humanReadableModifiers)(u.Modifiers.Shift, !1), 'F'],
          text: '{0} + {1}',
        }),
        p = (0, l.registryContextType)();
      class g extends s.PureComponent {
        ...
        render() {
          const { className: e, id: t, isActive: i } = this.props,
            { isFullscreen: l } = this.state;
          return s.createElement(r.ToolbarIconButton, {
            id: t,
            icon: l ? d : h,
            onClick: this._handleClick,
            className: a(e),
            tooltip: o.t(null, void 0, n(67092)),
    ...
    68976: (e, t, n) => {
      ...
      function l(e) {
        ...
        return (r(n, t), s.createElement(o.Provider, { value: n }, e.children));
      }
      function c() {
        return o;
      }
