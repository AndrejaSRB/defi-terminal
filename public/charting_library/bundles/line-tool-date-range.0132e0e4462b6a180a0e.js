  ...
  [4273],
  {
    22523: (e, t, s) => {
      s.d(t, {
        ...
        nonThemedFactoryDefaultsBase: () => m,
        themedFactoryDefaultsBase: () => h,
      });
      var i = s(50151),
        r = s(58978),
        o = s(24633),
        ...
        h = new Map([
          [
            o.StdTheme.Light,
            {
              ...
              linecolor: d,
              backgroundColor: (0, a.generateColor)(d, 85),
    ...
    65096: (e, t, s) => {
      ...
      const d = {
        ...
        m = u.themedFactoryDefaultsBase,
        h = (0, a.extractThemedColors)(
          (0, i.ensureDefined)(m.get(l.StdTheme.Light)),
          (0, i.ensureDefined)(m.get(l.StdTheme.Dark)),
        ),
        y = (0, a.extractAllPropertiesKeys)(
          (0, i.ensureDefined)(m.get(l.StdTheme.Light)),
        ),
        p = (0, a.extractAllPropertiesKeys)(d),
        f = [
          ...new Set([
            ...y,
            ...p,
        ...
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () =>
              (0, n.factoryDefaultsForCurrentTheme)(d, m),
        ...
        constructor(e, t, i, r) {
          (super(
            ...
            Promise.all([s.e(6290), s.e(986), s.e(6668), s.e(1583)])
              ...
              .then((e) => {
                this._setPaneViews([
                  new e.DateRangePaneView(this, this._model),
                ]);
              }));
        }
        destroy() {
