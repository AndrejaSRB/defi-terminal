  ...
  [1584],
  {
    ...
    41590: (e, t, n) => {
      ...
      function m(e) {
        const {
          ...
          [b] = (0, r.useState)(() => (0, i.randomHash)()),
          g = (0, r.useRef)(null),
          y = (0, r.useContext)(l.CloseDelegateContext);
        return (
          (0, r.useLayoutEffect)(
            () => (
              (0, o.ensureNotNull)(g.current).focus({ preventScroll: !0 }),
              y.subscribe(p, n),
              p.addDrawer(b),
              () => {
                (p.removeDrawer(b), y.unsubscribe(p, n));
              }
            ),
            [],
          ),
          r.createElement(
            ...
            r.createElement(
              'div',
              { ref: h, className: s(d.wrap, d[`position${t}`]) },
              b === p.currentDrawer &&
                r.createElement('div', { className: d.backdrop, onClick: n }),
              r.createElement(
                f,
                {
                  className: s(v.drawer, d[`position${t}`], m),
                  ref: g,
      ...
      function s(e, t) {
        return class extends r.PureComponent {
          render() {
            ...
            return 'parent' === s
              ? i
              : r.createElement(o.Portal, { shouldTrapFocus: t }, i);
          }
        };
      }
    },
              ...
              return (
                ...
                null !== l.current &&
                  (a
                    ...
                    : (0, o.disableBodyScroll)(l.current, {
                        allowTouchMove: u(l),
                      })),
                () => {
                  (c--,
                    null !== l.current &&
                      (a
                        ...
                        : (0, o.enableBodyScroll)(l.current)));
                }
              );
          }, []),
          r.createElement('div', { ref: l, ...s }, n)
        );
      });
      function u(e) {
        return (t) => {
    ...
    73607: (e, t, n) => {
      ...
      function l(e) {
        ...
        const i = m(e.currentTarget).sort(r.navigationOrderComparator);
        ...
        switch ((0, r.mapKeyCodeToDirection)(t)) {
          case 'inlinePrev':
            if (!u.length) return;
            (e.preventDefault(),
              b(0 === v ? i[l] : p ? d(u, v, -1) : u[u.length - 1]));
            break;
          case 'inlineNext':
            if (!u.length) return;
            (e.preventDefault(),
              v === u.length - 1 ? b(i[l]) : b(p ? d(u, v, 1) : u[0]));
            break;
          case 'blockPrev': {
            e.preventDefault();
            const t = d(i, l, -1);
    ...
    14474: (e, t, n) => {
      ...
      class c {
          ...
          (this._onShow && this._onShow(),
            ...
            this._render({
              ...
              position: (t) => {
                ...
                let h,
                  m = e.attachToYBy ?? 'auto';
                'auto-strict' === m &&
                  (m = s < a.y + a.h + l + r ? 'bottom' : 'top');
                let f = a.y;
                switch (m) {
                  case 'top':
                    ((f = a.y + a.h + l), (h = r > s - f ? s - f : void 0));
                    break;
                  case 'bottom':
                    ((f = Math.max(0, a.y - l - r)),
                      (h = 0 === f ? a.y - l : void 0));
                }
                return { x: d, y: f, overrideHeight: h };
              },
              isOpened: !0,
              onClose: () => {
        ...
        hide() {
          ((this._isShown = !1),
            this._render({ ...this._props, isOpened: !1 }));
        }
        isShown() {
        ...
        _render(e) {
          o.render(
            r.createElement(
              ...
              { value: this._manager },
              r.createElement(s.OverlapContextMenu, { ...e }),
            ),
            this._root,
          );
        }
