  ...
  [1313],
  {
    54707: (e, t, n) => {
      ...
      function _(e, t) {
        const n = e.x - t.x,
          i = e.y - t.y;
        if (!Number.isFinite(n) || !Number.isFinite(i) || (0 === n && 0 === i))
          return a.PaneCursorType.Default;
        let r = Math.atan2(i, n);
        return (
          r < 0 && (r += 2 * Math.PI),
          r >= p.deg337_5 ||
          r < p.deg22_5 ||
          (r >= p.deg157_5 && r < p.deg202_5)
            ? a.PaneCursorType.HorizontalResize
            : (r >= p.deg22_5 && r < p.deg67_5) ||
                (r >= p.deg202_5 && r < p.deg247_5)
              ? a.PaneCursorType.DiagonalNwSeResize
              : (r >= p.deg67_5 && r < p.deg112_5) ||
                  (r >= p.deg247_5 && r < p.deg292_5)
                ? a.PaneCursorType.VerticalResize
                : (r >= p.deg112_5 && r < p.deg157_5) ||
                    (r >= p.deg292_5 && r < p.deg337_5)
                  ? a.PaneCursorType.DiagonalNeSwResize
                  : void (0, o.assert)(!1, 'unexpected angle')
        );
      }
      function g(e, t) {
      ...
      class P {
        constructor(e, t, n) {
          ((this._invalidated = !0),
            ...
            (this._source = e),
            (this._model = t),
            (this._ownerSource = n ?? null));
        }
        priceToCoordinate(e) {
          const t = this._getOwnerSource(),
            n = t?.priceScale();
          if (null == n) return null;
          const i = null !== t ? t.firstValue() : null;
          return null === i ? null : n.priceToCoordinate(e, i);
        }
        anchorColor() {
          return h;
        }
        ...
        addAnchors(e, t = {}) {
          ...
          const i = this._source.points(),
            o = n.map((e, t) => {
              const n = i[t],
                o = (0, d.lineSourcePaneViewPointToLineAnchorPoint)(e);
              return (
        ...
        createLineAnchor(e, t) {
          ...
          return (
            l.setData({
              ...
              strokeWidth: o ? u.TouchStrokeWidth : u.RegularStrokeWidth,
          ...
          this._model.timeScale().isEmpty() ||
            (this._validatePriceScale() &&
              (this._source.points().forEach((e, t) => {
                const n = this._source.pointToScreenPoint(
                  e,
        ...
        _getLineAnchorRenderer(e) {
          for (; this._lineAnchorRenderers.length <= e; )
            this._lineAnchorRenderers.push(new d.LineAnchorRenderer());
    ...
    23712: (e, t, n) => {
      ...
      class v extends f.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          let d = 0;
          const a = this._points[2].subtract(this._points[1]).scaled(0.5),
            c = o.fillBackground.value(),
          ...
          for (let e = 0; e <= 8; e++) {
            ...
            if (o?.childs().visible.value()) {
              ...
              if (c) {
                {
                  const e = {
                      ...
                      p2: t,
                      p3: n,
                      p4: this._medianPoint.point.addScaled(a, d),
              ...
              d = o.childs().coeff.value();
              {
                ...
                (s.setData(r),
                  s.setHitTest(
                    new h.HitTestResult(h.HitTarget.MovePoint, void 0, e),
                  ),
                  i.append(s));
              }
              {
      ...
      const S = new s.TranslatedString(
        'erase level line',
      ...
      class w extends d.LineDataSource {
        constructor(e, t, n, i) {
          (super(
            e,
        ...
        processErase(e, t) {
          const n = 'level' + t,
            o = (0, i.ensureDefined)(this.properties().child(n)).childs()
              .visible;
          e.setProperty(o, !1, S, l.lineToolsDoNotAffectChartInvalidation);
        }
        ...
        async _getPropertyDefinitionsViewModelClass() {
          return c.PitchBaseDefinitionsViewModel;
        }
    ...
    39723: (e, t, n) => {
      ...
      var i = n(50151),
        ...
        a = n(52859),
        c = n(20820);
      class h extends c.MediaCoordinatesPaneRenderer {
        constructor() {
        ...
        _visiblePolygon(e) {
          ...
          if (
            ...
            ((0, s.distanceToLine)(n, r, l).distance < 1e-6 &&
              (0, s.distanceToLine)(n, r, a).distance < 1e-6)
          )
            return null;
          ...
          return (
            (c = (0, d.clipPolygonByEdge)(c, n, r, [a, l])),
            (c = (0, d.clipPolygonByEdge)(c, a, l, [n, r])),
            (0, o.equalPoints)(l, n) ||
              t.extendLeft ||
              (c = (0, d.clipPolygonByEdge)(c, l, n, [r, a])),
            c
          );
        }
      }
    ...
    73914: (e, t, n) => {
      n.d(t, {
        ...
        lineSourcePaneViewPointToLineAnchorPoint2: () => S,
      ...
      class f extends h.BitmapCoordinatesPaneRenderer {
          ...
          for (const t of n) {
            if (t.point.subtract(e).length() <= i)
              return new d.HitTestResult(
                t.hitTarget ?? d.HitTarget.ChangePoint,
                {
                  areaName: d.AreaName.AnchorPoint,
                  pointIndex: t.pointIndex,
                  cursorType: t.cursorType ?? a.PaneCursorType.Default,
        ...
        _drawPoints(e, t, n, o, s) {
          const {
            ...
            u = h.radius;
          let p = Math.max(1, Math.floor((h.strokeWidth || 2) * a));
          h.selected && (p += Math.max(1, Math.floor(a / 2)));
          const _ = Math.max(1, Math.floor(a));
          let g = Math.round(u * a * 2);
          g % 2 != _ % 2 && (g += 1);
          const P = (_ % 2) / 2;
          d.strokeStyle = h.color;
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  const e = Math.max(1, Math.floor(h.selectedStrokeWidth * a));
                  let t = Math.round(u * a * 2);
                  t % 2 != _ % 2 && (t += 1);
                  s(
                    d,
                    {
      ...
      function v(e, t = e.pointIndex, n, i, o, r, s, l, d, a) {
        return {
          point: e,
          pointIndex: t,
          cursorType: n,
