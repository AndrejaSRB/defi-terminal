  ...
  [9039],
  {
    ...
    8025: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        a = o(27011),
        s = o(86332);
      const c = n.createContext({ isInButtonGroup: !1, isGroupPrimary: !1 }),
        u = (e, t, o) => {
          const r = (0, n.useContext)(i.CustomBehaviourContext),
            {
              className: u,
              isSelected: p,
              children: d,
            ...
            N = (0, n.useContext)(s.ControlGroupContext),
            { isInButtonGroup: D, isGroupPrimary: B } = (0, n.useContext)(c);
          return l()(
            u,
            e.lightButton,
            w && e.link,
            S && e.active,
            p && e.selected,
            (0, a.isIconOnly)(d, f) && e.noContent,
            !!k && e.withStartSlot,
            (m || !!T) && e.withEndSlot,
            o && e.withGrouped,
            h && e[h],
    ...
    66860: (e, t, o) => {
      ...
      const m = (e) =>
        n.createElement(s.Icon, {
          className: l()(d().caret, e && d().activeCaret),
          icon: u(),
        });
      function h(e) {
        const {
        ...
        return n.createElement(
          ...
          h &&
            n.createElement(
              'span',
              { className: l()(d().slot, d().startSlot) },
              h,
            ),
          !(0, a.isIconOnly)(u, o) &&
            n.createElement(
              ...
              s || r
                ? n.createElement(
                    ...
                    n.createElement(
                      ...
                      {
                        className: l()(
                          !s && r && d().ellipsisContainer,
                          s && d().textWrapContainer,
                          s && r && d().textWrapWithEllipsis,
                        ),
                      },
                      u,
                    ),
                    n.createElement(
                      'span',
                      { className: d().visuallyHidden, 'aria-hidden': !0 },
                      u,
                    ),
                  )
                : n.createElement(
    ...
    15893: (e, t, o) => {
      ...
      function p(e) {
        const { isGrouped: t } = n.useContext(r.ControlGroupContext),
          ...
          W = x ? (S ?? 2) : 1,
          F =
            W > 0 ? { ...k, '--ui-lib-light-button-content-max-lines': W } : k;
        return n.createElement(
          'button',
          {
            ...B,
    ...
    51544: (e) => {
      e.exports = {
        drawer: 'drawer-KpYsc6dH',
        drawerItem: 'drawerItem-KpYsc6dH',
        menuWrap: 'menuWrap-KpYsc6dH',
        scrollWrap: 'scrollWrap-KpYsc6dH',
        menuBox: 'menuBox-KpYsc6dH',
        card: 'card-KpYsc6dH',
        fadeTop: 'fadeTop-KpYsc6dH',
        fadeBottom: 'fadeBottom-KpYsc6dH',
      };
    },
    36614: (e) => {
      e.exports = {
        wrap: 'wrap-GPY6iGF_',
        title: 'title-GPY6iGF_',
        content: 'content-GPY6iGF_',
        mob: 'mob-GPY6iGF_',
        subtitle: 'subtitle-GPY6iGF_',
        group: 'group-GPY6iGF_',
        text: 'text-GPY6iGF_',
        mini: 'mini-GPY6iGF_',
        anchor: 'anchor-GPY6iGF_',
      };
    },
    86288: (e) => {
      e.exports = {
        subtitle: 'subtitle-cEWFvaCX',
        text: 'text-cEWFvaCX',
        group: 'group-cEWFvaCX',
        groupIcon: 'groupIcon-cEWFvaCX',
        beforeMarketOpen: 'beforeMarketOpen-cEWFvaCX',
        afterMarketClose: 'afterMarketClose-cEWFvaCX',
        groupTitle: 'groupTitle-cEWFvaCX',
        groupRow: 'groupRow-cEWFvaCX',
        groupCell: 'groupCell-cEWFvaCX',
      };
    },
    60734: (e) => {
      e.exports = {
        lollipopTooltipTitle: 'lollipopTooltipTitle-jFagU3Qi',
        lollipopTooltipTitle_minimal: 'lollipopTooltipTitle_minimal-jFagU3Qi',
        lollipopTooltipTitle__title: 'lollipopTooltipTitle__title-jFagU3Qi',
        lollipopTooltipTitle_mobile: 'lollipopTooltipTitle_mobile-jFagU3Qi',
        lollipopTooltipTitle__icon: 'lollipopTooltipTitle__icon-jFagU3Qi',
      };
    },
    92892: (e, t, o) => {
      'use strict';
      (o.r(t), o.d(t, { showLollipopTooltip: () => L }));
      var n = o(50959),
        r = o(32227),
        l = o(50151),
        i = o(20057);
      ...
      const f = (0, n.forwardRef)((e, t) => {
        ...
        (0, n.useEffect)(
          () => (
            d.globalCloseDelegate.subscribe(null, r),
            () => {
              d.globalCloseDelegate.unsubscribe(null, r);
            }
          ),
          [r],
        );
        const c = (0, n.useCallback)(
            (t) => {
              (e.onKeyDown?.(t),
                27 === (0, m.hashFromEvent)(t) && (t.preventDefault(), r()));
            },
            [r],
          ),
          u = (0, n.useCallback)(() => {
      ...
      function S(e) {
        const {
          ...
          className: l,
          cardType: i,
          informationButtonProps: a,
        } = e;
        return n.createElement(
          'div',
          {
            className: w()(
              x.lollipopTooltipTitle,
              [
                'mob' === i && x.lollipopTooltipTitle_mobile,
                'mini' === i && x.lollipopTooltipTitle_minimal,
              ],
              l,
            ),
          },
          o &&
            n.createElement(E.Icon, {
              icon: o,
              className: x.lollipopTooltipTitle__icon,
              style: r,
            }),
          n.createElement(
            'span',
            { className: x.lollipopTooltipTitle__title },
            t,
          ),
          !1,
        );
      ...
      function D(e) {
        ...
        return n.createElement(
          'div',
          { className: w()(N.groupRow, s), style: r },
          t &&
            n.createElement(
              'div',
              { className: N.groupCell },
              n.createElement('span', { className: N.text }, t),
            ),
          n.createElement(
            'div',
            { className: N.groupCell },
            n.createElement(
              'span',
              { className: N.text, style: l, onClick: i },
              o,
            ),
            a &&
              n.createElement(E.Icon, {
      ...
      function B(e) {
        const { content: t = [], title: o, cardRowClass: r } = e,
          l = t.map((e, t) => {
            const { title: o, content: r } = e;
            return n.createElement(
              'div',
              { key: `group${t}`, className: N.group },
              o && n.createElement('span', { className: N.groupTitle }, o),
              r.map((e, t) =>
        ...
        return n.createElement(
          'div',
          { className: r },
          n.createElement('span', { className: N.subtitle }, i),
      ...
      !(function (e) {
        ((e[(e.BeforeMarketOpen = N.beforeMarketOpen)] = 'BeforeMarketOpen'),
          (e[(e.AfterMarketClose = N.afterMarketClose)] = 'AfterMarketClose'));
      })(O || (O = {}));
      var F = o(36614);
      const _ = F;
      var P;
      function Y(e) {
        const {
          ...
          u = w()(s.content, t && s[t]),
          p = (0, n.useMemo)(
            () => (r && l ? { color: a?.color } : void 0),
            [!!r, !!l, a?.color],
          ),
          d = a ? { borderColor: a.color } : { borderStyle: 'none' };
        return n.createElement(
          'div',
          { className: s.wrap, style: d },
          n.createElement(
            'div',
            { className: u },
            r &&
      ...
      var M = o(51544);
      const A = (0, y.mergeThemes)(b.DEFAULT_MENU_THEME, {
          menuWrap: M.menuWrap,
          menuBox: M.menuBox,
        }),
        G = (0, y.mergeThemes)(_, { wrap: M.drawerItem }),
        Q = (0, y.mergeThemes)(_, { wrap: M.card });
      function j(e) {
        const {
            tooltips: t,
            onClose: o,
          ...
          x = (0, n.useRef)(null),
          S = (0, n.useRef)(null),
          [k, T] = (0, n.useState)('100%'),
          O = (e) => {
            null !== e && T(`${e.clientWidth}px`);
          },
          [N, D] = (0, n.useState)(!1);
        a(
          x,
        ...
        const B = { display: N ? 'block' : 'none', width: k },
          [W, F] = (0, n.useState)(!1);
        a(
          S,
          () => F(!1),
        ...
        const _ = { display: W ? 'block' : 'none', width: k };
        return (
          v(d),
          (0, n.useEffect)(() => o, []),
          (0, n.useEffect)(() => {
      ...
      function L(e) {
        ...
        return (
          ...
          r.render(n.createElement(j, { ...d }), I),
          {
            hide: H,
            isClickInside: (e) =>
              null !== R.current && R.current.contains(e.target),
          }
        );
      }
      function H() {
        null !== I && (r.unmountComponentAtNode(I), I.remove(), (I = null));
      }
      function X(e, t) {
