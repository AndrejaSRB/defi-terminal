...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8422],
  {
    ...
    63117: (e, t, i) => {
      ...
      var m;
      !(function (e) {
        e[(e.TextEditingJustFinishedTime = 100)] =
          'TextEditingJustFinishedTime';
      })(m || (m = {}));
      ...
      class b extends p.LineDataSource {
        constructor(e, t, n, s) {
          (super(e, t, n, s),
            (this._container = null),
            (this._activeEditingOwnerSource = null),
            ...
            (this._editingDeactivationTime = 0),
        ...
        editableTextStyle() {
          return { ...(this._isDarkBackground.value() ? g : T) };
        }
        ...
        topPaneViews(e) {
          return this._activeEditingOwnerSource &&
            e.hasDataSource(this._activeEditingOwnerSource) &&
        ...
        async _openTextEditor(e, t, n, r, a) {
          ...
          const { updateChartEditorText: l, closeChartEditorText: c } =
            await Promise.all([i.e(3637), i.e(2227), i.e(5592)]).then(
              i.bind(i, 44847),
            );
          if (null === this._container || this._isDestroyed) return;
          ((this._activeEditingOwnerSource = e),
          ...
          const T = this.isFixed()
              ? (0, s.ensureDefined)(this.fixedPoint(e))
              : (0, s.ensureNotNull)(
                  this.pointToScreenPoint(this._points[0], e),
                ),
            g = {
        ...
        _closeTextEditor(e) {
          null === this._container ||
            this._isDestroyed ||
            ((this._editingActivationTime = null),
            (this._editingDeactivationTime = performance.now()),
    ...
    22132: (e, t, i) => {
      ...
      const b = {
          ...
          color: h.colors.colorGrapesPurple500,
          fillBackground: !0,
          backgroundColor: h.colors.colorGrapesPurple500Alpha20,
          linewidth: P.DEFAULT_LINE_TOOL_LINE_WIDTH,
          transparency: 50,
          horzLabelsAlign: T.HorizontalAlign.Center,
          vertLabelsAlign: T.VerticalAlign.Middle,
          textColor: h.colors.colorGrapesPurple500,
          fontSize: 14,
          bold: !1,
          italic: !1,
          extendLeft: !1,
          ...
          middleLine: {
            showLine: !1,
            lineWidth: 1,
            lineColor: h.colors.colorGrapesPurple500,
        ...
        f = (0, u.extractThemedColors)(
          (0, n.ensureDefined)(w.get(d.StdTheme.Light)),
          (0, n.ensureDefined)(w.get(d.StdTheme.Dark)),
        ),
        y = (0, u.extractAllPropertiesKeys)(
          (0, n.ensureDefined)(w.get(d.StdTheme.Light)),
        ),
        v = (0, u.extractAllPropertiesKeys)(b),
        C = [
          ...new Set([
            ...y,
            ...v,
            ...g.commonLineToolPropertiesStateKeys,
            'text',
          ]),
        ],
        S = [...new Set([...y, ...v, 'text'])];
      class V extends m.LineDataSourceProperty {
        constructor(e) {
        ...
        static create(e, t, i) {
          return new this({
            ...
            factoryDefaultsSupplier: () =>
              (0, p.factoryDefaultsForCurrentTheme)(b, w),
            nonThemedDefaultsKeys: v,
      ...
      class D extends l.InplaceTextLineDataSource {
        ...
        setPoint(e, t, i) {
          ...
          if (this._snapTo45DegreesApplicable(i)) {
            ...
            if (e >= 4)
              return (
                this._correctMiddlePoints(e, t, i),
        ...
        snapPoint45Degree(e, t, i) {
          ...
          const a = this._model.timeScale(),
            l = (0, n.ensureNotNull)(this.pointToScreenPoint(e)),
            c = (0, n.ensureNotNull)(this.pointToScreenPoint(t)),
            d = l.x - c.x,
            h = l.y - c.y,
            u = d < 0 ? -1 : 1,
            p = h < 0 ? -1 : 1,
            _ = Math.max(Math.abs(d), Math.abs(h)),
            x = Math.round(a.coordinateToIndex(c.x + _ * u)),
            T = Math.abs(a.indexToCoordinate(x) - c.x),
            g = s.coordinateToPrice(c.y + T * p, r);
          ((e.index = x), (e.price = g));
        }
        ...
        _correctRightLeftMiddlePoint(e, t, i) {
          const o = (0, n.ensureNotNull)(this.pointToScreenPoint(t)),
            r = (0, n.ensureNotNull)(this.pointToScreenPoint(i)),
            a = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
            l = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[1]));
          let c = o.x - r.x;
          if (0 === c) return;
          const d = a.x < l.x ? 1 : -1,
            h = a.y < l.y ? 1 : -1;
          switch (((c *= d), e)) {
            case 4: {
              const e = l.y - (h * c) / 2,
                t = (0, n.ensureNotNull)(
                  this.screenPointToPoint(new s.Point(l.x, e)),
                );
              this._points[1].price = t.price;
              const i = (0, n.ensureNotNull)(
                this.screenPointToPoint(
                  new s.Point(a.x + d * c, a.y + (h * c) / 2),
                ),
              );
            ...
            case 5: {
              const e = a.y - (h * c) / 2,
                t = (0, n.ensureNotNull)(
                  this.screenPointToPoint(new s.Point(a.x, e)),
                );
              this._points[0].price = t.price;
              const i = (0, n.ensureNotNull)(
                this.screenPointToPoint(
                  new s.Point(l.x + d * c, l.y + (h * c) / 2),
                ),
              );
        ...
        _correctTopBottomMiddlePoint(e, t, i) {
          ...
          const a = this._model.timeScale(),
            l = r.firstValue();
          if (null === l) return;
          const c = (0, n.ensureNotNull)(this.pointToScreenPoint(t)),
            d = (0, n.ensureNotNull)(this.pointToScreenPoint(i)),
            h = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[0])),
            u = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[1])),
            p = c.y - d.y,
            _ = p < 0 ? -1 : 1,
            x = h.x < u.x ? 1 : -1,
            T = h.y < u.y ? 1 : -1;
          switch (e) {
            case 6: {
              const e = Math.floor(u.x - (x * p) / 2),
                t = (0, n.ensureNotNull)(
                  this.screenPointToPoint(new s.Point(e, u.y)),
                ),
              ...
              ((this._points[0].price = o.coordinateToPrice(h.y + c, l)),
                (this._points[0].index = this._points[0].index + r));
              break;
            }
            case 7: {
              const e = Math.floor(h.x - (x * p) / 2),
                t = (0, n.ensureNotNull)(
                  this.screenPointToPoint(new s.Point(e, h.y)),
                ),
              ...
              this._points[0].index = this._points[0].index - r;
              const c =
                _ * Math.abs(a.indexToCoordinate(this._points[0].index) - h.x);
        ...
        static _configureProperties(e) {
          (super._configureProperties(e),
            ...
            e.addChild(
              'textsColors',
              new c.LineToolColorsProperty([e.childs().textColor]),
            ),
        ...
        _getAnchorPointForIndex(e) {
          ...
          switch (e) {
            ...
            case 3:
              ...
              break;
            case 4:
              ((s = (n.price + i.price) / 2), (o = i.index));
              break;
            case 5:
              ((s = (n.price + i.price) / 2), (o = n.index));
              break;
            case 6:
              ((s = i.price), (o = (n.index + i.index) / 2));
              break;
            case 7:
              ((s = n.price), (o = (n.index + i.index) / 2));
          }
          return { index: o, price: s };
        }
    ...
    70031: (e, t, i) => {
      ...
      function l(e, t) {
        const i = r.watchedTheme.value() ?? a.StdTheme.Light,
          l = (0, s.default)(e);
        return ((0, n.default)(l, (0, o.ensureDefined)(t.get(i))), l);
      }
    },
  },
]);
