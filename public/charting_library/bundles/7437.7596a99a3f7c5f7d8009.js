(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7437],
  {
    43705: (e, t, r) => {
      ...
      const s = function (e, t) {
        ...
        var o = new Promise(function (n) {
          r = setTimeout(n, Math.min(2147483647, e), t);
        });
        return (
          (o[n.CANCEL] = function () {
            clearTimeout(r);
      ...
      function re(e) {
        return (void 0 === e && (e = n.SELF_CANCELLATION), X(B, e));
      }
      function ne(e) {
        void 0 === e && (e = u);
        for (
          ...
          r[n - 1] = arguments[n];
        return X(q, { selector: e, args: r });
      }
      function oe(e, t) {
        return X(K, { pattern: e, buffer: t });
      }
      var ie = ee.bind(null, s);
    },
    17443: (e, t, r) => {
      'use strict';
      r.d(t, {
        ...
        return (e) => {
          ...
          function u(t) {
            ...
            const h = u ? t.store : a.store,
              ...
              [b, O] = (0, c.useMemo)(() => {
                if (!L) return x;
                const e = T(h, u ? void 0 : a.subscription),
                ...
                () => (e) =>
                  b
                    ? (function (e, t, r, n, o, i, s, a, c, u, l) {
                      ...
                      })(L, h, b, m, C, w, A, R, I, O, e)
                    : () => {},
                [b],
              );
            var H, U, F;
            let $;
            ((H = M), (U = [C, w, A, i, I, O]), D(() => H(...U), F));
            try {
              $ = P(k, j, g ? () => m(g(), i) : j);
            } catch (e) {
              throw (
            ...
            D(() => {
              ((_.current = void 0), (I.current = void 0), (w.current = $));
            });
            const B = (0, c.useMemo)(
    ...
    46212: (e, t, r) => {
      'use strict';
      r.d(t, { buffers: () => a.I, default: () => z, eventChannel: () => I });
      var n = r(45807),
        o = r(15882),
        i = r(30950),
        s = r(17443),
      ...
      var L =
        ...
        (x[a.P] = function (e, t, r) {
          ...
          h(function () {
            ...
            i && (0, s.promise)(t) ? P(t, r) : r(t);
          });
        }),
        (x[a.A] = function (e, t, r, n) {
        ...
        (x[a.C] = function (e, t, r, n) {
          ...
          try {
            var l = i.apply(o, c);
            if ((0, s.promise)(l)) return void P(l, r);
            if ((0, s.iterator)(l))
              return void G(e, l, u.context, M, (0, a.j)(i), !1, r);
            r(l);
          } catch (e) {
            r(e, !0);
          }
        ...
        (x[a.F] = function (e, t, r, n) {
          ...
          g(function () {
            var t = G(e, d, l.context, M, f, u, void 0);
            u
              ? r(t)
              : t.isRunning()
        ...
        (x[a.d] = function (e, t, r) {
          var n = t.pattern,
            o = C(t.buffer),
            i = w(n),
            s = function t(r) {
              (D(r) || e.channel.take(t, i), o.put(r));
            },
            a = o.close;
          ((o.close = function () {
            (s.cancel(), a());
        ...
        (x[a.g] = function (e, t, r) {
          t.flush(r);
        }),
        (x[a.G] = function (e, t, r, n) {
          r(n.task.context[t]);
        }),
        (x[a.h] = function (e, t, r, n) {
          var o = n.task;
          ((0, a.p)(o.context, t), r());
        }),
        x);
      ...
      function j(e) {
        var t = e.name,
          r = e.location;
        return r ? t + '  ' + _(r.fileName, r.lineNumber) : t;
      }
      function k(e) {
        ...
        q = function () {
          var e = U[0],
            ...
            r = e.crashedEffect
              ? (function (e) {
                  var t = (0, a.v)(e);
                  return t ? t.code + '  ' + _(t.fileName, t.lineNumber) : '';
                })(e.crashedEffect)
              : null;
          return [
      ...
      function K(e, t, r, o, i, s, c) {
        ...
        function m(t, r) {
          if (r) {
            if (((h = 2), F({ meta: i, cancelledTasks: p }), S.isRoot)) {
              var o = q();
        ...
        var S =
          ...
          (l.toPromise = function () {
            return (
              g || ((g = u()), 2 === h ? g.reject(f) : 0 !== h && g.resolve(d)),
              g.promise
            );
          }),
      ...
      function G(e, t, r, o, i, c, u) {
        var l = e.finalizeRunEffect(function (t, r, o) {
          if ((0, s.promise)(t)) P(t, o);
          else if ((0, s.iterator)(t)) G(e, t, f.context, r, i, !1, o);
          else if (t && t[n.IO]) {
            (0, L[t.type])(e, t.payload, o, h);
          } else o(t);
        });
        g.cancel = a.t;
        var d = {
      ...
      function W(e, t) {
        var r = e.channel,
          ...
          f = void 0 === d ? a.D : d;
        for (
          var h = arguments.length, p = new Array(h > 2 ? h - 2 : 0), v = 2;
          v < h;
          v++
        )
          p[v - 2] = arguments[v];
        ...
        if (
          (u &&
            ((u.rootSagaStarted = u.rootSagaStarted || a.t),
            (u.effectTriggered = u.effectTriggered || a.t),
            (u.effectResolved = u.effectResolved || a.t),
            (u.effectRejected = u.effectRejected || a.t),
            (u.effectCancelled = u.effectCancelled || a.t),
            (u.actionDispatched = u.actionDispatched || a.t),
            u.rootSagaStarted({ effectId: S, saga: t, args: p })),
          l)
        ) {
          var b = a.B.apply(void 0, l);
          m = function (e) {
        ...
        return g(function () {
          var e = G(O, y, c, S, (0, a.j)(t), !0, void 0);
          return (u && u.effectResolved(S, e), e);
        });
      }
      const Y = function (e) {
          var t,
    ...
    29885: (e, t, r) => {
          ...
          c(
            {
              q1: function () {
                return {
                  nextState: 'q2',
                  effect: { done: !1, value: (0, o.U)(t, (0, o.V)(1)) },
                  stateUpdater: g,
                };
              },
              q2: function () {
              ...
              q3: function () {
                return {
                  ...
                  effect:
                    ((e = l),
                    { done: !1, value: o.M.apply(void 0, [r].concat(s, [e])) }),
                };
                var e;
              },
              q4: function () {
      ...
      function l(e, t, r) {
        for (
          ...
          i[s - 3] = arguments[s];
        return o.M.apply(void 0, [u, e, t, r].concat(i));
      }
    },
    6047: (e, t, r) => {
      'use strict';
        ...
        try {
          !(function (e) {
            Object.keys(e).forEach(function (t) {
              ...
              if (void 0 === r(void 0, { type: d.PROBE_UNKNOWN_ACTION() }))
      ...
      var o = (function (e) {
        ...
        return function () {
          ...
          var i = 0,
            ...
            u = e(function () {
              for (var e = [], t = a.length, r = 0; r < t; r++)
                e.push(a[r].apply(null, arguments));
        ...
        return {
          ...
          y: E
            ...
            : (() => {
                ...
                return (
                  p() && i && (e += (window.devicePixelRatio - 1) * S),
                  e
                );
              })(),
        };
          ...
          ((this.getSourceClientOffset = (e) => {
            ...
            (this.handleTopMoveEndCapture = (e) => {
              ((this._isScrolling = !1),
                ...
                (function (e) {
                  return void 0 === e.buttons || !(e.buttons & s);
                })(e) &&
    ...
    94212: (e, t, r) => {
      ...
      function b(e) {
        return function (t = [], r = { publishSource: !0 }) {
          ...
          if (null == c) return void e.dispatch(S);
          let u = null;
          if (o) {
          ...
          e.dispatch(m(o, u));
          const f = a.getSource(c).beginDrag(s, c);
          if (null == f) return;
          (!(function (e) {
            (0, l.invariant)(d(e), 'Item must be an object.');
          })(f),
            a.pinSource(c));
          const g = a.getSourceType(c);
          return {
            type: h,
            payload: {
              itemType: g,
          ...
          o.forEach((o, i) => {
            const s = (function (e, t, r, n) {
                ...
                ((function (e) {
                  ...
                  void 0 === i && (i = 0 === t ? {} : n.getDropResult()));
                return i;
              })(o, i, n, r),
              a = { type: v, payload: { dropResult: E({}, t, s) } };
            e.dispatch(a);
          });
        };
      }
        ...
        return function (t, { clientOffset: r } = {}) {
          ...
          return (
            (function (e, t, r) {
              for (let n = e.length - 1; n >= 0; n--) {
                const o = e[n];
                D(t.getTargetType(o), r) || e.splice(n, 1);
              }
            })(n, i, o.getItemType()),
            (function (e, t, r) {
              ((0, l.invariant)(
              ...
              for (let t = 0; t < e.length; t++) {
                ...
                (0, l.invariant)(o, 'Expected targetIds to be registered.');
              }
            })(n, o, i),
            (function (e, t, r) {
              e.forEach(function (e) {
            ...
            { type: p, payload: { targetIds: n, clientOffset: r || null } }
          );
        };
      }
      function I(e) {
        return function () {
          if (e.getMonitor().isDragging()) return { type: g };
        };
      }
      class N {
        receiveBackend(e) {
      ...
      const R = 'undefined' != typeof global ? global : self,
        ...
        U = new (class {
          create(e) {
            const t = this.freeTasks,
              r = t.length
                ? t.pop()
                : new k(this.onError, (e) => (t[t.length] = e));
            return ((r.task = e), r);
          }
          constructor(e) {
            ((this.onError = e), (this.freeTasks = []));
          }
        })(H.registerPendingError);
      const F = 'dnd-core/ADD_SOURCE',
        $ = 'dnd-core/ADD_TARGET',
        B = 'dnd-core/REMOVE_SOURCE',
        q = 'dnd-core/REMOVE_TARGET';
      function K(e, t) {
        t && Array.isArray(e)
          ? e.forEach((e) => K(e, !1))
          : (0, l.invariant)(
      ...
      class V {
        addSource(e, t) {
          ...
          const r = this.addHandler(G.SOURCE, e, t);
          return (
            this.store.dispatch(
              (function (e) {
        ...
        addTarget(e, t) {
          ...
          const r = this.addHandler(G.TARGET, e, t);
          return (
            this.store.dispatch(
              (function (e) {
                return { type: $, payload: { targetId: e } };
              })(r),
            ),
            r
          );
        ...
        getSource(e, t = !1) {
          (0, l.invariant)(this.isSourceId(e), 'Expected a valid source ID.');
        ...
        getTarget(e) {
          return (
            (0, l.invariant)(this.isTargetId(e), 'Expected a valid target ID.'),
        ...
        removeSource(e) {
          var t;
          ((0, l.invariant)(this.getSource(e), 'Expected an existing source.'),
            this.store.dispatch(
              (function (e) {
                return { type: B, payload: { sourceId: e } };
              })(e),
            ),
            (t = () => {
              (this.dragSources.delete(e), this.types.delete(e));
            }),
            H.enqueueTask(U.create(t)));
        }
        removeTarget(e) {
          ((0, l.invariant)(this.getTarget(e), 'Expected an existing target.'),
            this.store.dispatch(
              (function (e) {
                return { type: q, payload: { targetId: e } };
              })(e),
            ),
        ...
        pinSource(e) {
          ...
          ((0, l.invariant)(t, 'Expected an existing source.'),
        ...
        addHandler(e, t, r) {
          ...
          return (
            ...
            e === G.SOURCE
              ...
              : e === G.TARGET && this.dropTargets.set(n, r),
            n
          );
        }
        constructor(e) {
      ...
      function ie(e = oe, t) {
        ...
        switch (t.type) {
          ...
          case g:
            return ne({}, e, { isSourcePublic: !0 });
          case p:
            return ne({}, e, { targetIds: r.targetIds });
          case q:
      ...
      function le(e = {}, t) {
        return {
          ...
          dragOffset: te(e.dragOffset, t),
          refCount: se(e.refCount, t),
          dragOperation: ie(e.dragOperation, t),
          stateId: ae(e.stateId),
        };
        var r, n, o;
      }
      function de(e, t = void 0, r = {}, n = !1) {
        const o = (function (e) {
            const t =
              'undefined' != typeof window &&
      ...
      var ye = (0, fe.memo)(function (e) {
        ...
        const [o, i] = (function (e) {
          ...
          const t = (function (e, t = me(), r, n) {
              const o = t;
              o[ve] || (o[ve] = { dragDropManager: de(e, t, r, n) });
              return o[ve];
        ...
        return (
          ...
          (0, n.jsx)(he.DndContext.Provider, { value: o, children: t })
        );
      });
      function me() {
    ...
    16812: (e, t, r) => {
        ...
        const o = (0, h.useDragDropManager)(),
          ...
          a = (function (e) {
            return (0, s.useMemo)(() => {
              const t = e.type;
              return (
                (0, n.invariant)(null != t, 'spec.type must be defined'),
                t
              );
            }, [e]);
          })(e);
      ...
      function O(e, t) {
        ...
        return (
          b(r, u, l),
          [(0, o.useCollectedProps)(r.collect, u, l), a(l), c(l)]
        );
      }
    },
    68788: (e, t, r) => {
