(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5572],
  {
    ...
    5164: (e) => {
      e.exports = {
        placeHolder: 'placeHolder-ylwae_Gt',
        hidden: 'hidden-ylwae_Gt',
      };
    },
    22536: (e) => {
      e.exports = {
        wrapper: 'wrapper-K4u4Ng3Z',
        title: 'title-K4u4Ng3Z',
        additionalButton: 'additionalButton-K4u4Ng3Z',
        buttons: 'buttons-K4u4Ng3Z',
        text: 'text-K4u4Ng3Z',
        button: 'button-K4u4Ng3Z',
      };
    },
    43970: (e) => {
      e.exports = {
    ...
    14543: (e, t, r) => {
      'use strict';
      r.d(t, { LightButton: () => o.LightButton });
      r(8025);
      var o = r(15893);
      (r(50959), r(21593), r(66860), r(78457), r(11985));
      r(49406);
    },
    8025: (e, t, r) => {
      'use strict';
      r.d(t, { useLightButtonClasses: () => d });
      var o = r(50959),
        n = r(97754),
        a = r.n(n),
        i = r(17946),
      ...
      const c = o.createContext({ isInButtonGroup: !1, isGroupPrimary: !1 }),
        d = (e, t, r) => {
          const n = (0, o.useContext)(i.CustomBehaviourContext),
            {
              className: d,
              isSelected: u,
              children: p,
            ...
            A = (0, o.useContext)(l.ControlGroupContext),
            { isInButtonGroup: T, isGroupPrimary: H } = (0, o.useContext)(c);
          return a()(
            d,
            e.lightButton,
            w && e.link,
            E && e.active,
            u && e.selected,
            (0, s.isIconOnly)(p, f) && e.noContent,
            !!B && e.withStartSlot,
            (m || !!_) && e.withEndSlot,
            r && e.withGrouped,
            h && e[h],
    ...
    66860: (e, t, r) => {
      ...
      const m = (e) =>
        o.createElement(l.Icon, {
          className: a()(p().caret, e && p().activeCaret),
          icon: d(),
        });
      function h(e) {
        const {
        ...
        return o.createElement(
          ...
          h &&
            o.createElement(
              'span',
              { className: a()(p().slot, p().startSlot) },
              h,
            ),
          !(0, s.isIconOnly)(d, r) &&
            o.createElement(
              'span',
              {
                ...
                'data-overflow-tooltip-text': c ?? (0, i.getTextForTooltip)(d),
              },
              l || n
                ? o.createElement(
                    o.Fragment,
                    ...
                    o.createElement(
                      ...
                      {
                        className: a()(
                          !l && n && p().ellipsisContainer,
                          l && p().textWrapContainer,
                          l && n && p().textWrapWithEllipsis,
                        ),
                      },
                      d,
                    ),
    ...
    15893: (e, t, r) => {
      ...
      var o = r(50959),
        ...
        d = r.n(c);
      function u(e) {
        const { isGrouped: t } = o.useContext(n.ControlGroupContext),
          {
            reference: r,
            className: s,
            isSelected: c,
          ...
          P = S ? (E ?? 2) : 1,
          k =
            P > 0 ? { ...B, '--ui-lib-light-button-content-max-lines': P } : B;
        return o.createElement(
          'button',
          {
            ...H,
    ...
    86332: (e, t, r) => {
      'use strict';
      r.d(t, { ControlGroupContext: () => o });
      const o = r(50959).createContext({
        isGrouped: !1,
    ...
    21593: (e, t, r) => {
      ...
      var o = r(50959),
        n = r(38952);
      function a(e) {
        return o.createElement('a', { ...(0, n.renameRef)(e) });
      }
      o.PureComponent;
    },
    17946: (e, t, r) => {
    ...
    19250: (e, t, r) => {
      'use strict';
      r.d(t, { Portal: () => c, PortalContext: () => d });
      var o = r(50959),
        n = r(32227),
        a = r(25931),
        i = r(67961),
        ...
        render() {
          ...
          return (
            ...
            this.props.shouldTrapFocus &&
              ...
              e.setAttribute(s.FOCUS_TRAP_DATA_ATTRIBUTE, 'true'),
            this.props['aria-hidden'] && e.setAttribute('aria-hidden', 'true'),
            n.createPortal(
              o.createElement(d.Provider, { value: this }, this.props.children),
              e,
            )
          );
        }
    ...
    34094: (e, t, r) => {
      'use strict';
      r.d(t, { getTextForTooltip: () => i });
      var o = r(50959);
      const n = (e) => (0, o.isValidElement)(e) && Boolean(e.props.children),
        a = (e, t = !0) =>
    ...
    53017: (e, t, r) => {
      ...
      r.d(t, { isomorphicRef: () => n, mergeRefs: () => o });
    },
    67961: (e, t, r) => {
      'use strict';
    ...
    65718: (e, t, r) => {
      'use strict';
      r.d(t, { Portal: () => o.Portal, PortalContext: () => o.PortalContext });
      var o = r(19250);
    },
    65551: (e, t, r) => {
      'use strict';
      r.d(t, { TooltipWidget: () => d, TooltipWizard: () => c });
      var o = r(50959),
        n = r(97754),
        a = r(9745),
        i = r(65718),
      ...
      class c extends o.PureComponent {
        ...
        _getArrowDirectionClass() {
          const { popperChildrenProps: e } = this.props;
          switch (e.placement) {
            case 'left':
            case 'left-start':
              return n(
                l['arrowHolder--after'],
                l['arrowHolder--after-ltr-fix'],
              );
            case 'top':
              return n(l['arrowHolder--above'], l['arrowHolder--above-fix']);
            case 'bottom':
            case 'bottom-start':
            case 'bottom-end':
            ...
            default:
              return n(
                l['arrowHolder--before'],
                l['arrowHolder--before-rtl-fix'],
              );
          }
        }
      }
      function d(e) {
        ...
        return o.createElement(
          'div',
          { ...x, className: t, ref: c, style: d, 'data-role': y },
          u && o.createElement('div', { className: p, ref: m, style: f }),
          o.createElement(
            'div',
            { className: n(l.container, r) },
            o.createElement('div', { className: n(l.content, i) }, g),
            h &&
    ...
    22391: (e) => {
      e.exports = { hintReference: 'hintReference-Mk5NbP1J' };
    },
    18299: (e, t, r) => {
      'use strict';
      (r.r(t), r.d(t, { showActivationHint: () => v }));
      var o = r(50959),
        n = r(32227),
        a = r(11542),
        i = r(97754),
      ...
      function u(e) {
        const {
          ...
          text: u,
          buttonText: p,
          additionalButtonText: m,
          onAdditionalClick: h,
          title: f,
          theme: g = d,
          containerClassName: y,
          arrowClassName: x,
          additionalButtonClassName: v,
          onClose: b,
          buttonSize: w = 'xsmall',
          buttonReference: C,
          onButtonFocus: S,
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement('div', { className: g.text }, u),
            o.createElement(
              'div',
              { className: g.buttons },
              h &&
                ...
                o.createElement(
                  c.LightButton,
                  {
                    variant: 'ghost',
                    color: 'gray',
                    className: i(g.additionalButton, v),
                    size: w,
                    onClick: h,
                  },
                  m,
      ...
      const m = {
        getHintState: (e, t) => {
          if (!e || t) return !0;
          const r = p.getBool(e);
          return window.is_authenticated && (r || void 0 === r);
        },
        setHintState: (e) => {
          e && p.setValue(e, !1, { forceFlush: !0 });
        },
      };
      var h = r(5164);
      const f = o.forwardRef((e, t) => {
        const {
            ...
            title: w,
            onAdditionalClick: C,
            additionalButtonText: S,
            additionalButtonClassName: E,
            escapeWithReference: B,
            overflowPadding: _,
            boundariesElement: N,
            hintStateHandler: A = m,
            containerClassName: T,
            hideWithReference: H = !1,
            enableFlip: P = !0,
            forceShowOnInit: k,
            onOpenedStateChanged: O,
            forceHide: W,
            placeHolderStyle: L,
            buttonSize: D,
            saveHintStateByClick: R = !0,
            saveHintStateByAdditionalClick: V = !0,
            onButtonFocus: z,
            buttonDataName: Q,
            isArrowHidden: I = !1,
          } = e,
          ...
          [G, j] = (0, o.useState)(() => A.getHintState(c, k)),
          [M, U] = (0, o.useState)(!1),
          [Z, K] = (0, o.useState)(Boolean(W)),
          q = (0, o.useRef)(null),
          J = (0, o.useRef)(null),
          $ = (0, o.useRef)(null),
          ee = (0, o.useRef)(null),
          te = (0, o.useMemo)(
            () => ({
              close(e = !1) {
                (j(!1), e && A.setHintState(c));
              },
              getPopperRef: () => q,
              getPlaceholderRef: () => $,
              getButtonRef: () => ee,
              update: () => J.current?.update(),
            }),
            [A],
          );
        if (
          ((0, o.useImperativeHandle)(t, () => te, [te]),
          (0, o.useEffect)(
            () => (
              G &&
                ((Y.current = r.e(7553).then(r.bind(r, 46503))),
                Y.current.then((e) => {
                  Y.current && F(e);
                })),
              () => {
          ...
          (0, o.useEffect)(() => {
            null !== q.current &&
              (q.current.style.pointerEvents = Z ? 'none' : '');
          }, [Z]),
          (0, o.useEffect)(() => K(Boolean(W)), [W]),
          (0, o.useEffect)(() => O?.(Boolean(G)), [G]),
          G && X)
        ) {
          const { Manager: e, Reference: t, Popper: r } = X;
          return o.createElement(
            e,
            null,
            o.createElement(t, null, (e) =>
              o.createElement('div', {
                style: L,
                ref: (0, s.mergeRefs)([e.ref, $]),
                className: i(h.placeHolder, a, M && l),
              }),
            ),
            o.createElement(
              r,
              {
                ...
                modifiers: [
                  ...
                  },
                  {
                    name: 'flip',
                    enabled: P,
                    options: { fallbackPlacements: ['left', 'bottom'] },
                  },
                  {
                    ...
                    fn: (e) => {
                      const { state: t } = e,
                        r = Boolean(t.modifiersData.hide?.isReferenceHidden);
                      Z !== r && K(r);
                    },
                  },
                ],
              ...
              (e) => (
                ...
                o.createElement(g, {
                  ...
                  title: w,
                  theme: n,
                  arrowClassName: i((I || Z) && h.hidden),
                  containerClassName: i(T, Z && h.hidden),
                  onClick: x ? void 0 : re,
                  buttonSize: D,
                  onAdditionalClick: oe,
                  additionalButtonText: S,
                  additionalButtonClassName: E,
                  buttonReference: ee,
                  onButtonFocus: z,
                  buttonDataName: Q,
                  onClose: x ? re : y ? ne : void 0,
                })
              ),
            ),
          );
        ...
        function ne() {
          const { saveHintStateByOnClose: t = !1 } = e;
          (te.close(t), v && v());
        }
      });
      function g(e) {
        const { setSmallSize: t, popperChildrenProps: r, ...n } = e;
        return (
          (0, o.useLayoutEffect)(() => {
            t(r.placement && r.placement.startsWith('bottom'));
          }, [t, r]),
          o.createElement(u, { ...n, popperChildrenProps: r })
        );
      }
      var y = r(22391);
      const x = { ...m, getHintState: (e) => !e || p.default.getBool(e, !0) };
      function v(e, t) {
        const i = document.createElement('div');
        i.classList.add(y.hintReference);
        function s() {
        ...
        (n.render(
          o.createElement(f, {
            placement: 'bottom',
            text: a.t(null, void 0, r(27947)),
            buttonText: a.t(null, void 0, r(32519)),
            settingsHintKey: 'hint.chartFloatingTooltipActivationHint',
            hintStateHandler: x,
            isArrowHidden: !0,
            onClick: () => {
              (t.signal.removeEventListener('abort', s), s());
            },
          }),
          i,
        ),
