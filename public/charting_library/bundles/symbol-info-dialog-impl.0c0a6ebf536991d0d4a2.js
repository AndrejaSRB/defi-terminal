(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9374],
  {
    24674: (e) => {
      e.exports = {
        brand: 'brand-H6_2ZGVv',
        hovered: 'hovered-H6_2ZGVv',
        background: 'background-H6_2ZGVv',
        'states-without-bg': 'states-without-bg-H6_2ZGVv',
        disableActiveStateStyles: 'disableActiveStateStyles-H6_2ZGVv',
        dimmed: 'dimmed-H6_2ZGVv',
        selected: 'selected-H6_2ZGVv',
        activated: 'activated-H6_2ZGVv',
        gray: 'gray-H6_2ZGVv',
        'light-gray': 'light-gray-H6_2ZGVv',
        xsmall: 'xsmall-H6_2ZGVv',
        small: 'small-H6_2ZGVv',
        medium: 'medium-H6_2ZGVv',
        large: 'large-H6_2ZGVv',
        textButton: 'textButton-H6_2ZGVv',
        link: 'link-H6_2ZGVv',
        content: 'content-H6_2ZGVv',
        withStartIcon: 'withStartIcon-H6_2ZGVv',
        'start-icon': 'start-icon-H6_2ZGVv',
        withEndIcon: 'withEndIcon-H6_2ZGVv',
        'end-icon': 'end-icon-H6_2ZGVv',
        iconOnly: 'iconOnly-H6_2ZGVv',
        caret: 'caret-H6_2ZGVv',
        semibold18px: 'semibold18px-H6_2ZGVv',
        semibold16px: 'semibold16px-H6_2ZGVv',
        semibold14px: 'semibold14px-H6_2ZGVv',
        regular12px: 'regular12px-H6_2ZGVv',
        regular14px: 'regular14px-H6_2ZGVv',
        regular16px: 'regular16px-H6_2ZGVv',
      };
    },
    51284: (e) => {
      e.exports = {
      ...
      function l(e) {
        ...
        return (
          (0, r.useIsomorphicLayoutEffect)(() => {
            const e = { click: t, mouseDown: o, touchEnd: l, touchStart: s },
              n = c ? c.current : u.current;
            return (0, i.addOutsideEventListener)(d.current, n, a, document, e);
          }, [t, o, l, s, a]),
          c || u
        );
      }
      ...
      const n = (() => {
        ...
        return () => {
          if (void 0 === e) {
            ...
            (t.parentNode?.removeChild(t), (e = n - i));
          }
          return e;
        };
      })();
    ...
    87896: (e, t, o) => {
      ...
      function d(e, t, o = 'legacy') {
        const l = n.createElement(u, { renderMode: o }, e);
        if ('modern' === o) {
          ...
          return (
            ...
            {
              render(t) {
                e.render(n.createElement(u, { renderMode: o }, t));
              },
              unmount() {
                e.unmount();
              },
        ...
        return (
          ...
          {
            render(e) {
              r.render(n.createElement(u, { renderMode: o }, e), t);
            },
            unmount() {
    ...
    29562: (e, t, o) => {
      'use strict';
      o.d(t, { SymbolSearchFlag: () => g });
      var n = o(50959),
        r = o(97754),
        i = o.n(r),
        l = o(24633),
        s = o(36279);
      const a = o.p + 'mock-dark.16b5f3a431f502b03ae3.svg',
        c = o.p + 'mock-light.d201313017eb2c1b989f.svg';
      function u(e) {
        return e === l.StdTheme.Dark ? a : c;
      }
      var d = o(77975),
        m = o(45345),
        p = o(50151);
      const v = s.LogoSize.Medium;
      var h = o(85448);
      function g(e) {
        const {
            country: t,
          ...
          g = (0, d.useWatchedValueReadonly)({ watchedValue: m.watchedTheme }),
          [y, f] = (0, n.useState)(
            (function ({
              country: e,
              providerId: t,
              ...
              return (i) => {
                const l = (e) => r.getProviderLogoUrl(e, v),
                  s = [
                    { value: n, resolve: (e) => r.getSymbolLogoUrl(e, v) },
                    { value: o, resolve: l },
                    {
                      value: e,
                      resolve: (e) => r.getCountryFlagUrl(e.toUpperCase(), v),
                    },
                    { value: t, resolve: l },
            ...
            })({ country: t, providerId: r, sourceId: l, sourceLogoId: a })(g),
          );
        return n.createElement('img', {
          className: i()(c, 'apply-common-tooltip', h.icon),
          crossOrigin: '',
          'data-tooltip': o,
          src: y,
          onError: function () {
    ...
    65718: (e, t, o) => {
      'use strict';
      o.d(t, { Portal: () => n.Portal, PortalContext: () => n.PortalContext });
      var n = o(19250);
    },
    41954: (e) => {
      e.exports = {
      ...
      const s = l,
        a = n.forwardRef((e, t) => {
          const {
            ...
            V = r(S, w.button, {
              'apply-common-tooltip': Boolean(b || x),
              'common-tooltip-vertical': Boolean(x) && 'vertical' === I,
              [w.isActive]: c,
              [w.isOpened]: u,
              [w.isInteractive]: (E || Boolean(g)) && !d && !m,
              [w.isDisabled]: Boolean(d || m),
              [w.isGrouped]: p,
              [w.hover]: v,
              [w.clicked]: h,
              [w.pressed]: B,
            ...
            C =
              s &&
              ('string' == typeof s
                ? n.createElement(i.Icon, { className: w.icon, icon: s })
                : n.cloneElement(s, {
                    className: r(w.icon, s.props.className),
                  }));
          return 'button' === o
            ? n.createElement(
                'button',
            ...
            : n.createElement(
                ...
                a && n.createElement(i.Icon, { icon: a, className: l.endIcon }),
                N,
              );
        });
    },
    46069: (e, t, o) => {
      'use strict';
      (o.r(t), o.d(t, { SymbolInfoDialogImpl: () => fe }));
      var n = o(50959),
        r = o(97754),
        i = o.n(r),
        l = o(11542),
        ...
        m = o.n(d);
      const p = (e) => {
        const t = (0, n.useContext)(a.CustomBehaviourContext),
          {
            className: o,
            isSelected: r,
            isDimmed: l,
      ...
      function v(e) {
        return n.createElement(
          ...
          n.createElement('span', {
            className: i()(
              m().background,
              e.statesWithoutBg && m()['states-without-bg'],
            ),
          }),
          e.startIcon &&
            n.createElement(s.Icon, {
              ...e.startIconAriaAttrs,
              className: m()['start-icon'],
              icon: e.startIcon,
            }),
          n.createElement('span', { className: m().content }, e.children),
          (e.endIcon || e.showCaret) &&
            ((e) =>
              n.createElement(s.Icon, {
                ...(e.showCaret ? void 0 : e.endIconAriaAttrs),
                className: i()(m()['end-icon'], e.showCaret && m().caret),
      ...
      class b extends n.PureComponent {
        ...
        render() {
          ...
          return this.props.source
            ...
            .value()
            ? null
            : n.createElement(f.FullSessionScheduleRenderer, {
                className: e,
      ...
      function k(e, t = {}) {
        const {
          initialDelay: n = B,
          leaveOnMouseOut: r,
          withoutThumbsupIcon: i,
          text: s = l.t(null, void 0, o(23339)),
        } = t;
        ((0, _.showOnElement)(e, {
          below: !0,
          tooltipDelay: n,
          content: {
            type: 'html',
            data: `${s}${i ? '' : ` <span style="vertical-align: middle;">${x}</span>`}`,
          },
        }),
          document.addEventListener('scroll', N),
          document.addEventListener('touchstart', N),
          r || document.addEventListener('mouseout', N));
      }
      var V = o(81662),
        C = o(47531),
        A = o(68182),
        ...
        M = o(41954);
      function G(e) {
        const { onClose: t, isOpened: i, groups: s, statusProvider: a } = e,
          [c, u] = (0, n.useState)(!1),
          d = (0, n.useRef)(null),
          m = (0, n.useRef)(null),
          p = c ? A : C;
        return (
          ...
          n.createElement(g.AdaptivePopupDialog, {
            ref: d,
            className: M.dialog,
            isOpened: i,
            title: l.t(null, void 0, o(17502)),
            onClose: t,
            onClickOutside: t,
            dataName: 'symbol-info-dialog',
            render: function ({ requestResize: e }) {
              return (
                (m.current = e),
                n.createElement(
                  'div',
                  { className: M.wrap, 'data-symbol-info-dialog-content': !0 },
                  v(),
                  s.flat().length &&
                    a &&
                    n.createElement('div', {
                      className: r(M.separator, M.widgetSeparator),
                    }),
                  a &&
                    n.createElement(
                      n.Fragment,
                      ...
                      n.createElement(
                        'div',
                        { className: M.sessionHeader },
                        n.createElement(
                          'span',
                          { className: M.title },
                          l.t(null, void 0, o(94031)),
                        ),
                        n.createElement(
                          h,
                          {
                          ...
                          l.t(null, void 0, o(17606)),
                        ),
                      ),
                      n.createElement(b, {
                        source: a,
                        showAllDays: c,
                        className: M.sessionWidget,
                        timeZoneClassName: M.timeZone,
                      }),
                    ),
                )
              );
            ...
            ? s.map((e, t) =>
                e.length
                  ? n.createElement(
                      ...
                      n.createElement(
                        'div',
                        { className: 0 === t ? M.firstGroup : void 0 },
                        (function (e) {
                          const t = [];
                          for (let o = 0; o < e.length; o += 2)
                            t.push(e.slice(o, o + 2));
                          return t.map((e, t) =>
                            n.createElement(L, { key: t, fields: e }),
                          );
                        })(e),
                      ),
                      t !== s.length - 1 &&
                        n.createElement('div', {
                          className: r(M.separator, M.groupSeparator),
                        }),
                    )
                  : null,
              )
          ...
          e.fields.map((e, t) => {
            const o = (function (e) {
              ...
              return !1 === e.capitalize || Array.isArray(t)
                ? t
                : (0, V.capitalizeFirstLetter)(t);
            })(e);
            return Array.isArray(o)
              ? n.createElement(D, { key: t, field: e, fieldValue: o })
              : n.createElement(O, { key: t, field: e, fieldValue: o });
          }),
        );
      }
      function D(e) {
        const { field: t, fieldValue: o } = e,
          r = (0, n.useMemo)(
            () =>
              o
                .map((e) => {
        ...
        return n.createElement(
          'div',
          { className: M.item },
          n.createElement('span', { className: M.title }, t.title),
          n.createElement(
            'div',
            { className: M.multipleLinks },
            n.createElement(P, {
              value: U(i),
            ...
            l.length
              ? n.createElement(
                  ToolWidgetMenu,
                  {
                    ...
                    content: n.createElement(s.Icon, { icon: dotsIcon }),
                  },
                  l.map((e) =>
                    n.createElement(PopupMenuItem, {
                      suppressToolboxClick: !1,
                      onClick: () => window.open(e.href),
                      label: U(e),
                      key: e.href,
                      toolbox: n.createElement(s.Icon, {
                        className: M.icon,
                        icon: H,
                      }),
                    }),
      ...
      function P(e) {
        const { value: t, canCopy: i, link: a, startSlot: c, endSlot: u } = e,
          d = (0, n.useRef)(null),
          m = a ? 'a' : 'div',
          p = '-' !== t;
        return n.createElement(
          'div',
          { className: M.valueItem },
          c && p && n.createElement('div', { className: M.startSlot }, c),
          n.createElement(
            m,
            { href: a, target: '_blank', className: r(a && M.link) },
            n.createElement('span', { ref: d }, t),
            a && n.createElement(s.Icon, { icon: H, className: M.icon }),
          ),
          i &&
            p &&
            n.createElement(w.ToolWidgetButton, {
              className: M.copyButton,
              onClick: async function () {
                (await (0, S.copyToClipboard)({ text: t }),
                  d.current &&
                    (k(d.current, {
                      initialDelay: 0,
                      leaveOnMouseOut: !0,
                      text: l.t(null, void 0, o(17254)),
                    }),
                    I()));
              },
              icon: Z,
            }),
          u && p && n.createElement('div', { className: M.endSlot }, u),
        );
      }
      var F = o(22613),
        Q = o(53107),
        R = o(57025);
      const z = new F.WatchedValue(!1);
      class T {
        constructor(e) {
          ((this._symbolInfo = new F.WatchedValue(null)),
            (this._quotesProvider = new R.QuotesProvider('simple')),
            ...
            (this._marketStatusModel = new Q.MarketStatusModel(
      ...
      var X = o(55279),
        q = o(37103);
      function $(e, t) {
        const o = Math.floor(t / 1e4) % 1e4,
          n = (Math.floor(t / 100) % 100) - 1,
          r = t % 100;
        return e.format(new Date(Date.UTC(o, n, r)));
      }
      var j = o(29562),
        K = o(25770);
      function Y(e) {
        return n.createElement(j.SymbolSearchFlag, { ...e, className: K.icon });
      }
      var J = o(95059),
        ee = o(50151),
        te = o(67563),
        oe = o(97514);
      const ne = new Set(['cfd', 'etf', 'reit', 'etn', 'dr', 'cdi']);
      function re(e, t) {
      ...
      function le(e, t) {
        const { minmov: n, pricescale: r, fractional: i, minmove2: s } = e;
        if (void 0 === n || void 0 === r) return null;
        if (i && r && n)
          return s
            ? l.t(
                null,
                {
                  ...
                  replace: { minmove2: String(s), pricescale: String(r / s) },
                },
                o(13197),
              )
            : `${n}/${r}`;
        const { variable_tick_size: a, ...c } = e;
        return (0, J.createSeriesFormatter)(c, 'default').format(n / r);
      }
      function se(e, t) {
        const { type: o = '', typespecs: n = [] } = e;
        return [o, ...n.filter((e) => oe.VISIBLE_TYPESPECS.has(e))]
          .map((e) => (ne.has(e) ? e.toUpperCase() : e))
          .join(' ');
      }
      function ae(e, t) {
        return !1;
      ...
      function ve(e) {
        ...
        return n.createElement(
          'span',
          { className: i()(t, pe.label) },
          n.createElement(s.Icon, { className: pe.icon, icon: me }),
          n.createElement(
            'span',
            { className: pe.text },
            l.t(null, void 0, o(54602)),
          ),
        );
      }
      var he = o(88145);
      ...
      class fe {
        ...
        async show(e) {
          ...
          const i = (function (e) {
            ...
            return [
              {
                title: l.t(null, void 0, o(99709)),
                group: 1,
                propName: 'name',
                getEndSlot: (e) => {
                  if ((0, he.isSymbolDelisted)(e.typespecs))
                    return n.createElement(ve, null);
                },
              },
              {
                title: l.t(null, void 0, o(78734)),
                group: 1,
                propName: 'description',
              },
              {
                title: l.t(null, void 0, o(12272)),
                group: 1,
              ...
              {
                title: l.t(null, void 0, o(99804)),
                group: 1,
                propName: 'sector',
                visibility: (e, t) => de.has(e.type ?? '') && !!t?.sector,
              },
              {
                title: l.t(null, void 0, o(7727)),
                group: 1,
                propName: 'industry',
                visibility: (e, t) => de.has(e.type ?? '') && !!t?.industry,
              },
              {
                title: l.t(null, void 0, o(88104)),
                group: 1,
              ...
              {
                title: l.t(null, void 0, o(98413)),
                group: 2,
                propName: 'type',
                getter: se,
              },
              {
                title: l.t(null, void 0, o(88191)),
                group: 2,
                propName: 'expiration',
                visibility: ue,
              ...
              {
                title: l.t(null, void 0, o(81314)),
                group: 2,
                propName: 'pointvalue',
              },
              {
                title: l.t(null, void 0, o(22415)),
                group: 2,
                propName: 'listed_exchange',
                visibility: ce,
                getStartSlot: (e, o) => {
                  const r = o?.country_code ?? e.country,
                    i = e.exchange_logo;
                  return t
                    ? n.createElement(Y, {
                        country: r,
              ...
              {
                title: l.t(null, void 0, o(86905)),
                group: 2,
                propName: 'exchange',
                visibility: ce,
                getter: J.getSymbolListedExchange,
              },
              {
                title: l.t(null, void 0, o(97751)),
                group: 2,
                propName: 'source',
              ...
              {
                title: l.t(null, void 0, o(91563)),
                group: 2,
                propName: 'value_unit_id',
                getter: (t, o) => e.unitDescription((0, J.measureUnitId)(t)),
                visibility: (t, o) =>
                  Boolean(
                    (0, J.measureUnitId)(t) &&
          ...
          ((0, X.getAdditionalSymbolInfoFields)().forEach((e) => {
            ...
            this._renderDialog(this._createDialogProps(i, r)));
        }
        static getInstance() {
        ...
        _retrieveValues(e, t, o) {
          const n = o ?? t;
          for (let r = 0; r < e.length; r++) {
            const i = e[r].getter,
              l = e[r].getStartSlot?.(t, o),
              s = e[r].getEndSlot?.(t, o);
            if ((l && (e[r].startSlot = l), s && (e[r].endSlot = s), i)) {
              const n = i(t, o);
              null !== n && this._setFieldValue(e[r], n);
              continue;
            }
            const a = e[r].propName,
              c = a in n ? a : void 0;
            if (void 0 !== c) {
              const t = n[c];
              this._setFieldValue(
                e[r],
                (e[r].formatter || this._defaultFormatter)(t),
              );
            }
          }
          this._removeHiddenFields(t, e, o);
        }
        _removeHiddenFields(e, t, o) {
    ...
    97514: (e, t, o) => {
      'use strict';
      o.d(t, { VISIBLE_TYPESPECS: () => l, marketType: () => s });
      var n = o(11542);
      const r = new Map([
        ['cfd', () => n.t(null, void 0, o(79599))],
        ['dr', () => n.t(null, void 0, o(47268))],
        ['index', () => n.t(null, void 0, o(87464))],
        ['forex', () => n.t(null, void 0, o(17770))],
        ['right', () => n.t(null, { context: 'symbol_type' }, o(53174))],
        ['bond', () => n.t(null, void 0, o(42358))],
        ['bitcoin', () => n.t(null, void 0, o(46128))],
        ['crypto', () => n.t(null, void 0, o(46128))],
        ['economic', () => n.t(null, void 0, o(54094))],
        ['indices', () => n.t(null, void 0, o(90250))],
        ['futures', () => n.t(null, void 0, o(4723))],
        ['stock', () => n.t(null, void 0, o(76752))],
        ['commodity', () => n.t(null, void 0, o(70932))],
      ]);
      o(40167);
      const i = new Map(),
        l = new Set([
