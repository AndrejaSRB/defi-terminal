(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [91],
  {
    ...
    2031: (e) => {
      e.exports = { en: ['Main symbol data is adjusted for dividends only'] };
    },
    95739: (e) => {
      e.exports = { en: ['Main symbol data is adjusted for splits only'] };
    },
    27665: (e) => {
    ...
    1e4: (e) => {
      e.exports = { en: ['Toggle Log Scale'], hu_HU: ['Váltás Log Skála'] };
    },
    81649: (e) => {
      e.exports = { en: ['Toggle Percentage'], hu_HU: ['Váltás Százalék'] };
    },
    77073: (e) => {
