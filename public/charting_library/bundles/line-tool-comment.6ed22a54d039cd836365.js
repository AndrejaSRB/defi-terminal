  ...
  [3966],
  {
    67046: (e, t, r) => {
      ...
      var n,
        ...
        C = r(20820),
        x = r(58221);
      class b extends C.MediaCoordinatesPaneRenderer {
        constructor() {
        ...
        hitTest(e) {
          ...
          const {
            ...
            i = t.x,
            o = t.y - n,
            s = (0, T.box)(new T.Point(i, o), new T.Point(i + r, o + n));
          return (0, m.pointInBox)(e, s)
        ...
        _drawImpl(e) {
          ...
          const t = e.context,
            ...
            d = r.y - i;
          (t.translate(l, d),
            (0, x.drawRoundRect)(t, 0, 0, n, i, [a, a, a, 2]),
            (t.fillStyle = o),
            t.fill(),
            (t.strokeStyle = s),
            (t.lineWidth = 2),
      ...
      class R extends p.InplaceTextLineSourcePaneView {
        constructor(e, t, r, n, i) {
          (super(e, t, r, n),
            ...
            (this._renderer = new f.CompositeRenderer()),
      ...
      class w extends l.LineToolBalloon {
        ...
        _createDataSourceBackgroundColorWV() {
          const e = (0, i.generateColorCached)(),
            { backgroundColor: t, transparency: r } =
    ...
    3156: (e, t, r) => {
      r.d(t, { generateColorCached: () => s });
      var n = r(59332),
        i = r(52859),
        o = r(16659);
      function s(e = 1e3) {
        const t = n.default.Cache;
        n.default.Cache = o.CircularCacheBuffer.bind(o.CircularCacheBuffer, e);
        const r = (0, n.default)(
          i.generateColor,
          (e, t, r) => `${e}_${t}_${r}`,
        );
        return ((n.default.Cache = t), r);
      }
    },
  },
]);
