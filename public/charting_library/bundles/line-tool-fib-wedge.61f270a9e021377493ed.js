  ...
  [3314],
  {
    67725: (e, t, i) => {
      ...
      const l = new n.TranslatedString(
        ...
        g = r.t(null, void 0, i(61856)),
        v = r.t(null, void 0, i(87430));
      function y(e, t, i, r, n) {
        ...
        return (
          void 0 !== t.showLine &&
            (y.checked = (0, s.convertToDefinitionProperty)(
              e,
              t.showLine,
              l.format({ toolName: i }),
            )),
          void 0 !== t.lineWidth &&
            (y.width = (0, s.convertToDefinitionProperty)(
              e,
              t.lineWidth,
              a.format({ toolName: i }),
            )),
          void 0 !== t.lineStyle &&
            (y.style = (0, s.convertToDefinitionProperty)(
              e,
              t.lineStyle,
              d.format({ toolName: i }),
            )),
          void 0 !== t.lineColor &&
            (y.color = (0, s.getColorDefinitionProperty)(
              e,
              t.lineColor,
              null,
              c.format({ toolName: i }),
          ...
          void 0 !== t.extendLeft &&
            ((y.extendLeft = (0, s.convertToDefinitionProperty)(
              e,
              t.extendLeft,
              h.format({ toolName: i }),
            )),
            (P.extendLeftTitle = (n && n.extendLeftTitle) || g)),
          void 0 !== t.leftEnd &&
            (y.leftEnd = (0, s.convertToDefinitionProperty)(
              e,
              t.leftEnd,
              u.format({ toolName: i }),
            )),
          void 0 !== t.extendRight &&
            ((y.extendRight = (0, s.convertToDefinitionProperty)(
              e,
              t.extendRight,
              p.format({ toolName: i }),
            )),
            (P.extendRightTitle = (n && n.extendRightTitle) || v)),
          void 0 !== t.rightEnd &&
            (y.rightEnd = (0, s.convertToDefinitionProperty)(
              e,
              t.rightEnd,
              _.format({ toolName: i }),
            )),
          (0, s.createLinePropertyDefinition)(y, P)
        );
      }
    },
    14472: (e, t, i) => {
      ...
      const _ = s.t(null, void 0, i(40091)),
        ...
        g = s.t(null, void 0, i(92516)),
        v = s.t(null, void 0, i(70320)),
        y = s.t(null, void 0, i(21429)),
      ...
      class b {
        ...
        _createTextPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'text', v) : null;
        }
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'inputs', y) : null;
        }
    ...
    40226: (e, t, i) => {
      ...
      class f extends o.DefaultProperty {
        constructor(e) {
          const { levelsIterator: t = p, map: i = {}, ...r } = e,
            n = { ...a, ...i };
          ...
          return i
            ...
            : ((n = r),
              ...
              (0, this._levelsIterator)(
                n,
                { tpl: h, fill: d, typecheck: s.typecheck.pack },
                s,
              ));
          var n, s;
        }
    ...
    69878: (e, t, i) => {
      ...
      var r = i(50151),
        ...
        s = i(63117),
        o = i(22613);
      class l extends s.InplaceTextLineDataSource {
        constructor() {
          (super(...arguments),
            ...
            try {
              if (((this._recursiveGuard = !0), 2 === e)) {
                ...
                const i = (0, r.ensureNotNull)(
                  ...
                  .length();
                let s = t.subtract(e);
                (s.length() <= 0 && (s = new n.Point(1, 0)),
                  (t = e.add(s.normalized().scaled(i))));
                const o = (0, r.ensureNotNull)(this.screenPointToPoint(t)),
                  l = this._pointsProperty.childs().points[1];
                (l.childs().price.setValue(o.price),
                  l.childs().bar.setValue(o.index));
              } else {
                const e = (0, r.ensureNotNull)(
                    this.pointToScreenPoint(this._points[0]),
                  ),
        ...
        addPoint(e) {
          if (2 === this._points.length) {
            ...
            const l = (0, r.ensureNotNull)(this.ownerSource()),
              ...
              d = (0, r.ensureNotNull)(this.priceScale()).coordinateToPrice(
                n.y,
                a,
              );
            e = {
    ...
    24745: (e, t, i) => {
      ...
      var r = i(50151),
        ...
        h = i(25672),
        u = i(73914);
      class p extends o.LineToolPaneViewFibWithLabels {
        constructor() {
          (super(...arguments),
            (this._renderer = null),
            (this._levels = []),
        ...
        _updateImpl(e) {
          ...
          const [t, i, s] = this._points,
            ...
            l = s.subtract(t).normalized(),
            a = new n.Point(1, 0),
            d = new n.Point(0, 1);
          let c = Math.acos(o.dotProduct(a));
          o.dotProduct(d) < 0 && (c = 2 * Math.PI - c);
          ...
          for (let e = 1; e <= this._source.levelsCount(); e++) {
            const n = 'level' + e,
              s = (0, r.ensureDefined)(u.child(n));
            if (!s.childs().visible.value()) continue;
            const a = s.childs().coeff.value(),
              d = s.childs().color.value(),
              c = Math.abs(i.subtract(t).length() * a),
              h = o.add(l).scaled(0.5).normalized().scaled(c),
              p = t.add(h);
            this._levels.push({
              coeff: a,
              color: d,
        ...
        _updateRenderer(e = NaN, t = NaN) {
          ...
          const i = new d.CompositeRenderer(),
            ...
            [n, o] = this._points,
            l = r.trendline.childs().visible.value()
              ? r.trendline.childs().linewidth.value()
              : 0,
            p = r.trendline.childs().linestyle.value();
          if (
            (this._baseTrendRenderer.setData({
              points: [n, o],
              color: r.trendline.childs().color.value(),
              linewidth: l,
              linestyle: p,
              extendleft: !1,
              extendright: !1,
          ...
          const f = _.pointIndex,
            g = o.subtract(n).length(),
            v = _.subtract(n).normalized();
          ((_ = n.add(v.scaled(g))),
            (_.pointIndex = f),
          ...
          for (let n = this._levels.length - 1; n >= 0; n--) {
            const o = this._levels[n],
              l = new c.ArcWedgeRenderer();
            (l.setData({
              center: this._points[0],
              radius: o.radius,
              prevRadius: n > 0 ? this._levels[n - 1].radius : 0,
              color: o.color,
              ...
              p1: o.p1,
              p2: o.p2,
              fillBackground: r.fillBackground.value(),
              transparency: r.transparency.value(),
              color1: '',
              color2: '',
            }),
              l.setHitTest(
                new a.HitTestResult(a.HitTarget.MovePoint, void 0, o.index),
              ),
              i.append(l));
    ...
    39653: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolFibWedge: () => A }));
      var r = i(50151),
        n = i(11542),
        s = i(95804),
        o = i(69878),
      ...
      const f = new s.TranslatedString(
        ...
        w = n.t(null, void 0, i(28683)),
        S = n.t(null, void 0, i(79468)),
        C = n.t(null, void 0, i(79650));
      class D extends u.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
          ...
          for (let i = 1; i <= d; i++) {
            const r = t[`level${i}`].childs(),
              s = (0, h.createLeveledLinePropertyDefinition)(
                {
          ...
          e.push(u);
          const D = (0, h.createTransparencyPropertyDefinition)(
            {
              checked: (0, h.convertToDefinitionProperty)(
                this._propertyApplier,
                t.fillBackground,
      ...
      var L = i(24745);
      const N = new s.TranslatedString(
        'erase level line',
      ...
      class A extends o.LineToolFibWedgeBase {
        constructor(e, t, i, r) {
          (super(
            e,
        ...
        processErase(e, t) {
          const i = `level${t}`,
            n = (0, r.ensureDefined)(this.properties().child(i)).childs()
              .visible;
          e.setProperty(n, !1, N, d.lineToolsDoNotAffectChartInvalidation);
        }
        ...
        static _configureProperties(e) {
          ...
          for (let n = 1; n <= 11; n++) {
            const s = (0, r.ensureDefined)(e.child(`level${n}`));
            (t.push(s.childs().linewidth), i.push(s.childs().color));
          }
    ...
    11795: (e, t, i) => {
      ...
      class l extends o.MediaCoordinatesPaneRenderer {
        constructor() {
          (super(...arguments),
            (this._data = null),
        ...
        hitTest(e) {
          ...
          if (this._data.fillBackground && i <= this._data.radius) {
            const e = this._data.p1.subtract(this._data.center).normalized(),
              ...
              s = r.dotProduct(e),
              o = r.dotProduct(i);
            if (s >= n && o >= n) return this._backHitTest;
          }
          return null;
        }
        _drawImpl(e) {
