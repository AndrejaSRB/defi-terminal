  ...
  [986, 1277],
  {
    2268: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        d = i(43838),
        c = i(39612);
      const h = o.t(null, void 0, i(6060));
      function u(e) {
        const t = (t, i) => {
      ...
      class _ extends a.LineSourcePaneView {
        ...
        closeTextEditor() {
          this._closeTextEditorImpl();
        }
        _closeTextEditorImpl(e) {
          ((this._textWasEdited = !1),
            (this._isTextEditModeActivated = !1),
            this._hideTextEditor?.(e));
        }
        _placeHolderMode(e) {
          return (
            ...
            !(0, c.lastMouseOrTouchEventInfo)().isTouch &&
        ...
        _isTextBeingEdited() {
          return this._textWasEdited;
        }
        _textData() {
          return this._text() || (this._textWasEdited ? '​' : h);
        }
        _textColor() {
        ...
        _activateEditMode(e) {
          (this._showTextEditor?.(
            (0, n.ensureNotNull)(this._getOwnerSource()),
            e,
            this._textInfo,
            h,
            this._closeTextEditorImpl.bind(this),
          ),
    ...
    63117: (e, t, i) => {
      ...
      class S extends _.LineDataSource {
        constructor(e, t, n, o) {
          (super(e, t, n, o),
        ...
        editableTextStyle() {
          return { ...(this._isDarkBackground.value() ? T : x) };
        }
        ...
        async _openTextEditor(e, t, n, r, a) {
          ...
          const x = this.isFixed()
              ? (0, o.ensureDefined)(this.fixedPoint(e))
              : (0, o.ensureNotNull)(
    ...
    54707: (e, t, i) => {
      ...
      function p(e, t) {
        ...
        return (
          ...
          s >= _.deg337_5 ||
          s < _.deg22_5 ||
          (s >= _.deg157_5 && s < _.deg202_5)
            ? d.PaneCursorType.HorizontalResize
            : (s >= _.deg22_5 && s < _.deg67_5) ||
                (s >= _.deg202_5 && s < _.deg247_5)
              ? d.PaneCursorType.DiagonalNwSeResize
              : (s >= _.deg67_5 && s < _.deg112_5) ||
                  (s >= _.deg247_5 && s < _.deg292_5)
                ? d.PaneCursorType.VerticalResize
                : (s >= _.deg112_5 && s < _.deg157_5) ||
                    (s >= _.deg292_5 && s < _.deg337_5)
      ...
      class x {
        ...
        createLineAnchor(e, t) {
          ...
          const o = (0, s.lastMouseOrTouchEventInfo)().isTouch,
    ...
    73914: (e, t, i) => {
      ...
      class T extends h.BitmapCoordinatesPaneRenderer {
        constructor(e) {
        ...
        _drawPoints(e, t, i, o, r) {
          const {
            ...
            h = (0, s.ensureNotNull)(this._data),
            u = h.radius;
          let _ = Math.max(1, Math.floor((h.strokeWidth || 2) * d));
          h.selected && (_ += Math.max(1, Math.floor(d / 2)));
          ...
          for (let e = 0; e < t.length; ++e) {
            ...
            if (
              !(
                ...
                h.linePointBeingEdited === s.pointIndex
              )
            ) {
              l.fillStyle = i[e];
              if (
                ...
                if (
                  ...
                  s.pointIndex === h.hoveredPointIndex
                ) {
