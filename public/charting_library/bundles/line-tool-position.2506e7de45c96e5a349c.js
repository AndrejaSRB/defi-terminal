...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1314],
  {
    ...
    69593: (e, t, r) => {
      var i = r(52974).LineToolTrading,
        o = r(41414).LineDataSource,
        s = r(17721).LineToolTradingPriceAxisView,
        n = r(32853),
        l = r(78176).DefaultProperty;
      const u = r(37103),
        a = r(40472).sourceChangeEvent;
      var h = r(67777).sortSourcesPreOrdered.LineToolPosition;
      function p(e) {
        return (null == e ? (e = '') : (e += ''), e);
      }
      class d {
        ...
        setBodyBorderSellColor(e) {
          return (
            this._line.properties().bodyBorderSellColor.setValue(e),
            this
          );
        }
        ...
        setBodyTextPositiveColor(e) {
          return (
            this._line.properties().bodyTextPositiveColor.setValue(e),
            this
          );
        }
        setBodyTextNegativeColor(e) {
          return (
            this._line.properties().bodyTextNegativeColor.setValue(e),
            this
          );
        }
        setBodyTextNeutralColor(e) {
          return (
            this._line.properties().bodyTextNeutralColor.setValue(e),
            this
          );
        }
        getBodyFont() {
        ...
        setQuantityBorderBuyColor(e) {
          return (
            this._line.properties().quantityBorderBuyColor.setValue(e),
            this
          );
        }
        setQuantityBorderSellColor(e) {
          return (
            this._line.properties().quantityBorderSellColor.setValue(e),
            this
          );
        }
        ...
        setCloseButtonIconBuyColor(e) {
          return (
            this._line.properties().closeButtonIconBuyColor.setValue(e),
            this
          );
        }
        setCloseButtonIconSellColor(e) {
          return (
            this._line.properties().closeButtonIconSellColor.setValue(e),
            this
          );
        }
        block() {
      ...
      class _ extends i {
        constructor(e, t) {
          ...
          (super(e, i),
            ...
            Promise.all([r.e(6290), r.e(986), r.e(6668), r.e(1583)])
              .then(r.t.bind(r, 48762, 19))
