(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8604],
  {
    ...
    67268: (e) => {
      e.exports = { desktopTimeInput: 'desktopTimeInput-cW0jHi4o' };
    },
    56718: (e) => {
    ...
    27365: (e, t, n) => {
      'use strict';
      n.d(t, { getChartTimezoneOffsetMs: () => r, getTimezoneName: () => a });
      var s = n(37236);
      function a(e) {
    ...
    15499: (e, t, n) => {
      ...
      const a = () => [
          ...
          s.t(null, { context: 'day_of_week' }, n(23230)),
    ...
    44313: (e, t, n) => {
      ...
      class f extends s.PureComponent {
        ...
        render() {
          ...
          return s.createElement(
            o.LightButton,
            {
              ...
              className: a(e, this.props.forceHover && u.hover),
              disabled: this.props.isDisabled,
              reference: this.props.reference,
              tabIndex: this.props.tabIndex,
              'aria-label': (0, g.getDayAriaLabel)(this.props.day),
              'aria-selected': t,
        ...
        _isBetweenByDay(e, t, n) {
          const s = (0, p.resetToDayStart)(e),
            a = (0, p.resetToDayStart)(t),
            r = (0, p.resetToDayStart)(n);
          return s < a && a < r;
        }
      }
      const m = 7;
      function v(e) {
        ...
        return s.createElement(
          'div',
          { role: 'row', className: r()(u.week, _) },
          n.map((e, r) =>
            s.createElement(f, {
              key: e.toDateString(),
              day: e,
              isDisabled: i(e),
              isSelected: !!g && (0, d.isSameDay)(e, g),
              onClick: D,
              onHover: y,
              highlightedFrom: l,
              highlightedTo: c,
              forceHover: F && C && e >= F && e <= C,
              reference: p(e),
              tabIndex: (0, d.isSameDay)(e, o) ? 0 : -1,
              onFocus: () =>
                (function (e) {
                  (w?.(e), (0, d.isSameDay)(e, o) && h(e));
                })(e),
              showFocusRing: a,
              todayDate: b,
              isAnotherMonth: !(0, d.isSameMonth)(e, v),
              ariaColIndex: 0 === t ? m - n.length + r + 1 : void 0,
            }),
          ),
        );
      }
      ...
      function w({
        ...
        const [c, h] = (0, D.useRefsMap)(),
          p = (0, s.useCallback)((t) => (t ? (e(t) ? null : t) : null), [e]),
          g = (0, s.useCallback)(
            (n, s) => {
              if (!n) return null;
              const a = (0, d.getCloneDateWithOffset)({
                dateFrom: n,
                offset: s,
                isDisabledDate: e,
                level: u,
      ...
      function b(e) {
        const {
          ...
          N = (0, s.useCallback)(() => r[0].days[0], [r]),
          T = (0, s.useCallback)(() => {
          ...
          H = (0, d.getDateInTabOrder)({
            selectedDate: t ?? new Date(),
            dateToFocus: a,
            currentlyFocused: Y,
            firstEnabledDate: (0, d.getFirstEnabledDay)(r, x),
            getFirstDate: N,
            getLastDate: T,
            isDisabledDate: x,
          });
        return (
          (0, s.useEffect)(() => {
            b.current = (H && I.current.get(H)) || null;
          }, [H, b]),
          s.createElement(
            s.Fragment,
            null,
            s.createElement(
              ...
              (0, g.getWeekDaysMin)().map((e) =>
                s.createElement('span', { key: e }, e),
              ),
            ),
            s.createElement(
              'div',
              { className: u['view-month'], tabIndex: -1, ...V },
              s.createElement(
                'div',
      ...
      function _(e) {
        ...
        const T = (0, s.useMemo)(() => (0, C.default)(t, F), [t]);
        return s.createElement(
          s.Fragment,
          null,
          s.createElement(
            'div',
            { className: u['sub-header'], 'aria-hidden': !0 },
            s.createElement('span', null, (0, g.getSubHeaderYear)()),
          ),
          s.createElement(
            'div',
            { role: 'grid', className: u['view-year'], ...k },
            T.map((e, t) =>
              s.createElement(
                'div',
                { key: t, role: 'row', className: u['grid-row'] },
                e.map(({ title: e, ariaLabel: t, date: a }) => {
                  const r = (0, d.isSameMonth)(a, n),
                    l = v(a),
                    c = r ? 'quiet-primary' : 'ghost';
                  return s.createElement(
                    o.LightButton,
                    {
                      key: a.toDateString(),
                      ...
                      onClick: () => p(a),
                      reference: M(a),
                      tabIndex: (0, d.isSameMonth)(a, N) ? 0 : -1,
                      onFocus: (0, d.isSameMonth)(a, N) ? () => E(a) : void 0,
      ...
      function S(e) {
        ...
        (0, s.useEffect)(() => {
          p.current = (T && _.current.get(T)) || null;
        }, [T, p]);
        const x = (0, s.useMemo)(() => (0, C.default)(t, M), [t]);
        return s.createElement(
          s.Fragment,
          null,
          s.createElement(
            'div',
            { className: u['sub-header'], 'aria-hidden': !0 },
            s.createElement('span', null, (0, g.getSubHeaderDecades)()),
          ),
          s.createElement(
            'div',
              ...
              s.createElement(
                ...
                e.map((e) => {
                  const t = e.getFullYear(),
                    a = (0, d.isSameYear)(e, n),
                    i = D(e),
                    l = a ? 'quiet-primary' : 'ghost';
                  return s.createElement(
                    o.LightButton,
                    {
                      key: e.toDateString(),
                      ...
                      onClick: () => f(e),
                      reference: S(e),
                      tabIndex: (0, d.isSameYear)(e, T) ? 0 : -1,
                      onFocus: (0, d.isSameYear)(e, T) ? () => k(e) : void 0,
                      'aria-selected': a,
                    },
                    t,
                  );
      ...
      function E({
        ...
        const [f, m] = (0, s.useState)(e),
          [v, D] = (0, s.useState)(g.CalendarViewType.Month),
          [y, w] = (0, s.useState)(t ? e : null),
          b = (0, s.useMemo)(() => (0, d.getDecadesStart)(f), [f]),
          C = (0, s.useCallback)(
            (e) => {
              const t = new Date(f),
                n = (0, g.getNextMonth)(f),
                s = new Date(n.getFullYear(), n.getMonth() + e, 0).getDate(),
                a = f.getDate() > s ? s : f.getDate();
          ...
          _ = (0, s.useCallback)(
            (e) => {
              const t = new Date(b);
              (t.setFullYear(t.getFullYear() + e), m(t), u && u(t));
            },
            [b, f, u],
          ),
          M = (0, s.useCallback)(
            (e, t) => {
              switch ((t && w(t), v)) {
                case g.CalendarViewType.Month:
                  return C(1 * e);
                case g.CalendarViewType.Year:
                  return F(1 * e);
                case g.CalendarViewType.Decades:
                  return _(e * g.DECADES_YEARS_AMOUNT);
              }
            },
            [v, C, F, _],
          ),
          S = (0, s.useCallback)((e) => M(-1, e), [M]),
          E = (0, s.useCallback)((e) => M(1, e), [M]),
          k = (0, s.useCallback)(() => {
            const e = Object.values(g.CalendarViewType);
            let t = e.indexOf(v) + 1;
            (t >= e.length && (t = 0), D(e[t]), c && c(e[t]));
          }, [v]),
          N = (0, s.useCallback)(
            (e) => {
          ...
          x = (0, s.useCallback)(
            (e) => {
              ...
              (n.setFullYear(e.getFullYear()),
                w(n),
                D(g.CalendarViewType.Year));
            },
            [f, o, k],
          ),
          I = (0, s.useMemo)(() => (0, d.getWeeks)(f, h), [f, h]),
          R = (0, s.useMemo)(
            () =>
              (function (e) {
                return (0, g.getMonthsShort)().map((t, n) => {
                  const s = (0, p.resetToMonthStart)(e);
                  return (
                    s.setMonth(n),
                    { title: t, ariaLabel: (0, g.getMonths)()[n], date: s }
                  );
                });
              })(f),
            [f],
          ...
          Y = (0, s.useMemo)(
            () =>
              (function (e) {
                const t = [];
                for (let n = 0; n < g.DECADES_YEARS_AMOUNT; n++) {
                  const s = new Date(e);
          ...
          P = (0, s.useMemo)(() => {
            switch (v) {
              case g.CalendarViewType.Month: {
                const e = I[I.length - 1].days,
                  t = new Date(e[e.length - 1]);
                return (t.setDate(t.getDate() + 1), !(0, d.isInRange)(t, a, r));
              }
              case g.CalendarViewType.Year: {
                const e = new Date(R[R.length - 1].date);
                return (
                  e.setMonth(e.getMonth() + 1),
                  !(0, d.isInRange)(e, a, r, 'month')
                );
              }
              case g.CalendarViewType.Decades: {
                const e = new Date(Y[Y.length - 1]);
                return (
                  e.setFullYear(e.getFullYear() + 1),
                  !(0, d.isInRange)(e, a, r, 'year')
                );
              }
            }
          }, [v, a, r, I, R, Y]),
          V = (0, s.useMemo)(() => {
            switch (v) {
              case g.CalendarViewType.Month: {
                const e = new Date(I[0].days[0]);
                return (e.setDate(e.getDate() - 1), !(0, d.isInRange)(e, a, r));
              }
              case g.CalendarViewType.Year: {
      ...
      const T = new (class {
        constructor() {
          ((this.isInited = !1),
            (this._politeQueue = new N('polite')),
            (this._assertiveQueue = new N('assertive')));
        }
        renderTo(e, t = !1) {
      ...
      function I({
        ...
        return {
          onPrevClick: (0, s.useCallback)(() => {
            (u(
              (0, g.getPrevLiveRegionConfirmation)(
                e,
                e === g.CalendarViewType.Decades ? t : n,
              ),
            ),
              a(null));
          }, [a, u]),
          onNextClick: (0, s.useCallback)(() => {
            (u(
              (0, g.getNextLiveRegionConfirmation)(
                e,
                e === g.CalendarViewType.Decades ? t : n,
              ),
            ),
          ...
          onSwitchViewType: (0, s.useCallback)(
            (s) => {
              (u(
                (0, g.getViewTypeLiveRegionConfirmation)(
                  e,
                  e === g.CalendarViewType.Year ? t : n,
                ),
              ),
                o(s));
            },
      ...
      function R(e) {
        ...
        const A = (0, s.useCallback)(
            (e) => {
              x &&
                38 === (0, y.hashFromEvent)(e) &&
                (e.preventDefault(), e.stopPropagation(), z(!1), x());
            },
            [x],
          ),
          $ = t ?? new Date(),
          ...
          })({ withFocusTrap: w, isPrevDisabled: G }),
          he = (0, s.useMemo)(() => U[0], [U]),
          {
            onPrevClick: pe,
            onNextClick: ge,
            onSwitchViewType: fe,
        ...
        return (
          (0, s.useImperativeHandle)(
            ...
            () => ({
              focus() {
                G ? le.current?.focus() : ie.current?.focus();
              },
              setViewDate: Q,
              setViewType: W,
            }),
          ...
          s.createElement(
            'div',
            {
              className: a(u.calendar, f && u.popupStyle, o),
              tabIndex: -1,
              onKeyDown: K,
            },
            s.createElement(c, {
              prevAriaLabel: (0, g.getPrevAriaLabel)(
                j,
                j === g.CalendarViewType.Decades ? he : B,
              ),
              nextAriaLabel: (0, g.getNextAriaLabel)(
                j,
                j === g.CalendarViewType.Decades ? he : B,
              ),
              currentAriaLabel: (0, g.getCurrentAriaLabel)(
                j,
                j === g.CalendarViewType.Year ? he : B,
              ),
              currentVisibleTitle: (0, g.getCurrentVisibleTitle)(
                j,
                j === g.CalendarViewType.Decades ? he : B,
              ),
              onPrevClick: pe,
            ...
            s.createElement('div', { className: u['slot-wrapper'] }, C),
            w && s.createElement('div', { tabIndex: 0, onFocus: de }),
          )
        );
      }
      !(function (e) {
    ...
    85528: (e, t, n) => {
      ...
      class y extends a.PureComponent {
        constructor(e) {
          (super(e),
            ...
            (this._onShowPicker = (e) => {
              if (((this._popupContainer = e), e && this._inputContainer)) {
            ...
            (this._onBlur = (e) => {
              (this._popupContainer &&
                this._popupContainer.contains(e.relatedTarget)) ||
                (this._inputContainer &&
                  this._inputContainer.contains(e.relatedTarget)) ||
                this.props.onBlur?.(e);
            }),
            (this.state = {
              value: e.value ?? '',
              updateValueKey: e.updateValueKey,
            }));
        }
        render() {
          const {
        ...
        static getDerivedStateFromProps(e, t) {
          return e.updateValueKey !== t.updateValueKey
            ? { value: e.value ?? '', updateValueKey: e.updateValueKey }
            : null;
        }
      }
                ...
                s && s.length
                  ...
                  : a.createElement(
                      ...
                      a.createElement(d.Icon, {
                        ...
                        className: r(D.icon, n && D.disabled),
                      }),
                    ),
              className: e,
      ...
      class M extends a.PureComponent {
        constructor(e) {
          (super(e),
            ...
            (this._isValid = (e) => {
              const t = M._dateFormatter.parse(e);
            ...
            (this._onBlur = (e) => {
              this.props.revertInvalidData &&
                !this._isValid(e.target.value) &&
                this.setState((e) => {
                  if (!e.isInvalid) return (this.props.onPick(e.date), e);
                  const t = new Date(this.state.date);
                  return (
                    this.props.onPick(t),
                    {
                      pickerInputValueKey: e.pickerInputValueKey + 1,
                      date: t,
                      isInvalid: !1,
                    }
                  );
            ...
            (this._onSelect = (e) => {
              (this.setState((t) => ({
                ...
                showCalendar: !1,
                isInvalid: !1,
                pickerInputValueKey: t.pickerInputValueKey + 1,
              })),
            ...
            (this._getErrors = () => {
              ...
              return (
                this.state.isInvalid && e.push(s.t(null, void 0, n(46420))),
                e
              );
            }));
          const t = new Date(),
            r = e.initial ?? t;
          this.state = {
            pickerInputValueKey: 0,
            date: r,
            showCalendar: !1,
            isInvalid: !this._isValid(M._dateFormatter.formatLocal(r)),
            autofocusCalendar: !1,
            initial: r,
          };
        }
        render() {
          ...
          return i.mobiletouch
            ? a.createElement(w, {
                value: M._dateFormatter.formatLocal(this.state.date),
                type: 'date',
                ...
                min:
                  this.props.minDate &&
                  M._dateFormatter.formatLocal(this.props.minDate),
                max:
                  this.props.maxDate &&
                  M._dateFormatter.formatLocal(this.props.maxDate),
                ...
                a.createElement(
                  y,
                  {
                    value: this.props.initial
                      ? M._dateFormatter.formatLocal(this.state.date)
                      : '',
                    inputRegex: /[0-9.]/,
                    ...
                    dataQaId: this.props.dataQaId,
                    updateValueKey: this.state.pickerInputValueKey,
                  },
                  a.createElement(u.Calendar, {
                    selectedDate: this.props.initial ? this.state.date : null,
        ...
        static getDerivedStateFromProps(e, t) {
          const n = new Date(),
            s = e.initial ?? n;
          return M._dateFormatter.formatLocal(t.initial) !==
            M._dateFormatter.formatLocal(s)
            ? {
                ...t,
                date: s,
                initial: s,
      ...
      ((M.defaultProps = { position: 'fixed', withCalendar: !0 }),
        (M._dateFormatter = new l.DateFormatter()));
    },
    76056: (e, t, n) => {
      'use strict';
      n.d(t, { DateInput: () => g });
          ...
          s.createElement(i.FormInput, {
            ...
            endSlot:
              ...
              s.createElement(
                ...
                s.createElement(r.Icon, { icon: h, className: g.icon }),
              ),
          }),
          t &&
            s.createElement(d, {
              text: a.t(null, void 0, n(27254)),
              className: g.tooltip,
            }),
        );
      }
    ...
    23935: (e, t, n) => {
      ...
      n.d(t, {
        addLocalTime: () => m,
        getCloneDateWithOffset: () => F,
        getDateInTabOrder: () => _,
        getDecadesStart: () => v,
        getFirstEnabledDay: () => w,
        getFirstEnabledMonth: () => b,
        getFirstEnabledYear: () => C,
        getWeeks: () => D,
        isDayDisabled: () => y,
        isInRange: () => h,
        isInvalidDateObj: () => p,
      ...
      function o(e, t) {
        return (
          !!t &&
          Number((0, a.resetToDayStart)(e)) ===
            Number((0, a.resetToDayStart)(t))
        );
      }
      function i(e, t) {
        return (
          !!t &&
          Number((0, a.resetToMonthStart)(e)) ===
            Number((0, a.resetToMonthStart)(t))
        );
      }
      function l(e, t) {
        return (
          !!t &&
          Number((0, a.resetToYearStart)(e)) ===
            Number((0, a.resetToYearStart)(t))
        );
      }
      function u(e) {
      ...
      const d = {
        day: a.resetToDayStart,
        month: a.resetToMonthStart,
        year: a.resetToYearStart,
      };
      function h(e, t, n, s = 'day') {
        const a = d[s],
      ...
      function f(e) {
        const t = new Date(e);
        return (t.setHours(t.getHours() + g(t)), t);
      }
      function m(e) {
        const t = new Date(e);
        return (t.setHours(t.getHours() - g(t)), t);
      ...
      function D(e, t) {
        const n = [];
        let s = (0, a.resetToWeekStart)((0, a.resetToMonthStart)(e), !0);
        for (let a = 0; a < 6; a++) {
          const a = [];
          for (let n = 0; n < 7; n++) {
            const r = new Date(s);
            (r.setDate(r.getDate() + n), (i(r, e) || t) && a.push(r));
          }
          (a.length && n.push({ week: u(s), days: a }), (s = new Date(c(s))));
        }
        return n;
      }
      function y({ day: e, minDate: t, maxDate: n, isDateDisabled: s }) {
        return !h(e, t, n) || (!!s && s(e));
      }
      function w(e, t) {
      ...
      function _({
        ...
        const i = h(e, a(), r(), 'day') && !o(e) ? e : null,
          l = t && h(t, a(), r(), 'day') && !o(t) ? t : null;
        return (n && h(n, a(), r(), 'day') && !o(n) ? n : null) || i || l || s;
      }
    },
    70412: (e, t, n) => {
      'use strict';
    ...
    42707: (e, t, n) => {
      'use strict';
      n.d(t, { useSafeMatchMedia: () => s.useSafeMatchMedia });
      var s = n(86781);
    },
    36565: (e, t, n) => {
      'use strict';
      ...
      var s = n(49483),
        ...
        g = n(39346);
      function f(e) {
        return a.createElement(h.Icon, { className: p.icon, icon: g });
      }
      var m = n(29202),
        v = n(56718);
      var D = n(89880),
      ...
      function _(e, t, n) {
        ...
        return (
          ...
          (0, a.useLayoutEffect)(() => {
            ...
            (h && (e.setSelectionRange(c, c), p(!1)), d(M(e)));
          }, [h]),
          [
            t,
            f,
                  ...
                  h = (function (e, t, n, s, a, r) {
                    if (e !== t) {
                      ...
                      let l = 0,
                        ...
                        h = 0;
                      for (h = s; h < o && a[h]; h++) u++;
                      for (h = s - 1; h >= 0 && a[h]; h--) l++;
                      for (h = s - 1; h >= 0; h--) a[h] && c++;
                      for (h = n - 1; h >= 0; h--) r[h] && d++;
                      if (s > i) s = 10 * o;
                      else if (n >= s && n !== i) {
                        if (r[s]) {
                          const e = s;
      ...
      function S(e) {
        ...
        return (
          ...
          a.createElement(d.InputControl, {
            ...r,
      ...
      const R = (() => {
        ...
        for (let t = 0; t < 24; ++t)
          for (let n = 0; n < 60; n += 15) {
            const [s, a] = [O(t.toString()), O(n.toString())],
              r = `${s}:${a}`,
              o = H(r) ? r : L(r);
            e.push(o);
          }
      ...
      const Y = 'desktop_time_input_item';
      function P(e) {
        if (void 0 !== e) return `${Y}_${e}`;
      }
      function V(e) {
        const [t = '', n = ''] = e.split(':'),
          [s, a] = [O(t), z(n)];
      ...
      function L(e) {
        const [t, n] = e.split(':'),
          [s, a] = [
            (0, b.clamp)(parseInt(t), 0, 23),
            (0, b.clamp)(parseInt(n), 0, 59),
          ],
          [r, o] = [O(s.toString()), z(a.toString())];
        return `${r}:${o}`;
      }
      function O(e) {
      ...
      const K = s.CheckMobile.any()
        ? function (e) {
            const {
              ...
              g = (0, a.useRef)(null),
              [D, y] = (0, m.useFocus)(),
              w = (0, u.createSafeMulticastEventHandler)(y.onBlur, function () {
                g.current && s && (g.current.defaultValue = s);
              });
            return (
              (0, a.useLayoutEffect)(() => {
                g.current && s && (g.current.defaultValue = s);
              ...
              (0, a.useLayoutEffect)(() => {
                g.current && s && (g.current.value = s);
              }, [s]),
              a.createElement(
                'div',
                {
                  'data-qa-id': 'time-input-wrapper',
                  className: o()(v.wrap, r),
                },
                a.createElement(d.InputControl, {
                  ...p,
                  type: 'text',
                  ...
                  onFocus: function (e) {
                    ((0, i.ensureNotNull)(g.current).focus(), n && n(e));
                  },
                  onChange: function () {},
                  dataQaId: (0, l.dataQaIds)('time-input', h),
                }),
                a.createElement('input', {
                  ...y,
                  disabled: e.disabled,
        ...
        : function (e) {
            ...
            const h = (0, a.useRef)(null),
              ...
              A =
                C ||
                te().some(
                  (e) => null !== e && e.contains(document.activeElement),
                );
            ((0, a.useLayoutEffect)(() => M(e.value), [e.value]),
              (0, a.useLayoutEffect)(() => K(O), [_, A]),
              (0, a.useEffect)(() => ne(z === O ? 'auto' : 'smooth'), [z]));
            const $ = A && s,
              B = (0, T.lowerbound)(R, O, (e, t) => e < t);
            let Q = R;
            R[B] !== O && ((Q = [...R]), Q.splice(B, 0, O));
            const j = (0, w.useOutsideEvent)({
                mouseDown: !0,
                touchStart: !0,
                handler: function (e) {
                  null !== p.current &&
              ...
              W = (0, x.useControlValidationLayout)({
                hasErrors: e.showErrorMessages && Y !== O,
                messagesPosition: x.MessagesPosition.Attached,
                errors: [D.t(null, { context: 'time_input' }, n(56525))],
              }),
              Z = (0, u.createSafeMulticastEventHandler)(function (t) {
                (setTimeout(se, 0), e.onFocus?.(t));
              }, W.onFocus),
              q = (0, u.createSafeMulticastEventHandler)(function (e) {
                G(e) || (r(t), J(_));
              }, W.onBlur);
            return a.createElement(
              'div',
              {
                className: o()(e.className, I.desktopTimeInput),
                onKeyDown: function (e) {
                  if (e.defaultPrevented) return;
                  const n = (0, E.hashFromEvent)(e.nativeEvent);
                  if (38 === n) {
                    if ((e.preventDefault(), $)) {
                      const e = (Q.indexOf(z) + Q.length - 1) % Q.length;
                      K(Q[e]);
                    }
                    t || r(!0);
                  }
              ...
              a.createElement(S, {
                dataQaId: (0, l.dataQaIds)('time-input', e.dataQaId),
                role: 'combobox',
                disabled: e.disabled,
                name: e.name,
                endSlot: a.createElement(
                  c.EndSlot,
                  { icon: !0 },
                  W.icon ?? a.createElement(f, null),
                ),
                reference: p,
                containerReference: (0, y.useMergedRefs)([
                  h,
                  W.containerReference,
                ]),
                mask: '09:00',
                value: _,
                onFocus: Z,
                onBlur: q,
                onMouseOver: W.onMouseOver,
                onMouseOut: W.onMouseOut,
                onChange: function (t) {
                  (M(t), e.onInput && e.onInput(t));
                },
                onKeyDown: function (n) {
                  if (n.defaultPrevented) return;
                  const s = (0, E.hashFromEvent)(n.nativeEvent);
                  13 === s &&
                    (n.preventDefault(),
                    J(z),
                    e.keepFocusOnKeyBoardNavigation ||
                      (0, i.ensureNotNull)(p.current).blur(),
                    t || r(!1));
                  27 === s &&
                    (n.preventDefault(),
                    e.keepFocusOnKeyBoardNavigation ||
              ...
              a.createElement(
                k.PopupMenu,
                {
                  ...
                  position: function () {
                    ...
                    let s = 231,
                      a = e.bottom;
                    if (s > n && s > t) {
                      const r = (0, b.clamp)(s, 0, n),
                        o = (0, b.clamp)(s, 0, t);
                      ((s = Math.max(r, o)),
                        (a = r > o ? e.top - r : e.bottom));
                    } else s > t && (a = e.top - s);
                    return {
                      x: e.left,
                      y: a,
                ...
                Q.map((e) =>
                  a.createElement(N.PopupMenuItem, {
                    key: e,
                    id: P(e),
                    role: 'option',
                    label: e,
            ...
            function J(t) {
              const n = V(t),
                s = H(n) ? n : L(n);
              (M(s), d || ((d = !0), e.onChange(s)));
            }
            function U(e) {
              v.current = e;
            }
            function X(e) {
              (J((0, i.ensureDefined)(e)),
                (0, i.ensureNotNull)(g.current).blur());
            }
            function G(e) {
              return (
                C &&
                (null !== ee(document.activeElement) ||
                  null !== ee(e.relatedTarget))
              );
            }
            function ee(e) {
              return (
                (e instanceof Node &&
                  te().find((t) => null !== t && t.contains(e))) ||
                null
              );
            }
            function te() {
              return [g.current, p.current];
            }
            function ne(e = 'auto') {
              if (null !== v.current) {
                ...
                (t.top > n.top || t.bottom < n.bottom) &&
                  v.current.scrollIntoView({ behavior: e });
              }
            }
            function se() {
              const e = p.current;
    ...
    10429: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="none"><path fill="currentColor" d="M10 6h8V4h1v2h1.5A2.5 2.5 0 0 1 23 8.5v11a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 5 19.5v-11A2.5 2.5 0 0 1 7.5 6H9V4h1zM6 19.5A1.5 1.5 0 0 0 7.5 21h13a1.5 1.5 0 0 0 1.5-1.5V11H6zM7.5 7A1.5 1.5 0 0 0 6 8.5V10h16V8.5A1.5 1.5 0 0 0 20.5 7H19v1h-1V7h-8v1H9V7z"/></svg>';
    },
    39346: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="none"><path fill="currentColor" d="M14 3c6.075 0 11 4.925 11 11s-4.925 11-11 11S3 20.075 3 14 7.925 3 14 3m0 1C8.477 4 4 8.477 4 14s4.477 10 10 10 10-4.477 10-10S19.523 4 14 4m1 12h-5v-1h4V8h1z"/></svg>';
    },
    98475: (e) => {
      e.exports =
    ...
    82665: (e, t, n) => {
      ...
      const l = function (e, t, n) {
        t = (n ? (0, a.default)(e, t, n) : void 0 === t)
          ? 1
          : i((0, r.default)(t), 0);
