...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6477],
  {
    22523: (e, t, i) => {
      ...
      class p extends u.LineDataSourceProperty {
        constructor({
          ...
          const o = i?.customText;
          ((this._textProperty = new c.Property(o?.text ?? '')),
            this.childs().customText?.addChild('text', this._textProperty),
            this.addChild(
              'textsColors',
              new a.LineToolColorsProperty([
                (0, s.ensureDefined)(this.childs().customText?.child('color')),
              ]),
            ));
        }
        template() {
