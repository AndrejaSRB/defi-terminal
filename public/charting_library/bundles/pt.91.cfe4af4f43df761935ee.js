(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [91],
  {
    ...
    1495: (s) => {
      s.exports = { en: ['All data'], pt: ['Todos os dados'] };
    },
    19273: (s) => {
      s.exports = { en: ['Year to day'], pt: ['De ano para dia'] };
    },
    58426: (s) => {
      s.exports = {
    ...
    67092: (s) => {
      s.exports = { en: ['Fullscreen mode'], pt: ['Modo tela cheia'] };
    },
    61206: (s) => {
      s.exports = { en: ['Maximize chart'], pt: ['Maximizar gráfico'] };
    },
    2031: (s) => {
      s.exports = {
    ...
    27665: (s) => {
      s.exports = { en: ['Sessions'], pt: ['Sessões'] };
    },
    31142: (s) => {
      s.exports = { en: ['Restore chart'], pt: ['Restaurar gráfico'] };
    },
    41888: (s) => {
      s.exports = {
    ...
    77073: (s) => {
      s.exports = { en: ['Timezone'], pt: ['Fuso Horário'] };
    },
    49545: (s) => {
      s.exports = {
