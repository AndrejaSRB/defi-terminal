  ...
  [7078],
  {
    ...
    22265: (e, t, i) => {
      ...
      var n,
        ...
        m = i(69101);
      function h(e) {
        return o.createElement('div', { className: m.wrapper, ...e });
      }
      function u(e) {
        const {
            mode: t,
          ...
          { isMobile: T, isTablet: _ } = (0, r.getSidebarMode)(t),
          S = (function () {
            if (T && v) return n?.bold;
            return l ? n?.bold : n?.default;
          })();
        return o.createElement(
          u,
          {
            ...
            className: a()(
              ...
              y && m.withoutArrow,
              b,
              _ && 'apply-common-tooltip',
            ),
            onClick: h,
          },
          n && o.createElement(s.Icon, { className: m.icon, icon: S }),
          !_ &&
            o.createElement(
              'span',
              {
              ...
              o.createElement(
                'span',
                { className: a()(m.titleText, 'apply-overflow-tooltip') },
                i,
              ),
              T &&
                !y &&
                o.createElement(s.Icon, { className: m.nested, icon: c }),
            ),
        );
      }
      !(function (e) {
    ...
    56080: (e, t, i) => {
      'use strict';
      (i.r(t), i.d(t, { GeneralChartPropertiesDialogRenderer: () => he }));
      var n = i(11542),
        o = i(50959),
        l = i(97737),
        a = i(72852),
        ...
        v = i(22489),
        y = (i(40167), i(3615));
      const C = n.t(null, void 0, i(6113));
      var T = i(50655),
        _ = i(29242),
        S = i(62576),
        f = i(51768),
      ...
      function P(e) {
        const {
                ...
                (0, y.showConfirm)(
                  {
                    ...
                    onConfirm: async ({ dialogClose: i }) => {
                      (await (0, v.removeTheme)(e), t && t(e), i());
                    },
                    onClose: i,
                    onCancel: n,
                  },
          ...
          c = o.useCallback(() => {
            (0, E.loadTheme)(i, { themeName: t, standardTheme: !1 }).then(
              () => {
                (0, f.trackEvent)('GUI', 'Switch to custom theme');
              },
            );
          }, [t, i]);
        return o.createElement(
          'div',
          { ...s },
          o.createElement(p.AccessibleMenuItem, {
            'data-series-theme-item-theme-name': t,
            className: w.defaultsButtonItem,
            isActive: !1,
            label: t,
            onClick: c,
            toolbox: o.createElement(S.MenuRemoveButton, {
              className: w.remove,
              hidden: !A.mobiletouch && !a,
              onClick: r,
            }),
          }),
        );
      ...
      var L = i(95276),
        M = i(73607),
        B = i(44996);
      const D = n.t(null, void 0, i(93553)),
        x = n.t(null, void 0, i(62518)),
        I = (0, _.appendEllipsis)(n.t(null, void 0, i(76266))),
        N = n.t(null, void 0, i(77571)),
        R = b.enabled('chart_template_storage');
      class F extends o.PureComponent {
        constructor(e) {
          (super(e),
            (this._manager = null),
            (this._reference = o.createRef()),
            (this._handleApplyDefaults = () => {
              const { model: e, chartWidgetCollection: t } = this.props;
              e.restorePreferences();
              const i = (0, v.getCurrentTheme)().name;
              (0, E.loadTheme)(t, {
                themeName: i,
                standardTheme: !0,
                applyOverrides: !0,
                ...
                window.runOrSignIn(
                  () =>
                    (async function (e, t, n, o) {
                      ...
                      l.showThemeSaveDialog(e, t, a, n, o);
                    })(
                      e.model().template(),
                      this._syncThemeList,
            ...
            (this._syncThemeList = () => {
              R &&
                (0, v.getThemeNames)().then((e) => {
                  this.setState({ themes: e });
                });
            }),
            (this._handleListboxFocus = (e) => {
              e.target instanceof HTMLElement &&
                (0, M.handleAccessibleMenuFocus)(e, this._reference);
            }),
            (this._handleRenameClose = () => {
        ...
        componentDidMount() {
          v.themeListChanged.subscribe(this, this._syncThemeList);
        }
        componentWillUnmount() {
          v.themeListChanged.unsubscribeAll(this);
        }
        render() {
          return o.createElement(
                ...
                (e) =>
                  o.createElement(
                    L.ControlDisclosure,
                    {
                      ...
                      onListboxKeyDown: M.handleAccessibleMenuKeyDown,
                    },
          ...
          return o.createElement(
            ...
            l.length > 0 &&
              o.createElement(
                o.Fragment,
                null,
                o.createElement(g.PopupMenuSeparator, { key: 'separator' }),
                l.map((e) =>
                  o.createElement(P, {
                    key: e,
                    themeName: e,
      ...
      var G = i(87713),
        ...
        O = i(65631),
        U = i(69101);
      const q = (0, o.forwardRef)((e, t) => {
        const [i, n] = (0, X.useRovingTabindexElement)(t),
          { className: l } = e;
        return o.createElement(K.DialogSidebarItem, {
          ...e,
          className: j()(U.accessible, l),
          tag: 'button',
          reference: i,
          tabIndex: n,
        });
      ...
      function Q(e) {
        const { mode: t, className: i, ...n } = e,
          { isMobile: l, isTablet: a } = (0, O.getSidebarMode)(t),
          s = j()(U.container, a && U.isTablet, l && U.isMobile, i);
        return o.createElement(H.Toolbar, {
          ...n,
          className: s,
      ...
      const Y = {
        ...
        prevCloseCheckableListGroup: 'big',
        prePostMarketCheckableListGroup: 'big',
        ...
        symbolCheckableListGroup: 'big',
        studiesCheckableListGroup: 'big',
        tradingNotifications: 'normal',
        tpoSymbolMinTick: 'normal',
        tpoSymbolTimezone: 'normal',
        tradingSoundMelody: 'normal',
        volFootprintSymbolMinTick: 'normal',
        volFootprintSymbolTimezone: 'normal',
        volFootprintRowSize: 'normal',
        volFootprintAtrLength: 'normal',
        volFootprintTicksPerRow: 'normal',
        volFootprintDisplay: 'normal',
        volFootprintType: 'normal',
        volFootprintTableCheckableList: 'big',
        volFootprintSummaryMode: 'big',
        mainSeriesLinesLabelsGroupVAH: 'normal',
        mainSeriesLinesLabelsGroupVAL: 'normal',
        mainSeriesLinesLabelsGroupPOC: 'normal',
        mainSeriesLinesLabelsGroupPoorHigh: 'normal',
        mainSeriesLinesLabelsGroupPoorLow: 'normal',
        mainSeriesLinesLabelsGroupSingleprints: 'normal',
        mainSeriesVolumeProfileGroupVAL: 'normal',
        mainSeriesVolumeProfileGroupVAH: 'normal',
        mainSeriesVolumeProfileGroupPOC: 'normal',
        watermark: 'big',
      };
      var Z = i(48199),
        $ = i(24640),
        ee = i(55647);
      function te(e) {
        return o.createElement(Z.BackButton, {
          className: ee.backButton,
          size: 'medium',
          'aria-label': n.t(null, { context: 'input' }, i(41256)),
          preservePaddings: !0,
          flipIconOnRtl: (0, $.isRtl)(),
          ...e,
        });
      }
      var ie = i(22692),
        ne = i(22944);
      const oe = 'properties_dialog.last_page_id';
      class le extends o.PureComponent {
        constructor(e) {
          (super(e),
            ...
            (this._renderApplyToAllButton = () =>
              o.createElement(
                u.MatchMedia,
                { rule: W.DialogBreakpoints.TabletNormal },
            ...
            (this._syncApplyToAllVisibility = () => {
              ...
              this.setState({
                isApplyToAllVisible: (0, h.isMultipleLayout)(e.layout.value()),
              });
            }),
            ...
            (this._handleForceFocus = (e) => {
              ((0, ie.updateTabIndexes)(),
                setTimeout(() => {
                  const [t] = (0, ie.queryTabbableElements)(e);
                  t && t.focus();
                }));
            }));
          const { pages: t, activePageId: i } = e,
            n = t.filter((e) => e.visible.value());
          let l = n.find((e) => e.id === i) ?? null;
          if (!l) {
            const e = m.default.getValue(oe),
              t = n.find((t) => t.id === e);
            l = t || (n.length > 0 ? n[0] : null);
          }
          this.state = {
            activePage: l,
            visiblePages: n,
            isApplyToAllVisible: (0, h.isMultipleLayout)(
        ...
        componentDidMount() {
          ...
          (e.layout.subscribe(this._syncApplyToAllVisibility),
            ...
            t.forEach((e) =>
              e.visible.subscribe(this._onTabVisibilityChanged),
            ));
        }
        componentWillUnmount() {
          const { chartWidgetCollection: e, pages: t } = this.props,
            ...
            return o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  n.map((e) =>
                    o.createElement(a.Section, { key: e.id, definition: e }),
                  ),
                ),
              ),
            );
      ...
      var ae = i(76422),
        ...
        re = i(36313),
        ce = i(87896);
      const me = n.t(null, void 0, i(32514));
      class he extends se.DialogRenderer {
        constructor(e) {
          (super(),
            (this._handleClose = () => {
        ...
        show(e) {
          this.visible().value() ||
            ((this._rootInstance = (0, ce.createReactRoot)(
              o.createElement(le, {
                title: me,
                isOpened: !0,
                onSubmit: this._handleSubmit,
            ...
            ae.emit('edit_object_dialog', {
              objectType: 'mainSeries',
              scriptTitle: this._model
                .mainSeries()
                .title(re.TitleDisplayTarget.StatusLine),
            }));
        }
        _ensureCheckpoint(e) {
    ...
    90397: (e, t, i) => {
      ...
      var n = i(50959),
        ...
        c = i(11098);
      function m(e) {
        const { className: t, reference: i, ...o } = e,
          [m, h] = (0, s.useRovingTabindexElement)(i ?? null);
        return n.createElement(r.PopupMenuItem, {
          ...o,
          className: l()(c.accessible, e.isActive && c.active, t),
          reference: m,
          tabIndex: h,
          onKeyDown: function (e) {
            ...
            (13 !== t && 32 !== t) ||
              (e.preventDefault(),
              m.current instanceof HTMLElement && m.current.click());
          },
          'data-role': 'menuitem',
    ...
    62576: (e, t, i) => {
      ...
      var n = i(50959),
        ...
        m = i(11064);
      function h(e) {
        const { onClick: t, isActive: o, onKeyDown: h, ...u } = e,
        ...
        return n.createElement(
          'button',
          {
            ...
            onClick: t,
            onKeyDown: h,
            className: l()(m.button, o && m.active, 'apply-common-tooltip'),
            'aria-label': a.t(null, void 0, i(67410)),
            'data-tooltip': a.t(null, void 0, i(67410)),
            type: 'button',
          },
