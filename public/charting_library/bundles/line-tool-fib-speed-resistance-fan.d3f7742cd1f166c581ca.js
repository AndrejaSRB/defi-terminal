...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [906],
  {
    14472: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          LineDataSourceDefinitionsViewModel: () => x,
          LineDataSourceTabTypes: () => r,
          pointPriceBarTitle: () => P,
        }));
      var r,
        n = i(50151),
        o = i(11542),
      ...
      const _ = o.t(null, void 0, i(40091)),
        ...
        f = o.t(null, void 0, i(92516)),
        y = o.t(null, void 0, i(70320)),
        v = o.t(null, void 0, i(21429)),
        P = o.t(null, { context: 'linetool point' }, i(80166));
      class x {
        constructor(e, t) {
        ...
        _createCoordinatesPropertyPage() {
          ...
          return null !== e
            ? (e.definitions.length < this._source.pointsCount() &&
              ...
              (0, a.createPropertyPage)(e, 'coordinates', g))
            : null;
        }
        ...
        _createTextPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'text', y) : null;
        }
    ...
    40226: (e, t, i) => {
        ...
        return (
          i.prefixes.forEach((r) => {
            ...
            for (let r = i.range[0]; r <= i.range[1]; r++)
              if (e[n + r] && (0, o.isSameType)(e[n + r], t.typecheck())) {
                let o = t.tpl();
                (i.names.forEach((i, s) => {
                  o = t.fill('' + s, i, e[n + r], o);
                }),
                  (e[n + r] = o));
              }
          }),
      ...
      class g extends s.DefaultProperty {
        constructor(e) {
          const { levelsIterator: t = u, map: i = {}, ...r } = e,
            n = { ...a, ...i };
          (r.state && (r.state = _(r.state, n, t)),
            super(r),
            (this._map = n),
    ...
    5352: (e, t, i) => {
      ...
      const _ = new o.TranslatedString(
        ...
        x = new o.TranslatedString(
          ...
          n.t(null, void 0, i(63021)),
        ),
        b = new o.TranslatedString(
          'change {title} right labels visibility',
          n.t(null, void 0, i(8390)),
        ),
        T = new o.TranslatedString(
          'change {title} top labels visibility',
          n.t(null, void 0, i(81301)),
        ),
        S = new o.TranslatedString(
          'change {title} bottom labels visibility',
          n.t(null, void 0, i(62130)),
        ),
        m = new o.TranslatedString(
          'change {title} reverse',
          n.t(null, void 0, i(50762)),
        ),
        w = new o.TranslatedString(
          'change {title} grid visibility',
          n.t(null, void 0, i(20664)),
        ),
        A = new o.TranslatedString(
          'change {title} grid line color',
          n.t(null, void 0, i(36467)),
        ),
        C = new o.TranslatedString(
          'change {title} grid line width',
          n.t(null, void 0, i(30127)),
        ),
        L = new o.TranslatedString(
          'change {title} grid line style',
          n.t(null, void 0, i(54244)),
        ),
        D = n.t(null, void 0, i(28683)),
        R = n.t(null, void 0, i(79468)),
        k = n.t(null, void 0, i(58557)),
        I = n.t(null, void 0, i(58476)),
        M = n.t(null, void 0, i(65e3)),
        V = n.t(null, void 0, i(28971)),
        E = n.t(null, void 0, i(74939)),
        N = n.t(null, void 0, i(17129)),
        H = n.t(null, void 0, i(81356)),
        W = n.t(null, void 0, i(64489));
        ...
        _stylePropertyDefinitions() {
          ...
          for (let e = 1; e <= a; e++) {
            const i = t[`hlevel${e}`].childs(),
              r = (0, d.createLeveledLinePropertyDefinition)(
                {
          ...
          const O = (0, d.createPropertyDefinitionsLeveledLinesGroup)(
              z,
              `${n}VLeveledLinesGroup`,
            ),
            Y = (0, d.createCheckablePropertyDefinition)(
              {
                checked: (0, d.convertToDefinitionProperty)(
                  this._propertyApplier,
                  t.showTopLabels,
              ...
              { id: `${n}TopLabels`, title: E },
            ),
            G = (0, d.createCheckablePropertyDefinition)(
              {
                checked: (0, d.convertToDefinitionProperty)(
                  this._propertyApplier,
                  t.showBottomLabels,
              ...
              { id: `${n}BottomLabels`, title: N },
            ),
            q = (0, d.createPropertyDefinitionsGeneralGroup)(
              [O, Y, G],
              `${n}VLevelGroup`,
              I,
            );
          e.push(q);
          const K = (0, d.createColorPropertyDefinition)(
            {
              color: (0, d.getColorDefinitionProperty)(
                this._propertyApplier,
            ...
            { id: `${n}AllLineColor`, title: D },
          );
          e.push(K);
          const j = (0, d.createTransparencyPropertyDefinition)(
            {
              checked: (0, d.convertToDefinitionProperty)(
                this._propertyApplier,
                t.fillBackground,
          ...
          e.push(j);
          const X = t.grid.childs(),
            U = (0, d.createLinePropertyDefinition)(
              {
                checked: (0, d.convertToDefinitionProperty)(
                  this._propertyApplier,
                  X.visible,
      ...
      var $ = i(10555),
        ...
        X = i(80819),
        U = i(54707);
      class J extends U.LineSourcePaneView {
        constructor(e, t) {
          (super(e, t),
          ...
          for (let e = 0; e < this._source.hLevelsCount(); e++)
            (this._leftTextRenderers.push(new j.TextRenderer()),
              this._rightTextRenderers.push(new j.TextRenderer()));
          for (let e = 0; e < this._source.vLevelsCount(); e++)
            (this._topTextRenderers.push(new j.TextRenderer()),
              this._bottomTextRenderers.push(new j.TextRenderer()));
        }
        renderer(e) {
        ...
        _updateImpl(e) {
          ...
          const t = this._source.priceScale(),
            i = (0, r.ensureNotNull)(this._source.ownerSource()).firstValue();
          if (
            null === i ||
            !t ||
            t.isEmpty() ||
          ...
          const n = this._source.points()[0],
            ...
            l = s.reverse.value(),
            a = [],
            c = l ? o.price - n.price : n.price - o.price,
            d = l ? n.price : o.price;
          for (let e = 1; e <= this._source.hLevelsCount(); e++) {
            const n = 'hlevel' + e,
              o = (0, r.ensureDefined)(
                this._source.properties().child(n),
              ).childs();
          ...
          const h = [],
            p = l ? o.index - n.index : n.index - o.index,
            u = l ? n.index : o.index;
          for (let e = 1; e <= this._source.vLevelsCount(); e++) {
            ...
            h.push({ coeff: n, color: o, x: l, index: e });
          }
          const _ = new q.CompositeRenderer(),
            g = this._points[0],
            f = this._points[1],
            y = Math.min(g.x, f.x),
            v = Math.min(g.y, f.y),
            P = Math.max(g.x, f.x),
            x = Math.max(g.y, f.y),
            b = s.grid.childs().color.value(),
            T = s.grid.childs().linewidth.value(),
            S = s.grid.childs().linestyle.value(),
            m = (0, O.getNumericFormatter)();
          for (let e = 0; e < a.length; e++) {
            const t = new $.Point(y, a[e].y),
              i = new $.Point(P, a[e].y);
            if (s.grid.childs().visible.value()) {
              const e = {
                  ...
                  extendleft: !1,
                  extendright: !1,
                  leftend: K.LineEnd.Normal,
                  rightend: K.LineEnd.Normal,
                },
                r = new X.TrendLineRenderer();
              (r.setData(e), _.append(r));
            }
            if (s.showLeftLabels.value()) {
              const i = {
                points: [t],
                text: m.format(a[e].coeff),
                color: a[e].color,
              ...
              (this._leftTextRenderers[e].setData(i),
                _.append(this._leftTextRenderers[e]));
            }
            if (s.showRightLabels.value()) {
              ...
              (this._rightTextRenderers[e].setData(t),
                _.append(this._rightTextRenderers[e]));
            }
          }
          for (let e = 0; e < h.length; e++) {
            const t = new $.Point(h[e].x, v),
              i = new $.Point(h[e].x, x);
            if (s.grid.childs().visible.value()) {
              const e = {
                  points: [t, i],
            ...
            if (s.showTopLabels.value()) {
              ...
              (this._topTextRenderers[e].setData(i),
                _.append(this._topTextRenderers[e]));
            }
            if (s.showBottomLabels.value()) {
              ...
              (this._bottomTextRenderers[e].setData(t),
                _.append(this._bottomTextRenderers[e]));
            }
          }
          const w = s.fillBackground.value(),
            A = s.transparency.value();
          for (let e = 0; e < a.length; e++) {
            const t = new $.Point(f.x, a[e].y);
            if (e > 0 && w) {
              const i = {
                  p1: g,
                  p2: t,
                  p3: g,
                  p4: new $.Point(f.x, a[e - 1].y),
                  color: a[e].color,
                  transparency: A,
                  hittestOnBackground: !0,
                  extendLeft: !1,
                },
                r = new G.ChannelRenderer();
              (r.setData(i), _.append(r));
            }
            {
              const i = {
                  points: [g, t],
              ...
              (r.setData(i),
                r.setHitTest(
                  new Y.HitTestResult(Y.HitTarget.MovePoint, void 0, {
                    type: 'h',
                    index: a[e].index,
                  }),
                ),
          ...
          for (let e = 0; e < h.length; e++) {
            const t = new $.Point(h[e].x, f.y);
            if (e > 0 && w) {
              const i = {
                  p1: g,
                  p2: t,
                  p3: g,
                  p4: new $.Point(h[e - 1].x, f.y),
                  color: h[e].color,
                  transparency: A,
                  hittestOnBackground: !0,
                  extendLeft: !1,
            ...
            }
            {
              const i = {
                ...
                r = new X.TrendLineRenderer();
              r.setData(i);
              const n = { type: 'v', index: h[e].index };
              (r.setHitTest(
                new Y.HitTestResult(Y.HitTarget.MovePoint, void 0, n),
              ),
                _.append(r));
            }
          }
      ...
      class ee extends s.LineDataSource {
        ...
        processErase(e, t) {
          const i = `${t.type}level${t.index}`,
            n = (0, r.ensureDefined)(this.properties().child(i)).childs()
              .visible;
        ...
        static _configureProperties(e) {
          ...
          for (let i = 1; i <= 7; i++)
            t.push((0, r.ensureDefined)(e.child(`hlevel${i}`)?.child('color')));
          for (let i = 1; i <= 7; i++)
            t.push((0, r.ensureDefined)(e.child(`vlevel${i}`)?.child('color')));
    ...
    54707: (e, t, i) => {
      ...
      function _(e, t) {
        const i = e.x - t.x,
          r = e.y - t.y;
        if (!Number.isFinite(i) || !Number.isFinite(r) || (0 === i && 0 === r))
        ...
        return (
          ...
          o >= u.deg337_5 ||
          o < u.deg22_5 ||
          (o >= u.deg157_5 && o < u.deg202_5)
            ? c.PaneCursorType.HorizontalResize
            : (o >= u.deg22_5 && o < u.deg67_5) ||
                (o >= u.deg202_5 && o < u.deg247_5)
              ? c.PaneCursorType.DiagonalNwSeResize
              : (o >= u.deg67_5 && o < u.deg112_5) ||
                  (o >= u.deg247_5 && o < u.deg292_5)
                ? c.PaneCursorType.VerticalResize
                : (o >= u.deg112_5 && o < u.deg157_5) ||
                    (o >= u.deg292_5 && o < u.deg337_5)
                  ? c.PaneCursorType.DiagonalNeSwResize
                  : void (0, n.assert)(!1, 'unexpected angle')
        );
      }
      function g(e, t) {
      ...
      class f {
        ...
        priceToCoordinate(e) {
          ...
          const r = null !== t ? t.firstValue() : null;
          return null === r ? null : i.priceToCoordinate(e, r);
        }
        anchorColor() {
          return h;
        }
    ...
    39723: (e, t, i) => {
      ...
      class h extends d.MediaCoordinatesPaneRenderer {
        ...
        _visiblePolygon(e) {
          ...
          let d = [
            new n.Point(0, 0),
            new n.Point(e.width, 0),
            new n.Point(e.width, e.height),
            new n.Point(0, e.height),
          ];
          return (
    ...
    73914: (e, t, i) => {
      i.d(t, {
        LineAnchorRenderer: () => y,
        lineSourcePaneViewPointToLineAnchorPoint: () => v,
        lineSourcePaneViewPointToLineAnchorPoint2: () => P,
        mapLineSourcePaneViewPointToLineAnchorPoint: () => x,
      });
      var r = i(10555),
        n = i(6453),
        o = i(50151),
      ...
      function p(e, t, i, r) {
        const { point: n } = t,
          o = i + r / 2;
        ((0, s.drawRoundRect)(e, n.x - o, n.y - o, 2 * o, 2 * o, (i + r) / 2),
          e.closePath(),
          (e.lineWidth = r));
      }
      function u(e, t, i, r) {
      ...
      function g(e, t, i, r) {
        ...
        ((e.globalAlpha = 0.2),
          e.beginPath(),
          e.arc(n.x, n.y, i + r / 2, 0, 2 * Math.PI, !0),
          e.closePath(),
          (e.lineWidth = r),
          e.stroke(),
          (e.globalAlpha = 1));
      ...
      class y extends h.BitmapCoordinatesPaneRenderer {
        constructor(e) {
        ...
        hitTest(e) {
          ...
          const { radius: t, points: i } = this._data,
            r = t + (0, d.interactionTolerance)().anchor;
          for (const t of i) {
            if (t.point.subtract(e).length() <= r)
        ...
        _drawImpl(e) {
          ...
          for (let e = 0; e < this._data.points.length; ++e) {
            ...
            o.square ? (t.push(o), i.push(s)) : (r.push(o), n.push(s));
          }
          (t.length && this._drawPoints(e, t, i, _, u),
            r.length && this._drawPoints(e, r, n, f, g));
        }
        _drawPoints(e, t, i, n, s) {
          const {
              context: a,
              ...
              if (
                (n(
                  a,
                  {
                    ...o,
                    point: new r.Point(
                      Math.round(o.point.x * c) + f,
                      Math.round(o.point.y * d) + f,
                    ),
                  },
                  g / 2,
                  u,
      ...
      function v(e, t = e.pointIndex, i, r, n, o, s, l, a, c) {
        return {
          point: e,
          pointIndex: t,
          cursorType: i,
