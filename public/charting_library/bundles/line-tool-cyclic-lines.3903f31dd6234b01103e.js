...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    67725: (e, t, i) => {
      i.d(t, { createLineStyleDefinition: () => f });
      var n = i(11542),
        r = i(95804),
        o = i(95338),
        s = i(91682);
      ...
      function f(e, t, i, n, r) {
        ...
        return (
          void 0 !== t.showLine &&
            (f.checked = (0, o.convertToDefinitionProperty)(
              e,
              t.showLine,
              l.format({ toolName: i }),
            )),
          void 0 !== t.lineWidth &&
            (f.width = (0, o.convertToDefinitionProperty)(
              e,
              t.lineWidth,
              a.format({ toolName: i }),
            )),
          void 0 !== t.lineStyle &&
            (f.style = (0, o.convertToDefinitionProperty)(
              e,
              t.lineStyle,
              d.format({ toolName: i }),
            )),
          void 0 !== t.lineColor &&
            (f.color = (0, o.getColorDefinitionProperty)(
              e,
              t.lineColor,
              null,
              c.format({ toolName: i }),
          ...
          void 0 !== t.extendLeft &&
            ((f.extendLeft = (0, o.convertToDefinitionProperty)(
              e,
              t.extendLeft,
              h.format({ toolName: i }),
            )),
            (y.extendLeftTitle = (r && r.extendLeftTitle) || P)),
          void 0 !== t.leftEnd &&
            (f.leftEnd = (0, o.convertToDefinitionProperty)(
              e,
              t.leftEnd,
              u.format({ toolName: i }),
            )),
          void 0 !== t.extendRight &&
            ((f.extendRight = (0, o.convertToDefinitionProperty)(
              e,
              t.extendRight,
              p.format({ toolName: i }),
            )),
            (y.extendRightTitle = (r && r.extendRightTitle) || S)),
          void 0 !== t.rightEnd &&
            (f.rightEnd = (0, o.convertToDefinitionProperty)(
              e,
              t.rightEnd,
              _.format({ toolName: i }),
            )),
          (0, o.createLinePropertyDefinition)(f, y)
        );
      }
    },
    38111: (e, t, i) => {
    ...
    14472: (e, t, i) => {
      ...
      const _ = o.t(null, void 0, i(40091)),
        ...
        y = o.t(null, { context: 'linetool point' }, i(80166));
      class m {
        constructor(e, t) {
        ...
        _createTextPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'text', S) : null;
        }
    ...
    75249: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolCyclicLines: () => R }));
      var n = i(41414),
        r = i(10555),
        o = i(94602),
        s = i(25672),
              ...
              this.createLineAnchor(
                {
                  points: [
                    (0, c.lineSourcePaneViewPointToLineAnchorPoint)(
                      new r.Point(this._points[0].x, i.height() / 2),
                      void 0,
                      void 0,
                      void 0,
      ...
      const w = {
        ...
        D = (0, y.extractThemedColors)(
          (0, g.ensureDefined)(x.get(P.StdTheme.Light)),
          (0, g.ensureDefined)(x.get(P.StdTheme.Dark)),
        ),
        C = (0, y.extractAllPropertiesKeys)(
          (0, g.ensureDefined)(x.get(P.StdTheme.Light)),
        ),
        I = (0, y.extractAllPropertiesKeys)(w),
        L = [...new Set([...C, ...I, ...f.commonLineToolPropertiesStateKeys])];
      class A extends v.LineDataSourceProperty {
        constructor(e) {
          (super(e),
            this.addChild(
              'linesColors',
              new T.LineToolColorsProperty([
                (0, g.ensureDefined)(this.child('linecolor')),
              ]),
            ),
            this.addChild(
              'linesWidths',
              new T.LineToolWidthsProperty([
                (0, g.ensureDefined)(this.child('linewidth')),
              ]),
            ));
        }
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () =>
              (0, m.factoryDefaultsForCurrentTheme)(w, x),
            nonThemedDefaultsKeys: I,
            themedDefaultsKeys: C,
            allStateKeys: L,
            themedColors: D,
      ...
      class R extends n.LineDataSource {
        constructor(e, t, i, n) {
          (super(
            e,
            t ?? R.createProperties(e.backgroundTheme().spawnOwnership()),
            i,
            n,
          ),
    ...
    73914: (e, t, i) => {
      i.d(t, {
        ...
        lineSourcePaneViewPointToLineAnchorPoint2: () => y,
      ...
      class S extends h.BitmapCoordinatesPaneRenderer {
        constructor(e) {
      ...
      function f(e, t = e.pointIndex, i, n, r, o, s, l, a, d) {
        return {
          point: e,
          pointIndex: t,
          cursorType: i,
