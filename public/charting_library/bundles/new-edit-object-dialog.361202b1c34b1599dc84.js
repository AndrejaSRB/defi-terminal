  ...
  [6265],
  {
    ...
    38546: (e, t, l) => {
      ...
      const i = n.forwardRef(function (e, t) {
        const { id: l, tabs: i, activeTab: o, onChange: s, className: a } = e;
    ...
    12981: (e, t, l) => {
      ...
      class S extends n.PureComponent {
        constructor(e) {
          (super(e),
            (this._handleClose = (e) => {
              const { onClose: t, closeOnOutsideClick: l = !0 } = this.props;
              l &&
                ((e?.target &&
        ...
        _renderChildren() {
          return ({ requestResize: e }) => {
            ...
            const { pages: t, source: l, model: r } = this.props,
              ...
              o = t.find((e) => e.id === i) ?? t[0],
              s = 'Component' in o ? void 0 : o.page,
            ...
            return n.createElement(
              ...
              n.createElement(
                ...
                'Component' in o
                  ? n.createElement(o.Component, { source: l, model: r })
      ...
      class _ extends n.PureComponent {
        constructor(e) {
          (super(e),
            (this._getInputs = () =>
              new E.MetaInfoHelper(
                this._metaInfoWV?.value() ?? this._initialMetaInfo,
              ).getUserEditableInputs()),
            (this._handleMetaInfoChange = () => {
              this.setState({ inputs: this._getInputs() });
            }),
            (this._properties = this.props.source.properties()),
            (this._metaInfoWV = this.props.source.metaInfoWV?.()),
            (this._initialMetaInfo = this.props.source.metaInfo()));
          const t = this._getInputs();
          this.state = { inputs: t };
        }
        componentDidMount() {
          this._metaInfoWV?.subscribe(this._handleMetaInfoChange);
        }
        componentWillUnmount() {
          this._metaInfoWV?.unsubscribe(this._handleMetaInfoChange);
        }
        render() {
          return n.createElement(P.InputsTabContent, {
            property: this._properties,
            model: this.props.model,
            study: this.props.source,
            studyMetaInfo: this._metaInfoWV?.value() ?? this._initialMetaInfo,
      ...
      const j = {
        ...
        X = Object.values(j)
          ...
          .map((e) => ({
            value: e.type,
            selectedContent: n.createElement(N.DisplayItem, { icon: e.icon }),
            content: n.createElement(N.DropItem, {
              icon: e.icon,
              label: e.label,
            }),
          })),
        q = i.t(null, void 0, l(72926));
      class $ extends n.PureComponent {
        render() {
          ...
          if (!(t in j)) return null;
          const a = {
            readonly: !0,
            content: n.createElement(
              n.Fragment,
              null,
              n.createElement(V.MenuItemSwitcher, {
              ...
              n.createElement(D.PopupMenuSeparator, null),
            ),
          };
          return n.createElement(N.IconDropdown, {
            id: e,
            disabled: s,
            className: l,
            hideArrowButton: !0,
      ...
      var J = l(17134),
        K = l(3618),
        Q = l(76431);
      const Z = new o.TranslatedString(
          'change plot type',
          i.t(null, void 0, l(43439)),
        ),
        ee = new o.TranslatedString(
          'change price line visibility',
          i.t(null, void 0, l(8662)),
        );
          ...
          return n.createElement(
            L.InputRow,
            {
              ...
              label: n.createElement(
                ...
                (0, K.getTranslatedInputTitle)(t.name),
              ),
              offset: a,
            },
            n.createElement(J.ColorWithLinePropertySelect, {
              disabled: !r.visible.value(),
              color: d.color,
              transparency: r.transparency,
              thickness: i ? d.width : void 0,
              isPaletteColor: !0,
              lineStyle: c ? d.style : void 0,
            }),
            i && o && r.plottype && r.trackPrice
              ? n.createElement($, {
                  id: (0, T.createDomId)(e, 'plot-type-select'),
                  disabled: !r.visible.value(),
                  className: Q.smallStyleControl,
      ...
      te.contextType = I.StylePropertyContext;
      var le = l(33066);
      function ne(e, t, l, i, o, s, a, c) {
        const d = t.colors,
          p = l.colors;
        return Object.keys(d).map((t, l) =>
          n.createElement(te, {
            key: a ? `${t}-secondary` : t,
            id: e,
            grouped: !0,
            paletteColor: (0, r.ensureDefined)(d[t]),
      ...
      class re extends n.PureComponent {
        render() {
          const {
            ...
            v = e ? e.id : (0, r.ensureDefined)(t).id,
            y = !v.startsWith('fill') && e && (0, x.isLinePlot)(e);
          return n.createElement(
            n.Fragment,
            null,
            !o &&
              n.createElement(
                le.PropertyTable.Row,
                null,
                n.createElement(
                  le.PropertyTable.Cell,
                  { placement: 'first', colSpan: 2, offset: p },
                  a
                    ? n.createElement('div', null, m)
                    : n.createElement(R.VisibilitySwitch, {
                        id: v,
                        title: m,
                        visible: s.visible,
                      }),
            ...
            ne(v, l, i, s, y, p, !1, d),
            u && h && ne(v, u, h, s, y, p, !0, d),
            c && n.createElement(le.PropertyTable.GroupSeparator, null),
          );
        }
      }
      ...
      class se extends n.PureComponent {
        constructor(e) {
          (super(e),
            (this._visible = new oe.StudyPlotVisibleProperty(
              e.styleProp.display,
            )));
        }
        render() {
          const {
            ...
            p =
              !!this.props.styleProp.plottype &&
              (0, x.doesLinePlotStyleSupportLineStyle)(
                this.props.styleProp.plottype.value(),
              );
      ...
      class ce extends n.PureComponent {
        constructor(e) {
          (super(e),
            (this._visible = new oe.StudyPlotVisibleProperty(e.display)));
        }
        render() {
          const { id: e, title: t, disabled: l } = this.props;
          return n.createElement(R.VisibilitySwitch, {
            id: e,
            title: t,
            disabled: l,
      ...
      var de = l(50890);
      const pe = new o.TranslatedString(
          'change plot type',
          i.t(null, void 0, l(43439)),
        ),
        ue = new o.TranslatedString(
          'change price line visibility',
          i.t(null, void 0, l(8662)),
        );
      class he extends n.PureComponent {
          ...
          (super(e),
            (this._onPlotTypeChange = (e) => {
              ...
              l &&
                (t(l, e, pe),
                this.setState({
                  showLineStyle: (0, x.doesLinePlotStyleSupportLineStyle)(e),
                }));
            }),
            (this._onPriceLineChange = (e) => {
              const { setValue: t } = this.context,
            ...
            (this.state = {
              showLineStyle: (0, x.doesLinePlotStyleSupportLineStyle)(
                e.property.plottype.value(),
              ),
            }));
        }
        render() {
          ...
          return n.createElement(
            L.InputRow,
            { label: n.createElement(ce, { id: e, title: t, display: d }) },
            l && !r
              ...
              : n.createElement(J.ColorWithLinePropertySelect, {
                  ...
                  transparency: a,
                  thickness: s,
                  lineStyle: this.state.showLineStyle ? p : void 0,
                }),
            n.createElement($, {
              id: (0, T.createDomId)(e, 'plot-type-select'),
              disabled: 0 === d.value(),
        ...
        _getInputForRgb() {
          const { id: e, showLineWidth: t, property: l } = this.props,
            { linewidth: r, linestyle: i, display: o } = l;
          return n.createElement(
            n.Fragment,
            null,
            r &&
              ...
              n.createElement(de.LineWidthSelect, {
                id: (0, T.createDomId)(e, 'line-width-select'),
                property: r,
                disabled: 0 === o.value(),
              }),
            i &&
              this.state.showLineStyle &&
              n.createElement(ae.LineStyleSelect, {
                id: (0, T.createDomId)(e, 'line-style-select'),
                property: i,
                disabled: 0 === o.value(),
                className: Q.smallStyleControl,
              }),
      ...
      var ve = l(53598),
        ye = l(86741);
      const ge = new o.TranslatedString(
        'change line style',
        i.t(null, void 0, l(28818)),
      );
      class be extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(ve.LineStyleSelect, {
            ...t,
            lineStyle: (0, ye.getPropertyValue)(e),
      ...
      class Ce extends n.PureComponent {
        render() {
          const {
            id: e,
            isRGB: t,
            property: { colorup: l, colordown: i, transparency: o, display: s },
          } = this.props;
          return n.createElement(me.Consumer, null, (a) =>
            n.createElement(
              n.Fragment,
              null,
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(ce, {
                    id: e,
                    title: dt((0, r.ensureNotNull)(a), e),
                    display: s,
                  }),
                ),
              ),
              ...
              n.createElement(le.PropertyTable.GroupSeparator, null),
            ),
          );
        }
      }
      ...
      var Se = l(87795),
        ...
        Ie = l(18330);
      const Re = {
          [Ie.MarkLocation.AboveBar]: {
            value: Ie.MarkLocation.AboveBar,
            content: i.t(null, void 0, l(8305)),
            order: 0,
          },
          [Ie.MarkLocation.BelowBar]: {
            value: Ie.MarkLocation.BelowBar,
            content: i.t(null, void 0, l(9417)),
            order: 1,
          },
          [Ie.MarkLocation.Top]: {
            value: Ie.MarkLocation.Top,
            content: i.t(null, void 0, l(97118)),
            order: 2,
          },
          [Ie.MarkLocation.Bottom]: {
            value: Ie.MarkLocation.Bottom,
            content: i.t(null, void 0, l(27567)),
            order: 3,
          },
          [Ie.MarkLocation.Absolute]: {
            value: Ie.MarkLocation.Absolute,
            content: i.t(null, void 0, l(69758)),
            order: 4,
          },
        },
        Le = Object.values(Re).sort((e, t) => e.order - t.order);
      class De extends n.PureComponent {
        render() {
          const {
            ...
            className: l,
            menuItemClassName: r,
            shapeLocationChange: i,
            disabled: o,
          } = this.props;
          return n.createElement(ke.Select, {
            id: e,
            disabled: o,
            className: l,
            menuItemClassName: r,
      ...
      const Ve = new o.TranslatedString(
          'change char',
          i.t(null, void 0, l(86955)),
        ),
        Ne = new o.TranslatedString(
          'change location',
          i.t(null, void 0, l(6834)),
        );
      class Be extends n.PureComponent {
        constructor() {
          (super(...arguments),
            (this._onCharChange = (e) => {
              const { setValue: t } = this.context,
                ...
                n = Pe()(l),
                i = 0 === n.length ? '' : n[n.length - 1];
              t((0, r.ensureDefined)(this.props.property.childs().char), i, Ve);
            }),
        ...
        render() {
          ...
          return n.createElement(
            ...
            {
              grouped: s,
              label: n.createElement(ce, { id: e, title: t, display: u }),
            },
            !s &&
              !i &&
            ...
            n.createElement(Te.InputControl, {
            ...
            n.createElement(De, {
              id: (0, T.createDomId)(e, 'shape-style-select'),
              disabled: 0 === u.value(),
              className: Ee(Q.defaultSelect, Q.additionalSelect),
              menuItemClassName: Q.defaultSelectItem,
      ...
      Object.keys(Me.plotShapesData).forEach((e) => {
        ...
        Qe.push({
          id: t.id,
          value: t.id,
          selectedContent: n.createElement(N.DisplayItem, { icon: Ke(t.icon) }),
          content: n.createElement(N.DropItem, {
            icon: Ke(t.icon),
            label: t.guiName,
          }),
      ...
      const et = new o.TranslatedString(
          'change shape',
          i.t(null, void 0, l(83468)),
        ),
        tt = new o.TranslatedString(
          'change location',
          i.t(null, void 0, l(6834)),
        );
      class lt extends n.PureComponent {
        constructor() {
          (super(...arguments),
            (this._onPlotTypeChange = (e) => {
              const { setValue: t } = this.context;
              t(this.props.property.childs().plottype, e, et);
            }),
            (this._onLocationChange = (e) => {
              const { setValue: t } = this.context;
              t(this.props.property.childs().location, e, tt);
            }));
        }
        render() {
          const {
          ...
          return n.createElement(
            ...
            n.createElement(De, {
              id: (0, T.createDomId)(e, 'shape-location-select'),
              disabled: 0 === d.value(),
              className: Ee(Q.defaultSelect, Q.additionalSelect),
              menuItemClassName: Q.defaultSelectItem,
      ...
      const nt = (0, ie.getLogger)('Chart.Study.PropertyPage'),
        rt = i.t(null, void 0, l(22691)),
        it = i.t(null, void 0, l(71776)),
        ot = i.t(null, void 0, l(74406)),
        st = i.t(null, void 0, l(32163)),
        at = i.t(null, void 0, l(38408));
      class ct extends n.PureComponent {
        render() {
          const { plot: e, palettes: t, study: l } = this.props,
            i = e.id,
            o = l.properties().styles,
            s = l.metaInfo().styles,
            a = o[i],
            c = e.type,
            d = t.main,
          ...
          if ('line' === c || 'bar_colorer' === c || 'bg_colorer' === c)
            return d && d.palette && d.paletteProps
              ...
              : n.createElement(he, {
                  id: i,
                  title: (0, r.ensureDefined)(s?.[i]?.title),
                  property: a,
                  isRGB: p,
                  isFundamental: false,
          ...
          if ('arrows' === c) {
            const r = this._getPlotSwitch(i, dt(l, i), a.display);
            if (p) return r;
            const o = t.up,
              s = t.down;
            return o || s
          ...
          if ((0, x.isOhlcPlot)(e)) {
            const o = e.target,
              ...
              a = (0, r.ensureDefined)(
                (0, r.ensureDefined)(l.metaInfo().ohlcPlots)[o],
              ),
              c = this._getPlotSwitch(i, a.title, s.display);
            if (p) return c;
          ...
          return (nt.logError('Unknown plot type: ' + c), null);
        }
        _getPlotSwitch(e, t, l) {
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(ce, { id: e, title: t, display: l }),
            ),
          );
        }
      }
      ...
      var pt = l(97569);
      const ut = new o.TranslatedString(
        'change value',
        i.t(null, void 0, l(21333)),
      );
      class ht extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(
            ...
            {
              labelAlign: 'adaptive',
              label: n.createElement(R.VisibilitySwitch, {
                id: e,
                title: t,
                visible: a,
              }),
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(pt.FloatInputComponent, {
      ...
      var vt = l(99481),
        yt = l(87438),
        gt = l(38527);
      const bt = new o.TranslatedString(
          'change percent width',
          i.t(null, void 0, l(62294)),
        ),
        ft = new o.TranslatedString(
          'change placement',
          i.t(null, void 0, l(81891)),
        ),
        wt = new o.TranslatedString(
          'change values visibility',
          i.t(null, void 0, l(9344)),
        ),
        Ct = [
          {
            value: vt.HHistDirection.LeftToRight,
            content: i.t(null, void 0, l(11626)),
          },
          {
            value: vt.HHistDirection.RightToLeft,
            content: i.t(null, void 0, l(50421)),
          },
        ],
        St = i.t(null, void 0, l(93710)),
        Pt = i.t(null, void 0, l(10783)),
        Et = i.t(null, void 0, l(60092)),
        _t = i.t(null, void 0, l(77753));
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(yt.IntegerInputComponent, {
            ...
            n.createElement(
              ...
              n.createElement(ke.Select, {
                id: 'hhist-graphic-placement-select',
                disabled: !s.value(),
                className: Q.defaultSelect,
                menuItemClassName: Q.defaultSelectItem,
                items: Ct,
                value: r.value(),
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(gt.BoolInputComponent, {
                  label: Et,
                  input: {
                    id: a + '_showValues',
                    type: 'bool',
      ...
      class xt extends n.PureComponent {
        render() {
          const { title: e, property: t } = this.props,
            { color: l, width: r, style: i, visible: o } = t.childs();
          return n.createElement(
            L.InputRow,
            {
              label: n.createElement(R.VisibilitySwitch, {
      ...
      class Rt extends n.PureComponent {
        render() {
          const { graphicType: e, study: t } = this.props,
            l = t.metaInfo(),
            i = l.graphics,
            o = t.properties().graphics.childs(),
            s = (0, r.ensureDefined)(i[e]);
          return Object.keys(s).map((t, i) => {
            const s = (0, r.ensureDefined)(o[e]?.childs()[t]);
      ...
      var Lt = l(73146),
        Dt = l(66045);
      const Vt = new o.TranslatedString(
          'change font size',
          i.t(null, void 0, l(27745)),
        ),
        Nt = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40].map((e) => ({
          value: e,
          title: e.toString(),
        }));
      ...
      const At = new o.TranslatedString(
          'change visibility',
          i.t(null, void 0, l(1924)),
        ),
        Mt = i.t(null, void 0, l(62791)),
        zt = i.t(null, void 0, l(5119)),
        Wt = {
          Traditional: new Set([
            'S5/R5',
            'S4/R4',
      ...
      class Ft extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              {
                labelAlign: 'adaptive',
                label: n.createElement('span', null, Mt),
              },
              n.createElement(
                'div',
                { className: Q.block },
                n.createElement(
                  'div',
                  { className: Ee(Q.wrapGroup, Q.additionalSelect) },
                  n.createElement(Bt, {
        ...
        _renderColors() {
          const { levelsStyle: e, inputs: t } = this.props.property.childs(),
            { colors: l, widths: i, visibility: o } = e.childs(),
            { kind: s } = t.childs(),
      ...
      const Ht = i.t(null, void 0, l(10783)),
        ...
        Gt =
          (new o.TranslatedString(
            ...
            i.t(null, void 0, l(85889)),
          ),
          i.t(null, void 0, l(81363))),
        Yt = i.t(null, void 0, l(60092)),
        jt = i.t(null, void 0, l(93710)),
        Xt = i.t(null, void 0, l(73033)),
        qt = i.t(null, { context: 'input' }, l(49191)),
        $t = i.t(null, { context: 'input' }, l(76542));
      class Jt extends n.PureComponent {
        ...
        render() {
          const { metaInfo: e } = this.props,
            ...
            S = a.childs().pocLines,
            P = (0, r.ensureDefined)(e.graphics.horizlines?.pocLines),
            E = l.childs().developingPoc,
            _ = new oe.StudyPlotVisibleProperty(E.childs().display),
            T = (0, r.ensureDefined)(e.styles?.developingPoc),
            x = l.childs().developingVAHigh,
            k = new oe.StudyPlotVisibleProperty(x.childs().display),
            I = l.childs().developingVALow,
            D = new oe.StudyPlotVisibleProperty(I.childs().display),
            V = e.graphics.polygons && e.graphics.polygons.histBoxBg;
          return n.createElement(
            n.Fragment,
            null,
            n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                le.PropertyTable.Cell,
                { placement: 'first' },
                n.createElement('div', { className: Q.childRowContainer }, jt),
              ),
              n.createElement(
                le.PropertyTable.Cell,
                { placement: 'last' },
            ...
            n.createElement(
              ...
              n.createElement(
                le.PropertyTable.Cell,
                { placement: 'first' },
                n.createElement('div', { className: Q.childRowContainer }, Ht),
              ),
              n.createElement(
                le.PropertyTable.Cell,
                { placement: 'last' },
                    ...
                    return n.createElement(
                      L.InputRow,
                      {
                        ...
                        label: n.createElement(
                          'div',
                          { className: Q.childRowContainer },
                          (r && (0, K.getTranslatedInputTitle)(r.titles[l])) ||
                            '',
                        ),
                      },
                      n.createElement(xe.BasicColorSelect, {
            ...
            E &&
              n.createElement(fe, {
                id: 'developingPoc',
                title:
                  (T.title && (0, K.getTranslatedInputTitle)(T.title)) || '',
            ...
            x &&
              ...
              n.createElement(fe, {
                id: 'developingPoc',
                title: Xt,
                color: [x.childs().color, I.childs().color],
                visible: [k, D],
                thickness: [x.childs().linewidth, I.childs().linewidth],
                lineStyle: [x.childs().linestyle, I.childs().linestyle],
              }),
            c &&
              n.createElement(
                L.InputRow,
                {
                  label: n.createElement(
                    'div',
                    null,
                    (V && (0, K.getTranslatedInputTitle)(V.name)) || '',
                  ),
                },
                n.createElement(xe.BasicColorSelect, {
        ...
        _setHhistsProperty(e, t) {
          const { setValue: l } = this.context,
            { metaInfo: n, property: i } = this.props,
            o = i.childs().graphics.childs().hhists,
      ...
      function Kt() {
        const e = (0, r.ensureNotNull)((0, n.useContext)(me)),
          t = e.metaInfo(),
          l = e.properties();
      ...
      const Zt = {
        ...
        PivotPointsStandard: function () {
          const e = (0, r.ensureNotNull)((0, n.useContext)(me)).properties();
          return n.createElement(Ft, { property: e });
        },
        VbPVisible: Kt,
        VbPAnchored: Kt,
      };
          ...
          return n.createElement(me.Consumer, null, (t) =>
            n.createElement(
              I.StylePropertyContainer,
              {
                ...
                affectSave: (0, Lt.doesStudyLikeAffectSave)(
                  (0, r.ensureNotNull)(t),
                ),
                model: e,
              },
      ...
      el.contextType = Qt.ModelContext;
      var tl = l(48282);
      const ll = new o.TranslatedString(
          'change precision',
          i.t(null, void 0, l(61863)),
        ),
        nl = i.t(null, void 0, l(16564)),
        rl = i.t(null, void 0, l(59766)),
        il = [{ value: 'default', content: nl }];
      for (let e = 0; e <= 8; e++) il.push({ value: e, content: e.toString() });
      ...
      ol.contextType = I.StylePropertyContext;
      const sl = new o.TranslatedString(
          'change min tick',
          i.t(null, void 0, l(26476)),
        ),
        al = i.t(null, void 0, l(16564)),
        cl = i.t(null, void 0, l(64075)),
        dl = [
            ...
            t
              ...
              : n.createElement(
                  ...
                  i &&
                    n.createElement(
                      'div',
                      { className: _e()(i && o && Q.additionalSelect) },
                      n.createElement(xe.BasicColorSelect, {
                        disabled:
                          r && !(Array.isArray(r) ? r[0].value() : r.value()),
                        color: i,
      ...
      const vl = i.t(null, void 0, l(79468)),
        yl = i.t(null, { context: 'input' }, l(49191)),
        gl = i.t(null, { context: 'input' }, l(76542)),
        bl = i.t(null, void 0, l(60051)),
        fl = i.t(null, void 0, l(50382));
      class wl extends n.PureComponent {
        constructor() {
          (super(...arguments),
        ...
        render() {
          const { study: e } = this.props,
            t = e.metaInfo();
          if ((0, tl.isCustomStudy)(t.shortId))
            return n.createElement(el, null);
          const l = e.properties(),
            ...
            c = t.plots.length > 0,
            d = t.plots.some((e) => !(0, x.isPlotWithTechnicalValues)(e)),
            p = c || t.inputs.some((e) => 'price' === e.type),
            u = (0, Lt.createAdapter)(e).canOverrideMinTick();
          return n.createElement(
            le.PropertyTable,
            null,
            this._plotsElement(),
            ...
            u &&
              n.createElement(ul, {
                id: (0, T.createDomId)(t.id, 'min-tick-select'),
                minTick: o,
              }),
            k.StudyMetaInfo.isScriptStrategy(t) &&
              n.createElement(mt, { orders: i.orders }),
            (p || d) &&
              n.createElement(
                le.PropertyTable.Row,
                null,
                n.createElement(le.PropertyTable.GroupSeparator, { size: 1 }),
                n.createElement(hl.GroupTitleSection, { title: bl, name: bl }),
                p &&
                  n.createElement(ol, {
                    id: (0, T.createDomId)(t.id, 'precision-select'),
                    precision: r,
                  }),
                d &&
                  n.createElement(
        ...
        _filledAreasElement() {
          ...
          return !l || t.isRGB
            ? []
            : l.map((l) => {
                const i = t.filledAreasStyle?.[l.id];
                if (i) {
                  if (i.isHidden) return null;
                } else if (l.isHidden) return null;
                const o = e.properties().filledAreasStyle[l.id],
                  s = l.title || vl;
                if (
                  o.hasChild('fillType') &&
                  'gradient' === o.childs().fillType.value()
                ) {
                  ...
                  if (l.palette) {
                    ...
                    return n.createElement(re, {
                      ...
                      secondaryPalette: i?.palette,
                      secondaryPaletteProps: i?.paletteProps,
                      styleProp: o,
                    });
                  }
                  return null;
        ...
        _graphicsElement() {
          ...
          return l.length
            ? n.createElement(
                n.Fragment,
                null,
                n.createElement(le.PropertyTable.GroupSeparator, {
                  className: Q.groupSeparator,
                  size: 1,
                }),
                n.createElement(
                  le.PropertyTable.Row,
                  null,
                  n.createElement(hl.GroupTitleSection, {
                    title: fl,
                    name: fl,
                  }),
                  l.map((t) =>
                    n.createElement(Rt, { key: t, graphicType: t, study: e }),
                  ),
                ),
              )
            : null;
        ...
        _findPalettesByTargetId(e) {
          const { study: t } = this.props,
            l = t.metaInfo(),
            n = l.plots,
            i = (0, r.ensureDefined)(l.palettes),
            o = {};
          for (const l of n) {
            if (
      ...
      function Cl(e) {
        return (0, I.bindPropertyContext)(
          ...
          (0, Lt.doesStudyLikeAffectSave)(e.study),
        );
      }
      class Sl extends n.PureComponent {
        render() {
          return n.createElement(
            Qt.ModelContext.Provider,
            { value: this.props.model },
            n.createElement(
              me.Provider,
              { value: this.props.source },
              n.createElement(Cl, { study: this.props.source }),
            ),
          );
        }
      }
      var Pl = l(60567),
        ...
        Tl = l(36313),
        xl = l(87896);
      class kl extends El.DialogRenderer {
        constructor(e, t, l, n) {
          (super(),
            (this._timeout = null),
        ...
        show(e = {}) {
          ...
          (o.hasUserEditableInputs() &&
            r.push({
              id: 'inputs',
              label: i.t(null, void 0, l(21429)),
              Component: _,
            }),
            o.hasUserEditableProperties(),
            o.hasUserEditableStyles() &&
              r.push({
                id: 'style',
                label: i.t(null, void 0, l(92516)),
                Component: Sl,
              }),
            this._propertyPages ||
              r.push({
                id: 'visibilities',
                label: i.t(null, void 0, l(40091)),
          ...
          const u =
            ...
            'inputs';
          let h = (0, s.clean)(t.shortDescription, !0);
          ...
          ((this._rootInstance = (0, xl.createReactRoot)(
            ...
            e.onDestroy && (this._onDestroy = e.onDestroy),
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, Pl.createPropertyPage)(
            (0, _l.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._model,
              e,
              new o.TranslatedString(
                this._source.name(!0),
        ...
        _closeDialogIfSourceIsDeleted() {
          const e = this._model.model().dataSourceForId(this._source.id());
          null !== e
            ? e.instanceId() !== this._source.instanceId() &&
              this._handleClose()
            : this._handleClose();
        }
      }
      ...
      class m extends n.PureComponent {
        render() {
          ...
          return n.createElement(
            ...
            {
              id: 'property-actions',
              className: i()('normal' === e && p.defaultsButtonText),
    ...
    48531: (e, t, l) => {
      ...
      function d(e) {
        return e.isTabletWidth
          ? n.createElement(i.Icon, { className: a.themesButtonIcon, icon: c })
    ...
    37289: (e, t, l) => {
      ...
      const i = {
          ...
          trendLineToolCheckableListGroup: 'big',
          trendLineToolStatsPosition: 'big',
          lineExtend: 'big',
          datePriceRangeCheckableListGroup: 'big',
        },
        o = {
          TextText: 'big',
    ...
    67829: (e, t, l) => {
      ...
      const b = (0, r.forwardRef)((e, t) => {
        const { size: l, overflowBehaviour: n } = (0, r.useContext)(m),
          i = (0, r.useContext)(v.CustomBehaviourContext),
          {
            active: s,
            fake: a,
            className: c,
            enableActiveStateStyles: d = i.enableActiveStateStyles,
      ...
      function R(e) {
        ...
        return r.createElement(P.Icon, {
          icon: I(t),
          className: i(k['arrow-icon'], k[`size-${t}`], l && k.dropped),
        });
      }
      var L = l(55185);
      const D = 4,
            ...
            return (
              ...
              (0, r.useCallback)(() => {
                ...
                return {
                  ...
                  indentFromWindow: { top: V, bottom: V, left: V, right: V },
                };
              }, [t, e])
            );
          })(t, g);
        return r.createElement(S.PopupMenuDisclosureView, {
          buttonRef: g,
          listboxTabIndex: -1,
          isOpened: n,
          onClose: y,
          ...
          button: r.createElement(
            ...
            d,
            r.createElement(R, { size: t, isDropped: n }),
          ),
          popupChildren: a.map((e) =>
            r.createElement(C.PopupMenuItem, {
              key: e.id,
              className: u ? L['link-item'] : void 0,
              onClick: v,
              onClickArg: e,
              isActive: h(e),
              label: e.label,
      ...
      function q(e) {
        ...
        return r.createElement(
          'div',
          {
            className: i(j().underline, t && j().disabled),
            style: {
              transform: `translateX(${l}px) scaleX(${o})`,
      ...
      function $(e) {
        const {
            ...
            activationType: i,
            disabled: v,
            moreButtonContent: y = s.t(null, void 0, l(37117)),
            size: g = 'small',
            onActivate: b,
            isActive: w,
            className: C,
            ...
            tablistLabelId: _,
            tablistLabel: T,
            'data-name': x = 'underline-tabs-buttons',
            stretchTabs: k,
            equalTabSize: I,
            defaultKeyboardFocus: R,
            stopPropagationIfKeyboardActionHandled: L,
            keyboardNavigationLoop: D,
            focusableItemAttributes: V,
            dataQaId: B = 'underline-tabs-buttons',
          } = e,
          A = O(),
          M = (function (e) {
            const t = (0, z.useSafeMatchMedia)(
          ...
          K = E ?? !A,
          {
            ...
            moreButtonRef: le,
            setItemRef: ne,
          } = (0, a.useCollapsible)(n, j, w),
          re = 'collapse' === M ? Q : n,
          ie = 'collapse' === M ? Z : [],
          oe = (0, r.useCallback)((e) => ie.includes(e), [ie]),
          se = (0, r.useRef)(new Map()),
          {
            ...
            close: de,
            onButtonClick: pe,
          } = (0, p.useDisclosure)({ id: t, disabled: v }),
          ue = (function (e = 'xsmall') {
            switch (e) {
              case 'xsmall':
              case 'small':
                return 12;
        ...
        const xe = (function (e, t, l = []) {
          const [n, i] = (0, r.useState)(),
            ...
            a = (e) => {
              ...
              s.current = e;
              const { left: n, right: r, width: o } = e.getBoundingClientRect(),
                { left: a, right: c } = t.getBoundingClientRect(),
                d = (0, G.isRtl)() ? r - c : n - a;
              i({ translateX: d, scale: o, transitionDuration: l });
            };
          return (
            (0, r.useEffect)(() => {
            ...
            (0, r.useEffect)(() => {
              ...
              const l = e.get(t);
              return void 0 !== l
                ? (a(l), o.current?.observe(l), () => o.current?.disconnect())
                : void 0;
            }, l),
            n
          );
        })(se.current, fe ?? we, [fe ?? we, re, g, $, M]);
        return r.createElement(
          m.Provider,
          { value: { size: g, overflowBehaviour: M } },
          r.createElement(
            'div',
            {
              ...ve,
              className: H({ size: g, overflowBehaviour: M, className: C }),
              style: S,
              'data-name': x,
              'data-qa-id': B,
            },
            r.createElement(
              ...
              {
                ...me,
                className: o()(F['underline-tabs'], {
                  [F['make-grid-column']]: $ || J,
                  [F['stretch-tabs']]: $,
                  [F['equal-tab-size']]: J,
                }),
              },
              ...
              xe
                ? r.createElement(q, { ...xe, disabled: v })
      ...
      var J = l(38952);
      function K(e) {
        return r.createElement('a', { ...(0, J.renameRef)(e) });
      }
      (0, r.forwardRef)((e, t) => {
        const { size: l, overflowBehaviour: n } = (0, r.useContext)(m),
          i = (0, r.useContext)(v.CustomBehaviourContext),
          {
            ...
            fake: p,
            className: u,
            enableActiveStateStyles: h = i.enableActiveStateStyles,
    ...
    87795: (e) => {
      ...
      function i(e) {
        ...
        for (; l < e.length; )
          ((n += o(l + n, e)),
            ...
            p(e[l + n])
              ? n++
              : (t.push(e.substring(l, l + n)), (l += n), (n = 0)));
        return t;
      }
      function o(e, r) {
        const i = r[e];
        if (
          !(function (e) {
            return e && h(e[0].charCodeAt(0), t, 56319);
          })(i) ||
          e === r.length - 1
        )
          return 1;
        const o = i + r[e + 1];
        let a = r.substring(e + 2, e + 5);
        return (s(o) && s(a)) ||
          (function (e) {
            return h(u(e), l, n);
          })(a)
      ...
      function s(e) {
        return h(u(e), 127462, 127487);
      }
      function a(e) {
        return 'string' == typeof e && h(e.charCodeAt(0), 65024, 65039);
      }
      function c(e) {
        return 'string' == typeof e && h(e.charCodeAt(0), 8400, 8447);
      }
      function d(e) {
      ...
      ((e.exports = i),
        (e.exports.substr = function (e, t, l) {
          const n = i(e);
          if (void 0 === t) return e;
          if (t >= n.length) return '';
          const r = n.length - t;
          let o = t + (void 0 === l ? r : l);
          return (o > t + r && (o = void 0), n.slice(t, o).join(''));
        }));
    },
    57213: (e) => {
      e.exports = {
    ...
    76431: (e) => {
      e.exports = {
        ...
        groupSeparator: 'groupSeparator-l5f4IL9k',
      };
    },
    74302: (e, t, l) => {
      'use strict';
      l.d(t, {
        DEFAULT_MENU_ITEM_SWITCHER_THEME: () => w,
        MenuItemSwitcher: () => C,
      });
      var n,
        r = l(50959),
      ...
      function d(e) {
        ...
        return r.createElement(
          ...
          r.createElement('span', { className: c().track }),
          r.createElement('span', { className: c().thumb }),
        );
      }
      !(function (e) {
      ...
      function v(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'span',
            { className: o()(m().thumbWrapper, m()[n]) },
            r.createElement(d, { checked: i, size: l, disabled: p }),
          ),
        );
      }
      !(function (e) {
      ...
      function C(e) {
        const {
          ...
          [E, _] = (0, g.useRovingTabindexElement)(null),
          T = o()(w.label, l && !d && w.labelOn, C && f.label_disabled),
          x = o()(
            i,
            w.wrapper,
        ...
        return r.createElement(
          ...
          {
            role: t,
            className: o()(x, P && w.withIcon, f.accessible),
            htmlFor: s,
            ref: h,
          ...
          void 0 !== P &&
            r.createElement(y.Icon, { className: w.icon, icon: P }),
          r.createElement(
            'div',
            { className: w.labelRow },
            r.createElement('div', { className: T }, a),
            c && r.createElement('div', { className: w.labelHint }, c),
          ),
          r.createElement(
            'div',
            { className: f.switchWrap },
            r.createElement(v, {
              disabled: C,
              className: w.switch,
    ...
    73863: (e, t, l) => {
      ...
      const p = new r.TranslatedString(
        ...
        L = n.t(null, void 0, l(65188)),
        D = n.t(null, void 0, l(42562)),
        V = n.t(null, void 0, l(56796)),
        N = n.t(null, void 0, l(72942)),
        B = n.t(null, void 0, l(835)),
        A = n.t(null, void 0, l(43154)),
        M = new r.TranslatedString('ticks', n.t(null, void 0, l(3539))),
        z = new r.TranslatedString('seconds', n.t(null, void 0, l(751))),
        W = new r.TranslatedString('seconds from', n.t(null, void 0, l(35801))),
        F = new r.TranslatedString('seconds to', n.t(null, void 0, l(73419))),
        H = new r.TranslatedString('minutes', n.t(null, void 0, l(18726))),
        ...
        $ = new r.TranslatedString('days to', n.t(null, void 0, l(89919))),
        J = new r.TranslatedString('weeks', n.t(null, void 0, l(45537))),
        K = new r.TranslatedString('weeks from', n.t(null, void 0, l(92859))),
        Q = new r.TranslatedString('weeks to', n.t(null, void 0, l(44127))),
        Z = new r.TranslatedString('months', n.t(null, void 0, l(95300))),
      ...
      function ae(e, t, l) {
        ...
        if ((0, s.isSecondsEnabled)()) {
          const r = (0, i.createRangePropertyDefinition)(
            ...
            },
            {
              ...
              title: L,
              min: new o.WatchedValue(le[0]),
              max: new o.WatchedValue(le[1]),
            },
          );
          n.push(r);
        }
        const r = (0, i.createRangePropertyDefinition)(
            ...
            },
            {
              ...
              title: D,
              min: new o.WatchedValue(ne[0]),
              max: new o.WatchedValue(ne[1]),
            },
          ),
          c = (0, i.createRangePropertyDefinition)(
            ...
            },
            {
              ...
              title: V,
              min: new o.WatchedValue(re[0]),
              max: new o.WatchedValue(re[1]),
            },
          ),
          d = (0, i.createRangePropertyDefinition)(
            ...
            },
            {
              ...
              title: N,
              min: new o.WatchedValue(ie[0]),
              max: new o.WatchedValue(ie[1]),
            },
          );
        n.push(r, c, d);
        const M = (0, i.createRangePropertyDefinition)(
            {
              checked: (0, i.convertToDefinitionProperty)(
                e,
                t.weeks,
            ...
            },
            {
              ...
              title: B,
              min: new o.WatchedValue(oe[0]),
              max: new o.WatchedValue(oe[1]),
            },
          ),
          z = (0, i.createRangePropertyDefinition)(
            ...
            },
            {
              ...
              title: A,
              min: new o.WatchedValue(se[0]),
              max: new o.WatchedValue(se[1]),
            },
          );
        return (n.push(M, z), { definitions: n });
      }
      function ce(e, t) {
        const l = [];
        if ((0, a.isTicksEnabled)()) {
    ...
    32823: (e, t, l) => {
      ...
      class u {
        ...
        hasUserEditableProperties() {
          return i.StudyMetaInfo.isScriptStrategy(this._metaInfo);
        }
        hasUserEditableStyles() {
          ...
          return (
            ...
            i.StudyMetaInfo.isScriptStrategy(this._metaInfo) ||
        ...
        getUserEditablePlots() {
          const e = new Set(),
            t = this._metaInfo;
          return t.plots.filter((l) => {
            if (
              (0, o.isColorerPlot)(l) ||
              (0, o.isTextColorerPlot)(l) ||
              (0, o.isDataOffsetPlot)(l) ||
              (0, o.isOhlcColorerPlot)(l) ||
              (0, o.isAlertConditionPlot)(l) ||
              (0, o.isDataPlot)(l)
            )
              return !1;
            if ((0, o.isOhlcPlot)(l)) {
              ...
              if (e.has(r)) return !1;
              e.add(r);
              const i = (0, n.ensureDefined)(t.ohlcPlots);
              return !(0, n.ensureDefined)(i[r]).isHidden;
            }
            {
              const e = t.styles ? t.styles[l.id] : void 0;
    ...
    66567: (e, t, l) => {
      ...
      var n = l(50151),
        ...
        i = l(95804),
        o = l(43337);
      const s = new i.TranslatedString(
        'change {propertyName} property',
        r.t(null, void 0, l(25167)),
      );
      class a extends o.Property {
        constructor(e, t, l) {
          (super(),
            (this._isProcess = !1),
    ...
    57058: (e, t, l) => {
      'use strict';
      l.d(t, { StudyPlotVisibleProperty: () => i });
      var n = l(38486),
        r = l(79603);
      class i extends r.PropertyBase {
        constructor(e) {
          (super(),
    ...
    51752: (e, t, l) => {
      'use strict';
      l.d(t, { plotShapesData: () => r });
      var n = l(11542);
      const r = {
        shape_arrow_down: {
          guiName: n.t(null, void 0, l(34247)),
          id: 'shape_arrow_down',
        ...
        shape_arrow_up: {
          guiName: n.t(null, void 0, l(45523)),
          id: 'shape_arrow_up',
        ...
        shape_circle: {
          guiName: n.t(null, void 0, l(91944)),
          id: 'shape_circle',
        ...
        shape_cross: {
          guiName: n.t(null, void 0, l(6969)),
          id: 'shape_cross',
        ...
        shape_diamond: {
          guiName: n.t(null, void 0, l(15179)),
          id: 'shape_diamond',
        ...
        shape_flag: {
          guiName: n.t(null, void 0, l(33885)),
          id: 'shape_flag',
        ...
        shape_label_down: {
          guiName: n.t(null, void 0, l(85924)),
          id: 'shape_label_down',
        ...
        shape_label_up: {
          guiName: n.t(null, void 0, l(49857)),
          id: 'shape_label_up',
        ...
        shape_square: {
          guiName: n.t(null, void 0, l(66205)),
          id: 'shape_square',
        ...
        shape_triangle_down: {
          guiName: n.t(null, void 0, l(76152)),
        ...
        shape_triangle_up: {
          guiName: n.t(null, void 0, l(21236)),
        ...
        shape_xcross: {
          guiName: n.t(null, void 0, l(11316)),
          id: 'shape_xcross',
