...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1455],
  {
    22523: (e, t, s) => {
      s.d(t, {
        DateAndPriceBaseProperties: () => f,
        allPropertiesStateKeysBase: () => y,
        nonThemedFactoryDefaultsBase: () => h,
      ...
      var i = s(50151),
        ...
        u = s(43337),
        c = s(88636);
      const d = (0, r.getHexColorByName)('color-tv-blue-500'),
        h = {
          linewidth: 2,
          fontsize: 12,
          ...
          showVolume: !0,
          intervalsVisibilities: { ...n.intervalsVisibilitiesDefaults },
        ...
        m = new Map([
          [
            o.StdTheme.Light,
            {
              ...
              linecolor: d,
              backgroundColor: (0, l.generateColor)(d, 85),
          ...
          [
            o.StdTheme.Dark,
            {
              ...
              labelBackgroundColor: (0, r.getHexColorByName)(
                'color-cold-gray-800',
              ),
              linecolor: d,
              backgroundColor: (0, l.generateColor)(d, 85),
      ...
      class f extends c.LineDataSourceProperty {
        constructor({
          ...
          const o = s?.customText;
          ((this._textProperty = new u.Property(o?.text ?? '')),
            this.childs().customText?.addChild('text', this._textProperty),
            this.addChild(
              'textsColors',
              new a.LineToolColorsProperty([
                (0, i.ensureDefined)(this.childs().customText?.child('color')),
              ]),
            ));
        }
        template() {
    ...
    22003: (e, t, s) => {
      (s.r(t), s.d(t, { LineToolDateAndPriceRange: () => T }));
      var i = s(50151),
        r = s(41414),
        o = s(19233),
        a = s(58978),
        ...
        c = s(31558),
        d = s(22523);
      const h = (0, a.getHexColorByName)('color-tv-blue-500'),
        m = {
        ...
        p = (0, n.extractThemedColors)(
          (0, i.ensureDefined)(y.get(l.StdTheme.Light)),
          (0, i.ensureDefined)(y.get(l.StdTheme.Dark)),
        ),
        f = (0, n.extractAllPropertiesKeys)(
          (0, i.ensureDefined)(y.get(l.StdTheme.Light)),
        ),
        g = (0, n.extractAllPropertiesKeys)(m),
        b = [
          ...new Set([
            ...f,
            ...g,
        ...
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () =>
              (0, u.factoryDefaultsForCurrentTheme)(m, y),
            nonThemedDefaultsKeys: g,
      ...
      class T extends r.LineDataSource {
        constructor(e, t, i, r) {
          (super(
            ...
            Promise.all([s.e(6290), s.e(986), s.e(6668), s.e(1583)])
              .then(s.bind(s, 33234))
              .then((e) => {
                this._setPaneViews([
    ...
    88636: (e, t, s) => {
      s.d(t, { LineDataSourceProperty: () => l });
      var i = s(90054),
        r = s(16738),
        o = s(50151),
        a = s(78176);
    ...
    70031: (e, t, s) => {
      ...
      var i = s(16738),
        ...
        l = s(24633);
      function n(e, t) {
        const s = a.watchedTheme.value() ?? l.StdTheme.Light,
          n = (0, r.default)(e);
