...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [607],
  {
    14472: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          LineDataSourceDefinitionsViewModel: () => g,
          LineDataSourceTabTypes: () => s,
      ...
      const h = r.t(null, void 0, i(40091)),
        _ = r.t(null, void 0, i(78930)),
        f = r.t(null, void 0, i(92516)),
        P = r.t(null, void 0, i(70320)),
        S = r.t(null, void 0, i(21429)),
        v = r.t(null, { context: 'linetool point' }, i(80166));
      class g {
        constructor(e, t) {
          ((this._yCoordinateStepWV = null),
            ...
            (this._source = t),
            (this._undoModel = e),
            (this._ownerSource = (0, o.ensureNotNull)(
              this._source.ownerSource(),
            )),
            (this._propertyApplier = new c.PropertyApplierWithoutSavingChart(
              () => e,
            )),
        ...
        _createPropertyRages() {
          ...
          const s = this._createCoordinatesPropertyPage();
          null !== s &&
            ((s.visible = this._source.hasEditableCoordinates()),
            this._propertyPages.push(s));
          const o = this._createVisibilitiesPropertyPage();
          ...
          return (0, a.createPropertyPage)(
            (0, p.getIntervalsVisibilitiesPropertiesDefinitions)(
              ...
              new n.TranslatedString(
                this._source.name(),
                this._source.title(y.TitleDisplayTarget.StatusLine, !0),
              ),
            ),
            'visibility',
            h,
        ...
        _getYCoordinateStepWV() {
          return (
            null === this._yCoordinateStepWV &&
              ((this._yCoordinateStepWV = new u.WatchedValue(
                (function (e) {
                  if (null !== e) {
                    const t = e.priceStep();
                    if (null !== t) return t;
        ...
        _createTextPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'text', P) : null;
        }
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'inputs', S) : null;
        }
      ...
      class V extends n.StudyLineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs().styles.childs(),
            ...
            s = new o.TranslatedString(t, this._source.translatedType()),
            n = e.baseLine.childs(),
            V = (0, r.createLinePropertyDefinition)(
              {
                checked: (0, r.convertToDefinitionProperty)(
                  this._propertyApplier,
                  new a.StudyPlotVisibleProperty(n.display),
                  u.format({ title: s }),
                ),
            ...
            M = (0, r.createLinePropertyDefinition)(
              {
                checked: (0, r.convertToDefinitionProperty)(
                  this._propertyApplier,
                  new a.StudyPlotVisibleProperty(A.display),
                  y.format({ title: s }),
                ),
                color: (0, r.getColorDefinitionProperty)(
                  this._propertyApplier,
              ...
              (0, r.createLinePropertyDefinition)(
                {
                  checked: (0, r.convertToDefinitionProperty)(
                    this._propertyApplier,
                    new a.StudyPlotVisibleProperty(L.display),
                    P.format({ title: s }),
                  ),
                  color: (0, r.getColorDefinitionProperty)(
                    this._propertyApplier,
    ...
    70162: (e, t, i) => {
      (i.r(t), i.d(t, { StudyOverlayDefinitionsViewModel: () => X }));
      var s = i(11542),
        o = i(95804),
        r = i(37103),
        n = i(50151),
      ...
      const b = s.t(null, void 0, i(92516)),
        D = s.t(null, void 0, i(21429)),
        I = s.t(null, void 0, i(40091)),
        w = [
          '1',
          '3',
          '5',
      ...
      class T {
        ...
        _createVisibilitiesPropertyPage() {
          const e = this._source
            ...
            .intervalsVisibilities.childs();
          return (0, a.createPropertyPage)(
            (0, g.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._undoModel,
              e,
              new o.TranslatedString(
                this._source.name(!0),
                this._source.title(v.TitleDisplayTarget.StatusLine, !0),
              ),
            ),
            'visibility',
            I,
          ...
          return (
            ...
            (function (e, t, i, s, r) {
              ...
              for (const u of t) {
                ...
                const t = _(u),
                  c = `StudyInput${u.id}`,
                  f = (0, d.getTranslatedInputTitle)(t),
                  P = new o.TranslatedString(t, f);
                let S = null;
                if ('resolution' === u.type)
                  ...
                  const t = (0, n.ensure)(r.sourcesItems);
                  S = (0, l.createOptionsPropertyDefinition)(
                    {
                      option: (0, l.convertToDefinitionProperty)(
                        e,
                  ...
                  S = (0, l.createOptionsPropertyDefinition)(
                    ...
                    { id: c, title: f, options: new p.WatchedValue(t) },
                  );
                } else if ('symbol' === u.type) {
                  const t = i[u.id],
                    s = (0, n.ensure)(r.getSymbolInfoBySymbol),
                    o = (0, n.ensure)(r.onSymbolsInfosChanged);
                  ...
                  S = (0, l.createTextPropertyDefinition)(
                    ...
                    { id: c, title: f, isEditable: !0, isMultiLine: !1 },
                  );
                a.push(S);
              }
        ...
        _getInputSourceItems() {
          const e = m.basePriceSources.slice(),
            t = (0, n.ensureNotNull)(this._sourceInput);
          if (this._source && this._source.isChildStudy()) {
            const i = this._source.inputs()[t.id],
              s = (0, n.ensureNotNull)(this._source.parentSourceForInput(i.v)),
              o = s.title(v.TitleDisplayTarget.StatusLine),
              r = P.StudyMetaInfo.getChildSourceInputTitles(t, s.metaInfo(), o);
          ...
          if (
            ...
            (this._source.isChildStudy() ||
              P.StudyMetaInfo.canBeChild(this._source.metaInfo()))
          ) {
            ...
            this._undoModel
              ...
              .forEach((t) => {
                const i = t.title(
                    v.TitleDisplayTarget.StatusLine,
                    !0,
                    void 0,
                    !0,
                  ),
                  ...
                  r = o.styles,
                  l = o.plots || [];
                if (1 === l.length) e.push({ id: s, value: s, title: i });
                else if (l.length > 1) {
                  const t = l.reduce((e, t, o) => {
                    if (!P.StudyMetaInfo.canPlotBeSourceOfChildStudy(t.type))
                      return e;
                    let l;
                    try {
                      l = (0, n.ensureDefined)(
                        (0, n.ensureDefined)(r)[t.id],
                      ).title;
                    } catch (e) {
                      l = t.id;
                    }
      ...
      const L = new o.TranslatedString(
          ...
          s.t(null, void 0, i(82924)),
        ),
        W = new o.TranslatedString(
          'change price line visibility',
          s.t(null, void 0, i(8662)),
        ),
        k = new o.TranslatedString(
          'change study overlay min tick',
          s.t(null, void 0, i(91109)),
        ),
        x = s.t(null, void 0, i(27377)),
        N = s.t(null, void 0, i(45054)),
        B = s.t(null, void 0, i(13459)),
        E = s.t(null, void 0, i(55761)),
        O = s.t(null, void 0, i(3554)),
        R = s.t(null, void 0, i(34456)),
        $ = s.t(null, void 0, i(99906)),
        U = s.t(null, void 0, i(59213)),
        H = s.t(null, void 0, i(98236)),
        F = s.t(null, void 0, i(9394)),
        Y = s.t(null, void 0, i(69217)),
        G = s.t(null, void 0, i(886)),
        j = s.t(null, void 0, i(92516)),
        q = s.t(null, void 0, i(72926)),
        z = s.t(null, void 0, i(64075)),
        J = [
          { title: x, value: 0 },
          { title: N, value: 1 },
          { title: B, value: 9 },
      ...
      r.enabled('chart_style_hilo') && J.push({ title: H, value: 12 });
      class X extends T {
        constructor(e, t) {
          (super(e, t),
        ...
        _stylePropertyDefinitions() {
          ...
          const e = this._source.properties().childs(),
            ...
            i = (0, l.createCheckablePropertyDefinition)(
              ...
              { id: 'StudyOverlayPriceLine', title: q },
            ),
            s = (0, l.createOptionsPropertyDefinition)(
              {
                option: (0, l.convertToDefinitionProperty)(
            ...
            o = (0, c.removeSpaces)(
              this._source.title(v.TitleDisplayTarget.StatusLine),
            );
          return {
            definitions: [
        ...
        _getSeriesStylesDefinitions() {
          ...
          return (0, C.getSeriesStylePropertiesDefinitions)(
            ...
            t,
            {
              seriesPriceSources: m.basePriceSources,
              isJapaneseChartsAvailable: !1,
            },
            'mainSeries',
            M.LineStylePropertyDefinitionsMode.Simple,
          );
        }
        _availableStyles() {
          ...
          return J.map((t) =>
            t.readonly
              ...
              : {
                  ...
                  title: t.title,
                  disabled:
                    ((0, A.isCloseBasedSymbol)(e) &&
                      !(0, A.isSingleValueBasedStyle)(t.value)) ||
                    ('hlc' === e?.visible_plots_set &&
                      !(
                        (0, A.isHLCBasedStyle)(t.value) ||
                        (0, A.isSingleValueBasedStyle)(t.value)
                      )),
                },
          );
    ...
    32823: (e, t, i) => {
      ...
      class c {
        ...
        hasUserEditableInputs() {
          return this._metaInfo.inputs.some(u);
        }
        getUserEditableInputs() {
          return this._metaInfo.inputs.filter(u);
        }
        ...
        hasUserEditableStyles() {
          ...
          return (
            ...
            (0, p.isCustomStudy)(e.shortId) ||
            r.StudyMetaInfo.isScriptStrategy(this._metaInfo) ||
        ...
        getUserEditablePlots() {
          ...
          return t.plots.filter((i) => {
            if (
              (0, n.isColorerPlot)(i) ||
              (0, n.isTextColorerPlot)(i) ||
              (0, n.isDataOffsetPlot)(i) ||
              (0, n.isOhlcColorerPlot)(i) ||
              (0, n.isAlertConditionPlot)(i) ||
              (0, n.isDataPlot)(i)
            )
              return !1;
            if ((0, n.isOhlcPlot)(i)) {
              ...
              if (e.has(o)) return !1;
              e.add(o);
              const r = (0, s.ensureDefined)(t.ohlcPlots);
              return !(0, s.ensureDefined)(r[o]).isHidden;
            }
            {
