...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    67725: (e, t, i) => {
      i.d(t, { createLineStyleDefinition: () => g });
      var r = i(11542),
        n = i(95804),
        s = i(95338),
        o = i(91682);
      const l = new n.TranslatedString(
          ...
          r.t(null, void 0, i(24550)),
        ),
        a = new n.TranslatedString(
          'change {toolName} line width',
          r.t(null, void 0, i(19541)),
        ),
        c = new n.TranslatedString(
          'change {toolName} line style',
          r.t(null, void 0, i(66429)),
        ),
        d = new n.TranslatedString(
          'change {toolName} line color',
          r.t(null, void 0, i(24059)),
        ),
        u = new n.TranslatedString(
          'change {toolName} line extending left',
          r.t(null, void 0, i(18773)),
        ),
        p = new n.TranslatedString(
          'change {toolName} line left end',
          r.t(null, void 0, i(21474)),
        ),
        h = new n.TranslatedString(
          'change {toolName} line extending right',
          r.t(null, void 0, i(43823)),
        ),
        _ = new n.TranslatedString(
          'change {toolName} line right end',
          r.t(null, void 0, i(54827)),
        ),
        f = r.t(null, void 0, i(3554)),
        v = r.t(null, void 0, i(61856)),
        y = r.t(null, void 0, i(87430));
      function g(e, t, i, r, n) {
        const g = {},
          P = {
            id: `${(0, o.removeSpaces)(i.originalText())}${r}`,
            title: (n && n.line) || f,
          };
        return (
          void 0 !== t.showLine &&
            (g.checked = (0, s.convertToDefinitionProperty)(
              e,
              t.showLine,
              l.format({ toolName: i }),
            )),
          void 0 !== t.lineWidth &&
            (g.width = (0, s.convertToDefinitionProperty)(
              e,
              t.lineWidth,
              a.format({ toolName: i }),
            )),
          void 0 !== t.lineStyle &&
            (g.style = (0, s.convertToDefinitionProperty)(
              e,
              t.lineStyle,
              c.format({ toolName: i }),
            )),
          void 0 !== t.lineColor &&
            (g.color = (0, s.getColorDefinitionProperty)(
              e,
              t.lineColor,
              null,
              d.format({ toolName: i }),
          ...
          void 0 !== t.extendLeft &&
            ((g.extendLeft = (0, s.convertToDefinitionProperty)(
              e,
              t.extendLeft,
              u.format({ toolName: i }),
            )),
            (P.extendLeftTitle = (n && n.extendLeftTitle) || v)),
          void 0 !== t.leftEnd &&
            (g.leftEnd = (0, s.convertToDefinitionProperty)(
              e,
              t.leftEnd,
              p.format({ toolName: i }),
            )),
          void 0 !== t.extendRight &&
            ((g.extendRight = (0, s.convertToDefinitionProperty)(
              e,
              t.extendRight,
              h.format({ toolName: i }),
            )),
            (P.extendRightTitle = (n && n.extendRightTitle) || y)),
          void 0 !== t.rightEnd &&
            (g.rightEnd = (0, s.convertToDefinitionProperty)(
              e,
              t.rightEnd,
              _.format({ toolName: i }),
            )),
          (0, s.createLinePropertyDefinition)(g, P)
        );
      }
    },
    14472: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          LineDataSourceDefinitionsViewModel: () => b,
      ...
      const _ = s.t(null, void 0, i(40091)),
        f = s.t(null, void 0, i(78930)),
        v = s.t(null, void 0, i(92516)),
        y = s.t(null, void 0, i(70320)),
        g = s.t(null, void 0, i(21429)),
        P = s.t(null, { context: 'linetool point' }, i(80166));
      class b {
        constructor(e, t) {
        ...
        _createCoordinatesPropertyPage() {
          ...
          return null !== e
            ? (e.definitions.length < this._source.pointsCount() &&
              ...
              (0, a.createPropertyPage)(e, 'coordinates', f))
            : null;
        }
        ...
        _createStylePropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'style', v) : null;
        }
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'inputs', g) : null;
        }
    ...
    40226: (e, t, i) => {
        ...
        return (
          i.prefixes.forEach((r) => {
            ...
            for (let r = i.range[0]; r <= i.range[1]; r++)
              if (e[n + r] && (0, s.isSameType)(e[n + r], t.typecheck())) {
                let s = t.tpl();
                (i.names.forEach((i, o) => {
                  s = t.fill('' + o, i, e[n + r], s);
                }),
                  (e[n + r] = s));
              }
          }),
      ...
      class f extends o.DefaultProperty {
        constructor(e) {
          const { levelsIterator: t = h, map: i = {}, ...r } = e,
            n = { ...a, ...i };
          ...
          return i
            ...
            : ((n = r),
              ...
              (0, this._levelsIterator)(
                n,
                { tpl: u, fill: c, typecheck: s.typecheck.pack },
                s,
              ));
          var n, s;
        }
    ...
    44005: (e, t, i) => {
      i.d(t, {
        ...
        CollectibleColorPropertyUndoWrapper: () => o,
      });
      var r = i(50151),
        n = i(43337);
      class s extends n.Property {
        constructor(e) {
          (super(),
      ...
      class u extends a.InplaceTextLineSourcePaneView {
        constructor(e, t, i, l) {
          ...
          for (let t = 1; t <= e.levelsCount(); t++)
            this._labelsRenderers[t] = new n.TextRenderer(
              void 0,
        ...
        _updateLabelForLevel(e) {
          ...
          if (!i) return null;
          const r = this._source.ownerSource()?.firstValue();
          if (null == r) return null;
          const n = this._source.properties(),
            s = Boolean(n.showCoeffs?.value()),
            o = Boolean(n.showPrices?.value());
          if (!s && !o) return null;
          const l = n['level' + e.levelIndex].coeff.value();
          let a = '';
          if (s) {
            a +=
              (n.coeffsAsPercents?.value() ?? !1)
        ...
        _updateRendererLabel(e, t, i) {
          ...
          return (
            t.setData({
              ...
              fontSize: p.labelFontSize?.value() ?? 12,
              ...u,
            }),
            t
          );
    ...
    2709: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolFibSpeedResistanceArcs: () => j }));
      var r = i(50151),
        n = i(11542),
        s = i(95804),
        o = i(40226),
        ...
        h = i(91682),
        _ = i(44005);
      const f = new s.TranslatedString(
          'change {title} level {index} line visibility',
          n.t(null, void 0, i(51403)),
        ),
        v = new s.TranslatedString(
          'change {title} levels visibility',
          n.t(null, void 0, i(54517)),
        ),
        y = new s.TranslatedString(
        ...
        w = new s.TranslatedString(
          'change {title} full circles visibility',
          n.t(null, void 0, i(30484)),
        ),
        x = n.t(null, void 0, i(51574)),
        S = n.t(null, void 0, i(28683)),
        C = n.t(null, void 0, i(79468)),
        D = n.t(null, void 0, i(79650)),
        L = n.t(null, void 0, i(95279));
      class A extends p.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            t = this._source.properties().childs(),
            i = this._source.name(),
            n = (0, h.removeSpaces)(i),
            o = new s.TranslatedString(i, this._source.translatedType()),
          ...
          const p = (0, u.createColorPropertyDefinition)(
            {
              color: (0, u.getColorDefinitionProperty)(
                this._propertyApplier,
          ...
          e.push(p);
          const A = (0, u.createTransparencyPropertyDefinition)(
            {
              checked: (0, u.convertToDefinitionProperty)(
                this._propertyApplier,
                t.fillBackground,
          ...
          e.push(A);
          const I = (0, u.createCheckablePropertyDefinition)(
            {
              checked: (0, u.convertToDefinitionProperty)(
                this._propertyApplier,
                t.showCoeffs,
          ...
          e.push(I);
          const R = (0, u.createCheckablePropertyDefinition)(
            {
              checked: (0, u.convertToDefinitionProperty)(
                this._propertyApplier,
                t.fullCircles,
            ...
            { id: `${n}FullCircles`, title: L },
          );
          return (e.push(R), { definitions: e });
        }
      }
      var I = i(10555),
        R = i(50605),
        ...
        H = i(4539),
        B = i(20820);
      class $ extends B.MediaCoordinatesPaneRenderer {
        constructor(e, t, i) {
          (super(),
            (this._data = e),
            (this._hittest = t || new V.HitTestResult(V.HitTarget.MovePoint)),
            (this._backHittest =
              i || new V.HitTestResult(V.HitTarget.MovePointBackground)));
        }
        hitTest(e) {
          const t = this._data;
          if (null === t) return null;
          if ((0, k.sign)(e.y - t.center.y) !== t.dir && !t.fullCircles)
            return null;
          const i = e.subtract(t.center).length(),
            r = (0, H.interactionTolerance)().curve;
          return Math.abs(i - t.radius) < r
            ? this._hittest
            : t.hittestOnBackground && Math.abs(i) <= t.radius + r
              ? this._backHittest
              : null;
        }
        _drawImpl(e) {
          ...
          ((i.lineCap = 'round'),
            ...
            t.fillBackground &&
              ...
              (i.fillStyle = (0, F.generateColor)(t.color, t.transparency, !0)),
              i.fill()));
        }
      }
      class z extends W.LineToolPaneViewFibWithLabels {
        constructor() {
          (super(...arguments),
            (this._trendLineRenderer = new N.TrendLineRenderer()),
            (this._renderer = null),
            (this._levels = []));
        }
        renderer(e) {
        ...
        _updateImpl(e) {
          ...
          for (let e = 1; e <= a; e++) {
            ...
            const l = i.coeff.value(),
              a = i.color.value(),
              c = Math.abs(s.subtract(n).length() * l),
              d = (0, k.sign)(s.y - n.y),
              u = new I.Point(n.x, n.y + d * o * Math.abs(l));
            this._levels.push({
              color: a,
              radius: c,
              dir: d,
          ...
          const c = new M.CompositeRenderer(),
            d = l.fillBackground.value(),
            u = l.transparency.value();
          for (let e = 0; e < this._levels.length; e++) {
            const t = this._levels[e],
              i = {
                ...
                fullCircles: l.fullCircles.value(),
                radius2: e > 0 ? this._levels[e - 1].radius : void 0,
              },
              r = new V.HitTestResult(V.HitTarget.MovePoint, void 0, t.index);
            c.append(new $(i, r));
            const s = this._updateLabelForLevel({
              ...
              horzAlign: R.HorizontalAlign.Left,
              vertAlign: R.VerticalAlign.Middle,
            });
            null !== s && c.append(s);
          }
          const p = l.trendline.childs();
          if (p.visible.value()) {
            const e = {
              ...
              extendleft: !1,
              extendright: !1,
              leftend: E.LineEnd.Normal,
              rightend: E.LineEnd.Normal,
            };
      ...
      const Y = new s.TranslatedString(
        'erase level line',
      ...
      class j extends c.InplaceTextLineDataSource {
        constructor(e, t, i, r) {
          (super(
            e,
            t ?? j.createProperties(e.backgroundTheme().spawnOwnership()),
            i,
            r,
          ),
            this._setPaneViews([new z(this, this._model)]));
        }
        levelsCount() {
          return 11;
        }
        ...
        processErase(e, t) {
          const i = `level${t}`,
            n = (0, r.ensureDefined)(this.properties().child(i)).childs()
              .visible;
          e.setProperty(n, !1, Y, a.lineToolsDoNotAffectChartInvalidation);
        }
        ...
        static _configureProperties(e) {
          ...
          const t = e.childs().trendline.childs(),
            ...
            n = [t.color];
          for (let t = 1; t <= 11; t++) {
            const s = (0, r.ensureDefined)(e.child(`level${t}`)).childs();
            (i.push(s.linewidth), n.push(s.color));
          }
          (e.addChild('linesColors', new l.LineToolColorsProperty(n)),
            e.addChild('linesWidths', new l.LineToolWidthsProperty(i)));
        }
      }
    },
    24961: (e, t, i) => {
