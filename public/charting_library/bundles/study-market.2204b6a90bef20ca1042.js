(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6456, 9790],
  {
    ...
    98301: (e) => {
      e.exports = {
        container: 'container-PVi_27Zl',
        centerElement: 'centerElement-PVi_27Zl',
        contentWrap: 'contentWrap-PVi_27Zl',
        withTransition: 'withTransition-PVi_27Zl',
        noticeShowed: 'noticeShowed-PVi_27Zl',
        icon: 'icon-PVi_27Zl',
        textWrap: 'textWrap-PVi_27Zl',
      };
    },
    35266: (e) => {
      e.exports = {
    ...
    37963: (e) => {
      e.exports = {
        ...
        mobile: 'mobile-XOHpda28',
        withoutFavoriting: 'withoutFavoriting-XOHpda28',
      };
    },
    58794: (e) => {
      e.exports = {
    ...
    86332: (e, t, i) => {
      'use strict';
      i.d(t, { ControlGroupContext: () => n });
      const n = i(50959).createContext({
        isGrouped: !1,
    ...
    95604: (e, t, i) => {
      ...
      i.d(t, { getGroupCellRemoveRoundBorders: () => n });
    },
    43010: (e, t, i) => {
      'use strict';
    ...
    87896: (e, t, i) => {
      ...
      function u(e, t, i = 'legacy') {
        const o = n.createElement(d, { renderMode: i }, e);
        if ('modern' === i) {
          ...
          return (
            ...
            {
              render(t) {
                e.render(n.createElement(d, { renderMode: i }, t));
              },
              unmount() {
                e.unmount();
              },
        ...
        return (
          ...
          {
            render(e) {
              r.render(n.createElement(d, { renderMode: i }, e), t);
            },
            unmount() {
    ...
    86682: (e, t, i) => {
      'use strict';
      (i.r(t), i.d(t, { IndicatorsLibraryContainer: () => ge }));
      var n = i(50959),
        r = i(11542),
        s = i(78861);
      ...
      function b(e) {
        const {
          ...
          h =
            v.enabled('graying_disabled_tools_enabled') &&
      ...
      function k(e) {
        ...
        return n.createElement(
          'span',
          { className: E()(P.title, r && P.disabled, i) },
          t,
        );
      }
      var L = i(91682);
      ...
      function B(e) {
        const t = (0, n.useContext)(F),
          ...
          P = (0, L.decodeHTMLEntities)(c.title),
          M = void 0 !== C,
          B = O(_, c),
          H = (0, n.useCallback)(
            (e) => {
        ...
        return n.createElement(
          ...
          n.createElement(
            'div',
            { className: E()(W.main, !M && W.paddingLeft) },
            M &&
              n.createElement(D.FavoriteButton, {
                className: E()(W.favorite, C && W.isActive),
                isFilled: C,
                onClick: U,
              }),
            n.createElement(
              k,
              { disabled: c.isGrayed, className: E()(l && W.mobileText) },
              n.createElement(A.HighlightedText, {
                queryString: d,
                rules: u,
                text: P,
              }),
            ...
            p &&
              n.createElement(BadgeStatus, { type: 'new', className: W.badge }),
            m &&
              n.createElement(BadgeStatus, {
                type: 'updated',
                className: W.badge,
      ...
      function O(e, t) {
        return (i) => {
          const n = 0 === (0, M.modifiersFromEvent)(i) && 0 === i.button;
      ...
      var q = i(37963);
      function V(e) {
        const { style: t, children: i, isMobile: r, withoutFavoriting: s } = e;
        return n.createElement(
          'div',
          {
            style: t,
      ...
      function Z(e) {
        const {
          ...
          [d, u] = (0, n.useState)(''),
          h = (0, n.useMemo)(() => (0, J.createRegExpList)(d, _), [d]),
          p = (0, n.useMemo)(
            () =>
              d
                ? (0, J.rankedSearch)({
            ...
            return (
              ...
              ),
              {
                ...
                handleKeyDown: function (e) {
                  ...
                  if (
                    (40 === (0, M.hashFromEvent)(e) &&
                      (e.preventDefault(), h(), v(n)),
                    38 === (0, M.hashFromEvent)(e) &&
                      (e.preventDefault(), p(), v(t)),
                    13 === (0, M.hashFromEvent)(e) && d)
                  ) {
                    if (!i) return;
                    (i(d), a(d));
                  }
          ...
          render: () =>
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  N,
                  { id: k, reference: b, role: 'listbox', className: z.scroll },
                  P
                      ...
                      ? n.createElement(
                          ...
                          m.map((e) =>
                            n.createElement(B, {
                              ...
                              query: d,
                              regExpRules: h,
                              reference: f?.id === e.id ? g : void 0,
                              isSelected: f?.id === e.id,
                              isHighlighted: v?.id === e.id,
                              favoriteClickHandler: (t) => {
                                (t.stopPropagation(),
                                  (0, Y.toggleFavorite)(e.title));
                              },
                            }),
                          ),
                        )
      ...
      const K = 'indicators_dialog_item';
      function Q(e) {
        if (void 0 !== e) return `${K}_${e}`;
      }
      var ee = i(89880),
        te = i(76422),
        ie = i(72972),
        ...
        de = i(99084);
      function ue(e) {
        const { text: t, withTransition: i = !0 } = e,
          r = (0, le.useHintShowAnimation)(2500);
        return n.createElement(
          'div',
          { className: ce.container },
          n.createElement(
            'div',
            { className: ce.centerElement },
            n.createElement(
              'div',
              {
                className: w(
              ...
              n.createElement(ae.Icon, { icon: de, className: ce.icon }),
              n.createElement('div', { className: ce.textWrap }, t),
            ),
          ),
        );
      }
      class he {
        constructor(e, t) {
          ((this._showed = !1),
            ...
            t && this._wrap.classList.add(t),
            (this._container = e),
            (this._debouncedHide = (0, oe.default)(() => this.hide(), 3e3)));
        }
        show(e, t) {
          this._wrap &&
            !this._showed &&
            ...
            se.render(
              n.createElement(ue, { text: e, withTransition: t }),
              this._wrap,
            ),
            this._debouncedHide());
        }
        hide() {
          this._wrap &&
            ((this._showed = !1),
            se.unmountComponentAtNode(this._wrap),
            this._wrap.remove());
        }
        destroy() {
      ...
      class me {
        constructor(e = !1) {
          ((this._searchInputRef = n.createRef()),
            ...
            (this._parentSources = []),
            (this._ignoreChecksWhenAddingStudy = !1),
            (this._visibility = new ne.WatchedValue(!1)),
            ...
            (this._ignoreChecksWhenAddingStudy = e));
        }
        isDestroyed() {
        ...
        _applyStudy(e, t) {
          e.isGrayed
            ...
            : (x.CheckMobile.any() || this._searchInputRef.current?.select(),
              this._insertStudyImpl(e, t).then((t) => {
                (null === t && this._hintRenderer?.hide(),
                  null !== t &&
                    ((0, pe.hasConfirmInputs)(t.inputs) ||
                      (0, pe.isSymbolicStudy)(t)) &&
                    this._hintRenderer?.show(this._getHintText(e.title)));
        ...
        _requestBuiltInJavaStudies() {
          return (0, ie.studyMetaInfoRepository)().findAllJavaStudies();
        }
        _focus() {
        ...
        _showHint(e) {
          if (window.matchMedia(re.DialogBreakpoints.TabletSmall).matches) {
            if ((this._hintRenderer?.hide(), !this._hintRenderer)) {
              const e = this._dialog.current?.getElement();
              e && (this._hintRenderer = new he(e));
            }
            this._hintRenderer?.show(this._getHintText(e));
          }
        }
        _getHintText(e) {
          return ee.t(null, { replace: { studyTitle: e } }, i(33673));
        }
      }
      function ve(e, t) {
        return e[t] || [];
      ...
      class ge extends me {
        constructor(e, t) {
          (super(),
            ...
            t && (this._options = t),
            (this._props = new ne.WatchedValue({
              data: [],
        ...
        async _insertStudyImpl(e, t) {
          const i = await (async function (e, t, i, n, r, o) {
            ...
            if ('java' === c.type) {
              const e = (0, f.tryFindStudyLineToolNameByStudyId)(c.studyId);
              if (null !== e)
                return (await (0, f.initLineTool)(e), s.tool.setValue(e), null);
            }
        ...
        async _init() {
          const e = (function (e) {
            ...
            })((await this._requestBuiltInJavaStudies()).map(b)),
          );
          ((this._indicatorData = await (async function (e, t) {
            let i = { ...t };
            return [
              ...ve(i, 'tv-basicstudies'),
              ...ve(i, 'Script$STD'),
              ...ve(i, 'tv-volumebyprice'),
            ]
            ...
            Y.favoriteAdded.subscribe(null, () => this._refreshFavorites()),
            Y.favoriteRemoved.subscribe(null, () => this._refreshFavorites()));
        }
        _setFavorites() {
          v.enabled('items_favoriting') &&
            this._indicatorData.forEach((e) => {
              e.isFavorite = (0, Y.isFavorite)(e.title);
            });
        }
        _refreshFavorites() {
        ...
        _render() {
          ...
          this._rootInstance
            ...
            : (this._rootInstance = (0, fe.createReactRoot)(i, t));
        }
      }
    },
    74670: (e, t, i) => {
    ...
    36189: (e, t, i) => {
      ...
      function h(e) {
        const {
          ...
          [v, f] = (0, l.useActiveDescendant)(null),
          g =
            p ??
            (i
    ...
    65718: (e, t, i) => {
      'use strict';
      i.d(t, { Portal: () => n.Portal, PortalContext: () => n.PortalContext });
      var n = i(19250);
    },
    63932: (e, t, i) => {
      'use strict';
      ...
      function c(e) {
        ...
        return n.createElement('div', {
          className: s()(
            ...
            'tv-spinner',
            'tv-spinner--shown',
            `tv-spinner--size_${o.spinnerSizeMap[c || o.DEFAULT_SIZE]}`,
            u && l().disableSelfPositioning,
          ),
          style: a,
          role: 'progressbar',
          id: d,
