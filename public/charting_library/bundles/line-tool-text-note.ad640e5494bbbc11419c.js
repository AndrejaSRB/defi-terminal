...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    91445: (e, t, i) => {
      i.d(t, { createTextStyleDefinition: () => D });
      var o = i(11542),
        r = i(95804),
        n = i(95338),
        l = i(91682);
      ...
      function D(e, t, i, o) {
        ...
        if (
          ...
          const l = h.format({ toolName: i });
          ((r.text = (0, n.convertToDefinitionProperty)(e, t.text, l, void 0)),
            (D.isEditable = Boolean(o.isEditable)),
            (D.isMultiLine = Boolean(o.isMultiLine)));
        }
        if (
          (void 0 !== t.vertLabelsAlign &&
            ...
            (D.alignmentVerticalItems = o.alignmentVerticalItems)),
          void 0 !== t.horzLabelsAlign &&
            ...
            (D.alignmentHorizontalItems = o.alignmentHorizontalItems)),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (D.backgroundTitle =
              (o.customTitles && o.customTitles.backgroundTitle) || T),
          ...
          (void 0 === t.borderVisible &&
            ...
            void 0 === t.borderWidth) ||
            (D.borderTitle =
              (o.customTitles && o.customTitles.borderTitle) || C),
          void 0 !== t.wrap &&
            ...
            (D.wrapTitle = (o.customTitles && o.customTitles.wrapTitle) || P)),
          (0, n.createTextPropertyDefinition)(r, D)
        );
      }
    },
    14472: (e, t, i) => {
      ...
      class x {
        ...
        _createTextPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'text', _) : null;
        }
    ...
    55241: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolTextNote: () => pe }));
      var o = i(18712),
        r = i(50151),
        n = i(24633),
        l = i(49156),
        ...
        h = i(65045);
      const p = {
          intervalsVisibilities: { ...s.intervalsVisibilitiesDefaults },
          drawBackground: !0,
          drawBorder: !1,
          fontSize: 14,
          bold: !1,
        ...
        f = (0, d.extractThemedColors)(
          (0, r.ensureDefined)(g.get(n.StdTheme.Light)),
          (0, r.ensureDefined)(g.get(n.StdTheme.Dark)),
        ),
        b = (0, d.extractAllPropertiesKeys)(
          (0, r.ensureDefined)(g.get(n.StdTheme.Light)),
        ),
        _ = (0, d.extractAllPropertiesKeys)(p),
        v = [
          ...new Set([
            ...b,
            ..._,
        ...
        y = [...new Set([...b, ..._, 'text'])];
      class x extends u.LineDataSourceProperty {
        constructor(e) {
          (super(e),
            this.hasChild('text') || this.addProperty('text', ''),
            this.addChild(
              'linesColors',
              new h.LineToolColorsProperty([
        ...
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () =>
              (0, c.factoryDefaultsForCurrentTheme)(p, g),
            nonThemedDefaultsKeys: _,
      ...
      var W,
        ...
        O = i(9750);
      function K(e) {
        return E.enabled('text-note-align-anchor-to-corner')
          ? (function (e) {
              let t, i;
              return (
                e >= -180 && e < -90
                  ? ((t = B.HorizontalAlign.Right),
                    (i = B.VerticalAlign.Bottom))
                  : e >= -90 && e <= 0
                    ? ((t = B.HorizontalAlign.Left),
                      (i = B.VerticalAlign.Bottom))
                    : e > 0 && e <= 90
                      ? ((t = B.HorizontalAlign.Left),
                        (i = B.VerticalAlign.Top))
                      : ((t = B.HorizontalAlign.Right),
                        (i = B.VerticalAlign.Top)),
                { horzAlign: t, vertAlign: i }
              );
      ...
      class Y extends R.BitmapCoordinatesPaneRenderer {
        constructor(e) {
          (super(),
            (this._data = null),
            (this._textLabelRenderer = new H.TextRenderer()),
            ...
            this._textHitTest.mergeData({ activeItem: W.Label }));
        }
        setData(e) {
          (null === this._data ||
          ...
          this._textLabelRenderer.setData({
            horzAlign: B.HorizontalAlign.Left,
            vertAlign: B.VerticalAlign.Middle,
            points: [t],
            ...
            backgroundRoundRect: F.RoundRectRadius,
            boxPaddingVert: F.LabelVertPadding,
            boxPaddingHorz: F.LabelHorzPadding,
            boxShadow:
          ...
          const i = this._textLabelRenderer.rect(),
            ...
            r = e.points[1],
            n = K(
              Math.round((180 * Math.atan2(r.y - o.y, r.x - o.x)) / Math.PI),
            );
          let l = e.points[1];
          switch (n.horzAlign) {
            case B.HorizontalAlign.Center:
              l = l.add((0, A.point)(0.5 * -i.width, 0));
              break;
            case B.HorizontalAlign.Right:
              l = l.add((0, A.point)(-i.width, 0));
          }
          switch (n.vertAlign) {
            case B.VerticalAlign.Top:
              l = l.add((0, A.point)(0, 0.5 * i.height));
              break;
            case B.VerticalAlign.Bottom:
              l = l.add((0, A.point)(0, 0.5 * -i.height));
          }
          this._textLabelRenderer.setPoint(l);
        }
        setCursorType(e) {
        ...
        hitTest(e) {
          ...
          const i = (0, M.interactionTolerance)().line + 0.5,
            o = t.points[0],
            r = t.points[1];
          if ((0, L.distanceToSegment)(o, r, e).distance <= i)
            return this._lineHitTest;
          const n = this._textLabelRenderer.rect(),
            l = (0, A.box)(
              (0, A.point)(n.x, n.y),
              (0, A.point)(n.x + n.width, n.y + n.height),
            );
          return (0, V.pointInBox)(e, l) ? this._textHitTest : null;
        }
        getTextInfo() {
          const e = (0, r.ensureNotNull)(this._data),
            t = (0, k.isRtl)() ? 'right' : 'left',
            i = F.RoundRectRadius,
            o = F.TextMargins,
            ...
            ).add((0, A.point)(0, 0.5 * -l.height)),
            { totalWidth: a, totalHeight: d } = n,
            c = i + o;
          return {
        ...
        positionToCoordinate(e, t) {
          ...
          return { x: l + o.textLeft, y: s + o.textTop, lineNumber: a };
        }
        _drawImpl(e) {
          const t = this._data;
          ...
          const { context: i } = e,
            o = t.points[0];
          let r = t.points[1];
          if (E.enabled('text-note-align-anchor-to-corner')) {
            const e = Math.atan2(r.y - o.y, r.x - o.x);
            r = r.add(new A.Point(2 * Math.cos(e), 2 * Math.sin(e)));
          }
          ((i.strokeStyle = t.lineColor),
            (i.lineWidth = Math.max(1, Math.floor(e.horizontalPixelRatio))),
            i.beginPath());
          const [n, l] = (0, z.addPixelPerfectLineToPath)(
            i,
            o.x,
            o.y,
            r.x,
          ...
          i.stroke();
          const s = Math.round(F.CircleRadius * e.horizontalPixelRatio);
          ((i.fillStyle = t.lineColor),
            ...
            (i.lineWidth = 1));
          const a = Math.round(
            F.CircleRadius * e.horizontalPixelRatio +
      ...
      var G = i(52859);
      const $ = (0, G.generateColor)(
          (0, T.getHexColorByName)('color-black'),
          80,
        ),
        U = (0, G.generateColor)((0, T.getHexColorByName)('color-black'), 60);
      class X extends w.InplaceTextLineSourcePaneView {
        constructor(e, t, i, o) {
          (super(e, t, i, o),
            (this._renderer = new S.CompositeRenderer()),
            (this._noteRenderer = new Y(
              new N.HitTestResult(
                N.HitTarget.MovePoint,
                (0, w.inplaceEditHandlers)(
      ...
      var j = i(11542),
        ...
        Z = i(95338),
        ee = i(91682);
      const te = new q.TranslatedString(
          'change {title} line color',
          j.t(null, void 0, i(7455)),
        ),
        ie = new q.TranslatedString(
          'change {title} background visibility',
          j.t(null, void 0, i(30839)),
        ),
        oe = new q.TranslatedString(
          'change {title} background color',
          j.t(null, void 0, i(49765)),
        ),
        re = new q.TranslatedString(
          'change {title} border visibility',
          j.t(null, void 0, i(19298)),
        ),
        ne = new q.TranslatedString(
          'change {title} border color',
          j.t(null, void 0, i(69437)),
        ),
        le = j.t(null, void 0, i(70320)),
        se = j.t(null, void 0, i(97575)),
        ae = j.t(null, void 0, i(34974)),
        de = j.t(null, void 0, i(16236));
      class ce extends Q.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = (0, ee.removeSpaces)(t),
            o = new q.TranslatedString(t, this._source.translatedType());
          return {
            definitions: [
              (0, Z.createColorPropertyDefinition)(
                {
                  checked: (0, Z.convertToDefinitionProperty)(
                    this._propertyApplier,
                    e.drawBackground,
                    ie.format({ title: o }),
                  ),
                  color: (0, Z.getColorDefinitionProperty)(
                    this._propertyApplier,
                    e.backgroundColor,
                    null,
                    oe.format({ title: o }),
                ...
                { id: (0, ee.removeSpaces)(`${t}BackgroundColor`), title: de },
              ),
              (0, Z.createColorPropertyDefinition)(
                {
                  checked: (0, Z.convertToDefinitionProperty)(
                ...
                { id: (0, ee.removeSpaces)(`${t}BorderColor`), title: ae },
              ),
              (0, Z.createColorPropertyDefinition)(
                {
                  color: (0, Z.getColorDefinitionProperty)(
        ...
        _textPropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, J.createTextStyleDefinition)(
                this._propertyApplier,
                { ...i, textColor: i.textColor, fontSize: i.fontSize },
                new q.TranslatedString(
                  this._source.name(),
                  this._source.translatedType(),
                ),
                { isEditable: !0, isMultiLine: !0, customTitles: { text: le } },
              ),
            ],
          };
        }
          ...
          if (null !== this._labelMovingDelta) {
            ...
            return (
              ...
              this._line.updateAllViews(
                (0, ue.sourceChangeEvent)(this._line.id()),
              ),
              !0
            );
          }
      ...
      class pe extends m.InplaceTextLineDataSource {
        constructor(e, t, i, o) {
          (super(
            e,
            t ?? pe.createProperties(e.backgroundTheme().spawnOwnership()),
            i,
            o,
          ),
            (this._moveAsChangeBehavior = new he(this, W.Label)),
            this._setPaneViews([
              new X(
                this,
                e,
