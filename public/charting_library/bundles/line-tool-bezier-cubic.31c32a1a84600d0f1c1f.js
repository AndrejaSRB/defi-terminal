  ...
  [9014],
  {
    67725: (e, t, i) => {
      ...
      const a = new r.TranslatedString(
        ...
        P = n.t(null, void 0, i(61856)),
        f = n.t(null, void 0, i(87430));
      function S(e, t, i, n, r) {
        ...
        return (
          void 0 !== t.showLine &&
            (S.checked = (0, o.convertToDefinitionProperty)(
              e,
              t.showLine,
              a.format({ toolName: i }),
            )),
          void 0 !== t.lineWidth &&
            (S.width = (0, o.convertToDefinitionProperty)(
              e,
              t.lineWidth,
              l.format({ toolName: i }),
            )),
          void 0 !== t.lineStyle &&
            (S.style = (0, o.convertToDefinitionProperty)(
              e,
              t.lineStyle,
              d.format({ toolName: i }),
            )),
          void 0 !== t.lineColor &&
            (S.color = (0, o.getColorDefinitionProperty)(
              e,
              t.lineColor,
              null,
              c.format({ toolName: i }),
          ...
          void 0 !== t.extendLeft &&
            ((S.extendLeft = (0, o.convertToDefinitionProperty)(
              e,
              t.extendLeft,
              h.format({ toolName: i }),
            )),
            (x.extendLeftTitle = (r && r.extendLeftTitle) || P)),
          void 0 !== t.leftEnd &&
            (S.leftEnd = (0, o.convertToDefinitionProperty)(
              e,
              t.leftEnd,
              u.format({ toolName: i }),
            )),
          void 0 !== t.extendRight &&
            ((S.extendRight = (0, o.convertToDefinitionProperty)(
              e,
              t.extendRight,
              p.format({ toolName: i }),
            )),
            (x.extendRightTitle = (r && r.extendRightTitle) || f)),
          void 0 !== t.rightEnd &&
            (S.rightEnd = (0, o.convertToDefinitionProperty)(
              e,
              t.rightEnd,
              _.format({ toolName: i }),
            )),
          (0, o.createLinePropertyDefinition)(S, x)
        );
      }
    },
    83138: (e, t, i) => {
    ...
    14472: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          LineDataSourceDefinitionsViewModel: () => y,
          LineDataSourceTabTypes: () => n,
          pointPriceBarTitle: () => x,
        }));
      var n,
        r = i(50151),
        o = i(11542),
      ...
      const _ = o.t(null, void 0, i(40091)),
        g = o.t(null, void 0, i(78930)),
        P = o.t(null, void 0, i(92516)),
        f = o.t(null, void 0, i(70320)),
        S = o.t(null, void 0, i(21429)),
        x = o.t(null, { context: 'linetool point' }, i(80166));
      class y {
        constructor(e, t) {
        ...
        _createPropertyRages() {
          ...
          const n = this._createCoordinatesPropertyPage();
          null !== n &&
            ((n.visible = this._source.hasEditableCoordinates()),
        ...
        _getYCoordinateStepWV() {
          return (
            null === this._yCoordinateStepWV &&
              ((this._yCoordinateStepWV = new d.WatchedValue(
                (function (e) {
                  if (null !== e) {
                    const t = e.priceStep();
                    if (null !== t) return t;
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return (
            e.forEach((e, r) => {
              ...
              o &&
                i.push(
                  (0, h.getCoordinatesPropertiesDefinitions)(
                    this._propertyApplier,
                    o,
                    e,
                    n,
                    x.format({ count: (r + 1).toString() }),
                    this._source.name(),
                  ),
                );
            }),
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, l.createPropertyPage)(e, 'inputs', S) : null;
        }
    ...
    42318: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolBezierCubic: () => v }));
      var n = i(50151),
        r = i(78176),
        o = i(41414),
        s = i(83138),
        ...
        P = i(4539),
        f = i(58221);
      class S extends d.MediaCoordinatesPaneRenderer {
        constructor(e) {
        ...
        hitTest(e) {
          ...
          if (4 === t.points.length) {
            const i = (0, P.interactionTolerance)().curve,
              [n, r, o, s] = t.points,
              a = s.subtract(n),
              l = o.subtract(a.scaled(0.25)),
              d = o.add(a.scaled(0.25)),
              h = r.subtract(o),
              p = s.subtract(h.scaled(0.25)),
              _ = s.add(h.scaled(0.25));
            if (
              (0, u.quadroBezierHitTest)(o, n, l, e, i) ||
              (0, u.cubicBezierHitTest)(o, d, p, s, e, i) ||
              (0, u.quadroBezierHitTest)(s, r, _, e, i)
            )
              return new c.HitTestResult(c.HitTarget.MovePoint);
            let f = (0, g.hitTestExtendedPoints)(e, i, t.extendLeftPoints);
            return (
              null === f &&
                (f = (0, g.hitTestExtendedPoints)(e, i, t.extendRightPoints)),
              f
            );
          }
          return null;
        ...
        _drawImpl(e) {
          ...
          ((t.lineCap = 'round'),
            ...
            (0, f.setLineStyle)(t, this._data.lineStyle));
          ...
          if (2 === this._data.points.length)
            (t.beginPath(),
              ...
              t.lineTo(n.x, n.y),
              t.stroke(),
              this._data.leftEnd === _.LineEnd.Arrow &&
                (0, p.drawArrow)(n, i, t, t.lineWidth, h.dpr1PixelRatioInfo),
              this._data.rightEnd === _.LineEnd.Arrow &&
                (0, p.drawArrow)(i, n, t, t.lineWidth, h.dpr1PixelRatioInfo));
          else {
            const e = this._data.points[2],
              r = this._data.points[3],
              o = r.subtract(i),
              s = e.subtract(o.scaled(0.25)),
              a = e.add(o.scaled(0.25)),
              l = n.subtract(e),
              d = r.subtract(l.scaled(0.25)),
              c = r.add(l.scaled(0.25));
            (this._data.fillBack &&
              ...
              t.bezierCurveTo(a.x, a.y, d.x, d.y, r.x, r.y),
              t.quadraticCurveTo(c.x, c.y, n.x, n.y),
              t.fill()),
              t.beginPath(),
              (0, g.buildExtendedSegments)(t, this._data.extendLeftPoints),
              t.moveTo(i.x, i.y),
              t.quadraticCurveTo(s.x, s.y, e.x, e.y),
              t.bezierCurveTo(a.x, a.y, d.x, d.y, r.x, r.y),
              t.quadraticCurveTo(c.x, c.y, n.x, n.y),
              (0, g.buildExtendedSegments)(t, this._data.extendRightPoints),
              this._data.leftEnd === _.LineEnd.Arrow &&
                (0, p.drawArrow)(s, i, t, t.lineWidth, h.dpr1PixelRatioInfo),
              this._data.rightEnd === _.LineEnd.Arrow &&
                (0, p.drawArrow)(c, n, t, t.lineWidth, h.dpr1PixelRatioInfo),
              t.stroke());
          }
        }
      }
      ...
      class m extends l.LineSourcePaneView {
        constructor() {
          (super(...arguments),
            (this._bezierCubicRenderer = new S()),
        ...
        _updateImpl(e) {
          ...
          if (4 === this._source.points().length) {
            const o = (0, n.ensureNotNull)(
              ...
              {
                mediaSize: { width: p, height: _ },
              } = e;
            (t.extendLeft.value() &&
              (i = this._extendSegmentLeft(a, o, c, p, _)),
              t.extendRight.value() &&
                (r = this._extendSegmentRight(l, s, u, p, _)));
          }
          const o = this._points.slice(),
            s = this._source.controlPoints();
          null !== s &&
            (o.push(
              (0, n.ensureNotNull)(this._source.pointToScreenPoint(s[0])),
            ),
            o.push(
              (0, n.ensureNotNull)(this._source.pointToScreenPoint(s[1])),
            ));
          const l = {
            points: o,
          ...
          return (
            (0, y.cacheIsValid)(
              ...
              (this._extendedSegmentLeftCache = {
                ...
                width: r,
                height: o,
                segment: (0, u.extendQuadroBezier)(e, t, i, r, o),
              }),
            (0, n.ensureNotNull)(this._extendedSegmentLeftCache).segment
          );
        }
        _extendSegmentRight(e, t, i, r, o) {
          return (
            (0, y.cacheIsValid)(
      ...
      class v extends o.LineDataSource {
        constructor(e, t, i, n) {
          (super(
            ...
            this._setPaneViews([new m(this, e)]));
        }
        pointsCount() {
          return 2;
        }
        ...
        _calculateControlPoints() {
          const e = (0, n.ensureNotNull)(
            ...
            t = (0, n.ensureNotNull)(this.pointToScreenPoint(this.points()[1])),
            i = t.subtract(e).scaled(0.5).transposed().scaled(0.3),
            r = e.add(t).scaled(0.33),
            o = e.add(t).scaled(0.67),
            s = r.add(i),
            a = o.subtract(i);
          return [
            (0, n.ensureNotNull)(this.screenPointToPoint(s)),
            (0, n.ensureNotNull)(this.screenPointToPoint(a)),
          ];
        }
      }
    },
    63342: (e, t, i) => {
      (i.r(t),
        i.d(t, { BezierQuadroPaneView: () => c, cacheIsValid: () => d }));
      var n = i(50151),
        r = i(52859),
        o = i(54707),
        s = i(94602),
      ...
      class c extends o.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          if (3 === this._source.points().length) {
            ...
            (t.extendLeft.value() &&
              (i = this._extendSegmentLeft(a, r, d, h, u)),
              t.extendRight.value() &&
                (o = this._extendSegmentRight(a, s, c, h, u)));
          }
        ...
        _extendSegmentLeft(e, t, i, r, o) {
          return (
            d(this._extendedSegmentLeftCache, e, t, i, r, o) ||
              (this._extendedSegmentLeftCache = {
                p1: e,
                p2: t,
                p3: i,
                width: r,
                height: o,
                segment: (0, a.extendQuadroBezier)(e, t, i, r, o),
              }),
            (0, n.ensureNotNull)(this._extendedSegmentLeftCache).segment
          );
        }
        _extendSegmentRight(e, t, i, r, o) {
          return (
            d(this._extendedSegmentRightCache, e, t, i, r, o) ||
              (this._extendedSegmentRightCache = {
                p1: e,
                p2: t,
                p3: i,
    ...
    78954: (e, t, i) => {
      ...
      function u(e, t, i) {
        for (const r of i)
          for (let i = 1; i < r.length; i++) {
            const o = r[i - 1],
              a = r[i];
            if ((0, n.distanceToSegment)(o, a, e).distance < t)
      ...
      class _ extends r.MediaCoordinatesPaneRenderer {
        constructor(e) {
          (super(), (this._data = e || null));
        }
        setData(e) {
        ...
        hitTest(e) {
          if (null !== this._data && 3 === this._data.points.length) {
            const t = (0, c.interactionTolerance)().curve,
              ...
              o = n.subtract(i),
              a = r.subtract(o.scaled(0.25)),
              d = r.add(o.scaled(0.25));
            if (
            ...
            return (
              null === h && (h = u(e, t, this._data.extendRightSegments)),
              h
            );
          }
          return null;
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            (this._data.fillBack &&
              ...
              r.beginPath(),
              r.moveTo(t.x, t.y),
              r.quadraticCurveTo(s.x, s.y, n.x, n.y),
              r.quadraticCurveTo(l.x, l.y, i.x, i.y),
              r.fill()),
              r.beginPath(),
              p(r, this._data.extendLeftSegments),
              r.moveTo(t.x, t.y),
              r.quadraticCurveTo(s.x, s.y, n.x, n.y),
              r.quadraticCurveTo(l.x, l.y, i.x, i.y),
              p(r, this._data.extendRightSegments),
              this._data.leftEnd === o.LineEnd.Arrow &&
                (0, d.drawArrow)(s, t, r, r.lineWidth, a.dpr1PixelRatioInfo),
              this._data.rightEnd === o.LineEnd.Arrow &&
    ...
    54707: (e, t, i) => {
      ...
      function _(e, t) {
        const i = e.x - t.x,
          n = e.y - t.y;
        if (!Number.isFinite(i) || !Number.isFinite(n) || (0 === i && 0 === n))
          return d.PaneCursorType.Default;
        let o = Math.atan2(n, i);
        return (
          o < 0 && (o += 2 * Math.PI),
          o >= p.deg337_5 ||
          o < p.deg22_5 ||
          (o >= p.deg157_5 && o < p.deg202_5)
            ? d.PaneCursorType.HorizontalResize
            : (o >= p.deg22_5 && o < p.deg67_5) ||
                (o >= p.deg202_5 && o < p.deg247_5)
              ? d.PaneCursorType.DiagonalNwSeResize
              : (o >= p.deg67_5 && o < p.deg112_5) ||
                  (o >= p.deg247_5 && o < p.deg292_5)
                ? d.PaneCursorType.VerticalResize
                : (o >= p.deg112_5 && o < p.deg157_5) ||
                    (o >= p.deg292_5 && o < p.deg337_5)
                  ? d.PaneCursorType.DiagonalNeSwResize
                  : void (0, r.assert)(!1, 'unexpected angle')
        );
      }
      function g(e, t) {
      ...
      (!(function (e) {
        ...
        (function (e) {
          ((e[(e.deg22_5 = Math.PI / 8)] = 'deg22_5'),
            (e[(e.deg67_5 = (3 * Math.PI) / 8)] = 'deg67_5'),
            (e[(e.deg112_5 = (5 * Math.PI) / 8)] = 'deg112_5'),
            (e[(e.deg157_5 = (7 * Math.PI) / 8)] = 'deg157_5'),
            (e[(e.deg202_5 = (9 * Math.PI) / 8)] = 'deg202_5'),
            (e[(e.deg247_5 = (11 * Math.PI) / 8)] = 'deg247_5'),
            (e[(e.deg292_5 = (13 * Math.PI) / 8)] = 'deg292_5'),
            (e[(e.deg337_5 = (15 * Math.PI) / 8)] = 'deg337_5'));
        })(p || (p = {})));
      class P {
        constructor(e, t, i) {
          ((this._invalidated = !0),
            ...
            (this._source = e),
            (this._model = t),
            (this._ownerSource = i ?? null));
        }
        priceToCoordinate(e) {
          const t = this._getOwnerSource(),
            i = t?.priceScale();
          if (null == i) return null;
          const n = null !== t ? t.firstValue() : null;
          return null === n ? null : i.priceToCoordinate(e, n);
        }
        anchorColor() {
          return h;
        }
        ...
        addAnchors(e, t = {}) {
          ...
          const n = this._source.points(),
            r = i.map((e, t) => {
              const i = n[t],
                r = (0, l.lineSourcePaneViewPointToLineAnchorPoint)(e);
              return (
        ...
        createLineAnchor(e, t) {
          const i = e.points.map((e) => e.point),
            n = this._getOwnerSource();
          if (this.isLocked()) {
            const r = this._getSelectionRenderer(t);
            return (
              r.setData({
          ...
          const r = (0, o.lastMouseOrTouchEventInfo)().isTouch,
            a = this._getLineAnchorRenderer(t),
          ...
          return (
            a.setData({
              ...
              strokeWidth: r ? u.TouchStrokeWidth : u.RegularStrokeWidth,
              selected: this.isSelectedSource(),
              selectedStrokeWidth: r
        ...
        _getOwnerSource() {
          return this._ownerSource ?? this._source.ownerSource();
        }
        _anchorRadius() {
          ...
          this._model.timeScale().isEmpty() ||
            (this._validatePriceScale() &&
              (this._source.points().forEach((e, t) => {
                const i = this._source.pointToScreenPoint(
                  e,
                  this._ownerSource ?? void 0,
                );
        ...
        _validatePriceScale() {
          const e = this._getOwnerSource()?.priceScale();
    ...
    95998: (e, t, i) => {
      ...
      function s(e, t, i, n, o) {
        ...
        for (let s = 0; ; s += a) {
          ...
          const a = e.scaled((1 - s) * (1 - s)),
            ...
            h = a.add(d).add(c);
          if (void 0 !== l) {
            if ((0, r.distanceToSegment)(h, l, n).distance < o) return !0;
      ...
      function l(e, t, i, n, o, s) {
        ...
        for (let l = 0; ; l += d) {
          const d = a(e, t, i, n, l);
          if (void 0 !== c) {
            if ((0, r.distanceToSegment)(d, c, o).distance < s) return !0;
          } else if (d.subtract(o).length() < s) return !0;
          if (((c = d), l >= 1)) break;
        }
        return !1;
      }
      function d(e, t, i, n, r) {
        ...
        const s = (function (e, t, i, n, r) {
          const o = [],
            s = c(e.y, t.y, i.y, 0).concat(c(e.y, t.y, i.y, r));
          for (let r = 0; r < s.length; r++) {
            const a = h(e.x, t.x, i.x, s[r]);
            a >= 0 && a <= n && o.push(s[r]);
          }
          const a = c(e.x, t.x, i.x, 0).concat(c(e.x, t.x, i.x, n));
          for (let n = 0; n < a.length; n++) {
            const s = h(e.y, t.y, i.y, a[n]);
            s >= 0 && s <= r && o.push(a[n]);
          }
          return o;
        })(e, t, i, n, r)
          .filter((e) => e > 1)
          .sort((e, t) => e - t);
        t.x >= 0 && t.x <= n && t.y >= 0 && t.y <= r && s.unshift(1);
        const a = 3 / o,
          l = [];
        for (let n = 0; n < s.length - 1; n += 2) {
          ...
          const c = [];
          for (; o <= d; ) {
            const n = e.scaled((1 - o) * (1 - o)),
              s = i.scaled(2 * o * (1 - o)),
              a = t.scaled(o * o),
              l = n.add(s).add(a);
            if (c.length > 0) {
              c[c.length - 1].subtract(l).length() < 2 && ((d += r), (r *= 2));
            }
            (c.push(l), (o += r));
          }
          c.length > 0 && l.push(c);
    ...
    73914: (e, t, i) => {
      i.d(t, {
        ...
        lineSourcePaneViewPointToLineAnchorPoint2: () => x,
        mapLineSourcePaneViewPointToLineAnchorPoint: () => y,
      });
      var n = i(10555),
        r = i(6453),
        o = i(50151),
      ...
      class f extends h.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          (t.length && this._drawPoints(e, t, i, _, p),
            n.length && this._drawPoints(e, n, r, P, g));
        }
              ...
              if (
                (r(
                  l,
                  {
                    ...o,
                    point: new n.Point(
                      Math.round(o.point.x * d) + P,
                      Math.round(o.point.y * c) + P,
                    ),
                  },
                  g / 2,
                  p,
      ...
      function S(e, t = e.pointIndex, i, n, r, o, s, a, l, d) {
        return {
          point: e,
          pointIndex: t,
          cursorType: i,
