(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [769],
  {
    59142: function (d, e) {
      ...
      ((t = [e]),
        (u = function (d) {
          ...
          ((d.disableBodyScroll = function (d, t) {
            if (n) {
              if (!d)
              ...
              if (
                d &&
                !c.some(function (e) {
                  return e.targetElement === d;
                })
              ) {
                var s = { targetElement: d, options: t || {} };
                ((c = [].concat(e(c), [s])),
                  (d.ontouchstart = function (d) {
            ...
            (d.clearAllBodyScrollLocks = function () {
              n
    ...
    50238: (d, e, u) => {
      'use strict';
      u.d(e, { useRovingTabindexElement: () => o });
      var t = u(50959),
        n = u(39416),
        c = u(43010);
      function o(d, e = []) {
        const [u, o] = (0, t.useState)(!1),
          r = (0, n.useFunctionalRefObject)(d);
        return (
            ...
            const d = (0, n.ensureNotNull)(e.current),
              u = () => {
                ...
                if (
                  0 === u.length ||
                  (u[0].parentElement &&
                    !v(u[0].parentElement, (0, n.ensureNotNull)(e.current)))
                ) {
                  const t = (function (d) {
                    const u = m(d).sort(c.navigationOrderComparator),
                      t = u.find((d) => v(d, (0, n.ensureNotNull)(e.current)));
                    if (!t) return null;
          ...
          [
            ...
            function (e) {
              ...
              if (d) {
                ...
                ((r = d ? Array.from(d.children) : []), (f = r.indexOf(t)));
              } else
                ((r = ((l = n),
                Array.from(
                  l.querySelectorAll(
                ...
                ).filter((0, a.createScopedVisibleElementFilter)(l))).sort(
                  c.navigationOrderComparator,
                )),
                  (f = r.indexOf(t)));
              var l;
              if (0 === r.length || -1 === f) return;
              const v = (0, c.mapKeyCodeToDirection)(u);
              switch (v) {
                case 'inlinePrev':
                  if ((e.preventDefault(), !d && 0 === f)) break;
                  h(s(r, f, -1));
                  break;
                case 'inlineNext':
                  if ((e.preventDefault(), !d && f === r.length - 1)) break;
                  h(s(r, f, 1));
                  break;
                case 'blockPrev':
                case 'blockNext':
                  ((u) => {
                    ...
                    const r =
                      t[
                        'blockNext' === u ? t.indexOf(c) + 1 : t.indexOf(c) - 1
                      ];
                    if (!r) return;
                    e.preventDefault();
                    const a = Array.from(r.children);
                    a.length && (!d && o <= a.length - 1 ? h(a[o]) : h(a[0]));
                  })(v);
              }
            },
          ]
    ...
    173: (d, e, u) => {
      ...
      u.d(e, {
        emojiGroups: () => T,
        isSupportedEmoji: () => k,
        localeCompareEmojiTitles: () => A,
        removeUnavailableEmoji: () => M,
        separateEmoji: () => I,
      });
      var t = u(50959),
        n = u(11542),
      ...
      const g = [
        ...
        S = new Set(j);
      function M(d) {
        return d.filter((d) => S.has(d));
      }
      function k(d) {
        return S.has(d);
      }
      const I = (0, c.default)((d) => {
        const e = (0, o.getFirstSegmentOrCodePointString)(d),
          u = null !== e && k(e) ? e : '';
        return { emoji: u, emojiLessString: d.replace(u, '') };
      });
      function A(d, e, ...u) {
        const t = I((0, r.ensureNotNull)(d)).emojiLessString.trim(),
          n = I((0, r.ensureNotNull)(e)).emojiLessString.trim();
        return t === n ? d.localeCompare(e, ...u) : t.localeCompare(n, ...u);
      }
      const T = () => [
        {
          title: n.t(null, { context: 'emoji_group' }, u(88906)),
          emojis: [],
          content: t.createElement(a.IconItem, { icon: f }),
        },
        {
          title: n.t(null, { context: 'emoji_group' }, u(43438)),
          emojis: g,
          content: t.createElement(a.IconItem, { icon: i }),
        },
        {
          title: n.t(null, { context: 'emoji_group' }, u(53288)),
          emojis: w,
          content: t.createElement(a.IconItem, { icon: l }),
        },
        {
          title: n.t(null, { context: 'emoji_group' }, u(90678)),
          emojis: E,
          content: t.createElement(a.IconItem, { icon: s }),
        },
        {
          title: n.t(null, { context: 'emoji_group' }, u(21311)),
          emojis: x,
          content: t.createElement(a.IconItem, { icon: m }),
        },
        {
          title: n.t(null, { context: 'emoji_group' }, u(28562)),
          emojis: y,
          content: t.createElement(a.IconItem, { icon: v }),
        },
        {
          title: n.t(null, { context: 'emoji_group' }, u(98355)),
          emojis: C,
          content: t.createElement(a.IconItem, { icon: h }),
        },
        {
          title: n.t(null, { context: 'emoji_group' }, u(40457)),
          emojis: z,
          content: t.createElement(a.IconItem, { icon: b }),
        },
        {
          title: n.t(null, { context: 'emoji_group' }, u(6715)),
          emojis: N,
          content: t.createElement(a.IconItem, { icon: p }),
        },
      ];
    },
    37285: (d, e, u) => {
      ...
      function s(d) {
        ...
        return t.createElement('img', {
          ...
          onContextMenu: function (d) {
            if (d.target instanceof Element && d.target.closest('a')) return;
            d.preventDefault();
          },
        });
      }
    ...
    26981: (d, e, u) => {
      ...
      var t = u(50959),
        ...
        f = u(39416),
        i = u(99247);
      const l = (0, t.forwardRef)(function (d, e) {
        const {
            onKeyDown: u,
            orientation: l,
        ...
        return (
          ...
          t.createElement('div', {
            ...
            'aria-orientation': l,
            ref: h,
            onKeyDown: (0, c.createSafeMulticastEventHandler)(function (d) {
        ...
        var d = {
            ...
            convert: {
              fromCodePoint: function (d) {
                var e = 'string' == typeof d ? parseInt(d, 16) : d;
