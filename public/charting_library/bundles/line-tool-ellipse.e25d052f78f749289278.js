      ...
      class _ extends d.InplaceTextLineDataSource {
        ...
        startChanging(t, e) {
          (super.startChanging(t, e),
            (this._radius2 = (0, s.distanceToLine)(
              this._screenPoint(0),
              this._screenPoint(1),
              this._screenPoint(2),
            ).distance));
        ...
        addPoint(t, e, i) {
          let n;
          const s = 1 === this._points.length ? this._preparePoint(t, e) : t;
          return (
            (n = this._addPointIntenal(s, e, i)),
            2 === this._points.length &&
              this._snapTo45DegreesApplicable(e) &&
              (n = this._addPointIntenal(this._calcPoint2(), e, i)),
            n && (this._fakePoint = null),
            n
          );
        }
        setPoint(t, e, i, r) {
          ...
          switch (t) {
            ...
            case 3:
              const r = this._screenPoint(0),
                ...
                c = (0, n.ensureNotNull)(this.pointToScreenPoint(a)),
                d = (0, s.distanceToLine)(r, h, c).distance,
                u = h.subtract(r),
                _ = r.add(h).scaled(0.5),
                p = new o.Point(-u.y, u.x).normalized(),
                P = _.add(p.scaled(d));
              this._setPoint(2, {
                ...(0, n.ensureNotNull)(this.screenPointToPoint(P)),
                interval: l,
              });
          }
        ...
        points() {
          ...
          return (
            2 === t.length && this._fakePoint && t.push(this._fakePoint),
            t
          );
        }
        pointsCount() {
        ...
        editableTextProperties() {
          ...
          return { text: t.text, textColor: t.textColor };
        }
        ...
        _preparePoint(t, e) {
          const i = this._preparePointInternal(t, this._points[0], e),
            n = this._points[1] ?? this._lastPoint;
          return (
            this._snapTo45DegreesApplicable(e) &&
              this._points[0].index === n.index &&
              this._fixVerticalDiameterPoints(n, this._points[0], i),
            i
          );
        }
        ...
        static _configureProperties(t) {
          (super._configureProperties(t),
            ...
            t.addChild(
              'textsColors',
              new c.LineToolColorsProperty([t.childs().textColor]),
            ),
        ...
        _preparePointInternal(t, e, i) {
          ...
          return (
            ...
            this._snapTo45DegreesApplicable(i) &&
              ...
              (this.snapPoint45Degree(s, e),
              (this._fakePoint = this._calcPoint2(
                (0, n.ensureNotNull)(this.pointToScreenPoint(e)),
                (0, n.ensureNotNull)(this.pointToScreenPoint(s)),
              ))),
            s
          );
        }
        _fixVerticalDiameterPoints(t, e, i) {
          const s = (0, n.ensureNotNull)(this.pointToScreenPoint(t)),
            r = (0, n.ensureNotNull)(this.pointToScreenPoint(e)),
          ...
          ((c *= e.price > t.price ? 1 : -1),
            (t.price = (0, n.ensureNotNull)(
              this.screenPointToPoint(new o.Point(s.x, r.y + c)),
            ).price));
        }
        _calcPoint2(t, e, i) {
          ((t = t ?? this._screenPoint(0)), (e = e ?? this._screenPoint(1)));
          const s = Math.atan2(e.y - t.y, e.x - t.x) + Math.PI / 2;
          i = i ?? e.subtract(t).length() / 2;
          const r = t
            .add(e)
            .scaled(0.5)
            .add(new o.Point(Math.cos(s) * i, Math.sin(s) * i));
          return (0, n.ensureNotNull)(this.screenPointToPoint(r));
        }
        _screenPoint(t) {
          return (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[t]));
        }
      }
    },
    63117: (t, e, i) => {
      ...
      var m;
      !(function (t) {
        t[(t.TextEditingJustFinishedTime = 100)] =
      ...
      class w extends _.LineDataSource {
        ...
        topPaneViews(t) {
          return this._activeEditingOwnerSource &&
            t.hasDataSource(this._activeEditingOwnerSource) &&
        ...
        async _openTextEditor(t, e, n, r, a) {
          ...
          ((this._activeEditingOwnerSource = t),
          ...
          const x = this.isFixed()
              ? (0, s.ensureDefined)(this.fixedPoint(t))
              : (0, s.ensureNotNull)(
                  this.pointToScreenPoint(this._points[0], t),
                ),
            g = {
        ...
        _onSelectionChange(t) {
          if (null === this._container) return;
          const e = {};
          if (void 0 !== t) {
            const { start: i, end: n } = t;
            i === n
              ? (e.cursorPosition = i)
              : (e.selectionRange = [Math.min(i, n), Math.max(i, n)]);
          }
          (0, n.default)(e, this._selectionData) ||
