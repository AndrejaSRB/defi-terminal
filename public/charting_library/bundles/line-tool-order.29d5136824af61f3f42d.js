...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2232],
  {
    ...
    28837: (t, e, i) => {
      var o = i(52974).LineToolTrading,
        r = i(17721).LineToolTradingPriceAxisView,
        n = i(32853),
        l = i(41414).LineDataSource,
        s = i(78176).DefaultProperty;
      const a = i(37103),
        u = i(40472).sourceChangeEvent;
      var c = i(67777).sortSourcesPreOrdered.LineToolOrder;
      function h(t) {
        return (null == t ? (t = '') : (t += ''), t);
      }
      class d {
        ...
        setLineInactiveBuyColor(t) {
          return (
            this._line.properties().lineInactiveBuyColor.setValue(t),
            this
          );
        }
        setLineActiveSellColor(t) {
          return (
            this._line.properties().lineActiveSellColor.setValue(t),
            this
          );
        }
        setLineInactiveSellColor(t) {
          return (
            this._line.properties().lineInactiveSellColor.setValue(t),
            this
          );
        }
        getLineStyle() {
        ...
        setBodyBorderActiveBuyColor(t) {
          return (
            this._line.properties().bodyBorderActiveBuyColor.setValue(t),
            this
          );
        }
        setBodyBorderInactiveBuyColor(t) {
          return (
            this._line.properties().bodyBorderInactiveBuyColor.setValue(t),
            this
          );
        }
        setBodyBorderActiveSellColor(t) {
          return (
            this._line.properties().bodyBorderActiveSellColor.setValue(t),
            this
          );
        }
        ...
        setBodyTextInactiveLimitColor(t) {
          return (
            this._line.properties().bodyTextInactiveLimitColor.setValue(t),
            this
          );
        }
        setBodyTextActiveLimitColor(t) {
          return (
            this._line.properties().bodyTextActiveLimitColor.setValue(t),
            this
          );
        }
        setBodyTextInactiveStopColor(t) {
          return (
            this._line.properties().bodyTextInactiveStopColor.setValue(t),
            this
          );
        }
        setBodyTextActiveStopColor(t) {
          return (
            this._line.properties().bodyTextActiveStopColor.setValue(t),
            this
          );
        }
        setBodyTextInactiveBuyColor(t) {
          return (
            this._line.properties().bodyTextInactiveBuyColor.setValue(t),
            this
          );
        }
        setBodyTextActiveBuyColor(t) {
          return (
            this._line.properties().bodyTextActiveBuyColor.setValue(t),
            this
          );
        }
        setBodyTextInactiveSellColor(t) {
          return (
            this._line.properties().bodyTextInactiveSellColor.setValue(t),
            this
          );
        }
        setBodyTextActiveSellColor(t) {
          return (
            this._line.properties().bodyTextActiveSellColor.setValue(t),
            this
          );
        }
        getBodyFont() {
