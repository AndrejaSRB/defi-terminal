  ...
  [4598],
  {
    ...
    70673: (e, t, r) => {
      ...
      var n = r(50959),
        ...
        c = r.n(u);
      function l(e) {
        const t = s()(c().wrapper, e.className);
        return n.createElement(
          ...
          n.createElement('input', {
            id: e.id,
            tabIndex: e.tabIndex,
            className: s()(e.intent && c()[e.intent], c().input),
            type: 'checkbox',
            name: e.name,
            checked: e.checked,
            disabled: e.disabled,
      ...
      function f(e) {
        const {
          ...
          y = s()(
            ...
            r && l().checked,
            c && l().disabled,
            f && l().disableActiveStyles,
          );
        return n.createElement(
          'span',
          { className: y, ...h },
          n.createElement(a.Icon, { icon: b, className: l().icon }),
        );
      }
    },
    15294: (e, t, r) => {
        ...
        render() {
          ...
          return (
            ...
            n.createElement(
              'label',
              { className: o },
              n.createElement(i.CheckboxInput, { ...r, className: e }),
              u,
            )
          );
        }
    ...
    30627: (e, t, r) => {
      ...
      var c = r(43982),
        l = r(5734);
      function f() {
        const e = (0, c.useProperty)(
          l.doNotShowDeleteLockedLineConfirmProperty,
        );
