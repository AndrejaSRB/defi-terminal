    ...
    66807: (t, e, i) => {
      ...
      class w extends p.LineDataSource {
        constructor(
          ...
          ((0, a.isString)(n) && e.childs().mode.setValue(parseInt(n)),
        ...
        _preparePoint(t, e) {
          ...
          return (
            (i.price = o.coordinateToPrice(l, a)),
            super._preparePoint(i, e)
          );
        }
        ...
        _calculateScale() {
          ...
          if (2 === this._points.length) {
            ...
            if (
              ...
              if (this._scale !== t)
                return (this._updateLastPoint(), this._scale);
              this._updatePointsCoordinatePricesDiff();
            }
          }
          return t;
