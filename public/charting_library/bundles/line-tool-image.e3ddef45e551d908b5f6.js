  ...
  [5231],
  {
    62414: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        f = i(68335),
        b = i(37103);
      const P = m.t(null, void 0, i(15402));
      var v = i(60709),
        w = i(78861);
      ...
      function I(e) {
        if ('LineToolImage' !== e)
          return (S?.then((e) => e()), void (S = null));
        (0, p.runOrSigninWithFeature)(
          () => {
            const e = 'LineToolImage';
            (w.tool.setValue(e),
              (0, g.trackDrawingToolSelected)(e, 'Left panel'),
              (S = C(U, () => {
                (S?.then((e) => e()),
                  (S = null),
                  w.tool.value() === e && (0, w.resetToCursor)(!0));
              })),
      ...
      function U(e) {
        const t = (0, v.chartWidgetCollectionService)();
        if (null === t) return;
        const r = !Boolean(c.getBool('hint.pasteImage')),
      ...
      const y = (0, s.getLogger)('Chart.LineToolImage');
      var T;
      function L(e) {
      ...
      function x(e) {
        return L(e) || N(e) ? e : null;
      }
      function O(e) {
        return N(e) ? e : new URL(e).pathname;
      }
      class M extends u.LineDataSource {
        constructor(e, t, n, r) {
          ...
          ((this._absoluteUserImageUrl = new l.Property(
            x(this.properties().childs().url.value()) ?? '',
          )),
            this._absoluteUserImageUrl.subscribe(this, (e) => {
              const t = e.value();
              if (L(t)) return;
              const i = x(t);
              null !== i && s.setValue(O(i));
            }),
            s.subscribe(this, () => {
              const e = x(s.value());
        ...
        pointToScreenPoint({ index: e, price: t }, i, s) {
          const o = this._model.timeScale(),
            a = (0, n.ensureNotNull)(i ? i.priceScale() : this.priceScale()),
            l = (0, n.ensure)((i ?? this.ownerSource())?.firstValue()),
            u = o.indexToCoordinate(e) + (s ?? 0),
            h = a.priceToCoordinate(t, l);
        ...
        static _configureProperties(e) {
          (super._configureProperties(e),
            e.hasChild('url') || e.addChild('url', new l.Property('')),
        ...
        _createImage(e) {
          const t = L(e),
            i = x(e);
          if (null === i) return void y.logWarn(`Invalid image URL: ${e}`);
