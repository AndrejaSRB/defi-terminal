(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    22233: (e) => {
      e.exports = { en: ['auto'], fr: ['automatique'] };
    },
    4161: (e) => {
      e.exports = { en: ['log'] };
    },
    1495: (e) => {
      e.exports = { en: ['All data'], fr: ['Toutes les données'] };
    },
    19273: (e) => {
      e.exports = { en: ['Year to day'], fr: ['Année à ce jour'] };
    },
    58426: (e) => {
      e.exports = {
    ...
    81649: (e) => {
      e.exports = { en: ['Toggle Percentage'], fr: ['Echelle en pourcentage'] };
    },
    77073: (e) => {
