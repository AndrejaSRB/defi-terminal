(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2878],
  {
    ...
    53885: (e, t, o) => {
      'use strict';
      o.d(t, { getStyleClasses: () => r, isCircleLogoWithUrlProps: () => c });
      var n = o(97754),
        i = o.n(n),
        a = o(52292),
        l = o(57554),
      ...
      function r(e, t = 2, o) {
        return i()(
          ...
          o,
          0 === t || 1 === t
            ? i()(a.skeletonTheme.wrapper, s().skeleton)
            : s().letter,
          1 === t && a.skeletonTheme.animated,
        );
      }
      function c(e) {
        return (
    ...
    67842: (e, t, o) => {
      'use strict';
      o.d(t, { useResizeObserver: () => l });
      var n = o(50959),
        i = o(43010),
        a = o(39416);
      function l(e, t = []) {
        const { callback: o, ref: l = null } = (function (e) {
            return 'function' == typeof e ? { callback: e } : e;
          })(e),
          s = (0, n.useRef)(null),
          r = (0, n.useRef)(o);
        r.current = o;
        const c = (0, a.useFunctionalRefObject)(l),
          u = (0, n.useCallback)(
            (e) => {
              (c(e),
                null !== s.current &&
    ...
    59695: (e, t, o) => {
      'use strict';
      o.d(t, { CircleLogo: () => s, hiddenCircleLogoClass: () => l });
      var n = o(50959),
        i = o(53885),
        a = o(57554);
      const l = o.n(a)().hidden;
      function s(e) {
        const t = (0, i.isCircleLogoWithUrlProps)(e),
          [o, a] = (0, n.useState)(0),
          l = (0, n.useRef)(null),
          s = (0, i.getStyleClasses)(e.size, o, e.className),
          r = e.alt ?? e.title ?? '',
          c = t ? r[0] : e.placeholderLetter;
        return (
          (0, n.useEffect)(() => a((l.current?.complete ?? !t) ? 2 : 1), [t]),
          t && 3 !== o
            ? n.createElement('img', {
                ref: l,
                className: s,
      ...
      function h(e) {
        ...
        return n.createElement(
          ee,
          {
            ...
            id: t,
            role: o,
            className: i(u, B.item, f && B.withIcon, {
              [B.isActive]: C,
              [B.isDisabled]: x || _,
              [B.hovered]: T,
            }),
            ...
            reference: function (e) {
              ((X.current = e), 'function' == typeof N && N(e));
              'object' == typeof N && (N.current = e);
            },
            onClick: function (e) {
              if (x) return;
              q && (0, a.trackEvent)(q.category, q.event, q.label);
              G && G(Q, e);
              U ||
            ...
            onContextMenu: function (e) {
              q &&
                J &&
                (0, a.trackEvent)(q.category, q.event, `${q.label}_rightClick`);
            },
            onMouseUp: function (e) {
              if (1 === e.button && k && q) {
                let e = q.label;
                (Z && (e += '_mouseWheelClick'),
                  (0, a.trackEvent)(q.category, q.event, e));
              }
            },
            onMouseOver: W,
            onMouseOut: D,
          ...
          K && n.createElement('span', { className: B.startSlot }, K),
          f &&
            n.createElement('span', {
              'aria-label': j && j['aria-label'],
              'aria-hidden': j && Boolean(j['aria-hidden']),
              className: i(B.icon, H && c['round-icon'], w),
              dangerouslySetInnerHTML: { __html: f },
            }),
          n.createElement(
            'span',
            { className: i(B.labelRow, m) },
            n.createElement('span', { className: i(B.label, p) }, E),
          ),
          (void 0 !== v || g) &&
            n.createElement(
              'span',
    ...
    20520: (e, t, o) => {
      ...
      function h(e) {
        const {
          ...
          x = (0, n.useContext)(r.CloseDelegateContext),
          T = n.useContext(d),
          _ = (0, n.useContext)(c),
          E = (0, u.useOutsideEvent)({
            handler: function (e) {
              b && b(e);
              if (!m) return;
              const t = (0, a.default)(p) ? p() : null == p ? [] : [p];
    ...
    19836: (e) => {
      e.exports = { button: 'button-KTgbfaP5' };
    },
    78299: (e) => {
      e.exports = {
    ...
    48814: (e) => {
      e.exports = {
        ...
        switcherLabel: 'switcherLabel-wg76fIbD',
      };
    },
    859: (e) => {
      e.exports = { switcherLabel: 'switcherLabel-ilIXB4Li' };
    },
    86443: (e) => {
      e.exports = {
    ...
    94293: (e) => {
      e.exports = { wrapper: 'wrapper-_XJBqWvq' };
    },
    65380: (e) => {
      e.exports = {
        wrap: 'wrap-Z4M3tWHb',
    ...
    90397: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        c = o(11098);
      function u(e) {
        const { className: t, reference: o, ...i } = e,
          [u, d] = (0, s.useRovingTabindexElement)(o ?? null);
        return n.createElement(r.PopupMenuItem, {
          ...
          onKeyDown: function (e) {
            ...
            (13 !== t && 32 !== t) ||
              (e.preventDefault(),
              u.current instanceof HTMLElement && u.current.click());
          },
          'data-role': 'menuitem',
    ...
    23484: (e, t, o) => {
      ...
      function u(e) {
        const { onClick: t, isFilled: o, isActive: i, ...u } = e,
          [d, h] = (0, l.useRovingTabindexElement)(null),
          m = o
        ...
        return (
          ...
          n.createElement(
            'button',
            {
              ...
              tabIndex: h,
              onClick: t,
              className: a()(c.button, i && c.active, 'apply-common-tooltip'),
              type: 'button',
              'aria-label': m,
              'data-tooltip': m,
            },
    ...
    74302: (e, t, o) => {
      ...
      var d,
        ...
        p = o.n(m);
      function b(e) {
        const t = (0, i.useContext)(s.CustomBehaviourContext),
          {
            size: o,
            intent: n = 'default',
            checked: a,
        ...
        return i.createElement(
          'span',
          { className: l()(r, p().switcher) },
          i.createElement('input', {
            ...k,
            type: 'checkbox',
            className: l()(
              p().input,
              c && p().activeStylesEnabled,
              a && p().checked,
              d && p().disabled,
            ),
            role: C,
            ...
            checked: a,
            onKeyDown: (e) => {
              13 === (0, h.hashFromEvent)(e) && e.currentTarget?.click();
            },
            onChange: m,
            disabled: d,
            'aria-disabled': x,
          ...
          i.createElement(
            'span',
            { className: l()(p().thumbWrapper, p()[n]) },
            i.createElement(u, { checked: a, size: o, disabled: d }),
          ),
        );
      }
      !(function (e) {
      ...
      function x(e) {
        const {
          ...
          [E, k] = (0, g.useRovingTabindexElement)(null),
          S = l()(C.label, o && !u && C.labelOn, x && w.label_disabled),
          F = l()(
            a,
            C.wrapper,
            o && C.wrapperWithOnLabel,
            c && C.wrapperWithDescription,
          );
        return i.createElement(
          'label',
          {
            role: t,
            className: l()(F, _ && C.withIcon, w.accessible),
            htmlFor: s,
            ref: m,
            onKeyDown: function (e) {
              if (e.target !== e.currentTarget) return;
          ...
          void 0 !== _ &&
            i.createElement(v.Icon, { className: C.icon, icon: _ }),
          i.createElement(
            'div',
            { className: C.labelRow },
            i.createElement('div', { className: S }, r),
            c && i.createElement('div', { className: C.labelHint }, c),
          ),
          i.createElement(
            'div',
            { className: w.switchWrap },
            i.createElement(b, {
              disabled: x,
              className: C.switch,
              reference: function (e) {
    ...
    31398: (e, t, o) => {
      'use strict';
      o.d(t, { menuItemSwitcherMobileTheme: () => l });
      var n = o(40173),
        i = o(74302),
        a = o(16284);
      const l = (0, n.mergeThemes)(i.DEFAULT_MENU_ITEM_SWITCHER_THEME, a);
    },
    32473: (e, t, o) => {
      'use strict';
      o.d(t, { ToolButton: () => c });
      ...
      const c = (0, n.forwardRef)((e, t) => {
        const {
          ...
          C = 'button' === v,
          x = h ? l.ToolWidgetButton : s;
        return n.createElement(x, {
          'aria-label': C ? f : void 0,
          ...w,
          id: o,
          ref: t,
          className: a()(r.button, i),
          tag: v,
          isActive: u,
      ...
      const s = l,
        r = n.forwardRef((e, t) => {
          const {
            ...
            M = i(x, C.button, {
              'apply-common-tooltip': Boolean(w || E),
              'common-tooltip-vertical': Boolean(E) && 'vertical' === k,
              [C.isActive]: c,
              [C.isOpened]: u,
              [C.isInteractive]: (T || Boolean(v)) && !d && !h,
              [C.isDisabled]: Boolean(d || h),
              [C.isGrouped]: m,
              [C.hover]: p,
              [C.clicked]: b,
              [C.pressed]: F,
            ...
            A =
              s &&
              ('string' == typeof s
                ? n.createElement(a.Icon, { className: C.icon, icon: s })
                : n.cloneElement(s, {
                    className: i(C.icon, s.props.className),
                  }));
          return 'button' === o
            ? n.createElement(
                'button',
                ...
                f &&
                  ...
                  n.createElement(
                    'div',
                    { className: i('js-button-text', C.text) },
                    g,
                  ),
                A,
                !f &&
            ...
            : n.createElement(
                ...
                r && n.createElement(a.Icon, { icon: r, className: l.endIcon }),
                S,
              );
        });
    },
    ...
    7314: (e, t, o) => {
      'use strict';
      (o.r(t), o.d(t, { DrawingToolbarRenderer: () => No }));
      var n = o(50959),
        i = o(32227),
        a = o(50151),
        l = o(97754),
        ...
        render() {
          ...
          return n.createElement(
            ...
            (h) =>
              n.createElement(
                'div',
                { className: E.wrap, onMouseOver: a, onMouseOut: l, ref: h },
                n.createElement(
                  'div',
                  {
                    className: s()(E.scrollWrap, { [E.noScrollBar]: !t }),
                ...
                o &&
                  n.createElement('div', {
                    className: s()(E.fadeTop, { [E.isVisible]: d && r > c }),
                  }),
                o &&
                  n.createElement('div', {
                    className: s()(E.fadeBot, { [E.isVisible]: u && r > c }),
                  }),
                i &&
                  n.createElement(
                    'div',
                    {
                      className: s()(E.scrollTop, {
                        [E.isVisible]: d && r > c,
                      }),
                    ...
                    n.createElement(
                      ...
                      n.createElement(C.Icon, { icon: k, className: E.icon }),
                    ),
                  ),
                i &&
                  n.createElement(
      ...
      function N(e) {
        const { id: t, action: o, isTransparent: i, toolName: a } = e;
        return n.createElement(I, {
          id: t,
          icon: v.lineToolsInfo[a].icon,
          isTransparent: i,
          onClick: o,
          tooltip: v.lineToolsInfo[a].localizedName,
          'data-name': a,
        });
      }
      var D,
      ...
      const O = c.getValue('ToolButtonIcons.LastCategory', D.Emojis),
        P = new B.WatchedValue(O);
      function V() {
        const [e, t] = (0, R.useWatchedValue)(P);
        return [
          e,
          (0, n.useCallback)(
            (e) => {
      ...
      var H = o(99616),
        j = o(93038);
      function z(e) {
        return n.createElement('div', { className: j.wrapper }, e.text);
      }
      var U = o(70173),
        G = o(51609),
        Q = o(22976),
      ...
      const X = [
        ...
        ie = [...X, ...Y, ...ee, ...te, ...oe, ...ne].map((e) => +e),
        ae = new Set(ie);
      const le = [
          {
            title: W.t(null, { context: 'emoji_group' }, o(88906)),
            emojis: [],
            content: n.createElement(H.IconItem, { icon: J }),
          },
          {
            title: W.t(null, { context: 'emoji_group' }, o(51853)),
            emojis: X,
            content: n.createElement(H.IconItem, { icon: K }),
          },
          {
            title: W.t(null, { context: 'emoji_group' }, o(33282)),
            emojis: te,
            content: n.createElement(H.IconItem, { icon: q }),
          },
          {
            title: W.t(null, { context: 'emoji_group' }, o(31054)),
            emojis: oe,
            content: n.createElement(H.IconItem, { icon: $ }),
          },
          {
            title: W.t(null, { context: 'emoji_group' }, o(14143)),
            emojis: Y,
            content: n.createElement(H.IconItem, { icon: Q }),
          },
          {
            title: W.t(null, { context: 'emoji_group' }, o(98355)),
            emojis: ne,
            content: n.createElement(H.IconItem, { icon: Z }),
          },
          {
            title: W.t(null, { context: 'emoji_group' }, o(74245)),
            emojis: ee,
            content: n.createElement(H.IconItem, { icon: G }),
          },
        ],
        se = {
          [D.Icons]: U.drawingToolsIcons.heart,
          [D.Emojis]: U.drawingToolsIcons.smile,
          [D.Stickers]: U.drawingToolsIcons.sticker,
        },
        re = [
          {
            title: D.Emojis,
            content: n.createElement(z, { text: W.t(null, void 0, o(16290)) }),
          },
          {
            title: D.Stickers,
            content: n.createElement(z, { text: W.t(null, void 0, o(50428)) }),
          },
          {
            title: D.Icons,
            content: n.createElement(z, { text: W.t(null, void 0, o(73829)) }),
          },
        ];
      var ce = o(3343),
        ue = o(20520),
      ...
      const ge = o(78299),
        fe = (0, n.forwardRef)((e, t) => {
          const {
              ...
              onClickButton: v,
              onArrowClick: g,
              openDropdownByClick: f,
              onMenuFocus: w = be.handleAccessibleMenuFocus,
              onMenuKeyDown: x = be.handleAccessibleMenuKeyDown,
              dataMenuQaId: T,
              ..._
            } = e,
            E = (0, pe.mergeThemes)(de.DEFAULT_MENU_THEME, {
              menuBox: b.menuBox,
            }),
            [k, S] = (0, n.useState)(!1),
            [F, y] = (0, n.useState)(!1),
            ...
            W = (0, n.useRef)(0),
            L = (0, n.useRef)(0),
            [R, B] = (0, A.useRovingTabindexElement)(null),
            [O, P] = (0, A.useRovingTabindexElement)(null);
          return (
            ...
            n.createElement(
              'div',
              {
                ...
                onKeyDown: function (e) {
                  ...
                  (e.preventDefault(), V(!1), F && O?.current?.focus());
                },
                ref: I,
              },
              n.createElement(
                'div',
                { ref: N, className: b.control },
                n.createElement(
                  'div',
                  {
                    ...(function () {
                      if (!d)
                        return r.mobiletouch
                          ? m
                            ? { onTouchStart: z, onTouchEnd: G, onTouchMove: U }
                            : { onClick: j }
                          : { onMouseDown: z, onMouseUp: Q };
                      return {};
                    })(),
                    className: l(b.buttonWrap, b.accessible),
                  },
                ...
                !d &&
                  ...
                  n.createElement(
                    'button',
                    {
                      className: l(
                        b.arrow,
                        s && 'apply-common-tooltip common-tooltip-vertical',
                        b.accessible,
                      ),
                      onClick: function (e) {
                        (g?.(), V(void 0, (0, he.isKeyboardClick)(e)));
                      },
                      onKeyDown: function (e) {
          ...
          function z() {
            if (r.mobiletouch && !m) !L.current && v && v();
            else {
              if (W.current)
                return (clearTimeout(W.current), (W.current = 0), void V(!0));
              W.current = setTimeout(() => {
                ((W.current = 0), !L.current && v && v());
              }, 175);
            }
      ...
      var we = o(38297),
        ...
        Te = o(67763),
        _e = o(21097);
      class Ee extends Te.CommonJsonStoreService {
      ...
      const Be = [
          {
            title: W.t(null, { context: 'emoji_group' }, o(88906)),
            emojis: [],
            content: n.createElement(H.IconItem, { icon: We }),
          },
          {
            title: 'TradingView',
            emojis: De,
            content: n.createElement(H.IconItem, { icon: Le }),
          },
        ],
        Oe = new Ee(
      ...
      const Ge = {
        [D.Icons]: {
          ...
          ItemComponent: function (e) {
            ...
            return n.createElement(
              'div',
              { className: s()(Me.item, o) },
              n.createElement(Fe, { charCode: Number(t) }),
            );
          },
          icons: le,
          onEmojiSelect: (e) => {
            (d.iconTool.setValue(Number(e)),
              d.tool.setValue('LineToolIcon'),
              (0, xe.trackDrawingToolSelected)('LineToolIcon', 'Left panel'));
          },
        },
        [D.Emojis]: {
          service: Ie,
          toolName: 'LineToolEmoji',
          icons: (0, Ae.emojiGroups)(),
          onEmojiSelect: (e) => {
            (d.emojiTool.setValue(e),
              d.tool.setValue('LineToolEmoji'),
              (0, xe.trackDrawingToolSelected)('LineToolEmoji', 'Left panel'));
          },
        },
        [D.Stickers]: {
          service: Oe,
          ...
          RowComponent: function (e) {
            return n.createElement(ze.EmojisRow, {
              ...e,
          ...
          icons: Be,
          onEmojiSelect: (e) => {
            (d.stickerTool.setValue(e),
              d.tool.setValue('LineToolSticker'),
              (0, xe.trackDrawingToolSelected)(
                'LineToolSticker',
                'Left panel',
              ));
          },
      ...
      function qe(e) {
        ...
        return (
          ...
          n.createElement(
            'div',
            { style: { maxHeight: o } },
            n.createElement(we.EmojiList, {
              className: l(Qe.desktopSize, t && Qe.smallSize),
              emojis: p,
              onSelect: function (e) {
      ...
      var Je = o(22692),
        ...
        Xe = o(93285);
      const Ye = {
          icon: W.t(null, void 0, o(37913)),
          dropdownTooltip: W.t(null, void 0, o(73829)),
        },
        et = (0, pe.mergeThemes)(ge, {
          menuBox: Xe.menuBox,
          drawer: Xe.drawer,
        }),
        tt = parseInt($e['default-drawer-min-top-distance']);
      function ot(e) {
        const { isGrayed: t, isSmallTablet: o } = e,
          i = (0, L.filterDataProps)(e),
          [a, l] = V(),
          [s] = (0, R.useWatchedValue)(d.tool),
          { toolName: r } = Ge[a];
        return n.createElement(
          fe,
          {
            ...
            onClickWhenGrayed: () =>
              (0, h.emit)('onGrayedObjectClicked', {
                type: 'drawing',
                name: v.lineToolsInfo[r].localizedName,
              }),
            ...
            onMenuKeyDown: function (e) {
              ...
              const t = (0, Ke.hashFromEvent)(e);
              (9 !== t && t !== Ke.Modifiers.Shift + 9) ||
                (0, Je.updateTabIndexes)();
            },
            dataMenuQaId: 'emojipicker-menu',
            ...i,
          },
          n.createElement(qe, {
            isSmallTablet: o,
            maxHeight: o ? Math.min(679, window.innerHeight - tt) : 679,
            activeTab: a,
            setActiveTab: l,
          }),
        );
      ...
      function nt(e) {
        ...
        e.target === t &&
          ...
          setTimeout(() => {
            ...
            const [e] = (0, Je.queryTabbableElements)(t).sort(
              Je.navigationOrderComparator,
            );
            e && e.focus();
          }));
      }
      ...
      var rt = o(51613),
        ...
        gt = o(77975),
        ft = o(859);
      const wt = (0, pe.mergeThemes)(vt.menuItemSwitcherMobileTheme, {
          label: ft.switcherLabel,
        }),
        Ct = (0, pe.mergeThemes)(bt.DEFAULT_MENU_ITEM_SWITCHER_THEME, {
          label: ft.switcherLabel,
        });
      function xt(e) {
        const {
          ...
          s = (0, gt.useWatchedValueReadonly)({ watchedValue: t });
        return n.createElement(bt.MenuItemSwitcher, {
          key: o,
          checked: s,
          onChange: function (e) {
            t.setValue(e);
      ...
      class _t extends n.PureComponent {
        constructor(e) {
          (super(e),
            ...
            (this._handleClickButton = () => {
              ...
              !p.CheckMobile.any() && e && this._selectTool(e);
            }),
            ...
            (this._handleClickFavorite = (e) => {
              this.state.favState && this.state.favState[e]
                ? ct.LinetoolsFavoritesStore.removeFavorite(e)
                : ct.LinetoolsFavoritesStore.addFavorite(e);
            }),
        ...
        componentDidMount() {
          (d.tool.subscribe(this._onChangeDrawingState),
            ct.LinetoolsFavoritesStore.favoriteAdded.subscribe(
              null,
              this._onAddFavorite,
            ),
            ct.LinetoolsFavoritesStore.favoriteRemoved.subscribe(
              null,
              this._onRemoveFavorite,
            ),
            ct.LinetoolsFavoritesStore.favoritesSynced.subscribe(
              null,
              this._onSyncFavorites,
            ));
        }
        componentWillUnmount() {
          (d.tool.unsubscribe(this._onChangeDrawingState),
            ct.LinetoolsFavoritesStore.favoriteAdded.unsubscribe(
              null,
              this._onAddFavorite,
            ),
            ct.LinetoolsFavoritesStore.favoriteRemoved.unsubscribe(
              null,
              this._onRemoveFavorite,
            ),
            ct.LinetoolsFavoritesStore.favoritesSynced.unsubscribe(
              null,
              this._onSyncFavorites,
            ));
        }
        ...
        render() {
          ...
          const {
            ...
            u = v.lineToolsInfo[e],
            d = (0, L.filterDataProps)(this.props);
          return n.createElement(
            'span',
            null,
            n.createElement(
              ...
              l.map((l, s) => {
                if ('title' in l)
                  return n.createElement(
                    n.Fragment,
                    { key: l.title ?? `separator${s}` },
                    s > 0 ? n.createElement(rt.PopupMenuSeparator, null) : null,
                    l.title &&
                      n.createElement(
                        ut.ToolWidgetMenuSummary,
                        { className: Tt.sectionTitle },
                        l.title,
                      ),
                  );
                if ((0, f.isLineToolOption)(l))
                  return this._getLineToolOption(l);
                const { name: u } = l,
                  d = v.lineToolsInfo[u]?.selectHotkey?.hash,
                  h = v.lineToolsInfo[u],
                  m = a[u];
                return n.createElement(ht.AccessibleMenuItem, {
                  key: u,
                  'data-name': u,
                  theme: r ? mt.multilineLabelWithIconAndToolboxTheme : void 0,
                  dontClosePopup: m,
                  forceShowShortcuts: c,
                  shortcut: !r && d ? (0, Ke.humanReadableHash)(d) : void 0,
                  icon: h.icon,
                  isActive: o && e === u,
                  appearAsDisabled: m,
                  ...
                  toolbox:
                    i && !m
                      ? n.createElement(dt.MenuFavoriteButton, {
                          isActive: o && e === u,
                          isFilled: t[u],
        ...
        _firstNonGrayedTool() {
          ...
          return t.find((t) => (0, f.isLineTool)(t) && !e[t.name])?.name;
        }
        _showShortcuts() {
          return this.props.lineTools.some((e) => 'hotkeyHash' in e);
        }
        _getLineToolOption(e) {
          return (0, f.isLineToolSwitcherOption)(e)
            ? n.createElement(
                n.Fragment,
                { key: `${e.value}-${e.type}` },
                n.createElement(rt.PopupMenuSeparator, null),
                n.createElement(xt, {
                  ...e,
        ...
        _getActiveToolName() {
          return this.props.lineTools.find(
            (e) => (0, f.isLineTool)(e) && e.name === d.tool.value(),
          )?.name;
        }
        async _selectTool(e) {
          (await (0, pt.initLineTool)(e),
            d.tool.setValue(e),
            (0, xe.trackDrawingToolSelected)(e, 'Left panel'));
        }
        _composeFavState() {
          const e = {};
          return (
            this.props.lineTools.forEach((t) => {
              (0, f.isLineTool)(t) &&
                (e[t.name] = ct.LinetoolsFavoritesStore.isFavorite(t.name));
            }),
            e
          );
        }
      ...
      var Et = o(51768),
        kt = o(16396),
        St = o(17850);
      const Ft = (0, pe.mergeThemes)(kt.DEFAULT_POPUP_MENU_ITEM_THEME, St);
      var yt = o(89947),
        Mt = o(5734),
        At = o(94293);
      const It = !1;
      class Nt extends n.PureComponent {
        constructor(e) {
          (super(e),
            (this._handleRemoveToolClick = () => {
              (r.mobiletouch || this._handleRemoveDrawings(), Wt());
            }),
            ...
            (this._handleAlwaysRemoveLockedDrawings = () => {
              const e = !yt.deleteLockedLineToolsProperty.value();
              (yt.deleteLockedLineToolsProperty.setValue(e),
                e && Mt.doNotShowDeleteLockedLineConfirmProperty.setValue(!0),
                this.setState(this._getActualState()));
            }),
            (this._handleChartWidgetInitialized = () => {
              this._activeChartWidget &&
                (this._unsubscribeToModelChanges(this._activeChartWidget),
                this._subscribeToModelChanges(this._activeChartWidget));
            }),
            (this._handleActiveChartWidgetChanged = (e) => {
              (this._activeChartWidget &&
                ...
                this._activeChartWidget
                  ...
                  .unsubscribe(null, this._handleChartWidgetInitialized)),
                e &&
                  (this._subscribeToModelChanges(e),
                  e
                    .chartWidgetInitialized()
                    .subscribe(null, this._handleChartWidgetInitialized)),
            ...
            (this._getActualState = () => {
              if (
                ...
                return {
                  removeAllDrawingsLabel: W.t(null, void 0, o(96374)),
                  removeAllStudiesLabel: W.t(null, void 0, o(99984)),
                  removeAllLabel: W.t(null, void 0, o(53981)),
                  alwaysRemoveLockedDrawings:
                    yt.deleteLockedLineToolsProperty.value(),
                };
        ...
        render() {
          const e = this.props.isSmallTablet ? Ft : void 0,
            t = this.props.isSmallTablet
              ? vt.menuItemSwitcherMobileTheme
              : bt.DEFAULT_MENU_ITEM_SWITCHER_THEME,
            i = this.props.isSmallTablet ? At.wrapper : void 0,
            {
              removeAllDrawingsLabel: a,
              removeAllStudiesLabel: l,
              removeAllLabel: s,
              alwaysRemoveLockedDrawings: r,
            } = this.state;
          return n.createElement(
            fe,
            {
              ...
              dropdownTooltip: W.t(null, void 0, o(2671)),
              isSmallTablet: this.props.isSmallTablet,
              'data-name': this.props.toolName,
              onArrowClick: this._handleArrowClick,
              openDropdownByClick: It,
            },
            n.createElement(ht.AccessibleMenuItem, {
            ...
            n.createElement(
              ...
              n.createElement(bt.MenuItemSwitcher, {
                checked: r,
                onChange: this._handleAlwaysRemoveLockedDrawings,
                label: W.t(null, void 0, o(94340)),
                value: 'alwaysRemoveLockedDrawingsSwitcher',
                theme: t,
                className: i,
              }),
            ),
      ...
      function Dt(e) {
        (0, Et.trackEvent)('GUI', 'Chart Left Toolbar', e);
      }
      function Wt(e) {
        0;
      }
      var Lt = o(89880),
        Rt = o(90995),
        Bt = o(14881);
      const Ot = n.createContext({ hideMode: 'drawings', isActive: !1 });
      function Pt(e) {
        const {
            hideMode: t,
          ...
          { hideMode: r, isActive: c } = (0, n.useContext)(Ot),
          u = a?.();
        return 'all' === t || u
          ? n.createElement(ht.AccessibleMenuItem, {
              label: o,
      ...
      function Ht(e) {
        const { isSmallTablet: t } = e,
          [{ isActive: i, hideMode: l }, s] = (0, n.useState)(() => ({
            isActive: !1,
            hideMode: (0, Rt.getSavedHideMode)(),
          }));
        (0, n.useEffect)(
          () => (
            Bt.hideStateChange.subscribe(null, s),
            () => {
              Bt.hideStateChange.unsubscribe(null, s);
            }
          ),
          [],
        );
        const r = v.lineToolsInfo.hideAllDrawings,
          {
            trackLabel: c,
            tooltip: u,
            dataName: d,
          } = (0, a.ensureDefined)((0, Rt.getHideOptions)().get(l)),
          h = Vt[l][i ? 'active' : 'inactive'],
        ...
        return n.createElement(
          fe,
          {
            ...
            dropdownTooltip: Lt.t(null, void 0, o(95343)),
            onClickButton: function () {
              ((0, Rt.toggleHideMode)(l), jt(c, !i), zt(i ? 'on' : 'off'));
            },
            isSmallTablet: t,
            isActive: i,
            checkable: !0,
          ...
          n.createElement(
            Ot.Provider,
            { value: { isActive: i, hideMode: l } },
            Array.from((0, Rt.getHideOptions)()).map(([e, o]) =>
              n.createElement(Pt, {
                key: e,
                hideMode: e,
                option: o,
        ...
        function p(e, t) {
          jt(
            (0, a.ensureDefined)((0, Rt.getHideOptions)().get(e)).trackLabel,
            t,
          );
        }
      }
      ...
      var Ut = o(69455),
        Gt = o(53573);
      const Qt = W.t(null, void 0, o(51465));
      class qt extends n.PureComponent {
        ...
        componentDidMount() {
          const e = (this._promise = (0, a.ensureNotNull)(
            (0, Ut.getFavoriteDrawingToolbarPromise)(),
          ));
          e.then((t) => {
            this._promise === e &&
              ((this._instance = t),
      ...
      var Zt = o(7024),
        ...
        Kt = o(48814);
      const $t = {
          [Zt.MagnetMode.WeakMagnet]: {
            id: Zt.MagnetMode.WeakMagnet,
            name: 'weakMagnet',
            icon: U.drawingToolsIcons.magnet,
            localizedName: W.t(null, void 0, o(3519)),
          },
          [Zt.MagnetMode.StrongMagnet]: {
            id: Zt.MagnetMode.StrongMagnet,
            name: 'strongMagnet',
        ...
        Xt = (0, pe.mergeThemes)(vt.menuItemSwitcherMobileTheme, {
          label: Kt.switcherLabel,
        }),
        Yt = (0, pe.mergeThemes)(bt.DEFAULT_MENU_ITEM_SWITCHER_THEME, {
          label: Kt.switcherLabel,
        });
      function eo(e) {
        const { isSmallTablet: t } = e,
          i = (0, gt.useWatchedValueReadonly)({
            watchedValue: (0, Jt.magnetEnabled)(),
          }),
          a = (0, gt.useWatchedValueReadonly)({
            watchedValue: (0, Jt.magnetMode)(),
          }),
          l = (0, gt.useWatchedValueReadonly)({
            watchedValue: (0, Jt.magnetSnapsToIndicators)(),
          });
        return n.createElement(
          'div',
          { className: Kt.toolButtonMagnet },
          n.createElement(
            fe,
            {
              ...
              dropdownTooltip: W.t(null, void 0, o(41964)),
              isActive: i,
              onClickButton: function () {
                const e = !i;
                ((0, Et.trackEvent)(
            ...
            Object.values($t).map(
              ({ id: e, name: o, localizedName: l, icon: r }) =>
                n.createElement(ht.AccessibleMenuItem, {
                  key: e,
                  className: t ? Kt.toolButtonMagnet__menuItem : void 0,
                  'data-name': o,
                  icon: r,
                  isActive: i && a === e,
                  label: l,
            ...
            n.createElement(
              ...
              n.createElement(rt.PopupMenuSeparator, null),
              n.createElement(bt.MenuItemSwitcher, {
                key: 'snap-to-indicators',
                checked: l,
                onChange: function (e) {
                  ((0, Et.trackEvent)(
                    'GUI',
                    'Chart Left Toolbar',
                    'magnet snaps ' + (e ? 'on' : 'off'),
                  ),
                    !1);
                  (0, Jt.setMagnetSnapsToIndicators)(e);
                },
                label: W.t(null, void 0, o(6545)),
                value: 'snapToIndicatorsSwitcher',
                theme: t ? Xt : Yt,
                disabled: !i,
              }),
            ),
        ...
        function s(e) {
          void 0 !== e &&
            ((0, Et.trackEvent)(
              'GUI',
              'Magnet mode',
              e === Zt.MagnetMode.WeakMagnet ? 'Weak' : 'Strong',
            ),
            (0, Jt.setMagnetMode)(e));
        }
      }
      var to;
      !(function (e) {
      ...
      function uo(e) {
        const { direction: t, theme: o = so } = e;
        return n.createElement(
          'svg',
          {
            xmlns: co,
            ...
            onContextMenu: no.preventDefault,
          },
          n.createElement(
            'g',
      ...
      var ho = o(39416),
        mo = o(99247),
        po = o(74623);
      const bo = (0, pe.mergeThemes)(ro, po),
        vo = {
          hide: W.t(null, void 0, o(99838)),
          show: W.t(null, void 0, o(32579)),
        },
        go = (0, n.forwardRef)((e, t) => {
          const { toolbarVisible: o, 'data-name': i } = e,
            a = (0, ho.useFunctionalRefObject)(t);
          return n.createElement(
            'button',
            {
              'data-tooltip-show-on-focus': 'true',
              ...mo.MouseClickAutoBlurHandler.attributes(),
              ref: a,
              type: 'button',
              'aria-label': o ? vo.hide : vo.show,
              'data-tooltip': o ? vo.hide : vo.show,
              className: l(
                bo.toggleButton,
              ...
              onClick: function () {
                w.isDrawingToolbarVisible.setValue(
                  !w.isDrawingToolbarVisible.value(),
                );
              },
              'data-name': i,
      ...
      var fo = o(37558),
        wo = o(73986),
        Co = o(90692);
      const xo = { chartWidgetCollection: o(19036).any.isRequired };
      var To = o(68976),
        _o = o(60873);
      const Eo = u.enabled('right_toolbar'),
        ko = u.enabled('keep_object_tree_widget_in_right_toolbar'),
        So =
          (u.enabled('saveload_separate_drawings_storage'), (0, p.onWidget)()),
        Fo = new m.Delegate(),
        yo = Et.trackEvent.bind(null, 'GUI', 'Chart Left Toolbar'),
        Mo = (e, t) => yo(`${e} ${t ? 'on' : 'off'}`);
      class Ao extends n.PureComponent {
        constructor(e) {
          (super(e),
            (this._grayedTools = {}),
            ...
            (this._handleDrawingClick = (e) => {
              (Mo('drawing mode', e), Io('drawing mode', e ? 'on' : 'off'));
            }),
            (this._handleLockClick = (e) => {
              (Mo('lock all drawing', e), Io('lock', e ? 'on' : 'off'));
            }),
            (this._handleSyncClick = (e) => {
              (Mo('sync', e), Io('sync', e ? 'on' : 'off'));
            }),
            ...
            (this._filteredLineTools = f.lineTools.reduce((e, t) => {
              const { id: o, title: n, trackLabel: i } = t,
                a = (e) =>
                  (0, f.isLineToolOption)(e) ||
                  this._toolsFilter.isToolEnabled(
                    v.lineToolsInfo[e.name].localizedName,
                  ),
                l = [];
              return (
                (0, f.isLineToolsGroupWithSections)(t)
                  ? t.sections.forEach((e) => {
                      const t = e.items.filter(a);
                      t.length && l.push({ title: e.title }, ...t);
                    })
                  : l.push(...t.items.filter(a)),
                l.length &&
                  e.push({ id: o, title: n, trackLabel: i, items: l }),
                e
              );
            }, [])),
            ...
            (this._features = {
              favoriting:
                !this.props.readOnly && !So && u.enabled('items_favoriting'),
        ...
        componentDidMount() {
          (w.isDrawingToolbarVisible.subscribe(this._handleChangeVisibility),
        ...
        componentWillUnmount() {
          (window.widgetbar
            ?.visible()
            .unsubscribe(this._handleWidgetbarVisible),
            w.isDrawingToolbarVisible.unsubscribe(this._handleChangeVisibility),
        ...
        render() {
          ...
          let c;
          c = n.createElement(go, {
            toolbarVisible: a,
            'data-name': 'toolbar-drawing-toggle-button',
          });
          const h = () =>
            !!this._features.tools &&
            !(!u.enabled('show_object_tree') || (ko && !Eo));
          return n.createElement(
            To.RegistryProvider,
            { validation: xo, value: this._registry },
            n.createElement(
              ao.CloseDelegateContext.Provider,
              { value: Fo },
              n.createElement(
                fo.DrawerManager,
                null,
                n.createElement(
                  Co.MatchMedia,
                  { rule: wo.DialogBreakpoints.TabletSmall },
                  (e) =>
                    n.createElement(
                      lo.Toolbar,
                      {
                        id: 'drawing-toolbar',
                        className: l(_o.drawingToolbar, { [_o.isHidden]: !a }),
                        style: s,
                        onClick: this.props.onClick,
                        onContextMenu: no.preventDefaultForContextMenu,
                        ...
                        n.createElement(
                          ...
                          !o &&
                            n.createElement(
                              'div',
                              { className: _o.group, style: s },
                              n.createElement(eo, { isSmallTablet: e }),
                              this._features.tools &&
                                n.createElement(at, {
                          ...
                          !o &&
                            ...
                            n.createElement(
                              'div',
                              {
                                className: l(_o.group, _o.lastGroup),
                                style: s,
                              },
                              !1,
                              this._features.tools &&
        ...
        _negotiateResizer() {
          const e = io.TOOLBAR_WIDTH_COLLAPSED;
          this.props.resizerBridge.negotiateWidth(
            this.state.isVisible ? io.TOOLBAR_WIDTH_EXPANDED : e,
          );
        }
        _handleGlobalClose() {
          Fo.fire();
      ...
      class No {
        constructor(e, t) {
          ((this._component = null),
            ...
            (this._container = e),
            i.render(
              n.createElement(Ao, { ...t, ref: this._handleRef }),
              this._container,
            ));
        }
        destroy() {
    ...
    68976: (e, t, o) => {
      ...
      function r(e) {
        ...
        return (s(o, t), n.createElement(l.Provider, { value: o }, e.children));
      }
      function c() {
        return l;
      }
