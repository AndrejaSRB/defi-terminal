(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1727],
  {
      ...
      function n(e, o = []) {
        ...
        return (
          (0, t.useLayoutEffect)(() => {
            ...
            return (
              e.addEventListener('active-descendant-focus', o),
              e.addEventListener('active-descendant-blur', o),
              () => {
                (e.removeEventListener('active-descendant-focus', o),
                  e.removeEventListener('active-descendant-blur', o));
              }
            );
          }, o),
          [a, l]
    ...
    71402: (e, o, l) => {
      'use strict';
      l.d(o, { RemoveTitleType: () => t, removeTitlesMap: () => n });
      var t,
        i = l(11542);
      !(function (e) {
      ...
      const n = {
        [t.Add]: i.t(null, void 0, l(69207)),
        [t.Remove]: i.t(null, void 0, l(85106)),
      };
    },
    36189: (e, o, l) => {
      'use strict';
      ...
      function d(e) {
        const {
          ...
          [g, L] = (0, s.useActiveDescendant)(null),
          T =
            m ??
            (l
    ...
    73607: (e, o, l) => {
      ...
      function s(e, o) {
        if (!e.target) return;
        const l = e.relatedTarget?.getAttribute('aria-activedescendant');
        if (e.relatedTarget !== o.current) {
          const e = l && document.getElementById(l);
          if (!e || e !== o.current) return;
        }
        v(e.target);
      }
      function c(e) {
        if (e.defaultPrevented) return;
        const o = (0, n.hashFromEvent)(e);
        if (!r.includes(o)) return;
        const l = document.activeElement;
        if (!(document.activeElement instanceof HTMLElement)) return;
        const a = m(e.currentTarget).sort(t.navigationOrderComparator);
        ...
        switch ((0, t.mapKeyCodeToDirection)(o)) {
          case 'inlinePrev':
            if (!v.length) return;
            (e.preventDefault(),
              T(0 === g ? a[c] : L ? h(v, g, -1) : v[v.length - 1]));
            break;
          case 'inlineNext':
            if (!v.length) return;
            (e.preventDefault(),
              g === v.length - 1 ? T(a[c]) : T(L ? h(v, g, 1) : v[0]));
            break;
          case 'blockPrev': {
            e.preventDefault();
            const o = h(a, c, -1);
      ...
      function v(e) {
        const [o] = m(e);
        o && ((0, i.becomeMainElement)(o), o.focus());
      }
      function h(e, o, l) {
        return e[(o + e.length + l) % e.length];
      }
      function d(e, o) {
        const l = u(e);
        return l.length ? l[(o + l.length) % l.length] : null;
      }
      function m(e) {
        return Array.from(
          e.querySelectorAll(
    ...
    70173: (e, o, l) => {
      'use strict';
      l.d(o, { drawingToolsIcons: () => t });
      const t = {
        SyncDrawing: l(99088),
        arrow: l(63743),
        cursor: l(18953),
        dot: l(72196),
        demonstration: l(54780),
        performance: '',
        drawginmode: l(52459),
        drawginmodeActive: l(63975),
        eraser: l(27999),
        group: l(34059),
    ...
    84902: (e, o, l) => {
      ...
      l.d(o, {
        isLineTool: () => h,
        isLineToolOption: () => d,
        isLineToolSwitcherOption: () => m,
        isLineToolsGroupWithSections: () => v,
        lineTools: () => c,
        lineToolsFlat: () => u,
      });
      var t = l(11542),
        ...
        a = l(57340),
        r = l(87465);
      const s = n.enabled('image_drawingtool'),
        c = [
          {
            id: 'linetool-group-cursors',
            title: t.t(null, void 0, l(81578)),
            sections: [
              {
                items: [
                  { name: 'cursor' },
              ...
              },
              {
                items: [
                  ...
                  i.CheckMobile.any()
                    ...
                    : {
                        type: 'switcher',
                        reactKey: 'values-tooltip-on-long-press',
                        label: t.t(null, void 0, l(84145)),
                        value: 'valuesTooltipOnLongPress',
                        watchedValue: a.chartFloatingTooltipEnabledWV,
                      },
                ].filter(r.isExistent),
              },
            ],
          ...
          },
          {
            ...
            title: t.t(null, void 0, l(48773)),
            sections: [
              {
                title: t.t(null, void 0, l(56982)),
                items: [
          ...
          },
          {
            ...
            title: t.t(null, void 0, l(2654)),
            sections: [
              {
                title: t.t(null, void 0, l(26578)),
                items: [
          ...
          },
          {
            ...
            title: t.t(null, void 0, l(1410)),
            sections: [
              {
                title: t.t(null, void 0, l(75747)),
                items: [
          ...
          },
          {
            ...
            title: t.t(null, void 0, l(22145)),
            sections: [
              {
                title: t.t(null, void 0, l(65695)),
                items: [
                  { name: 'LineToolBrush' },
          ...
          },
          {
            ...
            title: t.t(null, void 0, l(32064)),
            sections: [
              {
                title: t.t(null, void 0, l(65831)),
                items: [
                  { name: 'LineToolText' },
      ...
      function m(e) {
        return d(e) && 'switcher' === e.type;
      }
      const u = c
        .map(function (e) {
          return v(e)
            ? e.sections.map((e) => e.items.filter(h)).flat()
            : e.items.filter(h);
        })
        .flat();
    },
    18117: (e, o, l) => {
      ...
      var t = l(50151),
        ...
        r = l(70173);
      const s = {
        SyncDrawing: i.t(null, void 0, l(59377)),
        arrow: i.t(null, void 0, l(11858)),
        cursor: i.t(null, void 0, l(6969)),
        demonstration: i.t(null, void 0, l(14939)),
        dot: i.t(null, void 0, l(57157)),
        performance: i.t(null, void 0, l(35553)),
        drawginmode: i.t(null, void 0, l(99901)),
        eraser: i.t(null, void 0, l(8727)),
        group: i.t(null, void 0, l(3154)),
        hideAllDrawings: i.t(null, void 0, l(52563)),
        lockAllDrawings: i.t(null, void 0, l(79451)),
        magnet: i.t(null, void 0, l(81396)),
        measure: i.t(null, void 0, l(91563)),
        removeAllDrawingTools: i.t(null, void 0, l(57118)),
        showObjectsTree: i.t(null, void 0, l(85786)),
        zoom: i.t(null, void 0, l(55774)),
        'zoom-out': i.t(null, void 0, l(37310)),
      };
      var c = l(56876),
        v = l(68335),
        h = l(81360);
      const d = (0, v.humanReadableModifiers)(v.Modifiers.Shift, !1).trim(),
        m = (0, v.humanReadableModifiers)(v.Modifiers.Alt, !1).trim(),
        u = (0, v.humanReadableModifiers)(v.Modifiers.Mod, !1).trim(),
        g = { keys: [d], text: i.t(null, void 0, l(23369)) },
        L = { keys: [d], text: i.t(null, void 0, l(13798)) },
        T = { keys: [d], text: i.t(null, void 0, l(10539)) },
        w = {
          ...
          LineToolDateRange: {},
          LineToolDisjointAngle: { hotKey: (0, n.hotKeySerialize)(g) },
          ...
          LineToolEllipse: { hotKey: (0, n.hotKeySerialize)(L) },
          LineToolExtended: {},
          LineToolFibChannel: {},
          LineToolFibCircles: { hotKey: (0, n.hotKeySerialize)(L) },
          LineToolFibRetracement: {},
          LineToolFibSpeedResistanceArcs: {},
          LineToolFibSpeedResistanceFan: { hotKey: (0, n.hotKeySerialize)(T) },
          LineToolFibSpiral: {},
          LineToolFibTimeZone: {},
          LineToolFibWedge: {},
          LineToolFlagMark: {},
          LineToolFlatBottom: { hotKey: (0, n.hotKeySerialize)(g) },
          ...
          LineToolNote: {},
          LineToolSignpost: {},
          LineToolParallelChannel: { hotKey: (0, n.hotKeySerialize)(g) },
          LineToolPitchfan: {},
          LineToolPitchfork: {},
          LineToolPolyline: {},
          LineToolPath: {},
          LineToolPrediction: {},
          LineToolPriceLabel: {},
          LineToolPriceNote: { hotKey: (0, n.hotKeySerialize)(g) },
          LineToolTextNote: {},
          LineToolArrowMarker: {},
          LineToolPriceRange: {},
          LineToolProjection: {},
          ...
          LineToolRotatedRectangle: { hotKey: (0, n.hotKeySerialize)(g) },
          ...
          LineToolTimeCycles: {},
          LineToolTrendAngle: { hotKey: (0, n.hotKeySerialize)(g) },
          LineToolTrendBasedFibExtension: {},
          LineToolTrendBasedFibTime: {},
          LineToolTrendLine: { hotKey: (0, n.hotKeySerialize)(g) },
          LineToolInfoLine: {},
          LineToolTriangle: {},
          ...
          LineToolGhostFeed: {},
          LineToolTable: {},
          SyncDrawing: { iconActive: r.drawingToolsIcons.SyncDrawingActive },
          arrow: {},
          cursor: {},
          dot: {},
          demonstration: {
            hotKey: (0, n.hotKeySerialize)({
              keys: [m],
              text: i.t(null, void 0, l(42633)),
            }),
          },
          drawginmode: { iconActive: r.drawingToolsIcons.drawginmodeActive },
          eraser: {},
          group: {},
          hideAllDrawings: {
            iconActive: r.drawingToolsIcons.hideAllDrawingsActive,
            hotKey: (0, n.hotKeySerialize)({
              keys: [u, m, 'H'],
              text: '{0} + {1} + {2}',
            }),
          ...
          lockAllDrawings: {
            iconActive: r.drawingToolsIcons.lockAllDrawingsActive,
          },
          magnet: {
            hotKey: (0, n.hotKeySerialize)({ keys: [u], text: '{0}' }),
          },
          measure: {
            hotKey: (0, n.hotKeySerialize)({
              keys: [d],
              text: i.t(null, void 0, l(92949)),
            }),
          },
      ...
      Object.entries(w)
        .map(([e, o]) => {
          const l = a.lineToolsIcons[e] ?? r.drawingToolsIcons[e];
          (0, t.assert)(!!l, `Icon is not defined for drawing "${e}"`);
          ...
          return {
            ...
            icon: l,
            localizedName: i,
            selectHotkey: h.lineToolsSelectHotkeys[e],
          };
        })
        .forEach((e) => {
          f[e.name] = e;
    ...
    6519: (e, o, l) => {
      'use strict';
      l.d(o, { LinetoolsFavoritesStore: () => c });
      var t = l(48096),
        i = l(87465),
        n = l(1765);
      const a = ['LineToolBalloon', 'LineToolNoteAbsolute', null, null].filter(
          i.isExistent,
        ),
        r = !1;
      var s, c;
      (!(function (e) {
        function o() {
          ...
          if (0 === s.length && t && 'undefined' != typeof window) {
            const e = JSON.parse(
          ...
          (s.forEach((t, i) => {
            ...
            l(n)
              ? a.includes(n)
                ? (o = !0)
                : e.favorites.push(n)
              : r && r.includes(n) && e.hiddenToolsPositions.set(n, i);
          }),
            o && i(),
        ...
        function i(o) {
          ...
          (e.hiddenToolsPositions.forEach((e, o) => {
            ...
            (0, n.setJSON)('chart.favoriteDrawings', l, o));
        }
        ((e.favorites = []),
          (e.favoritesSynced = new t.Delegate()),
          (e.hiddenToolsPositions = new Map()),
          (e.favoriteIndex = function (o) {
        ...
        (function (e) {
          ...
          ((e.favoriteAdded = new t.Delegate()),
            (e.favoriteRemoved = new t.Delegate()),
            (e.favoriteMoved = new t.Delegate()),
            ...
            (e.favorite = function (e) {
              return e < 0 || e >= l() ? '' : s.favorites[e];
            }),
            (e.addFavorite = function (l, t) {
              return (
            ...
            (e.removeFavorite = function (o, l) {
              const t = s.favoriteIndex(o);
              if (-1 === t) return !1;
              s.favorites.splice(t, 1);
            ...
            (e.isFavorite = i),
            (e.moveFavorite = function (t, i, n) {
              if (i < 0 || i >= l() || !o(t)) return !1;
              const a = s.favoriteIndex(t);
              if (-1 === a || i === a) return !1;
              const r = s.hiddenToolsPositions;
              return (
                r.forEach((e, o) => {
                  (a < e && i > e ? e-- : i < e && a > e && e++, r.set(o, e));
                }),
                s.favorites.splice(a, 1),
                s.favorites.splice(i, 0, t),
                s.saveFavorites(n),
                e.favoriteMoved.fire(t, a, i),
                !0
              );
            }));
        })(c || (c = {})));
