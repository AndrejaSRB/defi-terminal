(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5386],
  {
    ...
    86332: (e, n, t) => {
      'use strict';
      t.d(n, { ControlGroupContext: () => o });
      const o = t(50959).createContext({
        isGrouped: !1,
    ...
    95604: (e, n, t) => {
      ...
      t.d(n, { getGroupCellRemoveRoundBorders: () => o });
    },
    67029: (e, n, t) => {
      'use strict';
      t.d(n, { ControlSkeleton: () => v, InputClasses: () => _ });
      var o = t(50959),
        r = t(97754),
        a = t.n(r),
        i = t(50151),
      ...
      function m(e) {
        ...
        return (
          0 !== e &&
            (1 & e && (n = a()(n, d()['no-corner-top-left'])),
            2 & e && (n = a()(n, d()['no-corner-top-right'])),
            4 & e && (n = a()(n, d()['no-corner-bottom-right'])),
            8 & e && (n = a()(n, d()['no-corner-bottom-left']))),
          n
        );
      }
      function h(e, n, t, o) {
        const {
          ...
          v = m(r ?? (0, c.getGroupCellRemoveRoundBorders)(t));
        return a()(
          d().container,
          d()[`container-${u}`],
          d()[`intent-${s}`],
      ...
      function f(e, n, t) {
        ...
        const i = m(r ?? (0, c.getGroupCellRemoveRoundBorders)(n));
        return a()(d().highlight, d().shown, d()[`size-${t}`], i);
      }
      const _ = {
      ...
      function b(e, n) {
        const {
          ...
          M = (function (e, n = null, t) {
            const r = (0, o.useRef)(null),
              a = (0, o.useRef)(null),
              i = (0, o.useCallback)(() => {
                if (null === r.current || null === a.current) return;
                const [e, n, t] = a.current;
        ...
        return o.createElement(
          ...
          R,
          z,
          o.createElement('span', { className: f(e, C, D) }),
        );
      }
      b.displayName = 'ControlSkeleton';
      const v = o.forwardRef(b);
    },
    78274: (e, n, t) => {
      'use strict';
      t.d(n, {
      ...
      function u(e) {
        ...
        return o.createElement(
          'span',
          { className: a()(s()['inner-slot'], s()['inner-middle-slot'], n) },
          t,
        );
      }
      function c(e) {
      ...
      function g(e) {
        const { className: n, children: t, dataQaId: r } = e;
        return o.createElement(
          'span',
          { className: a()(s()['after-slot'], n), 'data-qa-id': r },
          t,
        );
      }
    },
      ...
      function r(e, n) {
        ...
        const a = {
          onFocus: (0, o.useCallback)(
            function (n) {
              (void 0 !== e && e.current !== n.target) || r(!0);
            },
            [e],
          ),
          onBlur: (0, o.useCallback)(
            function (n) {
              (void 0 !== e && e.current !== n.target) || r(!1);
            },
            [e],
          ),
        };
    ...
    67842: (e, n, t) => {
      'use strict';
      t.d(n, { useResizeObserver: () => i });
      var o = t(50959),
        r = t(43010),
        a = t(39416);
      function i(e, n = []) {
        const { callback: t, ref: i = null } = (function (e) {
            return 'function' == typeof e ? { callback: e } : e;
          })(e),
          s = (0, o.useRef)(null),
          l = (0, o.useRef)(t);
        l.current = t;
        const u = (0, a.useFunctionalRefObject)(i),
          c = (0, o.useCallback)(
            (e) => {
              (u(e),
                null !== s.current &&
        ...
        return (
          (0, r.useIsomorphicLayoutEffect)(
            () => (
              (s.current = new ResizeObserver((e, n) => {
                l.current(e, n);
              })),
    ...
    47930: (e, n, t) => {
      ...
      t.d(n, {
        formatTime: () => d,
        isValidTimeOptionsDateStyle: () => g,
        isValidTimeOptionsRange: () => c,
      });
      const o = { calendar: 'gregory', numberingSystem: 'latn', hour12: !1 },
        ...
        i = { hour: '2-digit', minute: '2-digit', second: '2-digit' },
        s = { timeZoneName: 'shortOffset', weekday: 'short' },
        l = { year: 0, month: 1, day: 2, hour: 3, minute: 4, second: 5 };
      const u = ['year', 'month', 'day', 'hour', 'minute', 'second'];
      function c(e) {
        return u.includes(e);
      }
      function g(e) {
      ...
      function d(e, n, t = 'year', u = 'day', c) {
        const g = (function (e = 'year', n = 'day', t = {}) {
            [e, n] = l[n] > l[e] ? [e, n] : [n, e];
            const u = { ...('numeric' === t.dateStyle ? a : r), ...i },
              c = t.fractionalSecondDigits,
              g = {
                ...o,
                fractionalSecondDigits:
                  void 0 === c
                    ? void 0
                    : Math.floor(Math.min(Math.max(1, c), 3)),
                timeZone: t.timeZone,
                weekday: t.weekday ? s.weekday : void 0,
                timeZoneName: t.timeZoneName ? s.timeZoneName : void 0,
              };
            return (
              Object.keys(u).forEach((t) => {
                l[t] >= l[e] && l[t] <= l[n] && (g[t] = u[t]);
              }),
              g
            );
          })(t, u, c),
          d = new Intl.DateTimeFormat(n, g),
          m = new Date(e);
        return d.format(m);
      }
    },
    87896: (e, n, t) => {
      ...
      function c(e) {
        const [n] = (0, o.useState)({
          isOnMobileAppPage: (e) => (0, s.isOnMobileAppPage)(u[e]),
          isRtl: (0, l.isRtl)(),
          locale: window.locale,
          renderMode: e.renderMode ?? 'legacy',
        });
        return o.createElement(i.Provider, { value: n }, e.children);
      }
      function g(e, n, t = 'legacy') {
        const i = o.createElement(c, { renderMode: t }, e);
        if ('modern' === t) {
          const e = (0, a.createRoot)(n);
          return (
            e.render(i),
            {
              render(n) {
                e.render(o.createElement(c, { renderMode: t }, n));
              },
              unmount() {
                e.unmount();
              },
        ...
        return (
          ...
          {
            render(e) {
              r.render(o.createElement(c, { renderMode: t }, e), n);
            },
            unmount() {
    ...
    48126: (e, n, t) => {
      ...
      const r = JSON.parse(
        ...
        a = (function () {
          ...
          return (
            e.forEach((e) => {
              const t = (0, o.ensureNotNull)(e.getAttribute('data-locale'));
              n[t] = { ...r[t], href: e.href };
            }),
            n
          );
      ...
      function i(e) {
        return ((e = e || window.locale), a[e]?.iso);
      }
    },
    3085: (e, n, t) => {
      'use strict';
      t.d(n, { OverlayScrollContainer: () => p });
      var o = t(50959),
        r = t(97754),
        a = t.n(r),
        i = t(24640),
      ...
      function m(e) {
        const {
          ...
          R = (0, o.useRef)(0),
          {
            ...
            sizePropName: y,
            minSizePropName: D,
            startPointPropName: S,
            currentMousePointPropName: W,
            progressBarTransform: E,
          } = g[m];
        (0, o.useEffect)(() => {
          const e = (0, s.ensureNotNull)(b.current).ownerDocument;
          return (
            N
              ? (f && f(),
                e &&
        ...
        const C = n / t || 0,
          ...
          L = w ? -j : 0,
          T = w ? 0 : j,
          x = O((0, l.clamp)(i, L, T)) || 0;
        return o.createElement(
          'div',
          {
            ref: b,
            className: a()(h.wrap, z && h['wrap--horizontal']),
            style: { [y]: n },
            onMouseDown: function (e) {
              if (e.isDefaultPrevented()) return;
              e.preventDefault();
              const n = I(e.nativeEvent, (0, s.ensureNotNull)(b.current)),
                t = Math.sign(n),
                o = (0, s.ensureNotNull)(v.current).getBoundingClientRect();
              R.current = (t * o[y]) / 2;
              let r = Math.abs(n) - Math.abs(R.current);
              const a = O(j);
              r < 0
                ? ((r = 0), (R.current = n))
                : r > a && ((r = a), (R.current = n - t * a));
              (c(V(t * r)), P(!0));
            },
          },
          o.createElement(
            ...
            {
              ref: v,
              className: a()(h.bar, z && h['bar--horizontal']),
              style: { [D]: p, [y]: M, transform: `${E}(${x}px)` },
              onMouseDown: function (e) {
                (e.preventDefault(),
                  (R.current = I(
                    e.nativeEvent,
            ...
            o.createElement('div', {
              className: a()(h.barInner, z && h['barInner--horizontal']),
            }),
          ),
        );
        function B(e) {
          const n = I(e, (0, s.ensureNotNull)(b.current)) - R.current;
          c(V(n));
        }
        function H() {
          P(!1);
        ...
        function I(e, n) {
          const t = n.getBoundingClientRect()[S];
          return e[W] - t;
        }
        function O(e) {
          return e * C * Z;
      ...
      function p(e) {
        ...
        return o.createElement(
          'div',
          {
            ...N,
            ref: n,
            className: r(t, f.scrollWrap),
            style: { visibility: b || v || P ? 'visible' : 'hidden' },
          },
          z &&
            o.createElement(m, {
              size: a - y,
    ...
    898: (e, n, t) => {
      'use strict';
      t.d(n, { useDimensions: () => a });
      var o = t(50959),
        r = t(67842);
      function a(e) {
        const [n, t] = (0, o.useState)(null),
          a = (0, o.useCallback)(
            ([e]) => {
              const o = e.target.getBoundingClientRect();
              (o.width === n?.width && o.height === n.height) || t(o);
            },
            [n],
          );
        return [(0, r.useResizeObserver)({ callback: a, ref: e }), n];
      }
    },
    33127: (e, n, t) => {
      'use strict';
      t.d(n, { useOverlayScroll: () => l });
      var o = t(50959),
        r = t(50151),
        a = t(70412),
        i = t(49483);
      const s = { onMouseEnter: () => {}, onMouseLeave: () => {} };
      function l(e, n = i.CheckMobile.any()) {
        const t = (0, o.useRef)(null),
          ...
          m = (0, o.useCallback)(() => {
            ...
            const {
              ...
              s = t.current ? t.current.offsetTop : 0;
            d((t) => ({
              ...t,
              containerHeight: e - s,
              contentHeight: n - s,
