...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    67725: (e, t, i) => {
      i.d(t, { createLineStyleDefinition: () => P });
      var r = i(11542),
        n = i(95804),
        o = i(95338),
        s = i(91682);
      const l = new n.TranslatedString(
        ...
        _ = r.t(null, void 0, i(3554)),
        f = r.t(null, void 0, i(61856)),
        g = r.t(null, void 0, i(87430));
      function P(e, t, i, r, n) {
        const P = {},
          v = {
            id: `${(0, s.removeSpaces)(i.originalText())}${r}`,
            title: (n && n.line) || _,
          };
        return (
          void 0 !== t.showLine &&
            (P.checked = (0, o.convertToDefinitionProperty)(
              e,
              t.showLine,
              l.format({ toolName: i }),
            )),
          void 0 !== t.lineWidth &&
            (P.width = (0, o.convertToDefinitionProperty)(
              e,
              t.lineWidth,
              a.format({ toolName: i }),
            )),
          void 0 !== t.lineStyle &&
            (P.style = (0, o.convertToDefinitionProperty)(
              e,
              t.lineStyle,
              p.format({ toolName: i }),
            )),
          void 0 !== t.lineColor &&
            (P.color = (0, o.getColorDefinitionProperty)(
              e,
              t.lineColor,
              null,
              c.format({ toolName: i }),
          ...
          void 0 !== t.extendLeft &&
            ((P.extendLeft = (0, o.convertToDefinitionProperty)(
              e,
              t.extendLeft,
              u.format({ toolName: i }),
            )),
            (v.extendLeftTitle = (n && n.extendLeftTitle) || f)),
          void 0 !== t.leftEnd &&
            (P.leftEnd = (0, o.convertToDefinitionProperty)(
              e,
              t.leftEnd,
              h.format({ toolName: i }),
            )),
          void 0 !== t.extendRight &&
            ((P.extendRight = (0, o.convertToDefinitionProperty)(
              e,
              t.extendRight,
              d.format({ toolName: i }),
            )),
            (v.extendRightTitle = (n && n.extendRightTitle) || g)),
          void 0 !== t.rightEnd &&
            (P.rightEnd = (0, o.convertToDefinitionProperty)(
              e,
              t.rightEnd,
              y.format({ toolName: i }),
            )),
          (0, o.createLinePropertyDefinition)(P, v)
        );
      }
    },
    14472: (e, t, i) => {
      ...
      const y = o.t(null, void 0, i(40091)),
        _ = o.t(null, void 0, i(78930)),
        f = o.t(null, void 0, i(92516)),
        g = o.t(null, void 0, i(70320)),
        P = o.t(null, void 0, i(21429)),
      ...
      class b {
          ...
          return (0, a.createPropertyPage)(
            (0, c.getIntervalsVisibilitiesPropertiesDefinitions)(
              ...
              new s.TranslatedString(
                this._source.name(),
                this._source.title(d.TitleDisplayTarget.StatusLine, !0),
              ),
            ),
            'visibility',
            y,
        ...
        _getYCoordinateStepWV() {
          return (
            null === this._yCoordinateStepWV &&
              ((this._yCoordinateStepWV = new p.WatchedValue(
                (function (e) {
                  if (null !== e) {
                    const t = e.priceStep();
                    if (null !== t) return t;
    ...
    87997: (e, t, i) => {
      i.d(t, { PitchBaseDefinitionsViewModel: () => T });
      var r = i(50151),
        n = i(11542),
        o = i(95804),
        s = i(67725),
      ...
      const u = new o.TranslatedString(
        ...
        b = n.t(null, { context: 'study' }, i(29291)),
        S = n.t(null, void 0, i(28683)),
        m = n.t(null, void 0, i(79468)),
        D = n.t(null, void 0, i(819));
      class T extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            ...
            i = t.childs(),
            n = this._source.name(),
            l = (0, p.removeSpaces)(n),
            T = new o.TranslatedString(n, this._source.translatedType());
          t.hasChild('extendLines') &&
            e.push(
              (0, a.createCheckablePropertyDefinition)(
                ...
                { id: `${l}ExtendLines`, title: D },
              ),
            );
          const w = i.median.childs(),
            x = (0, s.createLineStyleDefinition)(
              this._propertyApplier,
              {
                lineColor: w.color,
          ...
          const A = (0, a.createColorPropertyDefinition)(
            {
              color: (0, a.getColorDefinitionProperty)(
                this._propertyApplier,
            ...
            { id: `${l}AllLineColor`, title: S },
          );
          e.push(A);
          const V = (0, a.createTransparencyPropertyDefinition)(
            {
              checked: (0, a.convertToDefinitionProperty)(
                this._propertyApplier,
                i.fillBackground,
    ...
    40226: (e, t, i) => {
      ...
      function y(e, t, i) {
        return i(e, { tpl: h, fill: c, typecheck: t.typecheck.unpack }, t);
      }
      class _ extends s.DefaultProperty {
        constructor(e) {
          const { levelsIterator: t = d, map: i = {}, ...r } = e,
            n = { ...a, ...i };
          (r.state && (r.state = y(r.state, n, t)),
            super(r),
            (this._map = n),
          ...
          return i
            ...
            : ((n = r),
              ...
              (0, this._levelsIterator)(
                n,
                { tpl: u, fill: p, typecheck: o.typecheck.pack },
                o,
              ));
          var n, o;
        }
        ...
        applyTemplate(e, t) {
          this.mergeAndFire(
            (0, s.extractState)(
              (0, n.default)(
                (0, r.default)(t),
                y(e, this._map, this._levelsIterator),
              ),
              this._allStateKeys,
        ...
        merge(e, t) {
          return super.merge(
            this._map ? y(e, this._map, this._levelsIterator) : e,
            t,
          );
        }
        _options() {
