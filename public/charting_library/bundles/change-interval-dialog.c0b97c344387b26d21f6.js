  ...
  [2077],
  {
    ...
    67029: (e, t, n) => {
      ...
      function p(e) {
        ...
        return (
          0 !== e &&
            (1 & e && (t = s()(t, h()['no-corner-top-left'])),
            2 & e && (t = s()(t, h()['no-corner-top-right'])),
            4 & e && (t = s()(t, h()['no-corner-bottom-right'])),
            8 & e && (t = s()(t, h()['no-corner-bottom-left']))),
          t
        );
      }
      function g(e, t, n, o) {
        const {
          ...
          y = p(i ?? (0, d.getGroupCellRemoveRoundBorders)(n));
        return s()(
          h().container,
          h()[`container-${c}`],
          h()[`intent-${a}`],
      ...
      function m(e, t, n) {
        ...
        if (!o) return h().highlight;
        const r = p(i ?? (0, d.getGroupCellRemoveRoundBorders)(t));
        return s()(h().highlight, h().shown, h()[`size-${n}`], r);
      }
      const f = {
          FontSizeMedium: (0, r.ensureDefined)(h()['font-size-medium']),
          FontSizeLarge: (0, r.ensureDefined)(h()['font-size-large']),
        },
        _ = { passive: !1 };
      function v(e, t) {
        const {
        ...
        return o.createElement(
          ...
          x,
          E,
          o.createElement('span', { className: m(e, T, b) }),
        );
      }
    ...
    78274: (e, t, n) => {
      ...
      function u(e) {
        const { className: t, children: n, dataQaId: i } = e;
        return o.createElement(
          'span',
          { className: s()(a()['after-slot'], t), 'data-qa-id': i },
          n,
        );
      }
    },
    31261: (e, t, n) => {
      ...
      function y(e) {
        const {
          ...
          X = (0, a.filterProps)(Y, v),
          K = {
            ...(0, a.filterAriaProps)(Y),
            ...(0, a.filterDataProps)(Y),
            id: t,
            title: n,
            role: i,
            tabIndex: l,
        ...
        return o.createElement(g.ControlSkeleton, {
          ...X,
          disabled: k,
          readonly: U,
          tabIndex: Z,
          className: s()(_().container, O),
          size: L,
          ref: j,
          onFocus: q,
          startSlot: H,
          ...
          endSlot: $,
          'data-qa-id': (0, r.dataQaIds)('ui-lib-Input', V),
        });
      }
      function D(e) {
        e = (0, u.useControl)(e);
        const {
          ...
          b = (0, l.createSafeMulticastEventHandler)(
            D.onFocus,
            function (e) {
              n && !E.current && (0, c.selectAllContent)(e.currentTarget);
            },
            s,
          ),
          R = (0, l.createSafeMulticastEventHandler)(D.onBlur, r),
          M = (0, o.useCallback)(
            (e) => {
              ((f.current = e),
                a &&
        ...
        return o.createElement(y, {
          ...
          onContainerFocus: function (e) {
            _.current === e.target && null !== f.current && f.current.focus();
          },
          onFocus: b,
          onBlur: R,
          reference: M,
          containerReference: (0, d.useMergedRefs)([_, g]),
          onMouseDown: C,
          onMouseUp: S,
          dataQaId: m,
        });
    ...
    48027: (e, t, n) => {
      ...
      function s(e) {
        const {
          ...
          d = (0, o.createSafeMulticastEventHandler)(a ? void 0 : c.onFocus, t),
          u = (0, o.createSafeMulticastEventHandler)(a ? void 0 : c.onBlur, n);
        return {
          ...e,
      ...
      function r(e) {
        ...
        return (
          (0, i.useIsomorphicLayoutEffect)(() => {
            ...
            return (0, s.addOutsideEventListener)(u.current, o, l, document, e);
          }, [t, n, r, a, l]),
          c || d
        );
      }
    ...
    87896: (e, t, n) => {
      ...
      function u(e, t, n = 'legacy') {
        const r = o.createElement(d, { renderMode: n }, e);
        if ('modern' === n) {
          ...
          return (
            ...
            {
              render(t) {
                e.render(o.createElement(d, { renderMode: n }, t));
              },
              unmount() {
                e.unmount();
              },
        ...
        return (
          ...
          {
            render(e) {
              i.render(o.createElement(d, { renderMode: n }, e), t);
            },
            unmount() {
    ...
    9722: (e, t, n) => {
      ...
      class h extends o.PureComponent {
        ...
        render() {
          const {
            ...
            p = (0, c.filterDataProps)(this.props),
            g = this.props.style
          ...
          return o.createElement(
            ...
            o.createElement(a.Slot, { reference: this._handleSlot }),
          );
        }
        _createStyles() {
          const {
      ...
      function y(e) {
        return {
          x: (0, f.clamp)(e.x, 20, document.documentElement.clientWidth - 20),
          y: (0, f.clamp)(e.y, 20, window.innerHeight - 20),
        };
      }
      function D(e) {
      ...
      class x {
        ...
        _moveDialog(e, t) {
          const n = this._dialog.getBoundingClientRect(),
            ...
            i = v(e, n.width, o ? 0 : -1 / 0, o ? window.innerWidth : 1 / 0),
            s = v(t, n.height, o ? 0 : -1 / 0, o ? window.innerHeight : 1 / 0);
      ...
      const T = (0, M.getLogger)('DialogEventDispatcher');
      class F {
        constructor() {
        ...
        dispatch(e) {
          if ('dialog-open' === e) {
            ...
            this._openSessionId = (0, P.randomHash)();
          }
        ...
        recalculateBounds() {
          ...
          if (this._isFullscreen) {
            ...
            const o = this._dialog.getBoundingClientRect(),
              i = t - 2 * n,
              s = v(o.left, o.width, 0, e),
              r = v(o.top, o.height, n, t);
            ((this._dialog.style.top = '0px'),
              (this._dialog.style.left = '0px'),
                    ...
                    h,
                    {
                      ...
                      className: i(
                        ...
                        (0, N.isOnMobileAppPage)('any') &&
                          ...
                          W.mobile,
                        this.props.fullscreen && W.fullscreen,
        ...
        componentDidMount() {
          ...
          if ((this._eventDispatcher.dispatch('dialog-open'), e)) {
            ...
            if (e && e instanceof HTMLElement) {
              ...
              (this._cleanUpFunctions.push(() => i.destroy()),
                (this._drag = i));
            }
          }
          (this.props.autofocus &&
            ...
            (this._isFullScreen() || this.props.fixedBody) &&
              (0, R.setFixedBodyState)(!0));
          const { guard: i, calculateDialogPosition: s } = this.props;
          if (this.props.resizeHandler) this._resize = this.props.resizeHandler;
          else {
            const e = new I(o, { guard: i, calculateDialogPosition: s });
            (this._cleanUpFunctions.push(() => e.destroy()),
              (this._resize = e));
          }
          if (
            (this._isFullScreen() &&
          ...
          if (!o.contains(document.activeElement)) {
            const e = (function (e) {
              ...
              const n = (0, _.getActiveElementSelectors)(),
                o = Array.from(e.querySelectorAll(n)).filter(
                  (0, _.createScopedVisibleElementFilter)(e),
                );
      ...
      const L = (0, g.makeOverlapable)(z, !0);
    },
    86431: (e, t, n) => {
      'use strict';
    ...
    3014: (e, t, n) => {
      'use strict';
      (n.r(t), n.d(t, { showChangeIntervalDialog: () => E }));
      var o = n(50959),
        i = n(97754),
        s = n.n(i),
        r = n(11542),
        ...
        u = n(9745),
        h = n(85508);
      const p = r.t(null, void 0, n(79290)),
      ...
      const y = 8;
      function D(e) {
        const { initVal: t, selectOnInit: i, onClose: u } = e,
          h = (0, o.useRef)(null),
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
                ...
                'form',
                {
                  ...
                  onSubmit: function (e) {
                    ...
                    n &&
                      t !== n &&
                      w &&
                      c.linking.setIntervalAndLogInitiator(
                        n,
              ...
              w
                ? o.createElement('div', { className: v.hint }, x)
                : o.createElement(
                    'div',
