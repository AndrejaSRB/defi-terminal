...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    4714: (e, t, n) => {
      (n.r(t), n.d(t, { tableActions: () => r }));
      var o = n(89880),
        a = n(14429),
        l = n(41706);
      const c = o.t(null, void 0, n(61702)),
        d = o.t(null, void 0, n(80473)),
        i = o.t(null, void 0, n(85069)),
        s = o.t(null, void 0, n(33500));
      function r(e, t) {
        const n = [];
        (n.push(
          new a.ActionWithStandardIcon({
            ...
            options: {
              ...
              checkable: !1,
              onExecute: () => {
                const n = e.insertCellsUndoCommand(1);
                t.undoHistory().pushUndoCommand(n);
              },
            },
          }),
        ),
          n.push(
            new a.ActionWithStandardIcon({
              ...
              options: {
                ...
                checkable: !1,
                onExecute: () => {
                  const n = e.insertCellsUndoCommand(0);
                  t.undoHistory().pushUndoCommand(n);
                },
              },
            }),
        ...
        return (
          -1 !== o &&
            -1 !== r &&
            (n.length > 0 && n.push(new l.Separator()),
            n.push(
              new a.ActionWithStandardIcon({
                ...
                options: {
                  ...
                  onExecute: () => {
                    const n = e.removeCellsUndoCommand(0);
                    null !== n && t.undoHistory().pushUndoCommand(n);
                  },
                },
              }),
            ),
            n.push(
              new a.ActionWithStandardIcon({
                ...
                options: {
                  ...
                  onExecute: () => {
                    const n = e.removeCellsUndoCommand(1);
                    null !== n && t.undoHistory().pushUndoCommand(n);
                  },
                },
              }),
    ...
    91974: (e, t, n) => {
      (n.r(t), n.d(t, { showTableContextMenu: () => c }));
      var o = n(60709),
        a = n(31932),
        l = n(31269);
      async function c(e, t, n) {
        ...
        const d = c.activeChartWidget.value(),
          { ActionsProvider: i } = await (0, a.actionsProviderModule)(),
          s = new i(d),
          r = await s.contextMenuActionsForSources([e]),
          u = await l.ContextMenuManager.createMenu(
            r,
            {},
