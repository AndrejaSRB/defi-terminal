...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5410],
  {
    ...
    80667: (e, t, i) => {
      i.d(t, { createPropertyDefinitionsCheckableListOptionsGroup: () => o });
      var r = i(22613);
      function o(e, t, i, o, n, s, p, l) {
        return {
          id: o,
          title: n,
          visible: s,
          ...
          checked: t,
          definitions: new r.WatchedValue(i),
    ...
    19537: (e, t, i) => {
      ...
      i.d(t, { createCheckablePropertyDefinition: () => r });
    },
    35106: (e, t, i) => {
      i.d(t, {
        getColorDefinitionProperty: () => a,
        getStdColorDefinitionProperty: () => c,
      });
      var r = i(24377),
        o = i(52859),
        n = i(67455),
      ...
      function l(e, t) {
        if ((0, o.isHexColor)(e)) {
          const i = (0, r.parseRgb)(e);
          return (0, r.rgbaToString)((0, r.rgba)(i, (100 - t) / 100));
        }
        return e;
      }
      function a(e, t, i, r, o) {
        let p;
        if (null !== i) {
          const e = (0, n.combineProperty)(
            l,
            t.weakReference(),
            i.weakReference(),
          );
          p = (0, s.makeProxyDefinitionProperty)(e.ownership());
        } else
          p = (0, s.makeProxyDefinitionProperty)(t.weakReference(), [
            () => l(t.value(), 0),
            (e) => e,
          ]);
        return (
      ...
      function c(e, t, i, r, o) {
        const l = (0, s.makeProxyDefinitionProperty)(
          (0, n.combineProperty)(
            (e) => t.value(e),
            (function (e) {
              const t = (0, p.createPrimitiveProperty)(e.value()),
                i = (e) => t.setValue(e);
              return (
                (t.destroy = () => {
        ...
        return (
          (l.setValue =
            ...
            o
              ? (...t) => {
                  (e.beginUndoMacro(r), a(...t), e.endUndoMacro());
                }
              : a)),
          l
        );
    ...
    95338: (e, t, i) => {
      i.d(t, {
        ...
        createCheckablePropertyDefinition: () =>
          r.createCheckablePropertyDefinition,
        ...
        createPropertyDefinitionsCheckableListOptionsGroup: () =>
          W.createPropertyDefinitionsCheckableListOptionsGroup,
        createPropertyDefinitionsGeneralGroup: () => M,
        ...
        createSymbolPropertyDefinition: () => A,
        createTextPropertyDefinition: () => w,
        createTransparencyPropertyDefinition: () => I,
        createTwoColorsPropertyDefinition: () => V,
        createTwoOptionsPropertyDefinition: () => d,
        destroyDefinitions: () => ie,
        getColorDefinitionProperty: () => q.getColorDefinitionProperty,
      ...
      const P = [
        ...
        T = [8, 10, 11, 12, 14, 16, 18, 20, 22, 24, 28, 32, 40].map((e) => ({
          title: String(e),
          value: e,
        })),
        h = [1, 2, 3, 4],
        m = v.t(null, void 0, i(25485)),
        k = v.t(null, void 0, i(67781));
      function w(e, t) {
        const i = {
          propType: 'text',
          properties: e,
        ...
        return (
          ...
          void 0 !== i.properties.orientation &&
            (void 0 === i.orientationItems && (i.orientationItems = g),
            void 0 === i.orientationTitle && (i.orientationTitle = k)),
          void 0 !== i.properties.borderWidth &&
            void 0 === i.borderWidthItems &&
            (i.borderWidthItems = h),
          i
        );
      }
      function V(e, t) {
      ...
      function j(e, t, i, r) {
        const o = (0, G.makeProxyDefinitionProperty)(t.weakReference());
        return (
          (o.setValue = (t) => {
            const o = { lockScale: t };
      ...
      function B(e, t, i, r) {
        const o = (0, G.makeProxyDefinitionProperty)(t.weakReference(), r);
        return (
          (o.setValue = (r) => {
      ...
      function J(e, t, i, r, o, n) {
        ...
        var p, l;
        const a = (0, G.convertToDefinitionProperty)(e, t, o, s);
        n && (a.setValue = n);
        const c = new Map();
        ((a.subscribe = (e, i) => {
          const r = (e) => {
      ...
      function ie(e) {
        e.forEach((e) => {
          ...
          } else (ie(e.definitions.value()), e.visible?.destroy());
        });
      }
    },
  },
