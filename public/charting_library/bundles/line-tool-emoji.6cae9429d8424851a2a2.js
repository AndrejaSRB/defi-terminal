...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5529],
  {
    14472: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          LineDataSourceDefinitionsViewModel: () => v,
          LineDataSourceTabTypes: () => n,
          pointPriceBarTitle: () => f,
        }));
      var n,
        r = i(50151),
        o = i(11542),
      ...
      const _ = o.t(null, void 0, i(40091)),
        ...
        S = o.t(null, void 0, i(70320)),
        y = o.t(null, void 0, i(21429)),
        f = o.t(null, { context: 'linetool point' }, i(80166));
      class v {
        constructor(e, t) {
          ((this._yCoordinateStepWV = null),
            ...
            (this._propertyApplier = new d.PropertyApplierWithoutSavingChart(
              () => e,
            )),
        ...
        _createTextPropertyPage() {
          ...
          return null !== e ? (0, l.createPropertyPage)(e, 'text', S) : null;
        }
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, l.createPropertyPage)(e, 'inputs', y) : null;
        }
    ...
    97879: (e, t, i) => {
      ...
      const g = {
        ...
        S = (0, p.extractAllPropertiesKeys)(g),
        y = (0, p.extractAllPropertiesKeys)(P),
        f = [...new Set([...y, ...S, ..._.commonLineToolPropertiesStateKeys])];
      class v extends u.LineDataSourceProperty {
        ...
        static create(e, t, i) {
          return new this({
            ...
            factoryDefaultsSupplier: () => (0, c.default)(g),
            nonThemedDefaultsKeys: S,
            themedDefaultsKeys: [],
            state: (0, h.default)({}, P, { emoji: i }, t ?? {}),
            allStateKeys: f,
            theme: e,
          });
        }
      ...
      var C = i(14472),
        w = i(34271);
      class m extends w.SvgIconPaneView {
        _iconColor() {
          return null;
        }
      }
      const x = (0, r.getLogger)('Chart.LineToolEmoji');
      var I;
      !(function (e) {
        e[(e.Version = 1)] = 'Version';
      })(I || (I = {}));
      class b extends l.LineToolSvgIconBase {
        constructor(e, t, i, n) {
          (super(
            e,
        ...
        static createProperties(e, t) {
          const i = v.create(e, t, s.emojiTool.value());
          return (b._configureProperties(i), i);
        }
        async _getPropertyDefinitionsViewModelClass() {
          return C.LineDataSourceDefinitionsViewModel;
        }
        async _loadViews() {
          const e = this._properties.childs().emoji.value(),
            t = (0, n.getTwemojiUrl)(e, 'svg');
          this._iconUrl = t;
          try {
            const i = await (0, o.fetch)(t).then((e) => e.text());
            if (!this._isDestroyed) {
              ((this._svgContent = i), this._onIconChanged.fire());
              const t = (0, a.svgRenderer)(i);
              (null === t &&
                x.logWarn(`Couldn't create svg renderer for emoji ${e}`),
                this._setPaneViews([new m(this, this._model, t)]));
            }
          } catch (t) {
            x.logWarn(
              `An error ocurred while loading emoji content ${e}: ${t}`,
            );
          }
        }
      }
    ...
    54707: (e, t, i) => {
      ...
      var n = i(58978),
        ...
        c = i(43838),
        h = i(4753);
      const u = n.colorsPalette['color-tv-blue-600'];
      var d, p;
      function _(e, t) {
        const i = e.x - t.x,
          n = e.y - t.y;
        ...
        createLineAnchor(e, t) {
          ...
          return (
            a.setData({
              ...
              strokeWidth: r ? d.TouchStrokeWidth : d.RegularStrokeWidth,
              selected: this.isSelectedSource(),
              selectedStrokeWidth: r
                ? d.TouchSelectedStrokeWidth
                : d.RegularSelectedStrokeWidth,
              visible: this.areAnchorsVisible(),
    ...
    70099: (e, t, i) => {
      ...
      !(function (e) {
        ((e[(e.AdditionalPaddingFor72PxSize = 4)] =
          'AdditionalPaddingFor72PxSize'),
          (e[(e.MinSizeWithoutPadding = 20)] = 'MinSizeWithoutPadding'));
      })(n || (n = {}));
      class u extends c.LineDataSource {
        constructor(e, t, i, n) {
          (super(e, t, i, n),
            (this._onIconChanged = new l.Delegate()),
        ...
        getAdditionalPadding() {
          return 4 * Math.max(1, this.properties().childs().size.value() / 72);
        }
        ...
        startChanging(e, t) {
          const i = (0, r.ensureNotNull)(
            ...
            s = n.size.value();
          let l;
          if (t) l = (0, r.ensureNotNull)(this.pointToScreenPoint(t));
          else {
            const e = s / 2 + this.getAdditionalPadding();
            ((l = (0, o.point)(i.y + e, i.y + e)),
              (t = (0, r.ensureNotNull)(this.screenPointToPoint(l, !0))));
          }
          ...
          ((this._changePointData = {
            ...
            initialLength: c,
            initialSize: s,
            originalAngle: n.angle.value(),
            startChangeAngle: h(l, i, e ?? 0),
            alwaysChangeAngle: (0, a.lastMouseOrTouchEventInfo)().isTouch,
            startPoint: t,
          }),
        ...
        setPoint(e, t, i) {
          const {
              ...
              alwaysChangeAngle: c,
              startPoint: u,
            } = (0, r.ensureNotNull)(this._changePointData),
            d = (0, r.ensureNotNull)(this.pointToScreenPoint(t)),
            p = this.properties().childs();
          if (e >= 4 || c) {
            const t = h(d, n, e);
            p.angle.setValue(l + (t - a));
          }
          if (e < 4) {
            const e = n.subtract(d).length(),
              i = Math.max(20, s * (e / o));
            if ((p.size.setValue(i), !c)) {
              const { index: e, price: i } = this._points[0],
                { index: n, price: r } = u,
                { index: o, price: s } = t;
              r <= i != s <= i || n <= e != o <= e
                ? p.angle.setValue(l + Math.PI)
                : p.angle.setValue(l);
            }
          }
        }
        getSourceIcon() {
          if (this._iconUrl) return { type: 'url', href: this._iconUrl };
    ...
    73914: (e, t, i) => {
      i.d(t, {
        LineAnchorRenderer: () => S,
        lineSourcePaneViewPointToLineAnchorPoint: () => y,
        lineSourcePaneViewPointToLineAnchorPoint2: () => f,
      ...
      function p(e, t, i, n) {
        ((e.globalAlpha = 0.2), d(e, t, i, n), e.stroke(), (e.globalAlpha = 1));
      }
      function _(e, t, i, n) {
        (d(e, t, i - n, n), e.fill(), e.stroke());
      }
      function g(e, t, i, n) {
        const { point: r } = t;
        ((e.globalAlpha = 0.2),
      ...
      class S extends u.BitmapCoordinatesPaneRenderer {
        constructor(e) {
              ...
              if (
                (r(
                  l,
                  {
                    ...o,
                    point: new n.Point(
                      Math.round(o.point.x * c) + P,
                      Math.round(o.point.y * h) + P,
                    ),
                  },
                  g / 2,
                  p,
                ...
                if (
                  ...
                  o.pointIndex === u.hoveredPointIndex
                ) {
                  const e = Math.max(1, Math.floor(u.selectedStrokeWidth * c));
                  let t = Math.round(d * c * 2);
                  t % 2 != _ % 2 && (t += 1);
                  s(
                    l,
                    {
      ...
      function y(e, t = e.pointIndex, i, n, r, o, s, a, l, c) {
        return {
          point: e,
          pointIndex: t,
          cursorType: i,
