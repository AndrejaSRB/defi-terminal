  ...
  [7806],
  {
    37130: (e, t, i) => {
      ...
      const v = {
          ...
          color: c.colors.colorTvBlue500,
          size: 72,
        },
        P = { icon: 61720, angle: 0.5 * Math.PI },
        f = (0, d.extractAllPropertiesKeys)(v),
        y = (0, d.extractAllPropertiesKeys)(P),
        m = [...new Set([...y, ...f, ...g.commonLineToolPropertiesStateKeys])];
      class b extends u.LineDataSourceProperty {
        constructor(e) {
          (super(e),
            this.addChild(
              'backgroundsColors',
              new p.LineToolColorsProperty([this.childs().color]),
            ));
        }
        static create(e, t, i) {
          return new this({
            defaultName: 'linetoolicon',
            factoryDefaultsSupplier: () => (0, a.default)(v),
            nonThemedDefaultsKeys: f,
            themedDefaultsKeys: [],
            state: (0, l.default)({}, P, { icon: i }, t ?? {}),
            allStateKeys: m,
            theme: e,
          });
        }
      }
      const V = (0, r.getLogger)('Chart.LineToolIcon');
      var S;
      !(function (e) {
        e[(e.Version = 1)] = 'Version';
      })(S || (S = {}));
      class C extends o.LineToolSvgIconBase {
        constructor(e, t, i, n) {
          (super(
            e,
        ...
        static createProperties(e, t) {
          const i = b.create(e, t, n.iconTool.value());
        ...
        async _loadViews() {
          ...
          if (!this._isDestroyed) {
            ...
            (null === o &&
              V.logWarn(`Couldn't create svg renderer for icon ${i}`),
    ...
    70099: (e, t, i) => {
      ...
      class h extends c.LineDataSource {
        constructor(e, t, i, n) {
          (super(e, t, i, n),
        ...
        startChanging(e, t) {
          ...
          if (t) l = (0, s.ensureNotNull)(this.pointToScreenPoint(t));
            ...
            const e = r / 2 + this.getAdditionalPadding();
            ((l = (0, o.point)(i.y + e, i.y + e)),
              (t = (0, s.ensureNotNull)(this.screenPointToPoint(l, !0))));
          }
        ...
        setPoint(e, t, i) {
          const {
            ...
            d = (0, s.ensureNotNull)(this.pointToScreenPoint(t)),
            g = this.properties().childs();
          if (e >= 4 || c) {
            const t = u(d, n, e);
            g.angle.setValue(l + (t - a));
          }
          if (e < 4) {
            const e = n.subtract(d).length(),
              i = Math.max(20, r * (e / o));
            if ((g.size.setValue(i), !c)) {
              const { index: e, price: i } = this._points[0],
                { index: n, price: s } = h,
                { index: o, price: r } = t;
              s <= i != r <= i || n <= e != o <= e
                ? g.angle.setValue(l + Math.PI)
                : g.angle.setValue(l);
            }
          }
        }
