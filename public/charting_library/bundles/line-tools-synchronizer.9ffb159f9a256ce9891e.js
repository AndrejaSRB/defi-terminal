...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7129, 5565],
  {
    ...
    67387: (e, t, i) => {
      (i.r(t),
        i.d(t, { LineToolsSynchronizer: () => K, lineToolDTO: () => F }));
      var o = i(90484),
        s = i(18573),
        n = i(66711),
        r = i(54404),
      ...
      const d = function (e) {
        return (0, a.default)(e) || (0, r.default)(e) || !!(l && e && e[l]);
      };
      ...
      const u = function (e) {
        return (null == e ? 0 : e.length) ? h(e, 1) : [];
      };
      var c = i(50151),
        _ = i(9343),
        g = i(76422),
        ...
        y = i(87465),
        f = i(88723);
      const m = (0, _.getLogger)('Chart.LinkKeyResolver');
      class L {
        constructor(e, t, i) {
        ...
        resolveLinkKey(e, t, i) {
          ...
          const n = (0, f.createDeferredPromise)();
          return (
            s.set(t, n),
        ...
        async _startNextRequest() {
          ...
          const e = await (0, T.getChartStorage)(),
            ...
            { symbol: i, brokerName: o } = (function (e) {
          ...
          try {
            ...
            m.logError(`Error requesting line tools: ${e}`);
          }
          (s.forEach((e) => {
            e.resolve(null);
          }),
      ...
      class w extends b.WatchedValue {
        constructor(e, t) {
          super(
            (function (e, t) {
              return t;
      ...
      var E = i(95406),
        ...
        G = i(61710);
      const k = [0, 1, 2],
        D = (0, _.getLogger)('LineToolsSynchronizer');
      function R(e) {
        return {
          lines: e
            .sourcesByGroup()
            .lineSourcesForAllSymbols()
            .map((e) => ({ id: e.id(), zOrder: e.zorder() })),
        };
      }
      function q(e) {
        return { id: e.id, tools: e.lineTools().map((e) => e.id()) };
      }
      function F(e, t) {
        const i = t.lineToolsGroupModel().groupForLineTool(e),
          o = {
            id: e.id(),
            ownerSource: (0, c.ensureNotNull)(e.ownerSource()).id(),
            state: e.state(!1),
          };
        return (
          e.boundToSymbol() && (o.symbol = e.symbol()),
          (o.serverUpdateTime = e.serverUpdateTime() ?? void 0),
      ...
      function P(e, t, i) {
        ...
        return (
          e.forEach((e, r) => {
            const a = !i || i.has(r);
            e.timestamp > t || !a
              ? (s.set(r, e), n.delete(r))
              : (o ||= !!e.savedToChartContent);
          }),
          {
            stillInvalidated: s,
            validated: Array.from(n),
            containResavedFromContent: o,
          }
        );
      }
      var x;
      function V(e) {
        return (0, p.isLineTool)(e) || A(e);
      }
      !(function (e) {
      ...
      class K {
        constructor(e, t, i, s) {
          ((this._invalidatedLineToolsAndStudyStubs = new Map()),
            (this._migratedSharedLineToolsDuplicates = new Set()),
            ...
            (this._tryToSaveChartStateMigrationsOnce = !0),
            (this._pendingLoadRequestsCounter = 0),
            (this._pendingSaveRequestsCounter = 0),
            (this._mainSeriesDrawingsReady = ['', Promise.resolve()]),
            (this._nextResolvedSymbolDeferredPromises = []),
            (this._destroyed = !1),
            ...
            this._chartModel
              .sourceZOrderChanged()
              .subscribe(this, this._processPropertiesChanged.bind(this)),
            (this._linkKeyResolver = new L(
              e.layoutId,
              e.chartId,
              t.mainSeries().id(),
            )),
            (this._brokerIdSession = new w('broker_id_session', !1)),
            (this._autofixZOrder = new w('autofix_line_tools_zorder', !1)));
          const n = this._loadAndMergeLineToolsWithoutSymbol(2, !1),
            r = this._loadAndMergeLineToolsWithoutSymbol(1, !1);
          (this._loadAndMergeLineToolsWithoutSymbol(0, !1, [n, r]),
            this._loadAndMergeLineToolsOnStudies(0, !1));
        }
        destroy() {
          (this._brokerIdSession.destroy(),
            ...
            this._saveChartService?.chartSaved().unsubscribeAll(this),
            (this._destroyed = !0));
        }
        reloadAllLineTools() {
        ...
        hasUnsavedMigrationsFromChartState() {
          return (
        ...
        setSaveChartService(e) {
          (this._saveChartService &&
            ...
            this._saveChartService.chartSaved().subscribe(
              this,
              () => {
                ((this._tryToSaveChartStateMigrationsOnce = !1),
        ...
        markAsValidatedBecauseOfSavingToContent() {
          (B(this._invalidatedLineToolsAndStudyStubs),
            B(this._invalidatedLineToolGroups),
            this._recalculateHasChanges());
        }
        resetInvalidated(e, t, i, o) {
          ...
          if (
            ...
            for (const e of Array.from(this._migratedSharedLineToolsDuplicates))
              null === r.get(e) &&
                this._migratedSharedLineToolsDuplicates.delete(e);
          ((d.containResavedFromContent || h.containResavedFromContent) &&
            g.emit('lineToolsResavedFromContent'),
            this._recalculateHasChanges());
        }
        async applyLineToolUpdateNotification(e, t) {
          const i = (function (e) {
            const t = U.exec(e);
            return 4 === t?.length
          ...
          if (
            ...
            return void 0 === e.symbol || null !== e.sources
              ? this._applyLineToolsAndGroupsDTO(e, t, i)
              : void this._withoutInvalidating(() => {
        ...
        applyAlertIdByExternalSource(e, t) {
          this._withoutInvalidating(() => {
            ...
            i && (0, p.isLineTool)(i) && i.setAlert(t);
          });
        }
        deleteAlertByExternalSource(e) {
          this._withoutInvalidating(() => {
            const t = this._chartModel.dataSourceForId(e);
            t && (0, p.isLineTool)(t) && t.removeAlert();
          });
        }
        ...
        invalidateAll(e = !1) {
          ...
          (this._allLineToolsAndStudyStubs.forEach((e) => {
            e.forEach((e, i) => {
              this._invalidateLineToolOrStudyStub(i, t);
            });
          }),
            this._chartModel
              .lineToolsGroupModel()
              .groupsForAllSymbols()
              .forEach((e) => {
                this._invalidateLineToolGroup(e.id, t);
              }),
            e && this.markAsValidatedBecauseOfSavingToContent());
        }
        async executeSynchronizationInLayoutAction(e) {
        ...
        flushPendingSavings() {
          return this._invalidatedLineToolGroups.size ||
            ...
            this._migratedSharedLineToolsDuplicates.size
            ? this._saveInvalidatedIfRequired(!1, !0)
            : null;
        }
        hasPendingLoadRequests() {
          const e = this._chartModel.mainSeries();
          for (const t of k) {
            const i = this._currentlyLoadedSymbol.get(t) ?? '';
            if (!e.symbolSameAsCurrent(i)) return !0;
          }
          return this._pendingLoadRequestsCounter > 0;
        }
        hasPendingSaveRequests() {
          return (
            this._pendingSaveRequestsCounter > 0 ||
            (this.hasChanges().value() && this._isAutosaveEnabled())
          );
        }
        async mainSeriesDrawingsReady(e) {
          let [t, i] = this._mainSeriesDrawingsReady;
          if (t === e) return i;
          const o = (0, f.createDeferredPromise)();
          return (
            this._nextResolvedSymbolDeferredPromises.push([e, o]),
            await o.promise,
            ([t, i] = this._mainSeriesDrawingsReady),
            (0, c.assert)(t === e, 'Unexpected symbol pro_name'),
            i
          );
        }
        ...
        _processPropertiesChanged(e, t) {
          V(t) &&
            this._invalidateLineToolOrStudyStub(t.id(), performance.now());
        }
        _processLineToolsGroupModelChanged(e, t) {
          const i = performance.now();
          this._invalidateLineToolGroup(e, i);
          const o = this._chartModel.lineToolsGroupModel().groupForId(e);
          let s = o?.lineTools().length ? o.sharingMode().value() : void 0;
          (t &&
            ((t.affectedLineTools || []).forEach((e) =>
              this._invalidateLineToolOrStudyStub(e, i),
            ),
            t.affectedLineTools?.length > 0 &&
              void 0 === s &&
              (s = this._originalLineToolSharingMode.get(
                t.affectedLineTools[0],
              ))),
            this._originalLineToolGroupsSharingMode.has(e) ||
              this._setOriginalLineToolGroupsSharingMode(e, s ?? 0));
        }
        ...
        _processDataSourceCollectionChanged(e) {
          const t = e.dataSources().filter(V),
              ...
              .map((e) => {
                ...
                if (t.sources.size || t.groups.size) {
                  ...
                  return (
                    ...
                    t.groups.forEach((t, i) => {
                      t && this._setOriginalLineToolGroupsSharingMode(i, e);
                    }),
                    (this._pendingSaveRequestsCounter += 1),
                    (0, c.ensureNotNull)(this._saveChartService)
                      .saveChartLineTools(this._origin.chartId, t, e, s.signal)
                      .then(({ serverUpdateTime: i }) => {
                        this._destroyed || this.resetInvalidated(r, t, e, i);
                      })
                      .catch(async (t) => {
                        if (!this._destroyed) {
                          t instanceof v.SavingLineToolsError &&
                            t.shouldBeCooled &&
        ...
        _onSymbolResolved(e) {
          const t = (t, i) => {
              ...
              return this._makeLoadRequestAndMerge(
                o,
                this._seriesLineToolsUnloader.bind(
                  this,
                  o,
              ...
              if (
                ...
                (this._withoutInvalidating(() => {
                  this._chartModel
                    ...
                    .filter(
                      (e) =>
                        0 === e.sharingMode().value() && e.linkKey().value(),
                    )
                    .forEach((e) => {
                ...
                this._autofixZOrder.value() &&
                  this._chartModel.lineToolsGroupModel().groupsForAllSymbols()
                    .length)
              ) {
                const t = {
                    panes: (e = this._chartModel).panes().map(R),
                    groups: e
                      .lineToolsGroupModel()
                      .groupsForAllSymbols()
                      .map(q),
                  },
                  i = (0, G.prepareZOrderFixIfRequired)(t);
                this._chartModel.bulkActionMacro(() => {
                  i.forEach((e, t) => {
                    const i = this._chartModel.dataSourceForId(t);
                    i?.setZorder(e);
                  });
                });
              }
            });
          this._mainSeriesDrawingsReady = [e.pro_name, n];
          for (const [t, i] of this._nextResolvedSymbolDeferredPromises)
            t === e.pro_name
              ? i.resolve()
              : i.reject(new Error('Symbol mismatch'));
          this._nextResolvedSymbolDeferredPromises = [];
        }
        async _makeLoadRequestAndMerge(e, t, i, o) {
          const s = this._chartModel.mainSeries(),
            n = this._currentlyLoadedSymbol.get(e.sharingMode) ?? '';
          if (!!s.symbolSameAsCurrent(n)) return;
          this._currentlyLoadedSymbol.delete(e.sharingMode);
          const r = await (0, T.getChartStorage)();
          return this._destroyed
            ? void 0
            : this._savePromise('mainSeriesLineTools' === e.requestType)
                .catch(() => {})
                .then(() =>
                  this._destroyed
                    ? null
                    : ((this._pendingLoadRequestsCounter += 1),
                      r.loadLineToolsAndGroups(
                        this._origin.layoutId,
                ...
                .then(async (i) => {
                  if (!this._destroyed) {
                    if (o)
                      try {
                        if ((await Promise.all(o), this._destroyed)) return;
                      } catch (e) {}
                    if (((this._pendingLoadRequestsCounter -= 1), null !== i)) {
                      const o = i.sources;
                      (o &&
                        (t((e) => o.has(e)),
                        await this._applyLineToolsAndGroupsDTO(
                          i,
                          e.sharingMode,
                        )),
                        i.serverRequestId &&
        ...
        _migrateStateFromMetainfo(e) {
          ...
          const i =
            void 0 !== e.currencyId &&
            e.currencyId !== e.state.state.currencyId;
        ...
        _restoreLineTool(e, t, i, o) {
          if ((t.state.points ?? []).some((e) => !(0, y.isNumber)(e.time_t)))
            return null;
          ...
          (0 !== i &&
            ...
            0 === i && t.state.linkKey && (t.state.sharingMode ??= 1));
          ...
          if (
            ...
            0 !== i && r.share(i),
            void 0 === o && (0, p.isEditableTextLineTool)(r))
          ) {
        ...
        _restoreLineToolAlert(e, t) {
          t
            ? e.restoreAlert(+t).catch((e) => {
                D.logError(`Failed to restore lineTool alert: ${(Error, e)}`);
              })
            : e.detachAlert();
        }
        _removeLineTool(e) {
          const t = this._chartModel.dataSourceForId(e);
          null !== t && this._chartModel.removeSource(t);
        }
        ...
        _restoreLineDTO(e, t, i, o, s, n) {
          if (!this._invalidatedLineToolsAndStudyStubs.get(t))
            if (null === e) {
              ...
              if (!e) return;
              if (!(0, p.isLineTool)(e)) return;
              e.sharingMode().value() === s &&
                this._origin.clientId !== n?.clientId &&
                (this._removeLineTool(t),
                this._setOriginalLineToolSharingMode(t, null));
            } else {
              if (0 === s && null != e.state.linkKey) {
                if (this._chartModel.dataSourceForId(t))
                  return void this._migratedSharedLineToolsDuplicates.add(e.id);
                this._invalidateLineToolOrStudyStub(
                  e.id,
                  performance.now(),
                  !0,
        ...
        async _applyLineToolsAndGroupsDTO(e, t, i) {
          ...
          if (
            ...
            await Promise.all(Array.from(r).map((e) => (0, p.initLineTool)(e))),
            !this._destroyed)
          )
            return (0, S.perfMeasureOperation)(n, () =>
              this._withoutInvalidating(() => {
                this._chartModel.bulkActionMacro(() => {
                  ((e.sources || new Map()).forEach((e, n) => {
                    try {
                      if (e && (0, O.isMtpPredictorToolName)(e.state.type))
                        return void D.logWarn(
        ...
        _invalidateLineToolOrStudyStub(e, t, i) {
          ...
          const { invalidatedViaSyncOnly: o, savedToChartContent: s } =
              this._invalidatedLineToolsAndStudyStubs.get(e) || {},
            n = (void 0 === o || o) && this.invalidateViaSync();
          (this._invalidatedLineToolsAndStudyStubs.set(e, {
            timestamp: t,
            invalidatedViaSyncOnly: n,
            savedToChartContent: s,
          }),
        ...
        _invalidateLineToolGroup(e, t, i) {
          if (this._ignoreInvalidatingEventsDepth > 0 && !i) return;
          const { savedToChartContent: o } =
            this._invalidatedLineToolGroups.get(e) || {};
          (this._invalidatedLineToolGroups.set(e, {
            timestamp: t,
            invalidatedViaSyncOnly: this.invalidateViaSync(),
            savedToChartContent: o,
          }),
            this._hasChanges.setValue(!0),
            this._debouncedSave());
        }
        _prepareDTOItem(e, t, i = !1) {
          ...
          if (
                ...
                if (null === l) {
                  ...
                  if (r) {
                    const e = this._chartModel
                      ...
                      .groupForLineTool(l);
                    if (d)
                      (o.set(a, F(l, this._chartModel)),
                        null !== e && s.set(e.id, N(e, this._chartModel)));
                    else {
            ...
            for (const e of this._migratedSharedLineToolsDuplicates)
              o.has(e) || o.set(e, null);
          return (
        ...
        _loadAndMergeLineToolsWithoutSymbol(e, t, i) {
          const o = {
            ...
            n = (0, c.ensureNotNull)(this._chartModel.paneForSource(s)),
            r = this._allLineToolsAndStudyStubs.get(n.id());
          return this._makeLoadRequestAndMerge(
            o,
            (i) => {
              const o = t && r ? Array.from(r.keys()).filter((e) => !i(e)) : [];
              this._unloadLineTools(
                o,
                (e) => !e.boundToSymbol() && e.ownerSource() === s,
                e,
              );
            },
            void 0,
        ...
        _recalculateHasChanges() {
          this._hasChanges.setValue(
            this._tryToSaveChartStateMigrationsOnce
              ? this._invalidatedLineToolsAndStudyStubs.size > 0 ||
                  this._invalidatedLineToolGroups.size > 0 ||
                  this._migratedSharedLineToolsDuplicates.size > 0
              : z(this._invalidatedLineToolsAndStudyStubs) ||
                  z(this._invalidatedLineToolGroups) ||
                  this._migratedSharedLineToolsDuplicates.size > 0,
          );
        }
        _generateOrigin() {
      ...
      function B(e) {
        for (const [, t] of e) t.savedToChartContent = !0;
      }
      function z(e) {
        for (const [, t] of e) if (!t.savedToChartContent) return !0;
        return !1;
      }
      function $(e) {
        for (const [, t] of e) if (t.savedToChartContent) return !0;
