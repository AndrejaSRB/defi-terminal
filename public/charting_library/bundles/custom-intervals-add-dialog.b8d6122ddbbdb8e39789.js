  ...
  [4013],
  {
    ...
    7953: (e, t, n) => {
      ...
      function c(e) {
        const {
          ...
          C = (0, o.useRef)(null),
          S = (0, o.useCallback)((e) => C.current?.focus(e), [C]),
          y = (0, o.useRef)(null),
          E = (0, o.useCallback)(
    ...
    36762: (e, t, n) => {
      ...
      function a(e, t, n, o, a, c, u = {}, d, p) {
        const b = (0, l.useCallback)(
          ...
          {
            next: g = v.next,
            previous: x = v.previous,
            first: C = v.first,
            last: S = v.last,
          } = u;
        return (0, r.useComposedKeyboardActionHandlers)(
          (0, r.useKeyboardActionHandler)(g, b, p?.next ?? (() => !0), e),
          (0, r.useKeyboardActionHandler)(x, f, p?.previous ?? (() => !0), e),
          (0, r.useKeyboardActionHandler)(C, m, () => !0, e),
          (0, r.useKeyboardActionHandler)(S, h, () => !0, e),
        );
      }
    },
    16921: (e, t, n) => {
          ...
          (function (e) {
            ...
            return (
              (m = window.requestAnimationFrame(function e(t) {
                ...
                const i = b + d * o(r / n);
                ((s[p] = Math.floor(i)), (m = window.requestAnimationFrame(e)));
              })),
              function () {
    ...
    59054: (e, t, n) => {
      ...
      function h(e) {
        ...
        return o.createElement(d.Icon, {
          className: r()(m().icon, t && m().dropped),
          icon: b(),
        });
      }
      function v(e) {
        ...
        return o.createElement(
          'span',
          { className: r()(m().button, n && m().disabled, t) },
      ...
      const x = o.forwardRef((e, t) => {
        const {
          ...
          z =
            ...
            o.createElement(
              c.EndSlot,
              null,
              o.createElement(v, { isDropped: x, disabled: !0, className: A }),
            );
        return o.createElement(u.PopupMenuDisclosureView, {
          ...
          onListboxKeyDown: R,
          listboxAria: T,
          dataQaId: (0, a.dataQaIds)('popup-menu-container', M),
          matchButtonAndListboxWidths: f,
          popupPosition: m,
          button: o.createElement(s.ControlSkeleton, {
            ...P,
            'data-qa-id': (0, a.dataQaIds)('ui-kit-disclosure-control', M),
            'data-role': 'listbox',
            disabled: h,
            className: r()(g.button, l),
            size: w,
            ref: (0, i.useMergedRefs)([B, t]),
            middleSlot: o.createElement(
              c.MiddleSlot,
              null,
              o.createElement(
                'span',
                { className: r()(g['button-children'], b && g.hiddenArrow, _) },
                F,
              ),
            ),
            endSlot: z,
        ...
        return (0, o.useCallback)(
          () =>
            (function (e, t, { x: n = s.x, y: o = s.y } = s) {
              const l = (0, i.ensureNotNull)(e).getBoundingClientRect(),
                r = {
                  x: l.left + n,
                  y: l.top + l.height + o,
                  indentFromWindow: { top: 4, bottom: 4, left: 4, right: 4 },
                };
              return (t && (r.overrideWidth = l.width), r);
            })(e.current, t, n),
          [e, t],
        );
      }
      ...
      function d(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            {
              ...S,
              dataQaId: (0, l.dataQaIds)('ui-kit-disclosure-popup', k),
              id: s,
              className: c,
              tabIndex: d,
              isOpened: b,
    ...
    90405: (e, t, n) => {
      ...
      function x(e) {
        ...
        if (!t) return o.createElement('span', { className: h.placeholder }, n);
      ...
      const C = o.forwardRef((e, t) => {
        ...
        const ue = (0, r.joinDomIds)(R, n),
          ...
          fe = (0, o.useCallback)(() => (G(), _ && _(re)), [G, _, re]),
          me = (0, d.useItemsKeyboardNavigation)(
            'vertical',
            m.isRtl,
            oe,
            be,
          ...
          he = (0, p.useKeyboardToggle)(J, W || P),
          ve = (0, p.useKeyboardToggle)(fe),
          ge = (0, p.useKeyboardClose)(W, we),
          xe = (0, p.useKeyboardOpen)(W, $),
          Ce = (0, p.useKeyboardEventHandler)([he, ge, xe]),
          Se = (0, p.useKeyboardEventHandler)([me, ve, ge]),
          ye = (function (e) {
            const t = (0, o.useRef)(''),
              n = (0, o.useMemo)(
                () =>
            ...
            void 0 !== o && _ && (n.stopPropagation(), W || $(), _(o.value));
          });
        return o.createElement(
          b.ControlDisclosureView,
          {
            ...
            buttonChildren: o.createElement(x, {
    ...
    45618: (e, t, n) => {
      ...
      const h = {
        ...
        already_exists: r.t(null, void 0, n(23033)),
      };
      function v(e) {
        const {
            onAdd: t,
          ...
          [C, S] = (0, o.useState)(d.INTERVALS[0].name),
          [y, E] = (0, o.useState)(''),
        ...
        return o.createElement(i.AdaptiveConfirmDialog, {
          ...
          className: x ? void 0 : b.intervalsDesktopDialog,
          isOpened: !0,
          onSubmit: function () {
            if (!D(C, y)) return;
            (t(y, C), m());
