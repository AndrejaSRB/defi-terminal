...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7488, 8673],
  {
    43470: (e, t, i) => {
      (i.r(t),
        i.d(t, { LineToolInfoLine: () => r, LineToolInfoLineConst: () => n }));
      var n,
        s = i(42150);
      !(function (e) {
        ((e.ConstructorName = 'LineToolInfoLine'), (e.Name = 'Info Line'));
      })(n || (n = {}));
      class r extends s.LineToolTrendLine {
        constructor(e, t, i, n) {
          super(
            e,
        ...
        static createProperties(e, t) {
          const i = s.LineToolTrendLine._createPropertiesImpl(
            'linetoolinfoline',
            e,
            t,
          );
          return (r._configureProperties(i), i);
        }
      }
    },
    63117: (e, t, i) => {
      ...
      class P extends c.UndoCommand {
        constructor(e, t, n, s) {
          (super(
            ...
            !0,
            !w.lineToolsDoNotAffectChartInvalidation,
          ),
            (this._sourceId = t.id()),
            (this._model = e),
            (this._oldValue = n),
      ...
      class m extends _.LineDataSource {
        ...
        editableTextStyle() {
          return { ...(this._isDarkBackground.value() ? x : g) };
        }
        ...
        async _openTextEditor(e, t, n, o, a) {
          ...
          const {
            ...
            { forbidLineBreaks: _, maxLength: w } = this.editableTextStyle();
    ...
    42150: (e, t, i) => {
      (i.r(t), i.d(t, { Consts: () => n, LineToolTrendLine: () => h }));
      var n,
        s = i(50151),
        r = i(43229),
        o = i(78176),
      ...
      class h extends d.InplaceTextLineDataSource {
        constructor(e, t, n, s) {
          (super(
            e,
            ...
            (this._delayedStudyViewsInitialization = !1),
            (this._viewsModule = new r.AsyncResourceWrapper(
              Promise.all([i.e(6290), i.e(986), i.e(6668), i.e(1583)]).then(
                i.bind(i, 81233),
              ),
            )),
            this._viewsModule.callFunction(() => {
              this._model.updateSource(this);
            }));
        }
        destroy() {
          (this._viewsModule.destroy(), super.destroy());
        }
        pointsCount() {
          return 2;
        }
        ...
        createPriceAxisView(e) {
          return new u.LineToolPriceAxisView(this, {
            pointIndex: e,
        ...
        isMultiPaneAvailable() {
          return this.supportsTargetSignature();
        }
        isMultiPaneEnabled() {
          return null !== this.targetSignature().value();
        }
        snapTo45DegreesAvailable() {
          return !0;
        }
        static createProperties(e, t, i) {
          return h._createPropertiesImpl('linetooltrendline', e, t, i);
        }
        _getPaneViews(e) {
          if (
            null === this.targetSignature().value() &&
            !this._paneViews.has(e) &&
            (!e || e.hasDataSource(this))
          ) {
            const t = this._viewsModule.get();
            t &&
              this._paneViews.set(e, [
                new t.TrendLinePaneView(
                  this,
                  this._model,
                  e ?? null,
        ...
        _createSignatureSourcePaneViews(e) {
          ...
          if (null === t)
            return (
              this._delayedStudyViewsInitialization ||
                ((this._delayedStudyViewsInitialization = !0),
                this._viewsModule.callFunction(() => {
                  (this._signaturesPaneViews.clear(),
                    this._updateSignaturesPaneViews());
                })),
              []
            );
          return [
