  ...
  [2745],
  {
    97578: (e, t, n) => {
      ...
      const y = -5e4,
        ...
        w = new l.TranslatedString(
          ...
          r.t(null, void 0, n(11737)),
        ),
        f = new l.TranslatedString(
          'change bar X coordinate',
          r.t(null, void 0, n(2066)),
        ),
        v = new l.TranslatedString(
          'move drawings',
          r.t(null, void 0, n(76261)),
        );
      function P(e, t, n) {
        return {
          property: (0, c.convertToDefinitionProperty)(e, t.price, w),
          info: { typeY: 1, stepY: n },
        };
      }
      function g(e, t) {
        return {
          property: (0, c.convertToDefinitionProperty)(
            e,
            t.bar,
            null,
            void 0,
            (n) => {
              n !== t.bar.value() &&
                e.setProperty(t.bar, (0, o.clamp)(n, y, m), f);
            },
          ),
          info: { typeX: 0, stepX: new p.WatchedValue(1) },
        };
      }
        ...
        return (
          (r.setValue = (r) => {
            try {
              ...
              const [, l, s] = o;
              if (!s.length) return;
              const a = n(parseFloat(s));
              if ('/' === l && (0 === a.price || 0 === a.index)) return;
              t.withMacro(v, () => {
                e.filter((e) => !e.isSourceHidden()).forEach((e) => {
                  ...
                  switch (l) {
                    case '': {
                      ...
                      let { index: t = e.index, price: r = e.price } = a;
                      ((r -= e.price),
                        (t -= e.index),
                        (o = n.map((e) => ({
                          ...e,
    ...
    73863: (e, t, n) => {
      ...
      const p = new o.TranslatedString(
          ...
          i.t(null, void 0, n(98596)),
        ),
        u = new o.TranslatedString(
          'change {title} visibility on seconds',
          i.t(null, void 0, n(41315)),
        ),
        h = new o.TranslatedString(
          'change {title} seconds from',
          i.t(null, void 0, n(86780)),
        ),
        y = new o.TranslatedString(
          'change {title} seconds to',
          i.t(null, void 0, n(6573)),
        ),
        m = new o.TranslatedString(
          'change {title} visibility on minutes',
          i.t(null, void 0, n(78219)),
        ),
        w = new o.TranslatedString(
          'change {title} minutes from',
          i.t(null, void 0, n(59820)),
        ),
        f = new o.TranslatedString(
          'change {title} minutes to',
          i.t(null, void 0, n(38011)),
        ),
        v = new o.TranslatedString(
          'change {title} visibility on hours',
          i.t(null, void 0, n(68715)),
        ),
        P = new o.TranslatedString(
          'change {title} hours from',
          i.t(null, void 0, n(8306)),
        ),
        g = new o.TranslatedString(
          'change {title} hours to',
          i.t(null, void 0, n(67233)),
        ),
        T = new o.TranslatedString(
          'change {title} visibility on days',
          i.t(null, void 0, n(56402)),
        ),
        b = new o.TranslatedString(
          'change {title} days from',
          i.t(null, void 0, n(91201)),
        ),
        S = new o.TranslatedString(
          'change {title} days to',
          i.t(null, void 0, n(96135)),
        ),
        C = new o.TranslatedString(
          'change {title} visibility on weeks',
          i.t(null, void 0, n(71084)),
        ),
        k = new o.TranslatedString(
          'change {title} weeks from',
          i.t(null, void 0, n(32481)),
        ),
        V = new o.TranslatedString(
          'change {title} weeks to',
          i.t(null, void 0, n(18678)),
        ),
        W = new o.TranslatedString(
          'change {title} visibility on months',
          i.t(null, void 0, n(67583)),
        ),
        D = new o.TranslatedString(
          'change {title} months from',
          i.t(null, void 0, n(99122)),
        ),
        _ = new o.TranslatedString(
          'change {title} months to',
          i.t(null, void 0, n(10518)),
        ),
        x =
          (new o.TranslatedString(
            'change {title} visibility on ranges',
            i.t(null, { replace: { ranges: 'ranges' } }, n(55616)),
          ),
          i.t(null, void 0, n(24821))),
        U = i.t(null, void 0, n(65188)),
        I = i.t(null, void 0, n(42562)),
        M = i.t(null, void 0, n(56796)),
        L = i.t(null, void 0, n(72942)),
        F = i.t(null, void 0, n(835)),
        A = i.t(null, void 0, n(43154)),
        R = new o.TranslatedString('ticks', i.t(null, void 0, n(3539))),
        N = new o.TranslatedString('seconds', i.t(null, void 0, n(751))),
        E = new o.TranslatedString('seconds from', i.t(null, void 0, n(35801))),
        X = new o.TranslatedString('seconds to', i.t(null, void 0, n(73419))),
        Y = new o.TranslatedString('minutes', i.t(null, void 0, n(18726))),
        H = new o.TranslatedString('minutes from', i.t(null, void 0, n(22476))),
        j = new o.TranslatedString('minutes to', i.t(null, void 0, n(67649))),
        $ = new o.TranslatedString('hours', i.t(null, void 0, n(2359))),
        O = new o.TranslatedString('hours from', i.t(null, void 0, n(82267))),
        z = new o.TranslatedString('hours to', i.t(null, void 0, n(15600))),
        q = new o.TranslatedString('days', i.t(null, void 0, n(35813))),
        B = new o.TranslatedString('days from', i.t(null, void 0, n(59215))),
        G = new o.TranslatedString('days to', i.t(null, void 0, n(89919))),
        J = new o.TranslatedString('weeks', i.t(null, void 0, n(45537))),
        K = new o.TranslatedString('weeks from', i.t(null, void 0, n(92859))),
        Q = new o.TranslatedString('weeks to', i.t(null, void 0, n(44127))),
        Z = new o.TranslatedString('months', i.t(null, void 0, n(95300))),
        ee = new o.TranslatedString('months from', i.t(null, void 0, n(17250))),
        te = new o.TranslatedString('months to', i.t(null, void 0, n(2828))),
        ne = (new o.TranslatedString('ranges', 'ranges'), [1, 59]),
        ie = [1, 59],
        oe = [1, 24],
        re = [1, 366],
        le = [1, 52],
      ...
      function ae(e, t, n) {
        ...
        if ((0, a.isTicksEnabled)()) {
          const o = (0, r.createCheckablePropertyDefinition)(
            {
        ...
        if ((0, s.isSecondsEnabled)()) {
          const o = (0, r.createRangePropertyDefinition)(
            {
              checked: (0, r.convertToDefinitionProperty)(
                e,
                t.seconds,
              ...
              from: (0, r.convertToDefinitionProperty)(
                e,
                t.secondsFrom,
                h.format({ title: n }),
              ),
              to: (0, r.convertToDefinitionProperty)(
                e,
                t.secondsTo,
                y.format({ title: n }),
              ),
        ...
        const o = (0, r.createRangePropertyDefinition)(
          ...
          d = (0, r.createRangePropertyDefinition)(
            {
              checked: (0, r.convertToDefinitionProperty)(
                e,
                t.hours,
          ...
          c = (0, r.createRangePropertyDefinition)(
            {
              checked: (0, r.convertToDefinitionProperty)(
                e,
                t.days,
        ...
        i.push(o, d, c);
        const R = (0, r.createRangePropertyDefinition)(
            {
              checked: (0, r.convertToDefinitionProperty)(
                e,
                t.weeks,
          ...
          N = (0, r.createRangePropertyDefinition)(
            {
              checked: (0, r.convertToDefinitionProperty)(
                e,
                t.months,
        ...
        return (i.push(R, N), { definitions: i });
      }
      function de(e, t) {
        const n = [];
        if ((0, a.isTicksEnabled)()) {
          const i = (0, r.createCheckablePropertyDefinition)(
            {
        ...
        if ((0, s.isSecondsEnabled)()) {
          const i = (0, r.createRangePropertyDefinition)(
            {
              checked: new c.CollectiblePropertyUndoWrapper(
        ...
        const i = (0, r.createRangePropertyDefinition)(
          ...
          o = (0, r.createRangePropertyDefinition)(
            {
              checked: new c.CollectiblePropertyUndoWrapper(
          ...
          p = (0, r.createRangePropertyDefinition)(
            {
              checked: new c.CollectiblePropertyUndoWrapper(
        ...
        n.push(i, o, p);
        const u = (0, r.createRangePropertyDefinition)(
            {
              checked: new c.CollectiblePropertyUndoWrapper(
          ...
          h = (0, r.createRangePropertyDefinition)(
            {
              checked: new c.CollectiblePropertyUndoWrapper(
        ...
        return (n.push(u, h), { definitions: n });
      }
    },
    66567: (e, t, n) => {
      n.d(t, { CollectiblePropertyUndoWrapper: () => a });
      var i = n(50151),
        o = n(11542),
        r = n(95804),
        l = n(43337);
      const s = new r.TranslatedString(
        ...
        o.t(null, void 0, n(25167)),
      );
      class a extends l.Property {
        constructor(e, t, n) {
          (super(),
            (this._isProcess = !1),
        ...
        unsubscribe(e, t) {
          const n = (0, i.ensureDefined)(
            this._listenersMappers.find((n) => n.obj === e && n.method === t)
              ?.callback,
          );
    ...
    81634: (e, t, n) => {
      n.d(t, { PropertyApplierWithoutSavingChart: () => o });
      var i = n(13896);
      class o {
        constructor(e) {
        ...
        setWatchedValue(e, t, n) {
          this._undoModelSupplier()
            .undoHistory()
            .setWatchedValue(e, t, n, i.lineToolsDoNotAffectChartInvalidation);
        }
      }
    },
  },
