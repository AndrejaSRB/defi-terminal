  ...
  [9418],
  {
    ...
    53177: (e, t, i) => {
      ...
      const _ = s.forwardRef((e, t) =>
        s.createElement(n.NavButton, { ...e, ref: t, icon: m(e.size) }),
      );
    },
    64388: (e, t, i) => {
      'use strict';
      ...
      function c(e) {
        ...
        return s.createElement(
          s.Fragment,
          null,
          s.createElement('span', { className: l().background }),
          ...
          t &&
            s.createElement('span', { className: l()['visually-hidden'] }, t),
        );
      }
      const h = (0, s.forwardRef)((e, t) => {
        ...
        return s.createElement(
          'button',
          { ...h, className: d({ ...e, children: l }), ref: t, type: n },
          s.createElement(c, { icon: i }, l),
        );
      });
      ...
      var u = i(21593),
        p = i(53017);
      (0, s.forwardRef)((e, t) => {
        const { icon: i, renderComponent: n, 'aria-label': o, ...a } = e,
          r = n ?? u.CustomComponentDefaultLink;
        return s.createElement(
          r,
          {
            ...a,
            className: d({ ...e, children: o, isLink: !0 }),
            reference: (0, p.isomorphicRef)(t),
          },
          s.createElement(c, { icon: i }, o),
        );
    ...
    79418: (e, t, i) => {
      ...
      function x(e) {
        const {
            ...
            className: m,
            unsetAlign: _,
            closeAriaLabel: x = f.t(null, void 0, i(47742)),
            closeButtonReference: b,
          } = e,
          [E, C] = (0, s.useState)(!1);
        return s.createElement(
          y.Provider,
          { value: { setHideClose: C } },
          s.createElement(
            'div',
            { className: a()(w.container, m, (l || _) && w.unsetAlign) },
            u,
            s.createElement(
              'div',
              { id: t, className: w.title, 'data-dragg-area': g },
              s.createElement(
                'div',
                { className: a()(o ? w.textWrap : w.ellipsis, r) },
                n,
              ),
              l &&
                s.createElement(
      ...
      class F extends s.PureComponent {
        constructor() {
          (super(...arguments),
            ...
            (this._embedResizerOverridesEnabled = D.enabled(
        ...
        render() {
          const {
            ...
            Q = this.props.fixedBody ?? (!!w || void 0),
            j = 'after' !== v ? y : void 0,
            J = 'after' === v ? y : void 0,
            ee = 'string' == typeof o ? o : W || '',
            te = (0, E.filterDataProps)(this.props),
            ie = (0, b.mergeRefs)([this._handleReference, $]);
          return s.createElement(
            p.MatchMedia,
              ...
              s.createElement(
                ...
                (u) =>
                  s.createElement(
                    ...
                    {
                      rounded: !(u || B) && z,
                      className: a()(S.dialog, B && V && S.bounded, e),
                      isOpened: n,
                      reference: ie,
                      ...
                      calculateDialogPosition:
                        B && V ? this._calculatePositionWithOffsets : void 0,
                      shadowed: G,
                      fixedBody: Q,
                      onClick: Z,
                      ...te,
    ...
    9722: (e, t, i) => {
      ...
      class u extends s.PureComponent {
        ...
        render() {
          const {
            ...
            p = (0, d.filterDataProps)(this.props),
            g = this.props.style
      ...
      function y(e) {
        return {
          x: (0, _.clamp)(e.x, 20, document.documentElement.clientWidth - 20),
          y: (0, _.clamp)(e.y, 20, window.innerHeight - 20),
        };
      }
      function w(e) {
      ...
      class b {
        ...
        _moveDialog(e, t) {
          const i = this._dialog.getBoundingClientRect(),
            ...
            n = v(e, i.width, s ? 0 : -1 / 0, s ? window.innerWidth : 1 / 0),
            o = v(t, i.height, s ? 0 : -1 / 0, s ? window.innerHeight : 1 / 0);
      ...
      const M = (0, A.getLogger)('DialogEventDispatcher');
      class T {
        constructor() {
        ...
        recalculateBounds() {
          ...
          if (this._isFullscreen) {
            ...
            const s = this._dialog.getBoundingClientRect(),
              n = t - 2 * i,
              o = v(s.left, s.width, 0, e),
              a = v(s.top, s.height, i, t);
            ((this._dialog.style.top = '0px'),
              (this._dialog.style.left = '0px'),
      ...
      class O extends s.PureComponent {
        ...
        componentDidMount() {
          const { draggable: e, boundByScreen: t, onDragStart: i } = this.props,
            s = (0, a.ensureNotNull)(this._dialog);
          if ((this._eventDispatcher.dispatch('dialog-open'), e)) {
            ...
            if (e && e instanceof HTMLElement) {
              ...
              (this._cleanUpFunctions.push(() => n.destroy()),
                (this._drag = n));
            }
          }
          (this.props.autofocus &&
            ...
            (this._isFullScreen() || this.props.fixedBody) &&
              (0, k.setFixedBodyState)(!0));
          const { guard: n, calculateDialogPosition: o } = this.props;
          if (this.props.resizeHandler) this._resize = this.props.resizeHandler;
          else {
            const e = new z(s, { guard: n, calculateDialogPosition: o });
          ...
          if (!s.contains(document.activeElement)) {
            const e = (function (e) {
              ...
              const i = (0, f.getActiveElementSelectors)(),
                s = Array.from(e.querySelectorAll(i)).filter(
                  (0, f.createScopedVisibleElementFilter)(e),
                );
      ...
      const L = (0, g.makeOverlapable)(O, !0);
    },
    1109: (e, t, i) => {
      'use strict';
      i.d(t, { Separator: () => a });
      ...
      function o(e, t) {
        return class extends s.PureComponent {
          render() {
            ...
            return 'parent' === o
              ? a
              : s.createElement(n.Portal, { shouldTrapFocus: t }, a);
          }
        };
      }
    },
