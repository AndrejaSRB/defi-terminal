(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3005],
  {
    ...
    33647: (e, t, r) => {
      ...
      (r.d(t, { becomeMainElement: () => s, becomeSecondaryElement: () => i }),
        (function (e) {
    ...
    23908: (e, t, r) => {
      ...
      var n = r(11542);
      const s = [
        { name: '', label: n.t(null, { context: 'interval' }, r(79930)) },
        {
          name: 'H',
          label: n.t(
            null,
        ...
        { name: 'D', label: n.t(null, { context: 'interval' }, r(23970)) },
        { name: 'W', label: n.t(null, { context: 'interval' }, r(7938)) },
        { name: 'M', label: n.t(null, { context: 'interval' }, r(18193)) },
      ];
    },
    26981: (e, t, r) => {
      'use strict';
          ...
          n.createElement('div', {
            ...
            onKeyDown: (0, i.createSafeMulticastEventHandler)(function (e) {
              ...
              const r = e.currentTarget,
                n = (0, o.queryFocusableElements)(r).sort(
                  o.navigationOrderComparator,
                );
              ...
              const i = () => {
                  ...
                  ((0, l.becomeSecondaryElement)(n[s]),
    ...
    38254: (e, t, r) => {
      'use strict';
      (r.r(t), r.d(t, { HeaderToolbarRenderer: () => Fe }));
      var n = r(50959),
        s = r(32227),
        i = r(50151),
        a = r(97754),
        ...
        return n.createElement(
          ...
          !c &&
            n.createElement(
              ...
              n.createElement(b, { className: y.separator }),
            ),
          n.createElement(
            'div',
            {
              className: a(r, y.group, {
                [y.noMinimalWidth]: o,
      ...
      var E = r(45601),
        ...
        M = r(92568),
        R = r(45820);
      const k = { text: _.t(null, void 0, r(48161)) };
      function I(e) {
        return n.createElement(
          'div',
          { className: M.wrap },
          n.createElement(w.Icon, { className: M.icon, icon: R }),
          k.text,
        );
      }
      var V = r(22961),
      ...
      function A(e) {
        return n.createElement(x, { ...e, className: L.scrollLeft });
      }
      function D(e) {
        return n.createElement(x, { ...e, className: L.scrollRight });
      }
      function x(e) {
        return n.createElement(
          'div',
          ...
          n.createElement(
            ...
            n.createElement(w.Icon, { icon: W, className: L.icon }),
          ),
        );
      }
      const P = (function (e = A, t = D, r = N, s = B) {
        var o;
        return (
          ((o = class extends n.PureComponent {
            ...
            animateTo(e, t = F.dur) {
              ...
              r &&
                ((0, O.isRtl)() && (e = (0, O.getLTRScrollLeftOffset)(r, e)),
                t <= 0
                ...
                (d) =>
                  n.createElement(
                    ...
                    n.createElement(
                      ...
                      l && n.createElement(r, { isVisible: S, className: f }),
                      l && n.createElement(s, { isVisible: g, className: f }),
                      c &&
                        n.createElement(e, {
      ...
      !(function (e) {
        ((e.SymbolSearch = 'header-toolbar-symbol-search'),
          ...
          (e.TelegramShare = 'header-toolbar-telegram-share'),
        ...
        constructor(e, t) {
          (super(e, t),
                    ...
                    switch (e.type) {
                      ...
                      case 'TradingViewStyledButton':
                        return n.createElement(
                          ...
                          { ...e.params, className: U.button, displayMode: r },
                        );
                      case 'Dropdown':
                        return n.createElement(s.Dropdown, {
                          displayMode: r,
                          params: e.params,
                        });
                      default:
            ...
            (this._fixLastGroup = (e, t, r) => {
              if (t === r.length - 1 && n.isValidElement(e) && e.type === C) {
                const t =
      ...
      var ee = r(87296),
        te = r(53470);
      class re extends $.AbstractJsonStoreService {
        constructor(e, t, r) {
      ...
      class ue {
        constructor(e) {
          ((this._customIntervalsService = le),
            ...
            ne.linking.supportedResolutions.subscribe(
              this._fireSupportedIntervalsMayChange,
            ),
            ne.linking.range.subscribe(this._fireSupportedIntervalsMayChange),
            ne.linking.seconds.subscribe(this._fireSupportedIntervalsMayChange),
            ne.linking.ticks.subscribe(this._fireSupportedIntervalsMayChange),
            ne.linking.intraday.subscribe(
              this._fireSupportedIntervalsMayChange,
            ),
            ne.linking.dataFrequencyResolution.subscribe(
              this._fireSupportedIntervalsMayChange,
            ));
        }
        destroy() {
          (ne.linking.supportedResolutions.unsubscribe(
            this._fireSupportedIntervalsMayChange,
          ),
            ne.linking.range.unsubscribe(this._fireSupportedIntervalsMayChange),
            ne.linking.seconds.unsubscribe(
              this._fireSupportedIntervalsMayChange,
            ),
            ne.linking.ticks.unsubscribe(this._fireSupportedIntervalsMayChange),
            ne.linking.intraday.unsubscribe(
              this._fireSupportedIntervalsMayChange,
            ),
            ne.linking.dataFrequencyResolution.unsubscribe(
              this._fireSupportedIntervalsMayChange,
            ));
        }
        getDefaultIntervals() {
      ...
      class ve {
        ...
        removeFavorite(e) {
          ...
          (-1 !== r &&
            (this._favorites.splice(r, 1), this._favoritesChanged.fire(t)),
            this._saveFavs());
        }
        favId(e) {
          return he(e);
      ...
      (new re(ae.TVXWindowEvents, ie, we()),
        new Z(ae.TVXWindowEvents, ie, _e()));
      const Me = {
      ...
      class Ve extends n.PureComponent {
        constructor(e) {
          ...
          ((this._favoriteIntervalsService =
            l || new re(ae.TVXWindowEvents, ie, E)),
        ...
        componentDidUpdate(e, t) {
          ...
          (r !== t.isVisible &&
            (p.emit('toggle_header', r), this._negotiateResizer()),
        ...
        removeButton(e) {
          const { leftCustomElements: t, rightCustomElements: r } = this.state;
          if ((0, d.default)(e)) this._removeCustomElementToState(e);
          else {
            const n = (t) => 'element' in t.params && t.params.element === e,
              s = t.find(n)?.id ?? r.find(n)?.id;
        ...
        updateDropdown(e, t) {
          const r = (t) => 'Dropdown' === t.type && t.id === e,
            n =
              this.state.leftCustomElements.find(r) ||
              this.state.rightCustomElements.find(r);
          void 0 !== n &&
            ((n.params = { ...n.params, ...t }),
            this.setState({
        ...
        _addCustomHTMLButton(e, t = 'left') {
          const r = new J.WatchedValue(0),
            n = (0, Re.parseHtmlElement)(
