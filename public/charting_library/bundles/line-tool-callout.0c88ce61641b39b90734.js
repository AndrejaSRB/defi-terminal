  ...
  [688],
  {
      ...
      class c extends d.InplaceTextLineDataSource {
          ...
          switch (t) {
            ...
            case 1:
              ...
              const n = this._points,
                s = this._dragStartLeftEdgeIndex,
                r = Math.round((e.index - s) / 2),
                o = this._model.mainSeries().interval();
              if (isFinite(s) && isFinite(r)) {
                ((n[1] = { index: s + r, price: n[1].price, interval: o }),
                  this._calculateBarOffset(),
                  this._normalizePoints());
                const t =
                  this._timeScale.indexToCoordinate(s + 2 * r) -
                  this._timeScale.indexToCoordinate(s) -
                  8 -
                  2;
        ...
        setPoints(t) {
          ...
          if (
            ...
            const t =
              this._timeScale.indexToCoordinate(i + 2 * n) -
        ...
        setPriceScale(t) {
          (super.setPriceScale(t),
            t && t.priceRange() && this.calculatePoint2());
        }
        template() {
        ...
        _correctPoints(t, e) {
          ...
          const i =
            ...
            s = t[1];
          return ((s.index = s.index + i), (s.price += n), (t[1] = s), !0);
        }
        ...
        _createDataSourceBackgroundColorWV() {
          const t = (0, r.generateColorCached)(),
            { backgroundColor: e, transparency: i } =
    ...
    63117: (t, e, i) => {
      ...
      class w extends _.LineDataSource {
        ...
        editableTextStyle() {
          return { ...(this._isDarkBackground.value() ? f : x) };
        }
        removeIfEditableTextIsEmpty() {
          return !1;
        }
        ...
        async _openTextEditor(t, e, n, o, a) {
        ...
        _changeEditableTextUndoCommand(t, e) {
          return new C(this._model, this, t, e);
        }
        _createDataSourceBackgroundColorWV() {
    ...
    3156: (t, e, i) => {
      i.d(e, { generateColorCached: () => o });
      var n = i(59332),
        s = i(52859),
        r = i(16659);
      function o(t = 1e3) {
        const e = n.default.Cache;
        n.default.Cache = r.CircularCacheBuffer.bind(r.CircularCacheBuffer, t);
        const i = (0, n.default)(
          s.generateColor,
          (t, e, i) => `${t}_${e}_${i}`,
        );
