...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    91445: (e, t, i) => {
      i.d(t, { createTextStyleDefinition: () => w });
      var o = i(11542),
        r = i(95804),
        n = i(95338),
        s = i(91682);
      const l = new r.TranslatedString(
        ...
        T = o.t(null, void 0, i(38408)),
        x = o.t(null, void 0, i(7560)),
        C = o.t(null, void 0, i(6060));
      function w(e, t, i, o) {
        const r = {},
          w = {
            id: `${(0, s.removeSpaces)(i.originalText())}Text`,
        ...
        if (
          ...
          const s = h.format({ toolName: i });
          ((r.text = (0, n.convertToDefinitionProperty)(e, t.text, s, void 0)),
            (w.isEditable = Boolean(o.isEditable)),
            (w.isMultiLine = Boolean(o.isMultiLine)));
        }
        if (
          (void 0 !== t.vertLabelsAlign &&
            ...
            (w.alignmentVerticalItems = o.alignmentVerticalItems)),
          void 0 !== t.horzLabelsAlign &&
            ...
            (w.alignmentHorizontalItems = o.alignmentHorizontalItems)),
        ...
        return (
          ...
          (void 0 === t.borderVisible &&
            ...
            void 0 === t.borderWidth) ||
            (w.borderTitle =
              (o.customTitles && o.customTitles.borderTitle) || T),
          void 0 !== t.wrap &&
            ...
            (w.wrapTitle = (o.customTitles && o.customTitles.wrapTitle) || x)),
          (0, n.createTextPropertyDefinition)(r, w)
        );
      }
    },
    14472: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          LineDataSourceDefinitionsViewModel: () => P,
          LineDataSourceTabTypes: () => o,
          pointPriceBarTitle: () => m,
        }));
      var o,
        r = i(50151),
        n = i(11542),
      ...
      const g = n.t(null, void 0, i(40091)),
        _ = n.t(null, void 0, i(78930)),
        b = n.t(null, void 0, i(92516)),
        f = n.t(null, void 0, i(70320)),
        v = n.t(null, void 0, i(21429)),
        m = n.t(null, { context: 'linetool point' }, i(80166));
      class P {
        constructor(e, t) {
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'inputs', v) : null;
        }
    ...
    54707: (e, t, i) => {
      i.d(t, {
        LineSourcePaneView: () => b,
        anchorResizeCursorType: () => g,
      ...
      function g(e, t) {
        const i = e.x - t.x,
          o = e.y - t.y;
        if (!Number.isFinite(i) || !Number.isFinite(o) || (0 === i && 0 === o))
          return c.PaneCursorType.Default;
        let n = Math.atan2(o, i);
        return (
          n < 0 && (n += 2 * Math.PI),
          n >= p.deg337_5 ||
          n < p.deg22_5 ||
          (n >= p.deg157_5 && n < p.deg202_5)
            ? c.PaneCursorType.HorizontalResize
            : (n >= p.deg22_5 && n < p.deg67_5) ||
                (n >= p.deg202_5 && n < p.deg247_5)
              ? c.PaneCursorType.DiagonalNwSeResize
              : (n >= p.deg67_5 && n < p.deg112_5) ||
                  (n >= p.deg247_5 && n < p.deg292_5)
                ? c.PaneCursorType.VerticalResize
                : (n >= p.deg112_5 && n < p.deg157_5) ||
                    (n >= p.deg292_5 && n < p.deg337_5)
                  ? c.PaneCursorType.DiagonalNeSwResize
      ...
      class b {
        ...
        priceToCoordinate(e) {
          ...
          const o = null !== t ? t.firstValue() : null;
          return null === o ? null : i.priceToCoordinate(e, o);
        }
        anchorColor() {
          return u;
        }
        ...
        createLineAnchor(e, t) {
          ...
          const r = (0, n.lastMouseOrTouchEventInfo)().isTouch,
            l = this._getLineAnchorRenderer(t),
          ...
          return (
            l.setData({
              ...
              strokeWidth: r ? h.TouchStrokeWidth : h.RegularStrokeWidth,
        ...
        _anchorRadius() {
          return (0, n.lastMouseOrTouchEventInfo)().isTouch
            ? h.TouchAnchorRadius
    ...
    97865: (e, t, i) => {
      (i.r(t), i.d(t, { LineToolPriceNote: () => te }));
      var o = i(50151),
        r = i(41414),
        n = i(58978),
        s = i(24633),
      ...
      const g = {
          ...
          horzLabelsAlign: l.HorizontalAlign.Center,
          vertLabelsAlign: l.VerticalAlign.Bottom,
          fontSize: 14,
          bold: !1,
          italic: !1,
        ...
        _ = (0, n.getHexColorByName)('color-tv-blue-500'),
        b = {
          lineColor: _,
          textColor: _,
          priceLabelBackgroundColor: _,
          priceLabelBorderColor: _,
          priceLabelTextColor: (0, n.getHexColorByName)('color-white'),
        },
        f = new Map([
          [s.StdTheme.Light, b],
          [s.StdTheme.Dark, b],
        ...
        v = (0, u.extractThemedColors)(
          (0, o.ensureDefined)(f.get(s.StdTheme.Light)),
          (0, o.ensureDefined)(f.get(s.StdTheme.Dark)),
        ),
        m = (0, u.extractAllPropertiesKeys)(
          (0, o.ensureDefined)(f.get(s.StdTheme.Light)),
        ),
        P = (0, u.extractAllPropertiesKeys)(g),
        S = [
          ...new Set([
            ...m,
            ...P,
        ...
        y = [...new Set([...m, ...P, 'text'])];
      class T extends p.LineDataSourceProperty {
        constructor(e) {
          (super(e),
        ...
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () =>
              (0, h.factoryDefaultsForCurrentTheme)(g, f),
      ...
      class F {
        ...
        draw(e, t) {
          ...
          e.save();
          const { horizontalPixelRatio: o, verticalPixelRatio: r } = t,
            n = Math.round(i.points[0].x * o),
            s = Math.round(i.points[0].y * r),
            l = Math.round(i.points[1].x * o),
            a = Math.round(i.points[1].y * r);
          ((e.lineCap = 'round'),
            (0, W.setLineStyle)(e, I.LINESTYLE_SOLID),
            (e.strokeStyle = i.lineColor),
            (e.fillStyle = i.lineColor),
            (e.lineWidth = Math.round(1 * o)));
          const c = (0, H.fillScaledRadius)(2, o);
          ((0, W.createCircle)(e, n, s, c),
            e.fill(),
            void 0 !== i.excludeBoundaries &&
              (e.save(), (0, M.addExclusionArea)(e, t, i.excludeBoundaries)),
            (0, W.drawLine)(e, n, s, l, a),
            void 0 !== i.excludeBoundaries && e.restore(),
            this._priceLabelRenderer.draw(e, t));
          const d = 1 * o;
          ((e.strokeStyle = i.circleBorderColor), (e.lineWidth = d));
          const u = c + d / 2;
          ((0, W.createCircle)(e, n, s, u), e.stroke(), e.restore());
        }
        hitTest(e) {
          const t = this._data;
          if (null === t) return null;
          const i = (0, z.lastMouseOrTouchEventInfo)().isTouch ? 20 : 3;
          return (0, V.distanceToSegment)(t.points[0], t.points[1], e)
            .distance <= i
            ? this._hittest
        ...
        _updateImpl(e) {
          ...
          const s = this._source.properties().childs(),
            a = this._model.dark().value()
              ? n.colorsPalette['color-cold-gray-900']
              : n.colorsPalette['color-white'],
            c = this._source.points()[0].price,
            d = {
              text: t.formatPrice(c, r),
              points: i,
              lineColor: s.lineColor.value(),
              circleBorderColor: a,
              backgroundColor: s.priceLabelBackgroundColor.value(),
              borderColor: s.priceLabelBorderColor.value(),
              textColor: s.priceLabelTextColor.value(),
              fontSize: s.priceLabelFontSize.value(),
              bold: s.priceLabelBold.value(),
              italic: s.priceLabelItalic.value(),
            };
          {
            const t = i[0],
              o = i[1],
            ...
            u =
              'left' === c
                ...
                : 'right' === c
                  ? n.clone()
                  : new D.Point((t.x + o.x) / 2, (t.y + o.y) / 2);
            const h = Math.atan((n.y - r.y) / (n.x - r.x)),
              p = {
                points: [u],
                text: s.text.value(),
            ...
            if (
              ...
              a === l.VerticalAlign.Middle)
            ) {
              const {
                mediaSize: { width: t, height: i },
              } = e;
              d.excludeBoundaries =
                (0, A.getTextBoundaries)(this._customLabelRenderer, t, i) ??
                void 0;
            }
          }
      ...
      var K = i(11542),
        ...
        X = i(95338),
        $ = i(91682);
      const U = new Y.TranslatedString(
          'change {title} line color',
          K.t(null, void 0, i(7455)),
        ),
        j = K.t(null, void 0, i(95170)),
        J = K.t(null, void 0, i(97575)),
        Q = K.t(null, void 0, i(34974)),
        Z = K.t(null, void 0, i(16236));
      class ee extends G.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = (0, $.removeSpaces)(t),
            o = new Y.TranslatedString(t, this._source.translatedType()),
            r = (0, X.createColorPropertyDefinition)(
              {
                color: (0, X.getColorDefinitionProperty)(
                  this._propertyApplier,
                  e.lineColor,
                  null,
                  U.format({ title: o }),
              ...
              { id: `${i}LineColor`, title: J },
            );
          return {
            definitions: [
              (0, q.createTextStyleDefinition)(
                this._propertyApplier,
                {
                ...
                o,
                {
                  isEditable: !1,
                  isMultiLine: !1,
                  customTitles: { text: j, borderTitle: Q, backgroundTitle: Z },
                },
              ),
              r,
            ],
      ...
      class te extends r.LineDataSource {
        constructor(e, t, i, o) {
          (super(
            e,
            t ?? te.createProperties(e.backgroundTheme().spawnOwnership()),
            i,
            o,
          ),
    ...
    73914: (e, t, i) => {
      i.d(t, {
        ...
        lineSourcePaneViewPointToLineAnchorPoint2: () => m,
      ...
      function h(e, t, i, o) {
        const { point: r } = t,
          n = i + o / 2;
        ((0, s.drawRoundRect)(e, r.x - n, r.y - n, 2 * n, 2 * n, (i + o) / 2),
          e.closePath(),
          (e.lineWidth = o));
      }
      function p(e, t, i, o) {
      ...
      function _(e, t, i, o) {
        ...
        ((e.globalAlpha = 0.2),
          e.beginPath(),
          e.arc(r.x, r.y, i + o / 2, 0, 2 * Math.PI, !0),
          e.closePath(),
          (e.lineWidth = o),
          e.stroke(),
          (e.globalAlpha = 1));
      ...
      class f extends u.BitmapCoordinatesPaneRenderer {
        constructor(e) {
        ...
        _drawImpl(e) {
          ...
          for (let e = 0; e < this._data.points.length; ++e) {
            const n = this._data.points[e],
              s = this._data.backgroundColors[e];
            n.square ? (t.push(n), i.push(s)) : (o.push(n), r.push(s));
          }
          (t.length && this._drawPoints(e, t, i, g, p),
            o.length && this._drawPoints(e, o, r, b, _));
        }
        _drawPoints(e, t, i, r, s) {
          ...
          for (let e = 0; e < t.length; ++e) {
            ...
            if (
              !(
                (0, l.isInteger)(n.pointIndex) &&
                u.linePointBeingEdited === n.pointIndex
              )
            ) {
              a.fillStyle = i[e];
              if (
                (r(
                  a,
                  {
                    ...n,
                    point: new o.Point(
                      Math.round(n.point.x * c) + b,
                      Math.round(n.point.y * d) + b,
                    ),
                  },
                  _ / 2,
                  p,
                ...
                if (
                  ...
                  n.pointIndex === u.hoveredPointIndex
                ) {
      ...
      function v(e, t = e.pointIndex, i, o, r, n, s, l, a, c) {
        return {
          point: e,
          pointIndex: t,
          cursorType: i,
    ...
    70031: (e, t, i) => {
      ...
      function a(e, t) {
        const i = s.watchedTheme.value() ?? l.StdTheme.Light,
          a = (0, r.default)(e);
        return ((0, o.default)(a, (0, n.ensureDefined)(t.get(i))), a);
      }
    },
  },
]);
