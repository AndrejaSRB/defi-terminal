  ...
  [319],
  {
    91445: (e, t, i) => {
      ...
      const l = new s.TranslatedString(
        ...
        v = o.t(null, void 0, i(38408)),
        P = o.t(null, void 0, i(7560)),
        w = o.t(null, void 0, i(6060));
      function S(e, t, i, o) {
        const s = {},
          S = {
            id: `${(0, n.removeSpaces)(i.originalText())}Text`,
            title: (o.customTitles && o.customTitles.text) || '',
            placeholder: o.placeholder ?? w,
          };
        if (
          (void 0 === t.showText ||
            o.hideTextCheckbox ||
          ...
          void 0 !== t.fontSize &&
            (s.size = (0, r.convertToDefinitionProperty)(
              e,
              t.fontSize,
              c.format({ toolName: i }),
            )),
          void 0 !== t.bold &&
            (s.bold = (0, r.convertToDefinitionProperty)(
              e,
              t.bold,
              h.format({ toolName: i }),
            )),
          void 0 !== t.italic &&
            (s.italic = (0, r.convertToDefinitionProperty)(
              e,
              t.italic,
              d.format({ toolName: i }),
            )),
          ...
          const n = u.format({ toolName: i });
          ((s.text = (0, r.convertToDefinitionProperty)(e, t.text, n, void 0)),
            (S.isEditable = Boolean(o.isEditable)),
            (S.isMultiLine = Boolean(o.isMultiLine)));
        }
        if (
          (void 0 !== t.vertLabelsAlign &&
            ((s.alignmentVertical = (0, r.convertToDefinitionProperty)(
              e,
              t.vertLabelsAlign,
              p.format({ toolName: i }),
            )),
          ...
          void 0 !== t.horzLabelsAlign &&
            ((s.alignmentHorizontal = (0, r.convertToDefinitionProperty)(
              e,
              t.horzLabelsAlign,
              g.format({ toolName: i }),
            )),
          ...
          void 0 !== t.textOrientation &&
            (s.orientation = (0, r.convertToDefinitionProperty)(
              e,
              t.textOrientation,
              _.format({ toolName: i }),
            )),
          void 0 !== t.backgroundVisible &&
            (s.backgroundVisible = (0, r.convertToDefinitionProperty)(
              e,
              t.backgroundVisible,
              m.format({ toolName: i }),
            )),
          ...
          (void 0 !== t.backgroundTransparency &&
            (o = t.backgroundTransparency),
            (s.backgroundColor = (0, r.getColorDefinitionProperty)(
              e,
              t.backgroundColor,
              o,
              f.format({ toolName: i }),
        ...
        return (
          ...
          void 0 !== t.borderVisible &&
            (s.borderVisible = (0, r.convertToDefinitionProperty)(
              e,
              t.borderVisible,
              x.format({ toolName: i }),
            )),
          void 0 !== t.borderWidth &&
            (s.borderWidth = (0, r.convertToDefinitionProperty)(
              e,
              t.borderWidth,
              b.format({ toolName: i }),
            )),
          void 0 !== t.borderColor &&
            (s.borderColor = (0, r.getColorDefinitionProperty)(
              e,
              t.borderColor,
              null,
              T.format({ toolName: i }),
          ...
          (void 0 === t.borderVisible &&
            ...
            void 0 === t.borderWidth) ||
            (S.borderTitle =
              (o.customTitles && o.customTitles.borderTitle) || v),
          void 0 !== t.wrap &&
            ((s.wrap = (0, r.convertToDefinitionProperty)(
              e,
              t.wrap,
              C.format({ toolName: i }),
            )),
            (S.wrapTitle = (o.customTitles && o.customTitles.wrapTitle) || P)),
          (0, r.createTextPropertyDefinition)(s, S)
        );
      }
    },
    56689: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          ...
          availableAlignmentVerticalItems: () => w,
        }));
      var o = i(50151),
        s = i(11542),
        r = i(95804),
      ...
      class V extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            ...
            i = this._source.name(),
            s = (0, h.removeSpaces)(i),
            l = new r.TranslatedString(i, this._source.translatedType()),
            a = this._source.levelsCount();
          for (let i = 1; i <= a; i++) {
            const o = t[`level${i}`].childs(),
              r = (0, n.createLeveledLinePropertyDefinition)(
                {
                  ...
                  style: (0, n.convertToDefinitionProperty)(
                    this._propertyApplier,
                    o.linestyle,
                    _.format({ title: l, index: i }),
                  ),
                  level: (0, n.convertToDefinitionProperty)(
                    this._propertyApplier,
                    o.coeff,
          ...
          const V = (0, n.createColorPropertyDefinition)(
            {
              color: (0, n.getColorDefinitionProperty)(
                this._propertyApplier,
            ...
            { id: `${s}AllLineColor`, title: y },
          );
          e.push(V);
          const D = (0, n.createTransparencyPropertyDefinition)(
            {
              checked: (0, n.convertToDefinitionProperty)(
                this._propertyApplier,
                t.fillBackground,
              ...
              transparency: (0, n.convertToDefinitionProperty)(
                this._propertyApplier,
                t.transparency,
                b.format({ title: l }),
              ),
            },
            { id: `${s}Background`, title: v },
          );
          e.push(D);
          const A = (0, n.createTwoOptionsPropertyDefinition)(
            {
              checked: (0, n.convertToDefinitionProperty)(
                this._propertyApplier,
                t.showLabels,
              ...
              option1: (0, n.convertToDefinitionProperty)(
                this._propertyApplier,
                t.horzLabelsAlign,
                C.format({ title: l }),
              ),
              option2: (0, n.convertToDefinitionProperty)(
                this._propertyApplier,
                t.vertLabelsAlign,
                C.format({ title: l }),
              ),
            },
            {
              ...
              optionsItems2: new c.WatchedValue(w),
            },
          );
    ...
    14472: (e, t, i) => {
      (i.r(t),
        i.d(t, {
          LineDataSourceDefinitionsViewModel: () => T,
          LineDataSourceTabTypes: () => o,
          pointPriceBarTitle: () => b,
        }));
      var o,
        s = i(50151),
        r = i(11542),
      ...
      const g = r.t(null, void 0, i(40091)),
        _ = r.t(null, void 0, i(78930)),
        m = r.t(null, void 0, i(92516)),
        f = r.t(null, void 0, i(70320)),
        x = r.t(null, void 0, i(21429)),
        b = r.t(null, { context: 'linetool point' }, i(80166));
      class T {
        constructor(e, t) {
          ((this._yCoordinateStepWV = null),
            ...
            (this._source = t),
            (this._undoModel = e),
            (this._ownerSource = (0, s.ensureNotNull)(
        ...
        _createPropertyRages() {
          ...
          const o = this._createCoordinatesPropertyPage();
          null !== o &&
            ((o.visible = this._source.hasEditableCoordinates()),
            this._propertyPages.push(o));
          const s = this._createVisibilitiesPropertyPage();
          this._propertyPages.push(s);
        }
        _createVisibilitiesPropertyPage() {
          ...
          return (0, a.createPropertyPage)(
            (0, h.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._propertyApplier,
              e,
        ...
        _createCoordinatesPropertyPage() {
          ...
          return null !== e
            ? (e.definitions.length < this._source.pointsCount() &&
              ...
              (0, a.createPropertyPage)(e, 'coordinates', _))
            : null;
        }
        ...
        _createStylePropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'style', m) : null;
        }
        _stylePropertyDefinitions() {
          return null;
        }
        _createTextPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'text', f) : null;
        }
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'inputs', x) : null;
        }
    ...
    44005: (e, t, i) => {
      i.d(t, {
        ...
        CollectibleColorPropertyUndoWrapper: () => n,
      });
      var o = i(50151),
        s = i(43337);
      class r extends s.Property {
        constructor(e) {
          (super(),
    ...
    88636: (e, t, i) => {
      ...
      var o = i(90054),
        ...
        r = i(50151),
        n = i(78176);
      class l extends n.DefaultProperty {
        ...
        template() {
          return (0, n.extractState)(this.state(), this._templateKeys, []);
        }
        applyTemplate(e) {
          this.mergeAndFire(
            (0, n.extractState)(
    ...
    53768: (e, t, i) => {
      ...
      class v {
        constructor(e) {
          ((this._textWidthCache = new T.TextWidthCache(1e3)), this.setFont(e));
        }
        setFont(e) {
          ((this._fontSize = e),
            (this._font = (0, C.makeFont)(e, y.CHART_FONT_FAMILY)));
        }
        font() {
          return this._font;
        }
        ...
        getSymbolWidth() {
          return (0, b.measureText)('0', this._font, this._textWidthCache)
            .width;
        }
        getSymbolHeight() {
      ...
      function A(e, t, i, o) {
        let s = 0;
        for (let e = 0; e < i; e++) s += t[e];
        const r = t[i];
        return [Math.round((e + s) * o), Math.round((e + s + r) * o)];
      }
      const {
          colorWhite: I,
          colorColdGray200: R,
        ...
        L = new Map([
          [
            h.StdTheme.Light,
            { backgroundColor: I, borderColor: R, textColor: H },
          ],
          [
            h.StdTheme.Dark,
            { backgroundColor: H, borderColor: W, textColor: R },
          ],
        ]),
        z = (0, d.extractThemedColors)(
          (0, o.ensureDefined)(L.get(h.StdTheme.Light)),
          (0, o.ensureDefined)(L.get(h.StdTheme.Dark)),
        ),
        N = (0, d.extractAllPropertiesKeys)(
          (0, o.ensureDefined)(L.get(h.StdTheme.Light)),
        ),
        M = (0, d.extractAllPropertiesKeys)(E),
        k = [
          ...new Set([
            ...N,
            ...M,
        ...
        B = [...new Set([...k, ...m.commonLineToolPropertiesStateKeys])];
      class F extends _.LineDataSourceProperty {
        constructor(e) {
          if ((super(e), (this._tableTextCache = new v(14)), !e.state)) {
            const e = 3,
              t = 3,
              i = [];
            for (let o = 0; o < e; o++) i.push(new Array(t).fill(''));
            const o = new Array(t).fill(120),
              s = new Array(e).fill(0);
        ...
        recreateCellsPropsByState(e) {
          ...
          (this.removeProperty('rowsCount'),
            ...
            this.addChild('columnWidths', new f.Property(s)),
        ...
        setColumnWidthValues(e) {
          const t = this.childs(),
            i = t.colsCount.value(),
            o = D(this._tableTextCache);
          for (let s = 0; s < i; s++)
            t.columnWidths.childs()[s].setValue(Math.max(e[s], o));
        }
        setRowHeightValues(e) {
          ...
          for (let s = 0; s < i; s++)
            t.rowHeights.childs()[s].setValue(Math.max(e[s], o));
        }
        cellsValues() {
        ...
        static create(e, t) {
          return new this({
            ...
            factoryDefaultsSupplier: () =>
              (0, u.factoryDefaultsForCurrentTheme)(E, L),
            nonThemedDefaultsKeys: M,
            themedDefaultsKeys: N,
            allStateKeys: B,
            themedColors: z,
      ...
      const re = c.colors.colorTvBlue500Alpha20,
        ne = c.colors.colorTvBlue500;
      class le extends ee.BitmapCoordinatesPaneRenderer {
        constructor() {
          (super(...arguments),
            (this._data = null),
        ...
        hitTest(e, t) {
            ...
            f = u / i;
          {
            ...
            for (const i of c.cells) {
              const { bottom: o, rowIndex: n } = i[0],
                l = o / r;
              if (
                ((t = (0, Q.pointInBox)(
                  e,
                  (0, s.box)((0, s.point)(_, l - d), (0, s.point)(f, l + d)),
                )
                  ? n
                  : null),
                null !== t)
            ...
            for (const t of c.cells[0]) {
              ...
              if (
                ((h = (0, Q.pointInBox)(
                  e,
                  (0, s.box)((0, s.point)(n - d, g), (0, s.point)(n + d, m)),
                )
                  ? r
                  : null),
                null !== h)
            ...
            if (l && (null !== h || null !== t)) {
              const e = { row: t, column: h },
                i =
                  null !== h && null !== t
                    ? j.PaneCursorType.Default
                    : null !== h
                      ? j.PaneCursorType.HorizontalResize
                      : j.PaneCursorType.VerticalResize;
              return new U.HitTestResult(
                a && h !== n.column && t !== n.row
                  ? U.HitTarget.MovePoint
                  : U.HitTarget.ChangePoint,
                {
                  cursorType: i,
                  activeItem: e,
                  pointIndex: (0, o.ensureNotNull)(se(e)),
                  nonDiscreteIndex: !0,
                },
              );
            }
          ...
          for (const t of c.cells)
            for (const o of t) {
              ...
              if (
                (0, Q.pointInBox)(
                  e,
                  (0, s.box)((0, s.point)(u, d), (0, s.point)(g, p)),
                )
              )
                return new U.HitTestResult(U.HitTarget.MovePoint, {
          ...
          return (0, Q.pointInBox)(
            e,
            (0, s.box)((0, s.point)(_, g), (0, s.point)(f, m)),
          )
        ...
        _drawImpl(e) {
          ...
          (!(function (e, t) {
            ...
            const { x: i, y: o } = t.cells.topLeft,
              { x: s, y: r } = t.cells.bottomRight;
            e.fillRect(i, o, s - i, r - o);
          })(t, i),
            (function (e, t) {
              const i = (0, Z.roundToMax)(1 * e.horizontalPixelRatio),
                o = (0, Z.roundToMax)(1 * e.verticalPixelRatio),
                s = e.context;
              s.fillStyle = t.borderColor;
              const [r, n] = t.editableCell || [-1, -1];
              let [l, a] = t.selectableCell || [-1, -1];
              r === l && n === a && ((l = -1), (a = -1));
              for (const c of t.cells.cells)
                for (const h of c) {
                  ...
                  if (
                    (0 === _ && s.fillRect(c, u, d - c, o),
                    0 === g && s.fillRect(c, u, i, p - u),
                    s.fillRect(c, p, d - c, o),
                    s.fillRect(d, u, i, p - u),
                    (r === _ && n === g) || (l === _ && a === g))
                  ) {
      ...
      class ae extends Y.InplaceTextLineSourcePaneView {
        constructor(e, t, i, o, r) {
          (super(e, t, o, r),
            ...
            (this._anchorPoints = Array.from({ length: 4 }, (e, t) => ({
              point: (0, s.point)(NaN, NaN),
              pointIndex: t,
              cursorType:
                t === O.TopLeft || t === O.BottomRight
                  ? j.PaneCursorType.DiagonalNwSeResize
                  : j.PaneCursorType.DiagonalNeSwResize,
              hitTarget: U.HitTarget.ChangePoint,
              nonDiscreteIndex: t === O.TopRight || t === O.BottomRight,
            }))),
            (this._tableRenderer = new le()),
        ...
        _updateImpl(e) {
          ...
          const { x: u, y: p } = d.topLeft,
            { x: g, y: _ } = d.bottomRight,
            { horizontalPixelRatio: m, verticalPixelRatio: f } = e,
            x = u / m,
            b = p / f,
            T = g / m,
            C = _ / f,
            y = this._source.isFixed();
          ((this._anchorPoints[O.TopLeft].point = (0, s.point)(x, b)),
            (this._anchorPoints[O.TopLeft].nonDiscreteIndex = y),
            (this._anchorPoints[O.BottomLeft].point = (0, s.point)(x, C)),
            (this._anchorPoints[O.BottomLeft].nonDiscreteIndex = y),
            (this._anchorPoints[O.TopRight].point = (0, s.point)(T, b)),
            (this._anchorPoints[O.BottomRight].point = (0, s.point)(T, C)),
            ...
            if (
              ...
              for (let o = 0; o < t.texts.length; o++) {
                ...
                for (let e = 0; e < s.length; e++) {
                  const i = (0, Y.inplaceEditHandlers)(
                  ...
                  (n.push(i),
                    r.push(
                      new q.LineToolTextRenderer(
                        ...
                        new U.HitTestResult(U.HitTarget.MovePoint, i),
                      ),
                    ));
                }
                (e.push(r), i.push(n));
              ...
              const { height: i, width: s } = e.mediaSize,
                r = this._getTextEditableRenderer();
              t.texts.forEach((e, n) => {
                e.forEach((e, l) => {
                  const a = this._cellsTextRenderers[n][l];
                  let c = {
                    ...(0, o.ensureNotNull)(a.data()),
                    text: e,
                    selectionHighlight: void 0,
                    fontSize: t.fontSize,
                    color: this._textColorForCell([n, l]),
                    horzTextAlign: t.horzAlign,
                    horzAlign: t.horzAlign,
                    wordWrapWidth: w(t.columnWidths[l], this._tableTextCache),
                    boxPadding: 8,
                  };
                  (r === a &&
                    ((c = {
        ...
        _setTextRendererPositions(e, t) {
          ...
          this._cellsTextRenderers.forEach((t, n) => {
            t.forEach((t, l) => {
              const { left: a, right: c, top: h, bottom: d } = e.cells[n][l];
              t.setPoint(
                (0, s.point)(
                  (a +
                    ('right' === i
        ...
        _rawPrecalculatedData(e, t) {
          const i = this._cellsTextRenderers.map((t, i) =>
            ...
            o = e.columnWidths.map((i, o) =>
              A(e.leftTop.x, e.columnWidths, o, t.horizontalPixelRatio),
            ),
            r = i.map((o, s) => A(e.leftTop.y, i, s, t.verticalPixelRatio)),
            n = i.map((t, i) =>
              e.columnWidths.map((t, s) => {
                const [n, l] = o[s],
                  [a, c] = r[i];
                return {
                  left: n,
          ...
          return {
            topLeft: (0, s.point)(o[0][0], r[0][0]),
            bottomRight: (0, s.point)(o[o.length - 1][1], r[r.length - 1][1]),
            cells: n,
          };
        }
      ...
      const fe = new he.TranslatedString(
        ...
        Te = ce.t(null, void 0, i(79468)),
        Ce = ce.t(null, void 0, i(38408)),
        ye = ce.t(null, void 0, i(70320)),
        ve = ce.t(null, void 0, i(25485));
      class Pe extends ue.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = (0, ge.removeSpaces)(t),
          ...
          return {
            definitions: [
              ...
              (0, de.createTextStyleDefinition)(
                ...
                o,
                { isEditable: !0, isMultiLine: !0, customTitles: { text: ye } },
              ),
              (0, pe.createOptionsPropertyDefinition)(
                ...
                },
                {
                  id: `${i}TextAlignment`,
                  title: ve,
                  options: new _e.WatchedValue(
                    me.availableAlignmentHorizontalItems,
                  ),
                },
              ),
            ],
      ...
      var we = i(12217),
        Se = i(40472),
        Ve = i(33065);
      class De extends a.InplaceTextUndoCommand {
      ...
      const Re = new he.TranslatedString(
        ...
        He = new he.TranslatedString(
          'remove column',
          r.t(null, void 0, i(16829)),
        ),
        Ee = new he.TranslatedString('remove row', r.t(null, void 0, i(4553)));
      class Le extends Ae.UndoCommand {
        constructor(e, t, i, o) {
          (super(o, !0, !Ie.lineToolsDoNotAffectChartInvalidation),
            (this._sourceId = t.id()),
            (this._model = e),
            (this._operationType = i));
          const { rowsCount: s, colsCount: r } = t.properties().state();
          ((this._rowsCountPropsState = s),
      ...
      function Me(e, t, i) {
        ...
        if (r < o)
          for (let i = 0; i < e.length; i++)
            e[i] === t[i] && ((o -= e[i]), (r -= e[i]));
        const n = r / o,
          l = e.map((e, i) => Math.max(t[i], e * n));
        return (0, we.sum)(l) > r + 0.01 ? Me(l, t, i) : l;
      }
      ...
      class Oe extends a.InplaceTextLineDataSource {
        ...
        getPoint(e) {
          ...
          if (i) {
            const e = this.columnWidths(),
              t = this.rowHeights(),
              r = i.add((0, s.point)((0, we.sum)(e), (0, we.sum)(t)));
        ...
        setInplaceEditableCellIndexes(e, t = !1) {
          ...
          const n = this.properties().childs().editableText,
            l = {};
          if (-1 !== s && -1 !== r) {
            const e = this.properties().childs().cells.childs()[s].childs()[r];
            (n.setValue(e.value()),
              n.subscribe(l, () => e.setValue(n.value())),
              e.subscribe(l, () => n.setValue(e.value())),
              (this._destroyEditableTextSubscriptions = () => {
                (n.unsubscribeAll(l), e.unsubscribeAll(l));
              }));
          }
          ((this._inplaceEditCellIndexes = [s, r]),
            this._editableText.setValue(n.value()),
            this.updateAllViews((0, Se.sourceChangeEvent)(this.id())),
            this._model.updateSource(this));
        }
        switchActiveCell(e = !1) {
          ...
          if (-1 === t && -1 === i) return !1;
          const { colsCount: o, rowsCount: s } = this.properties().state(),
            r = o * s,
            n = (t * o + i + (e ? r - 1 : 1)) % r;
          return (
            (t = Math.floor(n / o) % s),
        ...
        insertCells(e, t) {
          ...
          let { rowsCount: o, colsCount: s } = i;
          const r = this.properties().cellsValues(),
            n = this.properties().columnWidthValues(),
            l = this.properties().rowHeightValues();
          let [a, c] = t ?? this._inplaceEditCellIndexes,
            h = !1;
          switch (
            (-1 === a && -1 === c && ((h = !0), (a = o - 1), (c = s - 1)), e)
          ) {
            case 0:
              const e = a + 1,
                t = new Array(s).fill('');
              (e >= o ? r.push(t) : r.splice(e, 0, t), l.splice(e, 0, 0), o++);
              break;
            case 1:
              const i = c + 1;
        ...
        removeCells(e, t) {
          ...
          if (-1 === i && -1 === o) return;
          let { rowsCount: s, colsCount: r } = this.properties().state();
          const n = this.properties().cellsValues(),
            l = this.properties().columnWidthValues(),
            a = this.properties().rowHeightValues();
          switch (e) {
            case 0:
              (n.splice(i, 1), a.splice(i, 1), s--);
              break;
            case 1:
              for (const e of n) e.splice(o, 1);
              (l.splice(o, 1), r--);
          }
          this._properties.recreateCellsPropsByState({
            rowsCount: s,
        ...
        async additionalActions(e, t = 'Default') {
          ...
          return (
            'Default' === t &&
              (o = (
                await Promise.all([i.e(1629), i.e(620)]).then(i.bind(i, 4714))
              ).tableActions(this, e)),
        ...
        startChanging(e, t) {
          ...
          const [i, s] = this.columnWidths(!0),
            [r, n] = this.rowHeights(!0),
            l = (0, we.sum)(i),
            a = (0, we.sum)(r),
            c = (0, we.sum)(n);
          e ??= O.TopLeft;
          const h = this._topLeftPoint(),
            ...
            g = d.coordinateToPrice(p + a, u),
            _ = this._model.timeScale().indexToCoordinate(h.index),
            m = this._model.timeScale().coordinateToFloatIndex(_ + l);
          switch (e) {
            case O.BottomLeft:
              t = { index: h.index, price: g };
              break;
            case O.TopRight:
              t = { index: m, price: h.price };
              break;
            case O.BottomRight:
              t = { index: m, price: g };
              break;
        ...
        setPoint(e, t, i, r) {
          const n = this._model.timeScale(),
            l = (0, o.ensureNotNull)(this.priceScale()),
          ...
          const {
            ...
            b = this._topLeftPoint(),
            T = (0, o.ensureNotNull)(this.pointToScreenPoint(b)),
            C = e === O.TopLeft || e === O.BottomLeft,
            y = e === O.TopLeft || e === O.TopRight,
            v = d.add((0, s.point)(C ? p : -p, y ? g : -g)),
            P = D(this._tableTextCache);
          let { x: A, y: I } = u;
          if (!r) {
            const e = P * h.columnWidths.length,
              t = h.minTotalHeight;
            ((A = C ? Math.min(u.x, v.x - e) : Math.max(u.x, v.x + e)),
              (I = y ? Math.min(u.y, v.y - t) : Math.max(u.y, v.y + t)),
              (u = (0, s.point)(A, I)));
          }
          const R = this.isFixed(),
            W =
              C && !R
                ? Math.floor(n.coordinateToFloatIndex(A))
                : n.coordinateToFloatIndex(A);
          A = n.indexToCoordinate(W);
          const H = l.coordinateToPrice(I, a),
            E = d.x - A,
            L = d.y - I;
          switch (e) {
            case O.TopLeft:
              (R
                ...
                : this._setPoint(0, { ...t, price: H, index: W, interval: c }),
                r ||
                  (this._properties.setColumnWidthValues(
                    this._correctColumnWidths(Me(_, m, p + E), h),
                  ),
                  this._properties.setRowHeightValues(Me(f, x, g + L))));
              break;
            case O.BottomLeft:
              (R
                ? this.addFixedPoint((0, s.point)(u.x, T.y))
                : this._setPoint(0, {
                    ...t,
                    index: W,
                    price: b.price,
            ...
            case O.TopRight:
              (R
                ? this.addFixedPoint((0, s.point)(T.x, u.y))
                : this._setPoint(0, {
                    ...t,
                    price: H,
                    index: b.index,
                ...
                r ||
                  (this._properties.setColumnWidthValues(Me(_, m, p - E)),
                  this._properties.setRowHeightValues(Me(f, x, g + L))));
              break;
            case O.BottomRight:
              r ||
          ...
          if (e >= O.ResizeVirtualAnchorBase) {
            ...
            if (null !== t) {
              const e = (0, we.sum)(_.slice(0, t)) + T.x,
                i = Math.max(P, u.x - e),
                o = _.map((e, o) => (o === t ? i : e));
              this._properties.setColumnWidthValues(o);
            }
            if (null !== i) {
              const e = (0, we.sum)(f.slice(0, i)) + T.y;
              ...
              for (let e = 0; e < _.length; e++)
                t = Math.max(
                  ...
                  S(
                    this.cellText(i, e),
                    w(_[e], this._tableTextCache),
                    this._tableTextCache,
                  ),
                );
              const o = Math.max(t, u.y - e),
                s = f.map((e, t) => (t === i ? o : e));
              this._properties.setRowHeightValues(s);
            }
          } else;
        }
        columnWidths(e) {
          ...
          if (!e) return t;
          const i = D(this._tableTextCache),
            o = t.map((e) => i);
          return [t, o];
        }
        rowHeights(e) {
          const t = this.properties().rowHeightValues(),
            ...
            s = t.map((t, s) => {
              ...
              for (
                ...
                const t = S(
                  this.cellText(s, e),
                  w(i[e], this._tableTextCache),
                  this._tableTextCache,
                );
                ((n = Math.max(n, t)), (r = Math.max(r, t)));
              }
              return (e && o.push(r), n);
            });
          return e ? [s, o] : s;
        ...
        _closeTextEditor(e) {
          (super._closeTextEditor(),
            0 === e && (this._inplaceEditCellIndexes = [-1, -1]));
        }
        ...
        _createDataSourceBackgroundColorWV() {
          return (0, n.convertPropertyToWatchedValue)(
        ...
        _correctColumnWidths(e, t) {
          const i = (
            ...
            s = (0, o.ensureNotNull)(this.pointToScreenPoint(t.topLeftPoint)).x,
            [, r] = A(s, t.columnWidths, t.columnMinWidths.length - 1, i),
            n = (0, o.ensureNotNull)(
              this.pointToScreenPoint(this._topLeftPoint()),
            ).x,
            l = (0, we.sum)(e),
            a = r / i - n;
          return ((e[e.length - 1] += a - l), e);
        }
      }
    },
    24961: (e, t, i) => {
      i.d(t, { LineToolTextRenderer: () => s });
      var o = i(4753);
      class s extends o.TextRenderer {
        getTextInfo() {
    ...
    70031: (e, t, i) => {
      ...
      var o = i(16738),
        ...
        l = i(24633);
      function a(e, t) {
        const i = n.watchedTheme.value() ?? l.StdTheme.Light,
          a = (0, s.default)(e);
