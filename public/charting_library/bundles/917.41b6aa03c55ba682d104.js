(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [917],
  {
    ...
    74670: (e, t, o) => {
      'use strict';
      o.d(t, { useActiveDescendant: () => a });
      var n = o(50959),
        l = o(39416);
      function a(e, t = []) {
        const [o, a] = (0, n.useState)(!1),
          i = (0, l.useFunctionalRefObject)(e);
        return (
          (0, n.useLayoutEffect)(() => {
            const e = i.current;
            if (null === e) return;
    ...
    173: (e, t, o) => {
      ...
      o.d(t, {
        emojiGroups: () => S,
        isSupportedEmoji: () => I,
        localeCompareEmojiTitles: () => R,
        removeUnavailableEmoji: () => T,
        separateEmoji: () => H,
      });
      var n = o(50959),
        l = o(11542),
      ...
      const H = (0, a.default)((e) => {
        const t = (0, i.getFirstSegmentOrCodePointString)(e),
          o = null !== t && I(t) ? t : '';
        return { emoji: o, emojiLessString: e.replace(o, '') };
      });
      function R(e, t, ...o) {
        const n = H((0, r.ensureNotNull)(e)).emojiLessString.trim(),
          l = H((0, r.ensureNotNull)(t)).emojiLessString.trim();
        return n === l ? e.localeCompare(t, ...o) : n.localeCompare(l, ...o);
      }
      const S = () => [
        {
          title: l.t(null, { context: 'emoji_group' }, o(88906)),
          emojis: [],
          content: n.createElement(c.IconItem, { icon: s }),
        },
        {
          title: l.t(null, { context: 'emoji_group' }, o(43438)),
          emojis: f,
          content: n.createElement(c.IconItem, { icon: m }),
        },
        {
          title: l.t(null, { context: 'emoji_group' }, o(53288)),
          emojis: z,
          content: n.createElement(c.IconItem, { icon: v }),
        },
        {
          title: l.t(null, { context: 'emoji_group' }, o(90678)),
          emojis: x,
          content: n.createElement(c.IconItem, { icon: u }),
        },
        {
          title: l.t(null, { context: 'emoji_group' }, o(21311)),
          emojis: E,
          content: n.createElement(c.IconItem, { icon: h }),
        },
        {
          title: l.t(null, { context: 'emoji_group' }, o(28562)),
          emojis: M,
          content: n.createElement(c.IconItem, { icon: d }),
        },
        {
          title: l.t(null, { context: 'emoji_group' }, o(98355)),
          emojis: j,
          content: n.createElement(c.IconItem, { icon: p }),
        },
        {
          title: l.t(null, { context: 'emoji_group' }, o(40457)),
          emojis: L,
          content: n.createElement(c.IconItem, { icon: g }),
        },
        {
          title: l.t(null, { context: 'emoji_group' }, o(6715)),
          emojis: b,
          content: n.createElement(c.IconItem, { icon: w }),
        },
      ];
    },
    37285: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        v = o(6138);
      function u(e) {
        const { emoji: t, className: l } = e;
        if (t === s.EMPTY_EMOJI)
          return n.createElement(i.Icon, {
            className: a()(l, m.clearButton, 'apply-common-tooltip'),
            icon: v,
            title: r.t(null, void 0, o(47550)),
          });
        const u = (0, c.getTwemojiUrl)(t, 'png');
        return n.createElement('img', {
          className: a()(l, m.emoji),
          src: u,
          decoding: 'async',
          width: '24',
          height: '24',
    ...
    56127: (e, t, o) => {
      ...
      function r(e) {
        const {
            text: t,
            textRender: o,
            firstSegmentOnly: r = !1,
            spaceAfterEmoji: c = !0,
          } = e,
          { leadingEmoji: s, processedText: m } = (0, n.useMemo)(
            () =>
              (0, l.processTextWithLeadingEmoji)({
                text: t,
                textRender: o,
                firstSegmentOnly: r,
              }),
        ...
        return s
          ? n.createElement(
              ...
              n.createElement(
                ...
                ' ',
                n.createElement(a.EmojiItem, { className: i.emoji, emoji: s }),
              ),
              '' !== m &&
                n.createElement(
                  n.Fragment,
    ...
    63472: (e, t, o) => {
      'use strict';
      o.d(t, {
        getLeadingEmojiHtml: () => v,
        processTextWithLeadingEmoji: () => m,
      });
      var n = o(91682),
        l = o(173),
        a = o(88160),
        ...
        r = o(3415),
        c = o(59181);
      const s = i.enabled('advanced_emoji_in_titles');
      function m(e) {
        const {
            text: t,
            textRender: o = (e) => e,
          ...
          r = (0, n.getFirstSegmentOrCodePointString)(t),
          c = null !== r && (0, l.isSupportedEmoji)(r) ? r : a.EMPTY_EMOJI,
          m = i ? r || '' : t;
        if (!s || c === a.EMPTY_EMOJI)
          return { leadingEmoji: '', processedText: o(m) };
        return { leadingEmoji: c, processedText: o(m.replace(c, '')) };
      }
      function v(e) {
        const { processedText: t, leadingEmoji: o } = m({ text: e }),
          l = (0, n.htmlEscape)(t);
        if (!o) return l;
        return `${(function (e) {
          const t = (0, r.getTwemojiUrl)(e, 'png');
    ...
    71402: (e, t, o) => {
      'use strict';
      o.d(t, { RemoveTitleType: () => n, removeTitlesMap: () => a });
      var n,
        l = o(11542);
      !(function (e) {
      ...
      const a = {
        [n.Add]: l.t(null, void 0, o(69207)),
        [n.Remove]: l.t(null, void 0, o(85106)),
      };
    },
    36189: (e, t, o) => {
      'use strict';
    ...
    96040: (e, t, o) => {
      ...
      function v(e) {
        const {
          ...
          [f, z] = (0, c.useActiveDescendant)(null);
        return l.createElement(r.Icon, {
          ...w,
          'data-name': p,
          className: i()(
            m.button,
          ...
          onClick: v,
          onMouseDown: u,
          title: h ?? n.t(null, void 0, o(67410)),
          ariaLabel: h ?? n.t(null, void 0, o(67410)),
          ref: f,
        });
      }
    },
    36235: (e, t, o) => {
      'use strict';
      o.d(t, { showFavoriteLayouts: () => n });
      const n = !1;
    },
    3415: (e, t, o) => {
      'use strict';
      o.d(t, { getTwemojiUrl: () => l });
      var n = o(18438);
      function l(e, t) {
        let o = '';
        return (
      ...
      n.default.base = 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/13.0.1/';
    },
    6138: (e) => {
      e.exports =
