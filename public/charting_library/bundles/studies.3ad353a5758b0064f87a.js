  ...
  [7539],
  {
    52973: (e, t, s) => {
      ...
      var i = s(50151),
        ...
        c = s(40472),
        u = s(72972);
      const d = new o.PriceFormatter();
      class _ extends n.CustomSourceBase {
        constructor(e, t, s, i) {
          (super(e, t),
        ...
        stateData() {
          return null !== this._metaInfo
            ? {
                graphics: (0, a.saveStudyGraphics)(
                  this.graphics(),
        ...
        _loadStudyGraphics(e) {
          ...
          this._loadedGraphics = (0, a.loadStudyGraphics)(e);
        }
        _setMetaInfo(e) {
        ...
        _createPaneViews() {
          ...
          (0, a.createGraphicsPaneViews)(this, this._model, e).then((e) => {
        ...
        _canBeHibernated() {
          if (this._model.mainSeries().isDWM()) return !0;
          const e = this._properties.childs().sessionHighlight.childs(),
            {
              preMarket: t,
              postMarket: s,
              electronic: i,
              outOfSession: r,
            } = e.backgrounds.childs(),
            { sessBreaks: l } = e.vertlines.childs(),
            a =
              (t.childs().available.value() && t.childs().visible.value()) ||
              (s.childs().available.value() && s.childs().visible.value()) ||
              (i.childs().available.value() && i.childs().visible.value()) ||
              (r.childs().available.value() && r.childs().visible.value()),
            o = l.childs().available.value() && l.childs().visible.value();
          return !a && !o;
        }
        _isHibernated() {
          return (
    ...
    96664: (e, t, s) => {
      (s.r(t), s.d(t, { study_PivotPointsStandard: () => B }));
      var i = s(50151),
        r = s(11485);
      class l extends r.Study {
        isLinkedToSeries() {
          return !0;
        }
        clearData() {
        ...
        restoreData(e, t, s) {
          (super.restoreData(e), (this._customData = t), (this._indexes = s));
        }
        state(e) {
        ...
        _onDataUpdated(e, t, s) {
          (null !== t &&
            (t.indexes_replace
              ? ((0, i.assert)('nochange' !== s), (this._indexes = s))
              : ((this._customData = t.data),
                'nochange' !== s && (this._indexes = s))),
            super._onDataUpdated(e, t, s));
        }
      }
      var a = s(27714),
        o = s(33350);
                ...
                () => {
                  ...
                  for (let e = 0; e < this._prices.length; e++) {
                    ...
                    ((this._cache.fillStyle = this._renderParams.backColors[e]),
                      ...
                      this._cache.fillText(
                        '/',
                        0,
                        this._centerByIndex(e + 11),
                      ));
                  }
                },
              ),
      ...
      class _ extends c.PriceAxisView {
        constructor(e, t) {
      ...
      class g {
        ...
        _updateImpl() {
          ...
          const i = e
            .mainSeries()
            .bars()
            .search(s.lastBar(), m.PlotRowSearchMode.NearestLeft);
          if (null === i) return;
          ...
          for (let e = 0; e < a.length; e++) {
            if (!a[e]) continue;
            const s = r[a[e].startIndex],
              i = r[a[e].endIndex],
              h = o.inputs.childs().showHistoricalPivots.value();
            if (s <= l && (i >= l || h)) {
              ...
              for (let s = 0; s < b.length; s++) {
                ...
                const l = t.priceToCoordinate(r, n),
                  h = i.toUpperCase(),
                  c = S[h],
                  u = o.levelsStyle.childs().colors.childs()[c].value();
                this._prices.push({
      ...
      var f = s(10555),
        ...
        x = s(2383),
        V = s(10307);
      class I extends V.BitmapCoordinatesPaneRenderer {
        constructor(e, t, s) {
          (super(),
            (this._drawRects = []),
        ...
        _drawImpl(e) {
          ...
          const l = (e) => {
              const l = t.labelRectByIndex(e),
                a = {
                  left: Math.round(this._point.x - l.width + o),
      ...
      class A {
        ...
        _updateImpl() {
          ...
          const r = t.pivots,
            ...
            o = this._source.priceScale(),
            n = e.firstValue();
          if (!o || o.isEmpty() || a.isEmpty() || !r || !l || null === n)
            return;
          const h = (0, i.ensureNotNull)(a.visibleBarsStrictRange()),
            c = h.firstBar(),
            u = h.lastBar();
          for (let e = 0; e < r.length; e++) {
            ...
            (d.P.value() && T(h, r[e].p, 'P'),
              d['S1/R1'].value() && (T(h, r[e].s1, 'S1'), T(h, r[e].r1, 'R1')),
              d['S2/R2'].value() && (T(h, r[e].s2, 'S2'), T(h, r[e].r2, 'R2')),
              d['S3/R3'].value() && (T(h, r[e].s3, 'S3'), T(h, r[e].r3, 'R3')),
              d['S4/R4'].value() && (T(h, r[e].s4, 'S4'), T(h, r[e].r4, 'R4')),
              d['S5/R5'].value() && (T(h, r[e].s5, 'S5'), T(h, r[e].r5, 'R5')));
            const _ = a.indexToCoordinate(t),
              p = a.indexToCoordinate(i);
            for (const t of Object.keys(h)) {
              const s = parseFloat(t),
                i = o.priceToCoordinate(s, n);
              this._pivots.push({
                x1: _,
                x2: p,
                y: i,
          ...
          const d = s.levelsStyle.childs().colors,
            _ = s.levelsStyle.childs().widths,
            p = this._source.visiblePivots();
          for (let e = 0; e < this._pivots.length; e++) {
            const t = this._pivots[e];
            if (!p.has(t.src)) continue;
            const i = {
                color: d.childs()[t.labelIds[0]].value(),
                linewidth: _.childs()[t.labelIds[0]].value(),
                linestyle: w.LINESTYLE_SOLID,
                y: t.y,
                left: t.x1,
                right: t.x2,
              },
              r = new C.HorizontalLineRenderer();
            (r.setData(i),
              r.setHitTest(new x.HitTestResult(x.HitTarget.Regular)),
              this._renderer.append(r),
              s.levelsStyle.childs().showLabels.value() &&
                this._renderer.append(
                  new I(this._cacheProvider, new f.Point(t.x1, t.y), t.label),
                ));
          }
        }
      }
      ...
      class B extends l {
        constructor(e, t, s, i, r, l) {
          ...
          const a = ['P', 'S1/R1', 'S2/R2', 'S3/R3', 'S4/R4', 'S5/R5'],
            o = this.properties().childs().levelsStyle.childs().visibility;
          for (let e = 0; e < a.length; e++)
            o.childs()[a[e]].subscribe(this, () => this.processHibernate());
        }
        pricesView() {
        ...
        getCache(e) {
          if (
            ...
            ((this._cache = new n(s, t.font, t.fontSize, t.backColors)),
        ...
        priceLabelText(e) {
          return (
            this._metaInfo.value().shortDescription + ':' + e.toUpperCase()
          );
        }
        updateAllViews(e) {
          ...
          for (let s = 0; s < r.length; s++) {
            ...
            const o = [],
              n = this.properties()
                ...
                .levelsStyle.childs()
                .visibility.childs();
            (n.P.value() && o.push(r[s].p),
              n['S1/R1'].value() && o.push(r[s].s1, r[s].r1),
              n['S2/R2'].value() && o.push(r[s].s2, r[s].r2),
              n['S3/R3'].value() && o.push(r[s].s3, r[s].r3),
              n['S4/R4'].value() && o.push(r[s].s4, r[s].r4),
              n['S5/R5'].value() && o.push(r[s].s5, r[s].r5));
            for (let e = 0; e < o.length; e++)
              o[e] &&
                (null === a
                  ? (a = new L.PriceRange(o[e], o[e]))
                  : a.apply(o[e], o[e]));
          }
          const o = this.priceScale();
          return o && o.isLog() && a
            ? new L.PriceRange(
                o.priceToLogical(a.minValue()),
                o.priceToLogical(a.maxValue()),
              )
            : a;
        }
        _createViews() {
          ...
          const t = new A(this._model, this);
          this._paneViews.push(t);
          for (let t = 0; t < e.length; t++) {
            const s = new _(this, { name: e[t] });
          ...
          (this._dataWindowView ||
            (this._dataWindowView = new y.StudyDataWindowView(
              this,
              this._model,
            )),
            this._statusView ||
              (this._statusView = new v.StudyStatusView(this)),
            (this._legendView = null),
            (this._pricesView = new g(this)));
        }
    ...
    75848: (e, t, s) => {
      ...
      var i = s(50151),
        ...
        a = s(11485),
        o = s(64717);
      class n extends a.Study {
        constructor(e, t, s, i, r, a) {
          (super(e, t, s, i, r, a),
            (this._underlyingData = new l.PlotList(
              (0, o.studyPlotFunctionMap)(i),
              o.studyEmptyPlotValuePredicate,
            )));
        }
        clearData() {
          ...
          (this._underlyingData.merge(e),
            t !== this._underlyingData.firstIndex() &&
              (this._data = new l.PlotList(
                (0, o.studyPlotFunctionMap)(this._metaInfo.value()),
                o.studyEmptyPlotValuePredicate,
              )));
          let s = null;
          const i = this._data.lastIndex() ?? this._underlyingData.firstIndex(),
            a = this._underlyingData.lastIndex();
          if (null !== i && null !== a)
            for (const e of this._underlyingData.rangeIterator(i, a))
              (null === s && (s = e),
        ...
        _plotsForStrategyProcessing() {
          ...
          return (
            e.plots.forEach((s, r) => {
              if ('dataoffset' !== s.type) return;
              const l = e.plots.findIndex((e) => e.id === s.target);
              ((0, i.assert)(
                l >= 0,
                `target plot not found for strategy plot ${s.id}`,
              ),
                t.push({ strategyIndex: r, targetIndex: l }));
            }),
            t
          );
        }
      ...
      class h {
        ...
        rebuildData(e) {
          ...
          const l = this._startIndex ?? e.firstIndex(),
            a = e.lastIndex();
          if (null !== l && null !== a)
            for (const { index: o, value: n } of e.rangeIterator(l, a)) {
              const l = n[t],
                a = n[s] ? Math.round(n[s]) : null;
              if (((n[t] = null), (n[s] = null), !a || a > 0)) continue;
              const h = o + a,
    ...
    10635: (e, t, s) => {
      (s.r(t),
        s.d(t, {
          ...
          VolumeProfileStudyWithThemedColors: () => _,
          VolumeProfileWithPriceRangeStudy: () => p,
        }));
      var i = s(50151),
        r = s(22613),
        l = s(24062);
      var a = s(36281),
        o = s(52859);
      class n extends a.PriceAxisView {
        constructor(e, t) {
        ...
        _updateRendererData(e, t, s) {
          ...
          const u = (0, o.resetTransparency)(l.color.value());
          ((s.background = u),
      ...
      class d extends h.Study {
        ...
        async _createGraphicsPaneViews() {
          ...
          if (e.hhists) {
            const { HHistPaneView: e } = await s.e(507).then(s.bind(s, 70588)),
              l = this.properties()
                .childs()
                .graphics.childs()
                .polygons?.childs();
      ...
      class p extends _ {
        priceRange(e, t, s) {
          ...
          const o = (0, i.ensureNotNull)(this.priceScale());
          return o.isLog()
            ? new l.PriceRange(
                o.priceToLogical(a.minValue()),
                o.priceToLogical(a.maxValue()),
    ...
    85082: (e, t, s) => {
      s.d(t, { volumeProfileThemedColors: () => _ });
      var i = s(49156);
      const {
          colorColdGray200: r,
          colorColdGray900: l,
          colorBerryPink400Alpha50: a,
          colorBerryPink400Alpha75: o,
    ...
    51106: (e, t, s) => {
      ...
      class l extends i.Study {
        ...
        chartFloatingTooltipView() {
          return this._model.paneForSource(this) === this._model.mainPane()
            ? null
            : super.chartFloatingTooltipView();
        }
        _titleInParts(e, t, s, i, r, l) {
          const a = super._titleInParts(e, t, s, i, r),
    ...
    34771: (e, t, s) => {
      ...
      var i = s(50151),
        ...
        R = s(52945),
        T = s(52859);
      const A = v.enabled('force_exchange_as_title');
      class L extends V.PriceAxisView {
        constructor(e) {
        ...
        _updateRendererData(e, t, s) {
          ...
          if (null === a) return;
          if (!l.isPriceScaleVisible(a)) return;
          const o = l.timeScale().visibleBarsStrictRange(),
            n = l.mainSeries().bars().lastIndex();
          if (null === o || null === n) return;
          if (n <= o.lastBar())
            ((s.background = (0, T.resetTransparency)(r.color)),
              (s.textColor = this.generateTextColor(r.color)),
              (e.borderVisible = !1),
              (t.borderVisible = !1));
          else {
            const a = l.backgroundColorAtYPercentFromTop(
              r.coordinate /
                (0, i.ensureNotNull)(l.paneForSource(this._source)).height(),
            );
            ((s.background = a),
              (s.textColor = (0, T.resetTransparency)(r.color)),
          ...
          (h.showSeriesLastValue.value() &&
            ((e.text = (0, R.getCurrentModePriceText)(a, r)),
            h.seriesLastValueMode.value() !==
            I.PriceAxisLastValueMode.LastPriceAndPercentageValue
              ? (e.secondLine = '')
              : (e.secondLine = (0, R.getOppositeModePriceText)(a, r)),
            (e.visible = !0)),
            (t.text = ''),
        ...
        _paneText() {
          let e = '';
          const t = this._source.aliasSymbolInfo();
          return (
            A
              ? (e = (0, d.displayedSymbolExchange)(t))
              : this._source
                  .model()
                  .properties()
                  .childs()
                ...
                (e = (0, d.displayedSymbolName)(t)),
            e
          );
        }
      }
      var B = s(30693);
      class k extends B.PriceLineAxisView {
        constructor(e) {
          (super(), (this._study = e));
        }
        _value() {
      ...
      class N {
        constructor(e) {
          ((this._lineRenderer = new F.HorizontalLineRenderer()),
            (this._visible = !1),
            (this._source = e));
        }
        update() {
      ...
      var E = s(11946),
        ...
        Q = s(53660);
      const Y =
          G.lastDayChangeAvailable || G.alwaysShowLastPriceAndLastDayChange,
        K = a.CheckMobile.any(),
        Z = (0, z.getPercentageFormatter)();
      var J;
      !(function (e) {
        ((e[(e.Open = 0)] = 'Open'),
          (e[(e.High = 1)] = 'High'),
      ...
      const X = Q.notAvailable,
        ee = `${X} (${X}%)`;
      class te {
        constructor(e, t, i = !0) {
          ((this._study = e),
            (this._model = t),
            (this._searchNearestLeftValue = i),
            (this._emptyValues = [
              {
                title: W.t(null, void 0, s(16610)),
                visible: !1,
                value: '',
                index: 0,
                orderIndex: 0,
              ...
              {
                title: W.t(null, { context: 'input' }, s(51408)),
                visible: !1,
                value: '',
                index: 3,
                orderIndex: 3,
        ...
        getValues(e) {
          ...
          const r = this._searchNearestLeftValue
              ? f.PlotRowSearchMode.NearestLeft
              : f.PlotRowSearchMode.Exact,
            l = s.search(i, r, 1);
          if (null === l) return t;
          const a = this._showLastPriceAndChangeOnly();
          if (
            ((0, H.isNumber)(e) ||
              (a
                ? (e = i)
          ...
          const h = o.index,
            ...
            _ = c[3],
            p = c[4];
          for (const e of t) e.visible = !a;
          const y = t[4];
          y.visible = !1;
          const { barChange: v, lastDayChange: m } = (0, $.changesData)(
              s,
              this._study.quotes(),
              o.value,
              o.index,
            ...
            b = (0, j.getPriceValueFormatterForSource)(this._study);
          if (
            (0, j.shouldBeFormattedAsPercent)(this._study) ||
            (0, j.shouldBeFormattedAsIndexedTo100)(this._study)
          )
            ((t[7].value = ''), (t[6].value = ''));
          else {
            const e = this._study.formatter(),
              s = { signPositive: !0 };
            if (void 0 !== v) {
              const { currentPrice: i, prevPrice: r, change: l } = v,
                a = e.formatChange?.(i, r, s) ?? e.format(l, s);
              t[6].value = (0, U.forceLTRStr)(
                `${a} (${Z.format(v.percentChange, s)})`,
              );
            }
            if (void 0 !== m) {
              const {
              ...
              t[7].value = (0, U.forceLTRStr)(`${o} (${Z.format(a, s)})`);
            }
          }
          let S = null;
          if (a)
            ((t[5].value = null == p ? X : b(p)),
              (t[5].visible = !0),
              (S = this._getChangeColor(v?.change)),
              (t[6].visible = void 0 !== v),
              (t[7].visible = void 0 !== m || Y));
          else {
            ((t[0].value = null == u ? X : b(u)),
              (t[1].value = null == d ? X : b(d)),
              (t[2].value = null == _ ? X : b(_)),
              (t[3].value = null == p ? X : b(p)),
              (y.value = b(this._study.barFunction()(c))),
              (t[5].visible = !1));
            const e = this._model.mainSeries().intervalObj().value().is1Tick(),
            ...
            ((t[0].visible = !e && s),
              ...
              (t[7].visible = void 0 !== m || Y),
              (t[6].visible = void 0 !== v));
            const i = this._study.barColorer().barStyle(h, !1),
              r = i.barBorderColor ?? i.barColor;
            S = (0, $.calculateColor)(n, r);
          }
          S = (0, T.resetTransparency)((0, $.calculateColor)(n, S));
          for (const e of t) e.color || (e.color = S);
          return (
            t[7].visible &&
              (t[7].color = (0, T.resetTransparency)(
                (0, $.calculateColor)(n, this._getChangeColor(m?.change)),
              )),
            t
          );
        }
        _mobileNonTrackingMode() {
          return (
            ...
            (null === this._model.crosshairSource().pane ||
              (0, E.isLineToolName)(M.tool.value()) ||
              null !== this._model.lineBeingEdited())
          );
        }
        _showLastPriceAndChangeOnly() {
          return (
            G.alwaysShowLastPriceAndLastDayChange ||
        ...
        _getChangeColor(e) {
          const t =
            void 0 === e || e >= 0
              ? q.SeriesBarColorer.upColor(this._study.properties())
              : q.SeriesBarColorer.downColor(this._study.properties());
          return t.barBorderColor ?? t.barColor;
        }
      }
      var se = s(13212);
      const ie = a.CheckMobile.any();
      class re extends se.StudyDataWindowView {
        _updateImpl() {
          this._header = this._study.title(O.TitleDisplayTarget.DataWindow);
          let e;
          this._showLastPriceAndChangeOnly()
            ...
            : ((e = this._model.crosshairSource().appliedIndex()),
              (null === e || isNaN(e)) &&
                ((e = this._study.data().lastIndex()),
                v.enabled('use_last_visible_bar_value_in_legend') &&
                  (e =
                    this._model
                      .timeScale()
      ...
      class ae extends te {
        constructor(e, t) {
          ...
          ((this._showBarChangeProp = s.showBarChange),
            (this._showLastDayChangeProp = s.showLastDayChange),
            (this._showSeriesOHLCProp = s.showSeriesOHLC));
        }
        getValues(e) {
          const t = super.getValues(e),
            ...
            i = s.style.value(),
            r = 12 !== i,
            l = this._showSeriesOHLC(),
            a = r && this._showBarChangeProp.value(),
            o = r && this._showLastDayChangeProp.value();
          if (this._showLastPriceAndChangeOnly())
            return ((t[6].visible &&= a), (t[7].visible = !1), t);
          const n = (0, d.isPriceSourceStyle)(i),
            h = 12 !== i && 16 !== i && 21 !== i,
            c = 12 !== i,
            u = this._model.mainSeries().intervalObj().value().is1Tick(),
            _ = l && !n,
            p = l && n;
          if (
            ((t[0].visible = _ && h && !u),
        ...
        constructor(e, t) {
          (super(e, t),
            ...
            this._backgroundColorSpawn.subscribe(
              this.update.bind(this, (0, le.sourceChangeEvent)(e.id())),
            ));
          const s = t
            .properties()
            .childs()
      ...
      var he = s(69555),
        ...
        Se = s(54370),
        ge = s(12965);
      class fe extends ge.StudyStatusProvider {
        getSplitTitle() {
          return this._source.titleInParts(
            O.TitleDisplayTarget.StatusLine,
            !0,
            void 0,
            !1,
            !1,
        ...
        text() {
          return this._source.isActualInterval()
            ? this._source.isFailed()
              ? `${this._source.title(O.TitleDisplayTarget.StatusLine, !0, void 0, !1, !1)}: ${this.sourceStatusText()}`
              : `${this._source.title(O.TitleDisplayTarget.StatusLine, !0, void 0, !1, !1)} ${this.sourceStatusText()}`
            : this._source.title(
                O.TitleDisplayTarget.StatusLine,
                !0,
      ...
      class Ie {
        constructor(e, t) {
          ((this._study = e),
            (this._model = t),
            (this._valuesProvider = new te(e, t, !1)));
        }
        getItems() {
          const e = this._valuesProvider.getItems(),
            t = this._study.style();
          return (
            (0, Ve.fillSymbolSourceValuesProviderItemsVisibility)(
              e,
              this._study.priceSource(),
              t,
              this._model,
            ),
            (e[7].visible = !1),
        ...
        getValues(e) {
          const t = this._study.data().lastIndex(),
            s = this._study.data().firstIndex();
          return null === t || null === s || e > t || e < s
            ? null
            : this._valuesProvider.getValues(e);
        }
      }
      var Re = s(48943);
      const Te =
          v.enabled('show_symbol_logos') &&
          v.enabled('show_symbol_logo_in_legend') &&
          v.enabled('show_symbol_logo_for_compare_studies'),
        Ae = v.enabled('legend_last_day_change'),
        Le = (a.CheckMobile.any() || Te || Ae) && !1,
        Be = v.enabled('study_overlay_compare_legend_option'),
        ke = v.enabled('secondary_series_extend_time_scale'),
        De = v.enabled('hide_unresolved_symbols_in_legend'),
        Fe = !v.enabled('hide_study_overlay_legend_item'),
        Ne = v.enabled('symbol_info_price_source'),
        Ee = (0, o.getLogger)('Chart.StudyOverlay');
      var Me;
      function Oe(e, t) {
        return null == e[t];
      }
      ...
      class He extends n.Study {
        constructor(e, t, s, i, r, a) {
          (super(
            ...
            (this._isActingAsSymbolSource = new l.WatchedValue(!0)),
            (this._realignToolsLastParams = null),
            (this._precomputedBarStyles = new WeakMap()),
            (this._lastResolvedSymbolSource = ''),
            (this._data = new g.PlotList((0, u.seriesPlotFunctionMap)(), Oe)),
            (this._quotesProvider = new m.QuotesProvider(
              void 0,
          ...
          (o.currencyId.subscribe(this, this._onCurrencyChanged),
            o.unitId.subscribe(this, this._onUnitChanged),
            o.allowExtendTimeScale.subscribe(
              this,
              this._onAllowExtendTimeScaleChanged,
            ),
            this._onAllowExtendTimeScaleChanged(),
            o.style.subscribe(this, this._onChartStyleChanged),
            o.lineStyle
              .childs()
              .priceSource.subscribe(this, this._updateBarFunction),
            o.lineWithMarkersStyle
              .childs()
              .priceSource.subscribe(this, this._updateBarFunction),
            o.steplineStyle
              .childs()
            ...
            o.minTick.subscribe(this, this._onMinTickChanged),
            ...
            (this._symbolInfoWV = (0, oe.createWVFromGetterAndSubscriptions)(
              () => this.symbolInfo(),
              [this.symbolResolved(), this.onStatusChanged()],
            )),
            (this._aliasSymbolInfoWV || this._symbolInfoWV).subscribe(() =>
              this._recreatePriceFormattingDependencies(),
            ),
            (this._overlayValuesProvider = new te(this, e)),
            (this._overlayLegendValuesProvider = new ae(this, e)),
            (this._overlayTableViewValuesProvider = new Ie(this, e)),
            (this._overlayChartFloatingTooltipValuesProvider = new Ce(this, e)),
            (this._symbolSourceWV = (0, Re.combine)(
              (e) => (e ? this : super.symbolSource()),
              this._isActingAsSymbolSource.weakReference(),
            )));
        }
        destroy() {
          (this._model.mainSeries().onIntervalChanged().unsubscribeAll(this),
            this._quotesProvider.destroy(),
            this._symbolInfoWV.destroy(),
            this._symbolSourceWV.destroy(),
            this._aliasSymbolInfoWV?.release(),
            super.destroy());
        }
        ...
        barColorer() {
          return new q.SeriesBarColorer({
            data: () => this.data(),
            bars: () => this.data(),
            nsBars: () => new g.PlotList(),
        ...
        symbolParams() {
          return (0, b.symbolParams)(this);
        }
        compareSymbolParams(e) {
          return (0, b.compareSymbolParams)(
            this,
            e,
        ...
        aliasSymbolInfo() {
          return (
            this._aliasSymbolInfoWV ??
            this._symbolInfoWV ??
            new l.WatchedValue(null)
          ).value();
        }
        ...
        symbolSameAsCurrent(e) {
          return (0, b.symbolSameAsCurrent)(e, this.symbolInfo());
        }
        symbolSameAsResolved(e) {
          return (0, S.symbolSameAsResolved)(
            e,
            this._lastResolvedSymbolSource,
            this.symbol(),
          );
        ...
        isConvertedToOtherUnit() {
          return (0, d.isConvertedToOtherUnit)(
            this.symbolInfo(),
            this._model.unitConversionEnabled(),
          );
        }
        ...
        state(e, t) {
          ...
          const r = this.symbol();
          return (
            (s.state.inputs.symbol = (0, d.symbolToSaveInState)(
              this.symbolInfo() ??
        ...
        title(e, t, s, i, r) {
          ...
          return [l[0], ...(l[1] ?? [])].join(` ${d.symbolTitleSeparator} `);
        }
        ...
        firstValue() {
          ...
          const s = this.data().search(t, f.PlotRowSearchMode.NearestRight, 1);
          return (
            (this._ownFirstValue =
        ...
        lastValueData(e, t, s) {
          ...
          const n = this.nearestIndex(
            a.lastBar(),
            f.PlotRowSearchMode.NearestLeft,
            1,
          );
          if (void 0 === n) return i;
          const h = this.firstValue();
          if (null === h) return i;
          const c = this._lastNonEmptyPlotRow(4),
            u = null !== c && a.contains(c.index),
            d = null !== c ? c.value : null,
            _ = t || u ? d : this.data().valueAt(n);
          if (null === _) return i;
          const p = this._barFunction(_, 2);
          if (!(0, r.isNumber)(p)) return i;
          const y = l.priceToCoordinate(p, h);
          let v;
          switch (o.style.value()) {
            ...
            case 13:
              ...
              break;
            case 2:
              v = o.lineStyle.childs().color.value();
              break;
            case 14:
              v = o.lineWithMarkersStyle.childs().color.value();
              break;
            case 15:
              v = o.steplineStyle.childs().color.value();
              break;
            case 3:
              v = o.areaStyle.childs().linecolor.value();
              break;
            case 16:
              v = o.hlcAreaStyle.childs().closeLineColor.value();
              break;
            case 10: {
            ...
            case 12:
              v = o.hiloStyle.childs().color.value();
              break;
            case 21:
              v = o.hlcBarsStyle.childs().color.value();
              break;
            default:
              throw new Error('Not supported overlay style');
          }
          const m = {
            ...l.getFormattedValues(p, h, !0),
            noData: !1,
            floatCoordinate: y,
            coordinate: y,
            color: v,
          };
          return (s && (m.price = p), m);
        }
        priceRange(e, t, s) {
          if (s.forceOverlayOnly) return null;
          if (!(0, r.isInteger)(e))
            return (Ee.logDebug('priceRange: incorrect startBar'), null);
          if (!(0, r.isInteger)(t))
            return (Ee.logDebug('priceRange: incorrect endBar'), null);
          ...
          const a = null !== l ? new w.PriceRange(l.min, l.max) : null;
          return this._postProcessPriceRange(a, s);
        }
        bars() {
          return this.data();
        }
          ...
          return (
            ...
            Le &&
              this._setQuotesSymbol(
                (0, y.encodeExtendedSymbolOrGetSimpleSymbolString)(
        ...
        statusView() {
          return Fe ? super.statusView() : null;
        }
        moveItem(e, t, s) {
          if (10 === this.style() && 0 === t) {
            const t = (0, i.ensureNotNull)(this.priceScale()),
              ...
              r = t.height(),
              l = 100 - (e.y / r) * 100,
              a = l < 0 ? 0 : Math.round(10 * l) / 10;
            s.childs().baseLevelPercentage.setValue(
              Math.max(Math.min(a, 100), 0),
            );
          }
        }
        measureUnitId() {
        ...
        alertCreationAvailable() {
          return new l.WatchedValue(
            !this.priceScale()?.isPercentage() &&
              super.alertCreationAvailable().value(),
          ).readonly();
        }
        legendValuesProvider() {
          return this._overlayLegendValuesProvider;
        }
        tableViewValuesProvider() {
          return this._overlayTableViewValuesProvider;
        }
        valuesProvider() {
          return this._overlayValuesProvider;
        }
        chartFloatingTooltipValuesProvider() {
          return this._overlayChartFloatingTooltipValuesProvider;
        }
        ...
        _tryCreateFormatter() {
          const e =
            P.customFormatters?.priceFormatterFactory?.(
              this.symbolInfo(),
              this.properties().childs().minTick.value(),
            ) ?? null;
          return null !== e
            ? e
            : (0, d.createSeriesFormatter)(
                this.aliasSymbolInfo(),
                this.properties().childs().minTick.value(),
              );
        }
        _tryCreateDefaultFormatter() {
          return (0, d.createSeriesFormatter)(
            this.aliasSymbolInfo(),
            'default',
          );
        }
        _onUnitChanged() {
          ('alwaysOff' !== (0, c.currencyUnitVisibilityProperty)().value() &&
        ...
        _onSymbolResolved(e, t, s) {
          ...
          const i =
              t === this.symbol()
                ? (0, _.extractSymbolNameFromSymbolInfo)(s, this.symbol())
                : null,
            r = (0, d.symbolCurrency)(s),
            l = (0, d.symbolUnit)(s, this._model.unitConversionEnabled());
        ...
        _setQuotesSymbol(e) {
          const t = this.symbolInfo(),
            s = (0, _.extractSymbolNameFromSymbolInfo)(t, e);
        ...
        _onQuotesUpdate(e, t) {
          !this._legendView ||
            ...
            (this._legendView.update((0, le.sourceChangeEvent)(this.id())),
        ...
        _createViews() {
          ...
          switch (this.properties().childs().style.value()) {
            case 0:
              r = new ce.SeriesBarsPaneView(this, this._model);
              break;
            case 1:
              r = new ue.SeriesCandlesPaneView(this, this._model);
              break;
            case 9:
              r = new ve.SeriesHollowCandlesPaneView(this, this._model);
              break;
            case 13:
              r = new me.SeriesColumnsPaneView(this, this._model);
              break;
            case 2:
            case 14:
            case 15:
              r = new de.SeriesLinePaneView(this, this._model);
              break;
            case 3:
              r = new _e.SeriesAreaPaneView(this, this._model);
              break;
            case 16:
              r = new pe.SeriesHLCAreaPaneView(this, this._model);
              break;
            case 10: {
              r = new ye.SeriesBaselinePaneView(this, this._model);
              const e = this.properties().childs().baselineStyle.childs();
              s = new x.SeriesWaterlinePaneView({
                paneHeight: () =>
            ...
            case 12:
              r = new be.SeriesHiLoPaneView(this, this._model);
              break;
            case 21:
              r = new xe.SeriesHLCBarsPaneView(this, this._model);
          }
          (r && this._paneViews.push(r),
            null !== s && this._paneViews.push(s),
            this._paneViews.push(new N(this)),
            this._dataWindowView ||
              (this._dataWindowView = new re(this, this._model)),
            this._legendView || (this._legendView = new ne(this, this._model)),
            this._statusView ||
              (this._statusView = new C.StudyStatusView(this)),
            this._floatingTooltipView ||
              (this._floatingTooltipView = new Pe.StudyChartFloatingTooltipView(
                this,
                this._model,
              )),
            (this._priceAxisViews = [...this._priceAxisViewsBase]),
            this._labelPaneViews.push(
              new he.PanePriceAxisView(e, this, this._model),
            ));
        }
        ...
        _getSymbolTitlePart(e) {
          if (null === e)
            return De
              ? ''
              : ((e) =>
                  this._model.symbolAliasService()?.getAliasByProName(e)
                    ?.aliasName ?? e)(
                  this.properties().childs().inputs.childs().symbol.value(),
                );
          const t =
            this._model.symbolAliasService()?.getAliasByProName(e.pro_name)
              ?.aliasName ?? e.name;
          if (Be)
            switch (
        ...
        _getExchangeTitlePart(e, t) {
          return null === e || t ? null : (0, d.getSymbolListedExchange)(e);
        }
        ...
        _setSymbolParamsInternal(e, t) {
          const { symbol: s, currency: i, unit: r, style: l } = e,
            ...
            o = a.inputs.childs().symbol.value(),
            n = a.currencyId.value(),
            h = a.unitId.value(),
            c = a.style.value();
          if (
            (void 0 !== s && a.inputs.childs().symbol.setValueSilently(s),
            void 0 !== i && a.currencyId.setValueSilently(i),
            void 0 !== r && a.unitId.setValueSilently(r),
            void 0 !== l && a.style.setValueSilently(l),
            t)
          )
            ...
            null !== e &&
              (a.currencyId.setValueSilently((0, d.symbolCurrency)(e)),
              a.unitId.setValueSilently(
                (0, d.symbolUnit)(e, this._model.unitConversionEnabled()),
              ));
          }
          (a.inputs.childs().symbol.value() !== o &&
            a.inputs.childs().symbol.fireChanged(),
            a.currencyId.value() !== n && a.currencyId.fireChanged(),
            a.unitId.value() !== h && a.unitId.fireChanged(),
            a.style.value() !== c && a.style.fireChanged(),
            this._checkStyle(),
            this._realignLineToolsIfParamsChanged());
        }
        _updateBarFunction() {
          this._barFunction = (0, h.barFunctionByStyle)(
            this.style(),
            this.priceSource(),
          );
        }
        ...
        _checkStyle() {
          const e = this.style();
          (0, d.isCloseBasedSymbol)(this.symbolInfo()) ||
          this.model().mainSeries().intervalObj().value().is1Tick()
            ? (0, d.isSingleValueBasedStyle)(e) ||
              (this.setStyle(2),
