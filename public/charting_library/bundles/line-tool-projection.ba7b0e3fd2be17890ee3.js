...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3945],
  {
    40226: (e, t, i) => {
        ...
        return (
          i.prefixes.forEach((n) => {
            ...
            for (let n = i.range[0]; n <= i.range[1]; n++)
              if (e[s + n] && (0, o.isSameType)(e[s + n], t.typecheck())) {
                let o = t.tpl();
                (i.names.forEach((i, r) => {
                  o = t.fill('' + r, i, e[s + n], o);
                }),
                  (e[s + n] = o));
              }
          }),
      ...
      class g extends r.DefaultProperty {
        constructor(e) {
          const { levelsIterator: t = _, map: i = {}, ...n } = e,
            s = { ...l, ...i };
          (n.state && (n.state = p(n.state, s, t)),
            super(n),
            (this._map = s),
      ...
      class a extends o.InplaceTextLineDataSource {
            ...
            try {
              if (((this._recursiveGuard = !0), 2 === e)) {
                ...
                const i = (0, n.ensureNotNull)(
                  ...
                  .length();
                let o = t.subtract(e);
                (o.length() <= 0 && (o = new s.Point(1, 0)),
                  (t = e.add(o.normalized().scaled(i))));
                const r = (0, n.ensureNotNull)(this.screenPointToPoint(t)),
                ...
                let r = i.subtract(e);
                (r.length() <= 0 && (r = new s.Point(1, 0)),
                  (i = e.add(r.normalized().scaled(o))));
                const a = (0, n.ensureNotNull)(this.screenPointToPoint(i)),
        ...
        addPoint(e) {
          if (2 === this._points.length) {
            ...
            let s = (0, n.ensureNotNull)(this.pointToScreenPoint(e));
            const o = i.subtract(t).length(),
              r = s.subtract(t).normalized();
            s = t.add(r.scaled(o));
            const a = (0, n.ensureNotNull)(this.ownerSource()),
              l = (0, n.ensureNotNull)(a.firstValue()),
              c = (0, n.ensureNotNull)(this.priceScale()).coordinateToPrice(
                s.y,
                l,
              );
            e = {
              index: Math.round(this._model.timeScale().coordinateToIndex(s.x)),
              price: c,
            };
          }
    ...
    63117: (e, t, i) => {
      ...
      class P extends _.LineDataSource {
        ...
        editableTextStyle() {
          return { ...(this._isDarkBackground.value() ? m : x) };
        }
    ...
    11437: (e, t, i) => {
      ...
      class a extends s.LineToolFibWedgeBase {
        constructor(e, t, n, s) {
          (super(
            e,
