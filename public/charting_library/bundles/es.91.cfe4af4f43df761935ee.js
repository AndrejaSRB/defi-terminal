(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [91],
  {
    ...
    1495: (s) => {
      s.exports = { en: ['All data'], es: ['Todos los datos'] };
    },
    19273: (s) => {
      s.exports = { en: ['Year to day'], es: ['Año hasta la fecha'] };
    },
    58426: (s) => {
      s.exports = {
    ...
    67092: (s) => {
      s.exports = { en: ['Fullscreen mode'], es: ['Modo pantalla completa'] };
    },
    61206: (s) => {
      s.exports = { en: ['Maximize chart'], es: ['Maximizar gráfico'] };
    },
    2031: (s) => {
      s.exports = {
    ...
    27665: (s) => {
      s.exports = { en: ['Sessions'], es: ['Sesiones'] };
    },
    31142: (s) => {
      s.exports = { en: ['Restore chart'], es: ['Restaurar gráfico'] };
    },
    41888: (s) => {
      s.exports = {
    ...
    81649: (s) => {
      s.exports = { en: ['Toggle Percentage'], es: ['Alternar porcentaje'] };
    },
    77073: (s) => {
      s.exports = { en: ['Timezone'], es: ['Zona horaria'] };
    },
    49545: (s) => {
      s.exports = {
