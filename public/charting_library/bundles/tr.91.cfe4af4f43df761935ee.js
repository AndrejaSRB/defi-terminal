(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    22233: (r) => {
      r.exports = { en: ['auto'], tr: ['otomatik'] };
    },
    4161: (r) => {
      r.exports = { en: ['log'] };
    },
    1495: (r) => {
      r.exports = { en: ['All data'], tr: ['Tüm veri'] };
    },
    19273: (r) => {
      r.exports = { en: ['Year to day'], tr: ['Güncel yıl'] };
    },
    58426: (r) => {
      r.exports = {
    ...
    42432: (r) => {
      r.exports = { en: ['Go to'], tr: ['Tarihe git'] };
    },
    92966: (r) => {
      r.exports = {
    ...
    67092: (r) => {
      r.exports = { en: ['Fullscreen mode'], tr: ['Tam ekran modu'] };
    },
    61206: (r) => {
      r.exports = { en: ['Maximize chart'], tr: ['Grafiği genişlet'] };
    },
    2031: (r) => {
      r.exports = {
    ...
    27665: (r) => {
      r.exports = { en: ['Sessions'], tr: ['Oturum'] };
    },
    31142: (r) => {
      r.exports = { en: ['Restore chart'], tr: ['Grafiği geri yükle'] };
    },
    41888: (r) => {
      r.exports = {
    ...
    81649: (r) => {
      r.exports = { en: ['Toggle Percentage'], tr: ['Yüzde Olarak Değiştir'] };
    },
    77073: (r) => {
      r.exports = { en: ['Timezone'], tr: ['Zaman dilimi'] };
    },
    49545: (r) => {
      r.exports = {
