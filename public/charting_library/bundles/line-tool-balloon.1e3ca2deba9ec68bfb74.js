  ...
  [1277],
  {
    63117: (e, t, i) => {
      ...
      var n = i(50279),
        ...
        p = i(13896);
      const x = {
          selectionColor: (0, s.getHexColorByName)('color-tv-blue-500'),
          cursorColor: (0, s.getHexColorByName)('color-black'),
        },
        P = {
          selectionColor: (0, s.getHexColorByName)('color-white'),
          cursorColor: (0, s.getHexColorByName)('color-white'),
        };
      var T;
      !(function (e) {
      ...
      class S extends _.LineDataSource {
        ...
        async _openTextEditor(e, t, n, s, a) {
    ...
    54707: (e, t, i) => {
      ...
      function g(e, t) {
        ...
        return (
          ...
          r >= _.deg337_5 ||
          r < _.deg22_5 ||
          (r >= _.deg157_5 && r < _.deg202_5)
            ? d.PaneCursorType.HorizontalResize
            : (r >= _.deg22_5 && r < _.deg67_5) ||
                (r >= _.deg202_5 && r < _.deg247_5)
              ? d.PaneCursorType.DiagonalNwSeResize
              : (r >= _.deg67_5 && r < _.deg112_5) ||
                  (r >= _.deg247_5 && r < _.deg292_5)
                ? d.PaneCursorType.VerticalResize
                : (r >= _.deg112_5 && r < _.deg157_5) ||
                    (r >= _.deg292_5 && r < _.deg337_5)
    ...
    73914: (e, t, i) => {
      i.d(t, {
        ...
        lineSourcePaneViewPointToLineAnchorPoint2: () => w,
      ...
      class P extends h.BitmapCoordinatesPaneRenderer {
        constructor(e) {
        ...
        _drawImpl(e) {
          ...
          (t.length && this._drawPoints(e, t, i, g, _),
            n.length && this._drawPoints(e, n, o, x, p));
        }
              ...
              if (
                (o(
                  l,
                  {
                    ...r,
                    point: new n.Point(
                      Math.round(r.point.x * d) + x,
                      Math.round(r.point.y * c) + x,
                    ),
                  },
                  p / 2,
                  _,
      ...
      function T(e, t = e.pointIndex, i, n, o, r, s, a, l, d) {
        return {
          point: e,
          pointIndex: t,
          cursorType: i,
