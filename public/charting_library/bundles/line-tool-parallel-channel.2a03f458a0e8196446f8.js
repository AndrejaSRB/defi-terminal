...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2050],
  {
    ...
    31191: (e, t, i) => {
      (i.r(t),
        i.d(t, { Constants: () => s, LineToolParallelChannel: () => p }));
      var s,
        n = i(50151),
        o = i(10555),
        r = i(87465),
      ...
      class p extends l.LineDataSource {
        constructor(e, t, s, n) {
          (super(
            ...
            (this.version = 2),
            (this._priceOffsetProperty = new c(this)),
        ...
        setPoint(e, t, i, s) {
          ...
          switch (e) {
            ...
            case 2:
              (super._setPoint(e, { ...t, interval: p }),
                (this._points[0].price = h.coordinateToPrice(l.y - a, c)),
                (this._points[0].index = t.index),
                (this._points[0].interval = p));
              break;
            case 3:
              ((this._points[1].price = h.coordinateToPrice(l.y - a, c)),
            ...
            case 4: {
              const e = r.subtract(o),
                ...
                i = o.addScaled(e, t),
                s = l.y - i.y;
              this._points[2].price = h.coordinateToPrice(o.y + s, c);
              break;
            }
            case 5: {
              const e = r.subtract(o),
                ...
                i = o.addScaled(e, t),
                s = l.y - i.y;
              ((this._points[0].price = h.coordinateToPrice(o.y + s, c)),
                (this._points[1].price = h.coordinateToPrice(r.y + s, c)));
              break;
            }
            case 6:
        ...
        restoreData(e) {
          void 0 !== e.priceOffset &&
            (this._pendingPriceOffset = e.priceOffset);
        }
        getPoint(e) {
        ...
        template() {
          ...
          return (
            (e.labelText = this.properties().childs().labelText.value()),
            e
          );
        }
        hasStateForAlert() {
        ...
        static createProperties(e, t) {
          const i = h.LineToolParallelChannelPropertiesImpl.create(e, t);
        ...
        _getAlertPlots() {
          ...
          const h = this.properties().childs().extendLeft.value(),
            c = this.properties().childs().extendRight.value();
          return (
            t[0].index <= t[1].index ? ((l = h), (a = c)) : ((l = c), (a = h)),
            [
        ...
        _correctLastPoint(e) {
          ...
          const t = (0, n.ensureNotNull)(this.pointToScreenPoint(e)),
            ...
            a = s.addScaled(r, l),
            h = t.y - a.y,
            c = s.add(new o.Point(0, h));
          return (0, n.ensureNotNull)(this.screenPointToPoint(c));
        }
        ...
        _applyPendingPriceOffset() {
          ...
          const s = e + this._points[0].price,
            ...
            h = t.priceToCoordinate(l, i) - a,
            c = t.priceToCoordinate(this._points[0].price, i) + h,
            p = t.coordinateToPrice(c, i);
    ...
    70495: (e, t, i) => {
      i.d(t, {
        LineToolParallelChannelPropertiesImpl: () => A,
        coeffs: () => g,
      });
      var s = i(90054),
        n = i(16738),
      ...
      const T = {
        ...
        transparency: 80,
        labelVisible: !1,
        labelHorzAlign: h.HorizontalAlign.Left,
        labelVertAlign: h.VerticalAlign.Bottom,
        labelFontSize: 14,
        labelBold: !1,
        labelItalic: !1,
        version: 2,
      ...
      const m = {
        ...
        x = [...b, ...S, 'labelText'],
        C = [...b, ...S, ...c.commonLineToolPropertiesStateKeys, 'labelText'];
      function w(e) {
        const {
          linecolor: t,
          linestyle: i,
      ...
      class A extends d.LineDataSourceProperty {
        constructor(e) {
          (1 === (e.state && 'version' in e.state ? e.state.version : 1) &&
            ...
            this.addChild(
              'textsColors',
              new f.LineToolColorsProperty([
                (0, o.ensureDefined)(this.child('labelTextColor')),
              ]),
            ));
        }
        applyTemplate(e) {
          (1 === ('version' in e ? e.version : 1) &&
            ((e = w(e)), (e = (0, u.extractState)(e, this._templateKeys))),
        ...
        _userSettings() {
          ...
          return (
            1 === (e && 'version' in e ? e.version : 1) && (e = w(e)),
            (0, u.extractState)(
              (0, s.default)(e),
