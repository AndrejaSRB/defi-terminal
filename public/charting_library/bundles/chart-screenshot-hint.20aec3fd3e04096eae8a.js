  ...
  [92],
  {
    ...
    53177: (e, t, n) => {
      ...
      const w = r.forwardRef((e, t) =>
        r.createElement(i.NavButton, { ...e, ref: t, icon: p(e.size) }),
      );
    },
    64388: (e, t, n) => {
      'use strict';
      ...
      function u(e) {
        ...
        return r.createElement(
          r.Fragment,
          null,
          r.createElement('span', { className: l().background }),
      ...
      const d = (0, r.forwardRef)((e, t) => {
        ...
        return r.createElement(
          'button',
          { ...d, className: c({ ...e, children: l }), ref: t, type: i },
      ...
      var m = n(21593),
        h = n(53017);
      (0, r.forwardRef)((e, t) => {
        const { icon: n, renderComponent: i, 'aria-label': a, ...o } = e,
          s = i ?? m.CustomComponentDefaultLink;
        return r.createElement(
          s,
          {
            ...o,
    ...
    1524: (e, t, n) => {
      'use strict';
      (n.r(t), n.d(t, { ChartScreenshotHintRenderer: () => k }));
      var r,
        i,
        a = n(50959),
        o = n(32227),
      ...
      (!(function (e) {
        ...
        (function (e) {
          ((e.Inline = 'inline'), (e.NewLine = 'new-line'));
        })(i || (i = {})));
      const b = { danger: g(), warning: g(), success: v(), default: w() };
      function y(e) {
        const {
          informerIntent: t,
          content: n,
              ...
              a.createElement(
                ...
                o &&
                  a.createElement(u.Icon, {
                    className: c()(C().icon, f && C()['light-icon']),
                    icon: l ?? b[t],
                  }),
                a.createElement(
                  'div',
                    ...
                    a.createElement(
                      'span',
                      {
                        className: c()(
                          f && C()['light-title'],
                          C().header,
                          C()[`header-${f ? 'new-line' : p}`],
                        ),
                      },
                      i,
                    ),
                  a.createElement('span', { 'aria-live': 'assertive' }, ' ', n),
                ),
              ),
            w,
          ),
          s &&
            a.createElement(d.CloseButton, {
              'aria-label': g,
              onClick: h,
              className: c()(
                f && C()['light-close-button'],
                C()['close-button'],
              ),
              size: f ? 'xxsmall' : 'xsmall',
              preservePaddings: !f,
            }),
        );
      }
      ...
      function S(e) {
        const {
          ...
          o = (0, P.useHintShowAnimation)(r);
        return a.createElement(
          'div',
          { className: L.container, style: n },
          a.createElement(
            'div',
            ...
            a.createElement(y, {
              content: t,
              informerIntent: i,
              className: l(L.notice, o && L.noticeShowed),
            }),
          ),
        );
      }
      class k {
        constructor(e, t) {
          ((this._showed = !1),
            ...
            (this._container = e),
            (this._debouncedHide = (0, s.default)(() => this.hide(), 3e3)),
    ...
    29196: (e, t, n) => {
      ...
      function o(e) {
        ...
        return (
          (0, r.useLayoutEffect)(() => {
            const t = setTimeout(() => n(!0), i),
              r = setTimeout(() => n(!1), e ?? a);
            return () => {
