(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6645, 6155, 2303, 7122],
  {
    ...
    6060: (t) => {
      t.exports = { en: ['Add text'], th: ['เพิ่มข้อความ'] };
    },
    27567: (t) => {
      t.exports = { en: ['Bottom'], th: ['ข้างล่าง'] };
    },
    38408: (t) => {
      t.exports = { en: ['Border'], th: ['เส้นขอบ'] };
    },
    79468: (t) => {
    ...
    34974: (t) => {
      t.exports = { en: ['Label border'], th: ['ขอบของป้าย'] };
    },
    16236: (t) => {
      t.exports = { en: ['Label background'], th: ['พื้นหลังป้ายชื่อ'] };
    },
    11626: (t) => {
      t.exports = { en: ['Left'], th: ['ซ้าย'] };
    },
    97575: (t) => {
      t.exports = { en: ['Line color'], th: ['สีเส้น'] };
    },
    43154: (t) => {
    ...
    19298: (t) => {
      t.exports = {
        ...
        th: ['เปลี่ยนการมองเห็นเส้นขอบ {title}'],
      };
    },
    30839: (t) => {
      t.exports = {
