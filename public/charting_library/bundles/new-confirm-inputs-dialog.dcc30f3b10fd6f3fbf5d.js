            ...
            const e = (0, r.ensureNotNull)(t.current),
              n = () => {
                ...
                if (
                  ...
                  const o = (function (e) {
                    const n = m(e).sort(i.navigationOrderComparator),
                      o = n.find((e) => p(e, (0, r.ensureNotNull)(t.current)));
                    if (!o) return null;
          ...
          [
            ...
            function (t) {
              ...
              if (e) {
                ...
                ).filter((0, c.createScopedVisibleElementFilter)(d))).sort(
                  i.navigationOrderComparator,
                )),
                  (a = s.indexOf(o)));
              var d;
              if (0 === s.length || -1 === a) return;
              const p = (0, i.mapKeyCodeToDirection)(n);
              switch (p) {
                case 'inlinePrev':
                ...
                case 'blockNext':
                  ((n) => {
                    ...
                    const s =
                      o[
                        'blockNext' === n ? o.indexOf(i) + 1 : o.indexOf(i) - 1
                      ];
                    if (!s) return;
                    t.preventDefault();
                    const c = Array.from(s.children);
                    c.length && (!e && l <= c.length - 1 ? v(c[l]) : v(c[0]));
                  })(p);
              }
            },
          ]
