!(function (e, t) {
  ...
  ((e.ActionId = void 0),
    ...
    (t.AlertsLogRemoveFiltered = 'AlertsLog.RemoveFiltered'),
    ...
    (t.ChartDialogsShowInsertStockBonds = 'Chart.Dialogs.ShowInsertStockBonds'),
    (t.ChartDialogsShowInsertAnalysis = 'Chart.Dialogs.ShowInsertAnalysis'),
    ...
    (t.ChartOpenTableView = 'Chart.OpenTableView'),
    ...
    (t.TradingAddOrder = 'Trading.AddOrder'),
    ...
    ((W = e.ConnectionStatus || (e.ConnectionStatus = {}))[(W.Connected = 1)] =
      'Connected'),
    (W[(W.Connecting = 2)] = 'Connecting'),
    (W[(W.Disconnected = 3)] = 'Disconnected'),
    (W[(W.Error = 4)] = 'Error'),
    (function (e) {
      ((e[(e.LIMIT = 1)] = 'LIMIT'),
        (e[(e.MARKET = 2)] = 'MARKET'),
    ...
    (e.OrderType = void 0),
    ((M = e.OrderType || (e.OrderType = {}))[(M.Limit = 1)] = 'Limit'),
    (M[(M.Market = 2)] = 'Market'),
    (M[(M.Stop = 3)] = 'Stop'),
    (M[(M.StopLimit = 4)] = 'StopLimit'),
    (function (e) {
      ((e[(e.BUY = 1)] = 'BUY'), (e[(e.SELL = -1)] = 'SELL'));
    })(B || (B = {})),
    (e.Side = void 0),
    ((N = e.Side || (e.Side = {}))[(N.Buy = 1)] = 'Buy'),
    (N[(N.Sell = -1)] = 'Sell'),
    (function (e) {
    ...
    ((H = e.OrderStatus || (e.OrderStatus = {}))[(H.Canceled = 1)] =
      'Canceled'),
    (H[(H.Filled = 2)] = 'Filled'),
    (H[(H.Inactive = 3)] = 'Inactive'),
    (H[(H.Placing = 4)] = 'Placing'),
    (H[(H.Rejected = 5)] = 'Rejected'),
    (H[(H.Working = 6)] = 'Working'),
    (e.OrderStatusFilter = void 0),
    ((j = e.OrderStatusFilter || (e.OrderStatusFilter = {}))[(j.All = 0)] =
      'All'),
    (j[(j.Canceled = 1)] = 'Canceled'),
    (j[(j.Filled = 2)] = 'Filled'),
    (j[(j.Inactive = 3)] = 'Inactive'),
    (j[(j.Rejected = 5)] = 'Rejected'),
    (j[(j.Working = 6)] = 'Working'),
    (function (e) {
    ...
    (e.ParentType = void 0),
    (($ = e.ParentType || (e.ParentType = {}))[($.Order = 1)] = 'Order'),
    ($[($.Position = 2)] = 'Position'),
    ($[($.IndividualPosition = 3)] = 'IndividualPosition'),
    (function (e) {
      ((e[(e.StopLoss = 0)] = 'StopLoss'),
    ...
    ((q = e.OrderTicketFocusControl || (e.OrderTicketFocusControl = {}))[
      (q.LimitPrice = 1)
    ] = 'LimitPrice'),
    (q[(q.StopPrice = 2)] = 'StopPrice'),
    (q[(q.TakeProfit = 3)] = 'TakeProfit'),
    (q[(q.StopLoss = 4)] = 'StopLoss'),
    (q[(q.Quantity = 5)] = 'Quantity'),
    (function (e) {
      ((e[(e.ERROR = 0)] = 'ERROR'), (e[(e.SUCCESS = 1)] = 'SUCCESS'));
    })(Z || (Z = {})),
    (e.NotificationType = void 0),
    ((Q = e.NotificationType || (e.NotificationType = {}))[(Q.Error = 0)] =
      'Error'),
    (Q[(Q.Success = 1)] = 'Success'),
    (function (e) {
    ...
    ((se = e.StandardFormatterName || (e.StandardFormatterName = {})).Date =
      'date'),
    (se.DateOrDateTime = 'dateOrDateTime'),
    (se.Default = 'default'),
    (se.Fixed = 'fixed'),
    (se.FixedInCurrency = 'fixedInCurrency'),
    (se.VariablePrecision = 'variablePrecision'),
    (se.FormatQuantity = 'formatQuantity'),
    (se.FormatPrice = 'formatPrice'),
    (se.FormatPriceForexSup = 'formatPriceForexSup'),
    (se.FormatPriceInCurrency = 'formatPriceInCurrency'),
    (se.IntegerSeparated = 'integerSeparated'),
    (se.LocalDate = 'localDate'),
    (se.LocalDateOrDateTime = 'localDateOrDateTime'),
    (se.Percentage = 'percentage'),
    (se.Pips = 'pips'),
    (se.Profit = 'profit'),
    (se.ProfitInInstrumentCurrency = 'profitInInstrumentCurrency'),
    (se.ProfitInPercent = 'profitInPercent'),
    (se.Side = 'side'),
    (se.PositionSide = 'positionSide'),
    (se.Status = 'status'),
    (se.Symbol = 'symbol'),
    (se.Text = 'text'),
    (se.Type = 'type'),
    (se.MarginPercent = 'marginPercent'),
    (se.Empty = 'empty'),
    (e.OverridePriceAxisLastValueMode = void 0),
    ((le =
      e.OverridePriceAxisLastValueMode ||
      (e.OverridePriceAxisLastValueMode = {}))[
      (le.LastPriceAndPercentageValue = 0)
    ] = 'LastPriceAndPercentageValue'),
    (le[(le.LastValueAccordingToScale = 1)] = 'LastValueAccordingToScale'),
    (e.OverrideLineStyle = void 0),
    ((de = e.OverrideLineStyle || (e.OverrideLineStyle = {}))[(de.Solid = 0)] =
      'Solid'),
    ...
    (e.ChartStyle = void 0),
    ((ge = e.ChartStyle || (e.ChartStyle = {}))[(ge.Bar = 0)] = 'Bar'),
    (ge[(ge.Candle = 1)] = 'Candle'),
    (ge[(ge.Line = 2)] = 'Line'),
    (ge[(ge.Area = 3)] = 'Area'),
    (ge[(ge.Renko = 4)] = 'Renko'),
    (ge[(ge.Kagi = 5)] = 'Kagi'),
    (ge[(ge.PnF = 6)] = 'PnF'),
    (ge[(ge.LineBreak = 7)] = 'LineBreak'),
    (ge[(ge.HeikinAshi = 8)] = 'HeikinAshi'),
    (ge[(ge.HollowCandle = 9)] = 'HollowCandle'),
    (ge[(ge.Baseline = 10)] = 'Baseline'),
    (ge[(ge.Range = 11)] = 'Range'),
    (ge[(ge.HiLo = 12)] = 'HiLo'),
    (ge[(ge.Column = 13)] = 'Column'),
    (ge[(ge.LineWithMarkers = 14)] = 'LineWithMarkers'),
    (ge[(ge.Stepline = 15)] = 'Stepline'),
    (ge[(ge.HLCArea = 16)] = 'HLCArea'),
    (ge[(ge.VolFootprint = 17)] = 'VolFootprint'),
    (ge[(ge.TPO = 18)] = 'TPO'),
    (ge[(ge.VolCandle = 19)] = 'VolCandle'),
    (ge[(ge.SVP = 20)] = 'SVP'),
    (ge[(ge.HLCBars = 21)] = 'HLCBars'),
    (e.TimeHoursFormat = void 0),
    ((ue = e.TimeHoursFormat || (e.TimeHoursFormat = {})).TwentyFourHours =
      '24-hours'),
    (ue.TwelveHours = '12-hours'),
    (function (e) {
    ...
    (e.PlDisplay = void 0),
    ((Se = e.PlDisplay || (e.PlDisplay = {}))[(Se.Money = 0)] = 'Money'),
    (Se[(Se.Pips = 1)] = 'Pips'),
    (Se[(Se.Percentage = 2)] = 'Percentage'),
    (e.TradedGroupHorizontalAlignment = void 0),
    ((pe =
      e.TradedGroupHorizontalAlignment ||
      (e.TradedGroupHorizontalAlignment = {}))[(pe.Left = 0)] = 'Left'),
    ...
    ((be = e.VisibilityType || (e.VisibilityType = {})).AlwaysOn = 'alwaysOn'),
    (be.VisibleOnMouseOver = 'visibleOnMouseOver'),
    (be.AlwaysOff = 'alwaysOff'),
    (e.PriceScaleMode = void 0),
    ((Pe = e.PriceScaleMode || (e.PriceScaleMode = {}))[(Pe.Normal = 0)] =
      'Normal'),
    (Pe[(Pe.Log = 1)] = 'Log'),
    (Pe[(Pe.Percentage = 2)] = 'Percentage'),
    (Pe[(Pe.IndexedTo100 = 3)] = 'IndexedTo100'),
    (e.SeriesType = void 0),
    ((Le = e.SeriesType || (e.SeriesType = {}))[(Le.Bars = 0)] = 'Bars'),
    (Le[(Le.Candles = 1)] = 'Candles'),
    (Le[(Le.Line = 2)] = 'Line'),
    (Le[(Le.Area = 3)] = 'Area'),
    (Le[(Le.HeikenAshi = 8)] = 'HeikenAshi'),
    (Le[(Le.HollowCandles = 9)] = 'HollowCandles'),
    (Le[(Le.Baseline = 10)] = 'Baseline'),
    (Le[(Le.HiLo = 12)] = 'HiLo'),
    (Le[(Le.Column = 13)] = 'Column'),
    ...
    (Le[(Le.Renko = 4)] = 'Renko'),
    (Le[(Le.Kagi = 5)] = 'Kagi'),
    (Le[(Le.PointAndFigure = 6)] = 'PointAndFigure'),
    (Le[(Le.LineBreak = 7)] = 'LineBreak'),
    (function (e) {
      e.Value = '_seriesId';
    })(we || (we = {})),
    (function (e) {
    ...
    ((fe = e.HHistDirection || (e.HHistDirection = {})).LeftToRight =
      'left_to_right'),
    (fe.RightToLeft = 'right_to_left'),
    (function (e) {
    ...
    ((Oe = e.MarkLocation || (e.MarkLocation = {})).AboveBar = 'AboveBar'),
    (Oe.BelowBar = 'BelowBar'),
    (Oe.Top = 'Top'),
    (Oe.Bottom = 'Bottom'),
    (Oe.Right = 'Right'),
    (Oe.Left = 'Left'),
    (Oe.Absolute = 'Absolute'),
    (Oe.AbsoluteUp = 'AbsoluteUp'),
    (Oe.AbsoluteDown = 'AbsoluteDown'),
    (function (e) {
    ...
    _render(e, t, i) {
      ...
      const r = (function (e, t) {
        const i = new URL(`${e || ''}`, location.href).href,
          ...
          n = We.find((e) => e.language === r) ?? { iso: 'en', dir: 'ltr' },
