...
((exports.ActionId = void 0),
  ((e = exports.ActionId || (exports.ActionId = {})).UnknownAction =
    'UnknownAction'),
  (e.Spinner = 'Spinner'),
  (e.Loading = 'Loading'),
  ...
  (e.AlertsLogRemoveFiltered = 'AlertsLog.RemoveFiltered'),
  ...
  (e.ChartIndicatorApplyChildIndicator = 'Chart.Indicator.ApplyChildIndicator'),
  ...
  (e.ChartDialogsShowInsertStockBonds = 'Chart.Dialogs.ShowInsertStockBonds'),
  (e.ChartDialogsShowInsertAnalysis = 'Chart.Dialogs.ShowInsertAnalysis'),
  ...
  (e.ChartLegendToggleSymbolVisibility = 'Chart.Legend.ToggleSymbolVisibility'),
  (e.ChartLegendToggleVolumeVisibility = 'Chart.Legend.ToggleVolumeVisibility'),
  ...
  (e.ChartPriceScaleToggleIndexedTo100 = 'Chart.PriceScale.ToggleIndexedTo100'),
  ...
  (e.ChartSelectedObjectInsertRowTable = 'Chart.SelectedObject.InsertRowTable'),
  (e.ChartSelectedObjectInsertColumnTable =
    'Chart.SelectedObject.InsertColumnTable'),
  (e.ChartSelectedObjectRemoveRowTable = 'Chart.SelectedObject.RemoveRowTable'),
  ...
  (e.ChartSelectedObjectToggleAnchored = 'Chart.SelectedObject.ToggleAnchored'),
  ...
  (e.ChartSourceVisualOrderSendToBack = 'Chart.Source.VisualOrder.SendToBack'),
  (e.ChartSourceResetInputPoints = 'Chart.Source.ResetInputPoints'),
  (e.ChartOpenTableView = 'Chart.OpenTableView'),
  ...
  (e.ChartToggleVisibilityAllLineTools = 'Chart.ToggleVisibility.AllLineTools'),
  ...
  (e.PineEditorConsoleToggleVisibility = 'PineEditor.Console.ToggleVisibility'),
  ...
  (e.TradingAddOrder = 'Trading.AddOrder'),
  ...
  (exports.TimeFrameType = void 0),
  ((o = exports.TimeFrameType || (exports.TimeFrameType = {})).PeriodBack =
    'period-back'),
  (o.TimeRange = 'time-range'),
  (function (e) {
    ((e.PeriodBack = 'period-back'), (e.TimeRange = 'time-range'));
  })(r || (r = {})),
  (exports.MarketStatus = void 0),
  ((n = exports.MarketStatus || (exports.MarketStatus = {})).Open = 'market'),
  (n.Pre = 'pre_market'),
  (n.Post = 'post_market'),
  (n.Close = 'out_of_session'),
  (n.Holiday = 'holiday'),
  (exports.MenuItemType = void 0),
  ((a = exports.MenuItemType || (exports.MenuItemType = {})).Separator =
    'separator'),
  (a.Action = 'action'),
  (exports.ClearMarksMode = void 0),
  ((s = exports.ClearMarksMode || (exports.ClearMarksMode = {}))[(s.All = 0)] =
    'All'),
  (s[(s.BarMarks = 1)] = 'BarMarks'),
  (s[(s.TimeScaleMarks = 2)] = 'TimeScaleMarks'),
  (exports.LineStudyPlotStyle = void 0),
  ((l = exports.LineStudyPlotStyle || (exports.LineStudyPlotStyle = {}))[
    (l.Line = 0)
  ] = 'Line'),
  (l[(l.Histogram = 1)] = 'Histogram'),
  (l[(l.Cross = 3)] = 'Cross'),
  (l[(l.Area = 4)] = 'Area'),
  (l[(l.Columns = 5)] = 'Columns'),
  (l[(l.Circles = 6)] = 'Circles'),
  (l[(l.LineWithBreaks = 7)] = 'LineWithBreaks'),
  (l[(l.AreaWithBreaks = 8)] = 'AreaWithBreaks'),
  (l[(l.StepLine = 9)] = 'StepLine'),
  (l[(l.StepLineWithDiamonds = 10)] = 'StepLineWithDiamonds'),
  (l[(l.StepLineWithBreaks = 11)] = 'StepLineWithBreaks'),
  (exports.StudyPlotType = void 0),
  ((d = exports.StudyPlotType || (exports.StudyPlotType = {})).Line = 'line'),
  (d.Colorer = 'colorer'),
  (d.BarColorer = 'bar_colorer'),
  (d.BgColorer = 'bg_colorer'),
  (d.TextColorer = 'text_colorer'),
  (d.OhlcColorer = 'ohlc_colorer'),
  (d.CandleWickColorer = 'wick_colorer'),
  (d.CandleBorderColorer = 'border_colorer'),
  (d.UpColorer = 'up_colorer'),
  (d.DownColorer = 'down_colorer'),
  (d.Shapes = 'shapes'),
  (d.Chars = 'chars'),
  (d.Arrows = 'arrows'),
  (d.Data = 'data'),
  (d.DataOffset = 'dataoffset'),
  (d.OhlcOpen = 'ohlc_open'),
  (d.OhlcHigh = 'ohlc_high'),
  (d.OhlcLow = 'ohlc_low'),
  (d.OhlcClose = 'ohlc_close'),
  (function (e) {
    e.AlertCondition = 'alertcondition';
  })(c || (c = {})),
  (exports.StudyPlotDisplayTarget = void 0),
  ((h =
    exports.StudyPlotDisplayTarget || (exports.StudyPlotDisplayTarget = {}))[
    (h.None = 0)
  ] = 'None'),
  (h[(h.Pane = 1)] = 'Pane'),
  (h[(h.DataWindow = 2)] = 'DataWindow'),
  (h[(h.PriceScale = 4)] = 'PriceScale'),
  (h[(h.StatusLine = 8)] = 'StatusLine'),
  (h[(h.All = 15)] = 'All'),
  (function (e) {
    ((e[(e.None = 0)] = 'None'),
      (e[(e.Pane = 1)] = 'Pane'),
  ...
  (exports.OhlcStudyPlotStyle = void 0),
  ((u =
    exports.OhlcStudyPlotStyle || (exports.OhlcStudyPlotStyle = {})).OhlcBars =
    'ohlc_bars'),
  (u.OhlcCandles = 'ohlc_candles'),
  (function (e) {
    ((e.Auto = 'auto'),
      (e.Tiny = 'tiny'),
      (e.Small = 'small'),
  ...
  (exports.StudyInputType = void 0),
  ((p = exports.StudyInputType || (exports.StudyInputType = {})).Integer =
    'integer'),
  (p.Float = 'float'),
  (p.Price = 'price'),
  (p.Bool = 'bool'),
  ...
  (exports.StudyTargetPriceScale = void 0),
  ((P = exports.StudyTargetPriceScale || (exports.StudyTargetPriceScale = {}))[
    (P.Right = 0)
  ] = 'Right'),
  (P[(P.Left = 1)] = 'Left'),
  (P[(P.NoScale = 2)] = 'NoScale'),
  (function (e) {
    ((e[(e.Right = 0)] = 'Right'),
      (e[(e.Left = 1)] = 'Left'),
      (e[(e.None = 2)] = 'None'));
  })(L || (L = {})),
  (exports.FilledAreaType = void 0),
  ((w = exports.FilledAreaType || (exports.FilledAreaType = {})).TypePlots =
    'plot_plot'),
  ...
  (function (e) {
    ((e.Futures = 'futures'),
      (e.Options = 'options'),
      (e.Others = 'others'),
      (e.FutureAndOptions = 'futureAndOptions'));
  })(f || (f = {})),
  (function (e) {
    ((e.PerContract = 'contract'),
      (e.Fixed = 'fixed'),
      (e.Percent = 'percent'),
      (e.Disabled = 'disabled'));
  })(v || (v = {})),
  ...
  (function (e) {
    ((e[(e.Critical = 0)] = 'Critical'),
      (e[(e.Informational = 1)] = 'Informational'));
  })(R || (R = {})),
  (function (e) {
  ...
  ((V = exports.ConnectionStatus || (exports.ConnectionStatus = {}))[
    (V.Connected = 1)
  ] = 'Connected'),
  (V[(V.Connecting = 2)] = 'Connecting'),
  (V[(V.Disconnected = 3)] = 'Disconnected'),
  (V[(V.Error = 4)] = 'Error'),
  (function (e) {
    ((e[(e.LIMIT = 1)] = 'LIMIT'),
      (e[(e.MARKET = 2)] = 'MARKET'),
  ...
  ((W = exports.OrderType || (exports.OrderType = {}))[(W.Limit = 1)] =
    'Limit'),
  (W[(W.Market = 2)] = 'Market'),
  (W[(W.Stop = 3)] = 'Stop'),
  (W[(W.StopLimit = 4)] = 'StopLimit'),
  (function (e) {
    ((e[(e.BUY = 1)] = 'BUY'), (e[(e.SELL = -1)] = 'SELL'));
  })(E || (E = {})),
  (exports.Side = void 0),
  ((M = exports.Side || (exports.Side = {}))[(M.Buy = 1)] = 'Buy'),
  (M[(M.Sell = -1)] = 'Sell'),
  (function (e) {
  ...
  ((U = exports.OrderStatus || (exports.OrderStatus = {}))[(U.Canceled = 1)] =
    'Canceled'),
  (U[(U.Filled = 2)] = 'Filled'),
  (U[(U.Inactive = 3)] = 'Inactive'),
  (U[(U.Placing = 4)] = 'Placing'),
  (U[(U.Rejected = 5)] = 'Rejected'),
  (U[(U.Working = 6)] = 'Working'),
  (exports.OrderStatusFilter = void 0),
  ((H = exports.OrderStatusFilter || (exports.OrderStatusFilter = {}))[
    (H.All = 0)
  ] = 'All'),
  (H[(H.Canceled = 1)] = 'Canceled'),
  (H[(H.Filled = 2)] = 'Filled'),
  (H[(H.Inactive = 3)] = 'Inactive'),
  (H[(H.Rejected = 5)] = 'Rejected'),
  (H[(H.Working = 6)] = 'Working'),
  (function (e) {
  ...
  ((G = exports.ParentType || (exports.ParentType = {}))[(G.Order = 1)] =
    'Order'),
  (G[(G.Position = 2)] = 'Position'),
  (G[(G.IndividualPosition = 3)] = 'IndividualPosition'),
  (function (e) {
    ((e[(e.StopLoss = 0)] = 'StopLoss'),
  ...
  (exports.OrderTicketFocusControl = void 0),
  ((K =
    exports.OrderTicketFocusControl || (exports.OrderTicketFocusControl = {}))[
    (K.LimitPrice = 1)
  ] = 'LimitPrice'),
  (K[(K.StopPrice = 2)] = 'StopPrice'),
  (K[(K.TakeProfit = 3)] = 'TakeProfit'),
  (K[(K.StopLoss = 4)] = 'StopLoss'),
  (K[(K.Quantity = 5)] = 'Quantity'),
  (function (e) {
    ((e[(e.ERROR = 0)] = 'ERROR'), (e[(e.SUCCESS = 1)] = 'SUCCESS'));
  })(q || (q = {})),
  (exports.NotificationType = void 0),
  ((Z = exports.NotificationType || (exports.NotificationType = {}))[
    (Z.Error = 0)
  ] = 'Error'),
  ...
  (exports.OrderOrPositionMessageType = void 0),
  ((Y =
    exports.OrderOrPositionMessageType ||
    (exports.OrderOrPositionMessageType = {})).Information = 'information'),
  (Y.Warning = 'warning'),
  (Y.Error = 'error'),
  (function (e) {
  ...
  (function (e) {
    ((e.PlaceOrder = 'place_order'),
      ...
      (e.CancelMultipleOrders = 'cancel_multiple_orders'),
  ...
  (exports.StandardFormatterName = void 0),
  ((ae =
    exports.StandardFormatterName ||
    (exports.StandardFormatterName = {})).Date = 'date'),
  (ae.DateOrDateTime = 'dateOrDateTime'),
  (ae.Default = 'default'),
  (ae.Fixed = 'fixed'),
  (ae.FixedInCurrency = 'fixedInCurrency'),
  (ae.VariablePrecision = 'variablePrecision'),
  (ae.FormatQuantity = 'formatQuantity'),
  (ae.FormatPrice = 'formatPrice'),
  (ae.FormatPriceForexSup = 'formatPriceForexSup'),
  (ae.FormatPriceInCurrency = 'formatPriceInCurrency'),
  (ae.IntegerSeparated = 'integerSeparated'),
  (ae.LocalDate = 'localDate'),
  (ae.LocalDateOrDateTime = 'localDateOrDateTime'),
  (ae.Percentage = 'percentage'),
  (ae.Pips = 'pips'),
  (ae.Profit = 'profit'),
  (ae.ProfitInInstrumentCurrency = 'profitInInstrumentCurrency'),
  (ae.ProfitInPercent = 'profitInPercent'),
  (ae.Side = 'side'),
  (ae.PositionSide = 'positionSide'),
  (ae.Status = 'status'),
  (ae.Symbol = 'symbol'),
  (ae.Text = 'text'),
  (ae.Type = 'type'),
  (ae.MarginPercent = 'marginPercent'),
  (ae.Empty = 'empty'),
  (exports.OverridePriceAxisLastValueMode = void 0),
  ((se =
    exports.OverridePriceAxisLastValueMode ||
    (exports.OverridePriceAxisLastValueMode = {}))[
    (se.LastPriceAndPercentageValue = 0)
  ] = 'LastPriceAndPercentageValue'),
  (se[(se.LastValueAccordingToScale = 1)] = 'LastValueAccordingToScale'),
  (exports.OverrideLineStyle = void 0),
  ((le = exports.OverrideLineStyle || (exports.OverrideLineStyle = {}))[
    (le.Solid = 0)
  ] = 'Solid'),
  (le[(le.Dotted = 1)] = 'Dotted'),
  (le[(le.Dashed = 2)] = 'Dashed'),
  (function (e) {
  ...
  ((he = exports.ChartStyle || (exports.ChartStyle = {}))[(he.Bar = 0)] =
    'Bar'),
  (he[(he.Candle = 1)] = 'Candle'),
  (he[(he.Line = 2)] = 'Line'),
  (he[(he.Area = 3)] = 'Area'),
  (he[(he.Renko = 4)] = 'Renko'),
  (he[(he.Kagi = 5)] = 'Kagi'),
  (he[(he.PnF = 6)] = 'PnF'),
  (he[(he.LineBreak = 7)] = 'LineBreak'),
  (he[(he.HeikinAshi = 8)] = 'HeikinAshi'),
  (he[(he.HollowCandle = 9)] = 'HollowCandle'),
  (he[(he.Baseline = 10)] = 'Baseline'),
  (he[(he.Range = 11)] = 'Range'),
  (he[(he.HiLo = 12)] = 'HiLo'),
  (he[(he.Column = 13)] = 'Column'),
  (he[(he.LineWithMarkers = 14)] = 'LineWithMarkers'),
  (he[(he.Stepline = 15)] = 'Stepline'),
  (he[(he.HLCArea = 16)] = 'HLCArea'),
  (he[(he.VolFootprint = 17)] = 'VolFootprint'),
  (he[(he.TPO = 18)] = 'TPO'),
  (he[(he.VolCandle = 19)] = 'VolCandle'),
  (he[(he.SVP = 20)] = 'SVP'),
  (he[(he.HLCBars = 21)] = 'HLCBars'),
  (exports.TimeHoursFormat = void 0),
  ((ge =
    exports.TimeHoursFormat || (exports.TimeHoursFormat = {})).TwentyFourHours =
    '24-hours'),
  (ge.TwelveHours = '12-hours'),
  (function (e) {
    ((e[(e.Initial = 2)] = 'Initial'),
      (e[(e.SeriesZOrderIsAlwaysZero = 3)] = 'SeriesZOrderIsAlwaysZero'),
      (e[(e.Current = 3)] = 'Current'));
  })(ue || (ue = {})),
  (exports.PlDisplay = void 0),
  ((Ce = exports.PlDisplay || (exports.PlDisplay = {}))[(Ce.Money = 0)] =
    'Money'),
  (Ce[(Ce.Pips = 1)] = 'Pips'),
  (Ce[(Ce.Percentage = 2)] = 'Percentage'),
  (exports.TradedGroupHorizontalAlignment = void 0),
  ((pe =
    exports.TradedGroupHorizontalAlignment ||
    (exports.TradedGroupHorizontalAlignment = {}))[(pe.Left = 0)] = 'Left'),
  (pe[(pe.Center = 1)] = 'Center'),
  (pe[(pe.Right = 2)] = 'Right'),
  exports.PlDisplay.Money,
  exports.PlDisplay.Money,
  exports.TradedGroupHorizontalAlignment.Right,
  (function (e) {
  ...
  ((_e = exports.VisibilityType || (exports.VisibilityType = {})).AlwaysOn =
    'alwaysOn'),
  (_e.VisibleOnMouseOver = 'visibleOnMouseOver'),
  (_e.AlwaysOff = 'alwaysOff'),
  (exports.PriceScaleMode = void 0),
  ((be = exports.PriceScaleMode || (exports.PriceScaleMode = {}))[
    (be.Normal = 0)
  ] = 'Normal'),
  (be[(be.Log = 1)] = 'Log'),
  (be[(be.Percentage = 2)] = 'Percentage'),
  (be[(be.IndexedTo100 = 3)] = 'IndexedTo100'),
  (exports.SeriesType = void 0),
  ((Pe = exports.SeriesType || (exports.SeriesType = {}))[(Pe.Bars = 0)] =
    'Bars'),
  (Pe[(Pe.Candles = 1)] = 'Candles'),
  (Pe[(Pe.Line = 2)] = 'Line'),
  (Pe[(Pe.Area = 3)] = 'Area'),
  (Pe[(Pe.HeikenAshi = 8)] = 'HeikenAshi'),
  (Pe[(Pe.HollowCandles = 9)] = 'HollowCandles'),
  (Pe[(Pe.Baseline = 10)] = 'Baseline'),
  (Pe[(Pe.HiLo = 12)] = 'HiLo'),
  (Pe[(Pe.Column = 13)] = 'Column'),
  (Pe[(Pe.LineWithMarkers = 14)] = 'LineWithMarkers'),
  (Pe[(Pe.Stepline = 15)] = 'Stepline'),
  (Pe[(Pe.HLCArea = 16)] = 'HLCArea'),
  (Pe[(Pe.VolCandle = 19)] = 'VolCandle'),
  (Pe[(Pe.HLCBars = 21)] = 'HLCBars'),
  (Pe[(Pe.Renko = 4)] = 'Renko'),
  (Pe[(Pe.Kagi = 5)] = 'Kagi'),
  (Pe[(Pe.PointAndFigure = 6)] = 'PointAndFigure'),
  (Pe[(Pe.LineBreak = 7)] = 'LineBreak'),
  (function (e) {
    e.Value = '_seriesId';
  })(Le || (Le = {})),
  (function (e) {
  ...
  (exports.HHistDirection = void 0),
  ((Ae = exports.HHistDirection || (exports.HHistDirection = {})).LeftToRight =
    'left_to_right'),
  (Ae.RightToLeft = 'right_to_left'),
  (function (e) {
  ...
  (exports.MarkLocation = void 0),
  ((Ie = exports.MarkLocation || (exports.MarkLocation = {})).AboveBar =
    'AboveBar'),
  (Ie.BelowBar = 'BelowBar'),
  (Ie.Top = 'Top'),
  (Ie.Bottom = 'Bottom'),
  (Ie.Right = 'Right'),
  (Ie.Left = 'Left'),
  (Ie.Absolute = 'Absolute'),
  (Ie.AbsoluteUp = 'AbsoluteUp'),
  (Ie.AbsoluteDown = 'AbsoluteDown'),
  (function (e) {
  ...
  ((De = exports.LineStyle || (exports.LineStyle = {}))[(De.Solid = 0)] =
    'Solid'),
  (De[(De.Dotted = 1)] = 'Dotted'),
  (De[(De.Dashed = 2)] = 'Dashed'));
const ke = {
    width: 800,
    height: 500,
    interval: '1D',
...
const Ee = class {
  ...
  applyOverrides(e) {
    ((this._options = xe(this._options, { overrides: e })),
      this._doWhenInnerWindowLoaded((t) => {
        t.applyOverrides(e);
      }));
  }
  applyTradingCustomization(e) {
    return new Promise((t, i) => {
      this._doWhenInnerWindowLoaded((o) => {
        o.applyTradingCustomization(e).then(t).catch(i);
      });
    });
  }
  ...
  setLayoutSizes(e, t) {
    this._innerAPI().setLayoutSizes(e, t);
  }
  changeTheme(e, t) {
  ...
  async _create() {
    const e =
      ...
      i =
        e &&
        (this._options.enabled_features?.includes('iframe_loading_root_path') ??
          !1),
      [o, r] = this._render(!t, e, i),
      n = this._options.container,
      a = 'string' == typeof n ? document.getElementById(n) : n;
    if (null === a)
      throw new Error(`There is no such element - #${this._options.container}`);
    ((a.innerHTML = o), (this._iFrame = a.querySelector(`#${this._id}`)));
    const s = this._iFrame;
    (e && (await this._innerWindowEvent('sameOriginLoad')),
      ...
      (this._options.autosize || this._options.fullscreen) &&
        ((s.style.width = '100%'),
        this._options.fullscreen || (s.style.height = '100%')),
  ...
  _render(e, t, i) {
    ...
    const r = (function (e, t) {
      const i = new URL(`${e || ''}`, location.href).href,
        o = JSON.parse(
          '["bundles/runtime.1d4ed3742895f7c63ed9.js","bundles/__LANG__.938.5f20502c9172fdac1c7f.js","bundles/481.7c6283292170510c91f1.css","bundles/8971.352a74bc5eebf8040884.js","bundles/library.15664647653f41254b4d.js"]',
        ),
        r = encodeURIComponent(t),
        n = Ve.find((e) => e.language === r) ?? { iso: 'en', dir: 'ltr' },
    ...
    if (e) {
      ...
      const e = this._options.library_path ?? '/',
        t = i ? location.origin : location.href;
      n = new URL(e + 'sameorigin.html', t);
    }
    const a =
      'symbol=' +
...
((exports.version = We), (exports.widget = Ee));
