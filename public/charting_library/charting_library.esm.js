...
(!(function (e) {
  ...
  (function (e) {
    ((e.Date = 'date'),
      ...
      (e.ProfitInPercent = 'profitInPercent'),
      (e.Side = 'side'),
...
export {
  ...
  he as ChartStyle,
  s as ClearMarksMode,
  W as ConnectionStatus,
  f as FilledAreaType,
  we as HHistDirection,
  l as LineStudyPlotStyle,
  De as LineStyle,
  ve as MarkLocation,
  n as MarketStatus,
  a as MenuItemType,
  Z as NotificationType,
  u as OhlcStudyPlotStyle,
  Y as OrderOrPositionMessageType,
  x as OrderStatus,
  H as OrderStatusFilter,
  K as OrderTicketFocusControl,
  F as OrderType,
  le as OverrideLineStyle,
  se as OverridePriceAxisLastValueMode,
  G as ParentType,
  Ce as PlDisplay,
  be as PriceScaleMode,
  Pe as SeriesType,
  B as Side,
  ae as StandardFormatterName,
  S as StudyInputType,
  h as StudyPlotDisplayTarget,
  c as StudyPlotType,
  P as StudyTargetPriceScale,
  o as TimeFrameType,
  ge as TimeHoursFormat,
  Se as TradedGroupHorizontalAlignment,
  Te as VisibilityType,
  Fe as version,
  Me as widget,
};
